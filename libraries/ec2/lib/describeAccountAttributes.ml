...
let to_http service region req =
  let uri =
    Uri.add_query_params
      ...
      (List.append
         [ "Version", [ "2016-11-15" ]; "Action", [ "DescribeAccountAttributes" ] ]
         (Util.drop_empty
  ...
  try
    ...
    try
      Util.or_error
        ...
        BadResponse
          { body
          ; message = "Could not find well formed DescribeAccountAttributesResult."
          })
    with Xml.RequiredFieldMissing msg ->
      ...
      `Error
        (BadResponse
           { body
           ; message =
               "Error parsing DescribeAccountAttributesResult - missing field in body or \
                children: "
               ^ msg
           })
  with Failure msg ->
