...
module ReplaceableAttribute = struct
  ...
  let parse xml =
    Some
      ...
      ; replace = Util.option_bind (Xml.member "Replace" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.replace (fun f -> Query.Pair ("Replace", Boolean.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.replace (fun f -> "replace", Boolean.to_json f)
...
module Attribute = struct
  ...
  let parse xml =
    Some
      ...
      ; alternate_name_encoding =
          Util.option_bind (Xml.member "AlternateNameEncoding" xml) String.parse
      ; value =
          Xml.required "Value" (Util.option_bind (Xml.member "Value" xml) String.parse)
      ; alternate_value_encoding =
          Util.option_bind (Xml.member "AlternateValueEncoding" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.alternate_value_encoding (fun f ->
               Query.Pair ("AlternateValueEncoding", String.to_query f))
         ; Some (Query.Pair ("Value", String.to_query v.value))
         ; Util.option_map v.alternate_name_encoding (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.alternate_value_encoding (fun f ->
               "alternate_value_encoding", String.to_json f)
         ; Some ("value", String.to_json v.value)
         ; Util.option_map v.alternate_name_encoding (fun f ->
               "alternate_name_encoding", String.to_json f)
         ; Some ("name", String.to_json v.name)
         ])
  ...
  let of_json j =
    { name = String.of_json (Util.of_option_exn (Json.lookup j "name"))
    ; alternate_name_encoding =
        Util.option_map (Json.lookup j "alternate_name_encoding") String.of_json
    ; value = String.of_json (Util.of_option_exn (Json.lookup j "value"))
    ; alternate_value_encoding =
        Util.option_map (Json.lookup j "alternate_value_encoding") String.of_json
    }
end
...
module ReplaceableAttributeList = struct
  ...
  let parse xml =
    Util.option_all (List.map ReplaceableAttribute.parse (Xml.members "Attribute" xml))
...
module AttributeList = struct
  ...
  let parse xml = Util.option_all (List.map Attribute.parse (Xml.members "Attribute" xml))
...
module ReplaceableItem = struct
  ...
  let parse xml =
    Some
      ...
      ; attributes = Xml.required "Attributes" (ReplaceableAttributeList.parse xml)
      }
  ...
  let of_json j =
    { name = String.of_json (Util.of_option_exn (Json.lookup j "name"))
    ; attributes =
        ReplaceableAttributeList.of_json (Util.of_option_exn (Json.lookup j "attributes"))
    }
end
...
module DeletableItem = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Attributes.member", AttributeList.to_query v.attributes))
         ; Some (Query.Pair ("ItemName", String.to_query v.name))
         ])
  ...
  let of_json j =
    { name = String.of_json (Util.of_option_exn (Json.lookup j "name"))
    ; attributes = AttributeList.of_json (Util.of_option_exn (Json.lookup j "attributes"))
    }
end
...
module UpdateCondition = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.exists (fun f -> Query.Pair ("Exists", Boolean.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.exists (fun f -> "exists", Boolean.to_json f)
...
module ReplaceableItemList = struct
  ...
  let parse xml =
    Util.option_all (List.map ReplaceableItem.parse (Xml.members "Item" xml))
...
module AttributeNameList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "AttributeName" xml))
...
module DeletableItemList = struct
  ...
  let parse xml = Util.option_all (List.map DeletableItem.parse (Xml.members "Item" xml))
...
module ItemList = struct
  ...
  let parse xml = Util.option_all (List.map Item.parse (Xml.members "Item" xml))
...
module DomainNameList = struct
  ...
  let parse xml = Util.option_all (List.map String.parse (Xml.members "DomainName" xml))
...
module DeleteAttributesRequest = struct
    ...
    Some
      ...
      ; item_name =
          Xml.required
            ...
            (Util.option_bind (Xml.member "ItemName" xml) String.parse)
      ; attributes = Util.of_option [] (AttributeList.parse xml)
      ; expected = Util.option_bind (Xml.member "Expected" xml) UpdateCondition.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.expected (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.expected (fun f -> "expected", UpdateCondition.to_json f)
         ; Some ("attributes", AttributeList.to_json v.attributes)
  ...
  let of_json j =
    { domain_name = String.of_json (Util.of_option_exn (Json.lookup j "domain_name"))
    ; item_name = String.of_json (Util.of_option_exn (Json.lookup j "item_name"))
    ; attributes = AttributeList.of_json (Util.of_option_exn (Json.lookup j "attributes"))
    ; expected = Util.option_map (Json.lookup j "expected") UpdateCondition.of_json
    }
end
...
module NumberDomainBytesExceeded = struct
  ...
  let parse xml =
    Some { box_usage = Util.option_bind (Xml.member "BoxUsage" xml) Float.parse }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.box_usage (fun f ->
               Query.Pair ("BoxUsage", Float.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.box_usage (fun f -> "box_usage", Float.to_json f) ])

  let of_json j =
    { box_usage = Util.option_map (Json.lookup j "box_usage") Float.of_json }
end
...
module BatchPutAttributesRequest = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Items.member", ReplaceableItemList.to_query v.items))
         ; Some (Query.Pair ("DomainName", String.to_query v.domain_name))
         ])
  ...
  let of_json j =
    { domain_name = String.of_json (Util.of_option_exn (Json.lookup j "domain_name"))
    ; items = ReplaceableItemList.of_json (Util.of_option_exn (Json.lookup j "items"))
    }
end
...
module GetAttributesRequest = struct
  ...
  let parse xml =
    Some
      ...
      ; consistent_read = Util.option_bind (Xml.member "ConsistentRead" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.consistent_read (fun f ->
               Query.Pair ("ConsistentRead", Boolean.to_query f))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.consistent_read (fun f ->
               "consistent_read", Boolean.to_json f)
  ...
  let of_json j =
    ...
    ; consistent_read = Util.option_map (Json.lookup j "consistent_read") Boolean.of_json
    }
end
...
module GetAttributesResult = struct
  ...
  let parse xml = Some { attributes = Util.of_option [] (AttributeList.parse xml) }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Some ("attributes", AttributeList.to_json v.attributes) ])
...
module BatchDeleteAttributesRequest = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Items.member", DeletableItemList.to_query v.items))
         ; Some (Query.Pair ("DomainName", String.to_query v.domain_name))
         ])
  ...
  let of_json j =
    { domain_name = String.of_json (Util.of_option_exn (Json.lookup j "domain_name"))
    ; items = DeletableItemList.of_json (Util.of_option_exn (Json.lookup j "items"))
    }
end
...
module DomainMetadataRequest = struct
  ...
  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("domain_name", String.to_json v.domain_name) ])
...
module SelectResult = struct
  ...
  let of_json j =
    { items = ItemList.of_json (Util.of_option_exn (Json.lookup j "items"))
  ...
  let parse xml =
    Some
      { max_number_of_domains =
          Util.option_bind (Xml.member "MaxNumberOfDomains" xml) Integer.parse
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Util.option_map v.max_number_of_domains (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Util.option_map v.max_number_of_domains (fun f ->
               "max_number_of_domains", Integer.to_json f)
         ])

  let of_json j =
    { max_number_of_domains =
        Util.option_map (Json.lookup j "max_number_of_domains") Integer.of_json
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module SelectRequest = struct
  ...
  let parse xml =
    Some
      { select_expression =
          Xml.required
            "SelectExpression"
            (Util.option_bind (Xml.member "SelectExpression" xml) String.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      ; consistent_read = Util.option_bind (Xml.member "ConsistentRead" xml) Boolean.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some (Query.Pair ("SelectExpression", String.to_query v.select_expression))
         ])
  ...
  let of_json j =
    { select_expression =
        String.of_json (Util.of_option_exn (Json.lookup j "select_expression"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    ; consistent_read = Util.option_map (Json.lookup j "consistent_read") Boolean.of_json
    }
end
...
module DomainMetadataResult = struct
  ...
  let parse xml =
    Some
      { item_count = Util.option_bind (Xml.member "ItemCount" xml) Integer.parse
      ; item_names_size_bytes =
          Util.option_bind (Xml.member "ItemNamesSizeBytes" xml) Long.parse
      ; attribute_name_count =
          Util.option_bind (Xml.member "AttributeNameCount" xml) Integer.parse
      ; attribute_names_size_bytes =
          Util.option_bind (Xml.member "AttributeNamesSizeBytes" xml) Long.parse
      ; attribute_value_count =
          Util.option_bind (Xml.member "AttributeValueCount" xml) Integer.parse
      ; attribute_values_size_bytes =
          Util.option_bind (Xml.member "AttributeValuesSizeBytes" xml) Long.parse
      ; timestamp = Util.option_bind (Xml.member "Timestamp" xml) Integer.parse
      }
    ...
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.timestamp (fun f ->
               Query.Pair ("Timestamp", Integer.to_query f))
         ; Util.option_map v.attribute_values_size_bytes (fun f ->
               Query.Pair ("AttributeValuesSizeBytes", Long.to_query f))
         ; Util.option_map v.attribute_value_count (fun f ->
               Query.Pair ("AttributeValueCount", Integer.to_query f))
         ; Util.option_map v.attribute_names_size_bytes (fun f ->
               Query.Pair ("AttributeNamesSizeBytes", Long.to_query f))
         ; Util.option_map v.attribute_name_count (fun f ->
               Query.Pair ("AttributeNameCount", Integer.to_query f))
         ; Util.option_map v.item_names_size_bytes (fun f ->
               Query.Pair ("ItemNamesSizeBytes", Long.to_query f))
         ; Util.option_map v.item_count (fun f ->
               Query.Pair ("ItemCount", Integer.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.timestamp (fun f -> "timestamp", Integer.to_json f)
         ; Util.option_map v.attribute_values_size_bytes (fun f ->
               "attribute_values_size_bytes", Long.to_json f)
         ; Util.option_map v.attribute_value_count (fun f ->
               "attribute_value_count", Integer.to_json f)
         ; Util.option_map v.attribute_names_size_bytes (fun f ->
               "attribute_names_size_bytes", Long.to_json f)
         ; Util.option_map v.attribute_name_count (fun f ->
               "attribute_name_count", Integer.to_json f)
         ; Util.option_map v.item_names_size_bytes (fun f ->
               "item_names_size_bytes", Long.to_json f)
         ; Util.option_map v.item_count (fun f -> "item_count", Integer.to_json f)
         ])

  let of_json j =
    { item_count = Util.option_map (Json.lookup j "item_count") Integer.of_json
    ; item_names_size_bytes =
        Util.option_map (Json.lookup j "item_names_size_bytes") Long.of_json
    ; attribute_name_count =
        Util.option_map (Json.lookup j "attribute_name_count") Integer.of_json
    ; attribute_names_size_bytes =
        Util.option_map (Json.lookup j "attribute_names_size_bytes") Long.of_json
    ; attribute_value_count =
        Util.option_map (Json.lookup j "attribute_value_count") Integer.of_json
    ; attribute_values_size_bytes =
        Util.option_map (Json.lookup j "attribute_values_size_bytes") Long.of_json
    ; timestamp = Util.option_map (Json.lookup j "timestamp") Integer.of_json
    }
end
...
module ListDomainsResult = struct
    ...
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some
             (Query.Pair ("DomainNames.member", DomainNameList.to_query v.domain_names))
         ])
  ...
  let of_json j =
    { domain_names =
        DomainNameList.of_json (Util.of_option_exn (Json.lookup j "domain_names"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
