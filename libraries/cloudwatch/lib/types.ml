...
module MetricStat = struct
  ...
  let parse xml =
    Some
      { metric =
          Xml.required "Metric" (Util.option_bind (Xml.member "Metric" xml) Metric.parse)
      ; period =
          Xml.required "Period" (Util.option_bind (Xml.member "Period" xml) Integer.parse)
      ; stat = Xml.required "Stat" (Util.option_bind (Xml.member "Stat" xml) String.parse)
  ...
  let of_json j =
    { metric = Metric.of_json (Util.of_option_exn (Json.lookup j "metric"))
...
module InsightRuleContributorDatapoint = struct
  ...
  let parse xml =
    Some
      ...
      ; approximate_value =
          Xml.required
            "ApproximateValue"
            (Util.option_bind (Xml.member "ApproximateValue" xml) Double.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("ApproximateValue", Double.to_query v.approximate_value))
  ...
  let of_json j =
    ...
    ; approximate_value =
        Double.of_json (Util.of_option_exn (Json.lookup j "approximate_value"))
    }
end
...
module AnomalyDetectorExcludedTimeRanges = struct
  ...
  let parse xml = Util.option_all (List.map Range.parse (Xml.members "member" xml))
...
module MetricDataQuery = struct
  ...
  let parse xml =
    Some
      ...
      ; metric_stat = Util.option_bind (Xml.member "MetricStat" xml) MetricStat.parse
      ; expression = Util.option_bind (Xml.member "Expression" xml) String.parse
      ; label = Util.option_bind (Xml.member "Label" xml) String.parse
      ; return_data = Util.option_bind (Xml.member "ReturnData" xml) Boolean.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.return_data (fun f ->
               Query.Pair ("ReturnData", Boolean.to_query f))
         ; Util.option_map v.label (fun f -> Query.Pair ("Label", String.to_query f))
         ; Util.option_map v.expression (fun f ->
               Query.Pair ("Expression", String.to_query f))
         ; Util.option_map v.metric_stat (fun f ->
               Query.Pair ("MetricStat", MetricStat.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.return_data (fun f -> "return_data", Boolean.to_json f)
         ; Util.option_map v.label (fun f -> "label", String.to_json f)
         ; Util.option_map v.expression (fun f -> "expression", String.to_json f)
         ; Util.option_map v.metric_stat (fun f -> "metric_stat", MetricStat.to_json f)
         ; Some ("id", String.to_json v.id)
         ])

  let of_json j =
    { id = String.of_json (Util.of_option_exn (Json.lookup j "id"))
    ; metric_stat = Util.option_map (Json.lookup j "metric_stat") MetricStat.of_json
    ; expression = Util.option_map (Json.lookup j "expression") String.of_json
    ; label = Util.option_map (Json.lookup j "label") String.of_json
    ; return_data = Util.option_map (Json.lookup j "return_data") Boolean.of_json
...
module InsightRuleContributorDatapoints = struct
  ...
  let parse xml =
    Util.option_all
      (List.map InsightRuleContributorDatapoint.parse (Xml.members "member" xml))

  let to_query v = Query.to_query_list InsightRuleContributorDatapoint.to_query v
...
module AnomalyDetectorConfiguration = struct
    ...
    Some
      { excluded_time_ranges =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ExcludedTimeRanges" xml)
               AnomalyDetectorExcludedTimeRanges.parse)
      ; metric_timezone = Util.option_bind (Xml.member "MetricTimezone" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.metric_timezone (fun f ->
               Query.Pair ("MetricTimezone", String.to_query f))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.metric_timezone (fun f ->
               "metric_timezone", String.to_json f)
         ; Some
             ( "excluded_time_ranges"
  ...
  let of_json j =
    ...
    ; metric_timezone = Util.option_map (Json.lookup j "metric_timezone") String.of_json
    }
end
...
module MetricDataQueries = struct
  ...
  let parse xml =
    Util.option_all (List.map MetricDataQuery.parse (Xml.members "member" xml))
...
module DatapointValues = struct
  ...
  let parse xml = Util.option_all (List.map Double.parse (Xml.members "member" xml))
...
module MetricDataResultMessages = struct
  ...
  let parse xml = Util.option_all (List.map MessageData.parse (Xml.members "member" xml))
...
module Timestamps = struct
  ...
  let parse xml = Util.option_all (List.map DateTime.parse (Xml.members "member" xml))
...
module DatapointValueMap = struct
  ...
  let to_query v = Query.to_query_hashtbl String.to_string Double.to_query v
...
module AlarmHistoryItem = struct
  ...
  let parse xml =
    Some
      ...
      ; alarm_type = Util.option_bind (Xml.member "AlarmType" xml) AlarmType.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.alarm_type (fun f ->
               Query.Pair ("AlarmType", AlarmType.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.alarm_type (fun f -> "alarm_type", AlarmType.to_json f)
  ...
  let of_json j =
    ...
    ; alarm_type = Util.option_map (Json.lookup j "alarm_type") AlarmType.of_json
...
module PartialFailure = struct
  ...
  let parse xml =
    Some
      ...
      ; exception_type = Util.option_bind (Xml.member "ExceptionType" xml) String.parse
      ; failure_code = Util.option_bind (Xml.member "FailureCode" xml) String.parse
      ; failure_description =
          Util.option_bind (Xml.member "FailureDescription" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.failure_description (fun f ->
         ...
         ; Util.option_map v.exception_type (fun f ->
               Query.Pair ("ExceptionType", String.to_query f))
         ; Util.option_map v.failure_resource (fun f ->
               Query.Pair ("FailureResource", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.failure_description (fun f ->
               "failure_description", String.to_json f)
         ; Util.option_map v.failure_code (fun f -> "failure_code", String.to_json f)
         ; Util.option_map v.exception_type (fun f -> "exception_type", String.to_json f)
         ; Util.option_map v.failure_resource (fun f ->
               "failure_resource", String.to_json f)
         ])

  let of_json j =
    { failure_resource = Util.option_map (Json.lookup j "failure_resource") String.of_json
    ; exception_type = Util.option_map (Json.lookup j "exception_type") String.of_json
    ; failure_code = Util.option_map (Json.lookup j "failure_code") String.of_json
    ; failure_description =
        Util.option_map (Json.lookup j "failure_description") String.of_json
    }
end
  ...
  let parse xml =
    Some
      { keys =
          Xml.required
            "Keys"
            (Util.option_bind (Xml.member "Keys" xml) InsightRuleContributorKeys.parse)
      ; approximate_aggregate_value =
          Xml.required
            "ApproximateAggregateValue"
            (Util.option_bind (Xml.member "ApproximateAggregateValue" xml) Double.parse)
      ; datapoints =
          Xml.required
            "Datapoints"
            (Util.option_bind
               (Xml.member "Datapoints" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("Keys.member", InsightRuleContributorKeys.to_query v.keys))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some
             ("approximate_aggregate_value", Double.to_json v.approximate_aggregate_value)
         ; Some ("keys", InsightRuleContributorKeys.to_json v.keys)
         ])

  let of_json j =
    { keys =
        InsightRuleContributorKeys.of_json (Util.of_option_exn (Json.lookup j "keys"))
    ; approximate_aggregate_value =
        Double.of_json (Util.of_option_exn (Json.lookup j "approximate_aggregate_value"))
    ; datapoints =
...
module InsightRuleMetricDatapoint = struct
    ...
    Some
      { timestamp =
          Xml.required
            ...
            (Util.option_bind (Xml.member "Timestamp" xml) DateTime.parse)
      ; unique_contributors =
          Util.option_bind (Xml.member "UniqueContributors" xml) Double.parse
      ; max_contributor_value =
          Util.option_bind (Xml.member "MaxContributorValue" xml) Double.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.max_contributor_value (fun f ->
               Query.Pair ("MaxContributorValue", Double.to_query f))
         ; Util.option_map v.unique_contributors (fun f ->
               Query.Pair ("UniqueContributors", Double.to_query f))
         ; Some (Query.Pair ("Timestamp", DateTime.to_query v.timestamp))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.max_contributor_value (fun f ->
               "max_contributor_value", Double.to_json f)
         ; Util.option_map v.unique_contributors (fun f ->
               "unique_contributors", Double.to_json f)
         ; Some ("timestamp", DateTime.to_json v.timestamp)
         ])
  ...
  let of_json j =
    { timestamp = DateTime.of_json (Util.of_option_exn (Json.lookup j "timestamp"))
    ; unique_contributors =
        Util.option_map (Json.lookup j "unique_contributors") Double.of_json
    ; max_contributor_value =
        Util.option_map (Json.lookup j "max_contributor_value") Double.of_json
...
module DashboardValidationMessage = struct
  ...
  let parse xml =
    Some
      { data_path = Util.option_bind (Xml.member "DataPath" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.data_path (fun f ->
               Query.Pair ("DataPath", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.data_path (fun f -> "data_path", String.to_json f)
         ])

  let of_json j =
    { data_path = Util.option_map (Json.lookup j "data_path") String.of_json
...
module AnomalyDetector = struct
  ...
  let parse xml =
    Some
      ...
      ; configuration =
          Util.option_bind
            (Xml.member "Configuration" xml)
            AnomalyDetectorConfiguration.parse
      ; state_value =
          Util.option_bind (Xml.member "StateValue" xml) AnomalyDetectorStateValue.parse
      }
    ...
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.state_value (fun f ->
               Query.Pair ("StateValue", AnomalyDetectorStateValue.to_query f))
         ; Util.option_map v.configuration (fun f ->
               Query.Pair ("Configuration", AnomalyDetectorConfiguration.to_query f))
         ; Util.option_map v.stat (fun f -> Query.Pair ("Stat", String.to_query f))
         ; Some (Query.Pair ("Dimensions.member", Dimensions.to_query v.dimensions))
         ; Util.option_map v.metric_name (fun f ->
               Query.Pair ("MetricName", String.to_query f))
         ; Util.option_map v.namespace (fun f ->
  ...
  let of_json j =
    ...
    ; configuration =
        Util.option_map
          (Json.lookup j "configuration")
          AnomalyDetectorConfiguration.of_json
    ; state_value =
        Util.option_map (Json.lookup j "state_value") AnomalyDetectorStateValue.of_json
    }
end
...
module CompositeAlarm = struct
  ...
  let parse xml =
    Some
      ...
      ; alarm_name = Util.option_bind (Xml.member "AlarmName" xml) String.parse
      ; alarm_rule = Util.option_bind (Xml.member "AlarmRule" xml) String.parse
      ; insufficient_data_actions =
          Util.of_option
            []
            (Util.option_bind
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.alarm_rule (fun f ->
               Query.Pair ("AlarmRule", String.to_query f))
         ; Util.option_map v.alarm_name (fun f ->
               Query.Pair ("AlarmName", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.alarm_rule (fun f -> "alarm_rule", String.to_json f)
         ; Util.option_map v.alarm_name (fun f -> "alarm_name", String.to_json f)
         ; Util.option_map v.alarm_description (fun f ->
  ...
  let of_json j =
    ...
    ; alarm_name = Util.option_map (Json.lookup j "alarm_name") String.of_json
    ; alarm_rule = Util.option_map (Json.lookup j "alarm_rule") String.of_json
    ; insufficient_data_actions =
...
module MetricAlarm = struct
  ...
  let parse xml =
    Some
      ...
      ; extended_statistic =
          Util.option_bind (Xml.member "ExtendedStatistic" xml) String.parse
      ; dimensions =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Dimensions" xml) Dimensions.parse)
      ...
      ; datapoints_to_alarm =
          Util.option_bind (Xml.member "DatapointsToAlarm" xml) Integer.parse
      ...
      ; treat_missing_data =
          Util.option_bind (Xml.member "TreatMissingData" xml) String.parse
      ; evaluate_low_sample_count_percentile =
          Util.option_bind
      ...
      ; metrics =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Metrics" xml) MetricDataQueries.parse)
      ; threshold_metric_id =
          Util.option_bind (Xml.member "ThresholdMetricId" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.threshold_metric_id (fun f ->
               Query.Pair ("ThresholdMetricId", String.to_query f))
         ; Some (Query.Pair ("Metrics.member", MetricDataQueries.to_query v.metrics))
         ; Util.option_map v.evaluate_low_sample_count_percentile (fun f ->
               Query.Pair ("EvaluateLowSampleCountPercentile", String.to_query f))
         ; Util.option_map v.treat_missing_data (fun f ->
               Query.Pair ("TreatMissingData", String.to_query f))
         ...
         ; Util.option_map v.datapoints_to_alarm (fun f ->
               Query.Pair ("DatapointsToAlarm", Integer.to_query f))
         ; Util.option_map v.evaluation_periods (fun f ->
               Query.Pair ("EvaluationPeriods", Integer.to_query f))
         ; Util.option_map v.unit (fun f -> Query.Pair ("Unit", StandardUnit.to_query f))
         ; Util.option_map v.period (fun f -> Query.Pair ("Period", Integer.to_query f))
         ; Some (Query.Pair ("Dimensions.member", Dimensions.to_query v.dimensions))
         ; Util.option_map v.extended_statistic (fun f ->
               Query.Pair ("ExtendedStatistic", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("dimensions", Dimensions.to_json v.dimensions)
         ; Util.option_map v.extended_statistic (fun f ->
               "extended_statistic", String.to_json f)
  ...
  let of_json j =
    ...
    ; extended_statistic =
        Util.option_map (Json.lookup j "extended_statistic") String.of_json
    ; dimensions = Dimensions.of_json (Util.of_option_exn (Json.lookup j "dimensions"))
    ; period = Util.option_map (Json.lookup j "period") Integer.of_json
    ; unit = Util.option_map (Json.lookup j "unit") StandardUnit.of_json
    ; evaluation_periods =
    ...
    ; datapoints_to_alarm =
        Util.option_map (Json.lookup j "datapoints_to_alarm") Integer.of_json
    ...
    ; treat_missing_data =
        Util.option_map (Json.lookup j "treat_missing_data") String.of_json
    ; evaluate_low_sample_count_percentile =
        Util.option_map
          (Json.lookup j "evaluate_low_sample_count_percentile")
          String.of_json
    ; metrics = MetricDataQueries.of_json (Util.of_option_exn (Json.lookup j "metrics"))
    ; threshold_metric_id =
        Util.option_map (Json.lookup j "threshold_metric_id") String.of_json
    }
end
...
module MetricDataResult = struct
  ...
  let parse xml =
    Some
      ...
      ; timestamps =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Timestamps" xml) Timestamps.parse)
      ; values =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Values" xml) DatapointValues.parse)
      ; status_code = Util.option_bind (Xml.member "StatusCode" xml) StatusCode.parse
      ; messages =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Messages" xml) MetricDataResultMessages.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("Messages.member", MetricDataResultMessages.to_query v.messages))
         ; Util.option_map v.status_code (fun f ->
               Query.Pair ("StatusCode", StatusCode.to_query f))
         ; Some (Query.Pair ("Values.member", DatapointValues.to_query v.values))
         ; Some (Query.Pair ("Timestamps.member", Timestamps.to_query v.timestamps))
         ; Util.option_map v.label (fun f -> Query.Pair ("Label", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.status_code (fun f -> "status_code", StatusCode.to_json f)
  ...
  let of_json j =
    ...
    ; label = Util.option_map (Json.lookup j "label") String.of_json
    ; timestamps = Timestamps.of_json (Util.of_option_exn (Json.lookup j "timestamps"))
    ; values = DatapointValues.of_json (Util.of_option_exn (Json.lookup j "values"))
    ; status_code = Util.option_map (Json.lookup j "status_code") StatusCode.of_json
    ; messages =
        MetricDataResultMessages.of_json (Util.of_option_exn (Json.lookup j "messages"))
    }
end
...
module DashboardEntry = struct
  ...
  let parse xml =
    Some
      { dashboard_name = Util.option_bind (Xml.member "DashboardName" xml) String.parse
      ; dashboard_arn = Util.option_bind (Xml.member "DashboardArn" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.dashboard_arn (fun f ->
               Query.Pair ("DashboardArn", String.to_query f))
         ; Util.option_map v.dashboard_name (fun f ->
               Query.Pair ("DashboardName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.dashboard_arn (fun f -> "dashboard_arn", String.to_json f)
         ; Util.option_map v.dashboard_name (fun f -> "dashboard_name", String.to_json f)
         ])

  let of_json j =
    { dashboard_name = Util.option_map (Json.lookup j "dashboard_name") String.of_json
    ; dashboard_arn = Util.option_map (Json.lookup j "dashboard_arn") String.of_json
...
module InsightRule = struct
  ...
  let parse xml =
    Some
      ...
      ; schema =
          Xml.required "Schema" (Util.option_bind (Xml.member "Schema" xml) String.parse)
      ; definition =
          Xml.required
            "Definition"
  ...
  let of_json j =
    ...
    ; schema = String.of_json (Util.of_option_exn (Json.lookup j "schema"))
    ; definition = String.of_json (Util.of_option_exn (Json.lookup j "definition"))
    }
end
...
module MetricDatum = struct
  ...
  let parse xml =
    Some
      ...
      ; counts =
          Util.of_option [] (Util.option_bind (Xml.member "Counts" xml) Counts.parse)
      ; unit = Util.option_bind (Xml.member "Unit" xml) StandardUnit.parse
      ; storage_resolution =
          Util.option_bind (Xml.member "StorageResolution" xml) Integer.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.storage_resolution (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.storage_resolution (fun f ->
               "storage_resolution", Integer.to_json f)
         ; Util.option_map v.unit (fun f -> "unit", StandardUnit.to_json f)
  ...
  let of_json j =
    ...
    ; counts = Counts.of_json (Util.of_option_exn (Json.lookup j "counts"))
    ; unit = Util.option_map (Json.lookup j "unit") StandardUnit.of_json
    ; storage_resolution =
        Util.option_map (Json.lookup j "storage_resolution") Integer.of_json
    }
end
...
module Datapoint = struct
  ...
  let parse xml =
    Some
      ...
      ; unit = Util.option_bind (Xml.member "Unit" xml) StandardUnit.parse
      ; extended_statistics =
          Util.option_bind (Xml.member "ExtendedStatistics" xml) DatapointValueMap.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.extended_statistics (fun f ->
               Query.Pair ("ExtendedStatistics", DatapointValueMap.to_query f))
         ; Util.option_map v.unit (fun f -> Query.Pair ("Unit", StandardUnit.to_query f))
         ; Util.option_map v.maximum (fun f -> Query.Pair ("Maximum", Double.to_query f))
         ; Util.option_map v.minimum (fun f -> Query.Pair ("Minimum", Double.to_query f))
         ; Util.option_map v.sum (fun f -> Query.Pair ("Sum", Double.to_query f))
  ...
  let of_json j =
    ...
    ; unit = Util.option_map (Json.lookup j "unit") StandardUnit.of_json
    ; extended_statistics =
        Util.option_map (Json.lookup j "extended_statistics") DatapointValueMap.of_json
    }
end
...
module BatchFailures = struct
  ...
  let parse xml =
    Util.option_all (List.map PartialFailure.parse (Xml.members "member" xml))
...
module AlarmTypes = struct
  ...
  let parse xml = Util.option_all (List.map AlarmType.parse (Xml.members "member" xml))
...
module InsightRuleContributors = struct
  ...
  let parse xml =
    Util.option_all (List.map InsightRuleContributor.parse (Xml.members "member" xml))
...
module InsightRuleMetricDatapoints = struct
  ...
  let parse xml =
    Util.option_all (List.map InsightRuleMetricDatapoint.parse (Xml.members "member" xml))

  let to_query v = Query.to_query_list InsightRuleMetricDatapoint.to_query v
...
module DashboardValidationMessages = struct
  ...
  let parse xml =
    Util.option_all (List.map DashboardValidationMessage.parse (Xml.members "member" xml))

  let to_query v = Query.to_query_list DashboardValidationMessage.to_query v
...
module AnomalyDetectors = struct
  ...
  let parse xml =
    Util.option_all (List.map AnomalyDetector.parse (Xml.members "member" xml))
...
module CompositeAlarms = struct
  ...
  let parse xml =
    Util.option_all (List.map CompositeAlarm.parse (Xml.members "member" xml))
...
module MetricDataResults = struct
  ...
  let parse xml =
    Util.option_all (List.map MetricDataResult.parse (Xml.members "member" xml))
...
module DashboardEntries = struct
  ...
  let parse xml =
    Util.option_all (List.map DashboardEntry.parse (Xml.members "member" xml))
...
module InsightRules = struct
  ...
  let parse xml = Util.option_all (List.map InsightRule.parse (Xml.members "member" xml))
  ...
  let parse xml =
    Some
      { failures =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Failures" xml) BatchFailures.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Failures.member", BatchFailures.to_query v.failures)) ])

  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("failures", BatchFailures.to_json v.failures) ])

  let of_json j =
    { failures = BatchFailures.of_json (Util.of_option_exn (Json.lookup j "failures")) }
end
...
module GetDashboardOutput = struct
  ...
  let parse xml =
    Some
      { dashboard_arn = Util.option_bind (Xml.member "DashboardArn" xml) String.parse
      ; dashboard_body = Util.option_bind (Xml.member "DashboardBody" xml) String.parse
      ; dashboard_name = Util.option_bind (Xml.member "DashboardName" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.dashboard_name (fun f ->
               Query.Pair ("DashboardName", String.to_query f))
         ; Util.option_map v.dashboard_body (fun f ->
               Query.Pair ("DashboardBody", String.to_query f))
         ; Util.option_map v.dashboard_arn (fun f ->
               Query.Pair ("DashboardArn", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.dashboard_name (fun f -> "dashboard_name", String.to_json f)
         ; Util.option_map v.dashboard_body (fun f -> "dashboard_body", String.to_json f)
         ; Util.option_map v.dashboard_arn (fun f -> "dashboard_arn", String.to_json f)
         ])

  let of_json j =
    { dashboard_arn = Util.option_map (Json.lookup j "dashboard_arn") String.of_json
    ; dashboard_body = Util.option_map (Json.lookup j "dashboard_body") String.of_json
    ; dashboard_name = Util.option_map (Json.lookup j "dashboard_name") String.of_json
    }
end
...
module GetDashboardInput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("DashboardName", String.to_query v.dashboard_name)) ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Some ("dashboard_name", String.to_json v.dashboard_name) ])

  let of_json j =
    { dashboard_name =
        String.of_json (Util.of_option_exn (Json.lookup j "dashboard_name"))
    }
end
...
module ListMetricsInput = struct
  ...
  let parse xml =
    Some
      ...
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      ; recently_active =
          Util.option_bind (Xml.member "RecentlyActive" xml) RecentlyActive.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.recently_active (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.recently_active (fun f ->
               "recently_active", RecentlyActive.to_json f)
         ; Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
  ...
  let of_json j =
    ...
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    ; recently_active =
        Util.option_map (Json.lookup j "recently_active") RecentlyActive.of_json
    }
end
...
module TagResourceInput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("ResourceARN", String.to_query v.resource_a_r_n))
         ])
  ...
  let of_json j =
    { resource_a_r_n =
        String.of_json (Util.of_option_exn (Json.lookup j "resource_a_r_n"))
...
module EnableInsightRulesInput = struct
  ...
  let parse xml =
    Some
      { rule_names =
          Xml.required
            "RuleNames"
            (Util.option_bind (Xml.member "RuleNames" xml) InsightRuleNames.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("RuleNames.member", InsightRuleNames.to_query v.rule_names))
         ])
  ...
  let of_json j =
    { rule_names =
        InsightRuleNames.of_json (Util.of_option_exn (Json.lookup j "rule_names"))
    }
end
...
module GetInsightRuleReportInput = struct
  ...
  let parse xml =
    Some
      ...
      ; period =
          Xml.required "Period" (Util.option_bind (Xml.member "Period" xml) Integer.parse)
      ; max_contributor_count =
          Util.option_bind (Xml.member "MaxContributorCount" xml) Integer.parse
      ; metrics =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Metrics" xml) InsightRuleMetricList.parse)
      ; order_by = Util.option_bind (Xml.member "OrderBy" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.order_by (fun f -> Query.Pair ("OrderBy", String.to_query f))
         ; Some (Query.Pair ("Metrics.member", InsightRuleMetricList.to_query v.metrics))
         ; Util.option_map v.max_contributor_count (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.order_by (fun f -> "order_by", String.to_json f)
         ; Some ("metrics", InsightRuleMetricList.to_json v.metrics)
         ; Util.option_map v.max_contributor_count (fun f ->
               "max_contributor_count", Integer.to_json f)
         ; Some ("period", Integer.to_json v.period)
         ; Some ("end_time", DateTime.to_json v.end_time)
         ; Some ("start_time", DateTime.to_json v.start_time)
  ...
  let of_json j =
    { rule_name = String.of_json (Util.of_option_exn (Json.lookup j "rule_name"))
    ; start_time = DateTime.of_json (Util.of_option_exn (Json.lookup j "start_time"))
    ; end_time = DateTime.of_json (Util.of_option_exn (Json.lookup j "end_time"))
    ; period = Integer.of_json (Util.of_option_exn (Json.lookup j "period"))
    ; max_contributor_count =
        Util.option_map (Json.lookup j "max_contributor_count") Integer.of_json
    ; metrics =
        InsightRuleMetricList.of_json (Util.of_option_exn (Json.lookup j "metrics"))
    ; order_by = Util.option_map (Json.lookup j "order_by") String.of_json
    }
end
...
module DescribeAlarmHistoryInput = struct
  ...
  let parse xml =
    Some
      ...
      ; alarm_types =
          Util.of_option
            []
            (Util.option_bind (Xml.member "AlarmTypes" xml) AlarmTypes.parse)
      ; history_item_type =
          Util.option_bind (Xml.member "HistoryItemType" xml) HistoryItemType.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.scan_by (fun f -> Query.Pair ("ScanBy", ScanBy.to_query f))
         ; Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ...
         ; Util.option_map v.history_item_type (fun f ->
               Query.Pair ("HistoryItemType", HistoryItemType.to_query f))
         ; Some (Query.Pair ("AlarmTypes.member", AlarmTypes.to_query v.alarm_types))
         ; Util.option_map v.alarm_name (fun f ->
               Query.Pair ("AlarmName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.scan_by (fun f -> "scan_by", ScanBy.to_json f)
         ; Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
  ...
  let of_json j =
    { alarm_name = Util.option_map (Json.lookup j "alarm_name") String.of_json
    ; alarm_types = AlarmTypes.of_json (Util.of_option_exn (Json.lookup j "alarm_types"))
    ; history_item_type =
        Util.option_map (Json.lookup j "history_item_type") HistoryItemType.of_json
...
module DescribeAlarmsInput = struct
    ...
    Some
      ...
      ; alarm_types =
          Util.of_option
            ...
            (Util.option_bind (Xml.member "AlarmTypes" xml) AlarmTypes.parse)
      ; children_of_alarm_name =
          Util.option_bind (Xml.member "ChildrenOfAlarmName" xml) String.parse
      ; parents_of_alarm_name =
          Util.option_bind (Xml.member "ParentsOfAlarmName" xml) String.parse
      ; state_value = Util.option_bind (Xml.member "StateValue" xml) StateValue.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.state_value (fun f ->
               Query.Pair ("StateValue", StateValue.to_query f))
         ; Util.option_map v.parents_of_alarm_name (fun f ->
               Query.Pair ("ParentsOfAlarmName", String.to_query f))
         ; Util.option_map v.children_of_alarm_name (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.state_value (fun f -> "state_value", StateValue.to_json f)
         ; Util.option_map v.parents_of_alarm_name (fun f ->
               "parents_of_alarm_name", String.to_json f)
         ; Util.option_map v.children_of_alarm_name (fun f ->
               "children_of_alarm_name", String.to_json f)
         ; Some ("alarm_types", AlarmTypes.to_json v.alarm_types)
         ; Util.option_map v.alarm_name_prefix (fun f ->
  ...
  let of_json j =
    ...
    ; alarm_types = AlarmTypes.of_json (Util.of_option_exn (Json.lookup j "alarm_types"))
    ; children_of_alarm_name =
        Util.option_map (Json.lookup j "children_of_alarm_name") String.of_json
    ; parents_of_alarm_name =
        Util.option_map (Json.lookup j "parents_of_alarm_name") String.of_json
    ; state_value = Util.option_map (Json.lookup j "state_value") StateValue.of_json
...
module ListTagsForResourceInput = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Some ("resource_a_r_n", String.to_json v.resource_a_r_n) ])
...
module GetMetricDataInput = struct
    ...
    Some
      { metric_data_queries =
          Xml.required
            "MetricDataQueries"
            (Util.option_bind
               (Xml.member "MetricDataQueries" xml)
      ...
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      ; scan_by = Util.option_bind (Xml.member "ScanBy" xml) ScanBy.parse
      ; max_datapoints = Util.option_bind (Xml.member "MaxDatapoints" xml) Integer.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.max_datapoints (fun f ->
               Query.Pair ("MaxDatapoints", Integer.to_query f))
         ; Util.option_map v.scan_by (fun f -> Query.Pair ("ScanBy", ScanBy.to_query f))
         ; Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some (Query.Pair ("EndTime", DateTime.to_query v.end_time))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.max_datapoints (fun f -> "max_datapoints", Integer.to_json f)
         ; Util.option_map v.scan_by (fun f -> "scan_by", ScanBy.to_json f)
         ; Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("end_time", DateTime.to_json v.end_time)
         ; Some ("start_time", DateTime.to_json v.start_time)
         ; Some ("metric_data_queries", MetricDataQueries.to_json v.metric_data_queries)
         ])
  ...
  let of_json j =
    ...
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    ; scan_by = Util.option_map (Json.lookup j "scan_by") ScanBy.of_json
    ; max_datapoints = Util.option_map (Json.lookup j "max_datapoints") Integer.of_json
    }
end
...
module GetMetricWidgetImageInput = struct
  ...
  let parse xml =
    Some
      ...
      ; output_format = Util.option_bind (Xml.member "OutputFormat" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.output_format (fun f ->
               Query.Pair ("OutputFormat", String.to_query f))
         ; Some (Query.Pair ("MetricWidget", String.to_query v.metric_widget))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.output_format (fun f -> "output_format", String.to_json f)
         ; Some ("metric_widget", String.to_json v.metric_widget)
         ])

  let of_json j =
    { metric_widget = String.of_json (Util.of_option_exn (Json.lookup j "metric_widget"))
    ; output_format = Util.option_map (Json.lookup j "output_format") String.of_json
    }
end
  ...
  let parse xml =
    Some
      { dashboard_name_prefix =
          Util.option_bind (Xml.member "DashboardNamePrefix" xml) String.parse
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Util.option_map v.dashboard_name_prefix (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Util.option_map v.dashboard_name_prefix (fun f ->
               "dashboard_name_prefix", String.to_json f)
         ])

  let of_json j =
    { dashboard_name_prefix =
        Util.option_map (Json.lookup j "dashboard_name_prefix") String.of_json
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module GetMetricWidgetImageOutput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.metric_widget_image (fun f ->
               Query.Pair ("MetricWidgetImage", Blob.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.metric_widget_image (fun f ->
               "metric_widget_image", Blob.to_json f)
         ])
...
module GetInsightRuleReportOutput = struct
    ...
    Some
      { key_labels =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "KeyLabels" xml)
               InsightRuleContributorKeyLabels.parse)
      ; aggregation_statistic =
          Util.option_bind (Xml.member "AggregationStatistic" xml) String.parse
      ; aggregate_value = Util.option_bind (Xml.member "AggregateValue" xml) Double.parse
      ; approximate_unique_count =
          Util.option_bind (Xml.member "ApproximateUniqueCount" xml) Long.parse
      ; contributors =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "Contributors" xml)
               InsightRuleContributors.parse)
      ; metric_datapoints =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "MetricDatapoints" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.approximate_unique_count (fun f ->
               Query.Pair ("ApproximateUniqueCount", Long.to_query f))
         ; Util.option_map v.aggregate_value (fun f ->
               Query.Pair ("AggregateValue", Double.to_query f))
         ; Util.option_map v.aggregation_statistic (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some
             ("metric_datapoints", InsightRuleMetricDatapoints.to_json v.metric_datapoints)
         ; Some ("contributors", InsightRuleContributors.to_json v.contributors)
         ; Util.option_map v.approximate_unique_count (fun f ->
               "approximate_unique_count", Long.to_json f)
         ; Util.option_map v.aggregate_value (fun f ->
               "aggregate_value", Double.to_json f)
         ; Util.option_map v.aggregation_statistic (fun f ->
               "aggregation_statistic", String.to_json f)
         ; Some ("key_labels", InsightRuleContributorKeyLabels.to_json v.key_labels)
         ])
  ...
  let of_json j =
    ...
    ; aggregation_statistic =
        Util.option_map (Json.lookup j "aggregation_statistic") String.of_json
    ; aggregate_value = Util.option_map (Json.lookup j "aggregate_value") Double.of_json
    ; approximate_unique_count =
        Util.option_map (Json.lookup j "approximate_unique_count") Long.of_json
    ; contributors =
  ...
  let of_json j =
    ...
    ; dashboard_validation_messages =
        DashboardValidationMessages.of_json
          (Util.of_option_exn (Json.lookup j "dashboard_validation_messages"))
    }
end
...
module DescribeAnomalyDetectorsOutput = struct
  ...
  let parse xml =
    Some
      { anomaly_detectors =
          Util.of_option
            []
            (Util.option_bind (Xml.member "AnomalyDetectors" xml) AnomalyDetectors.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("anomaly_detectors", AnomalyDetectors.to_json v.anomaly_detectors)
         ])

  let of_json j =
    { anomaly_detectors =
        AnomalyDetectors.of_json (Util.of_option_exn (Json.lookup j "anomaly_detectors"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module PutDashboardInput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("DashboardBody", String.to_query v.dashboard_body))
         ; Some (Query.Pair ("DashboardName", String.to_query v.dashboard_name))
         ])
  ...
  let of_json j =
    { dashboard_name =
        String.of_json (Util.of_option_exn (Json.lookup j "dashboard_name"))
    ; dashboard_body =
        String.of_json (Util.of_option_exn (Json.lookup j "dashboard_body"))
    }
end
  ...
  let parse xml =
    Some
      { composite_alarms =
          Util.of_option
            []
            (Util.option_bind (Xml.member "CompositeAlarms" xml) CompositeAlarms.parse)
      ; metric_alarms =
          Util.of_option
            []
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("composite_alarms", CompositeAlarms.to_json v.composite_alarms)
         ])

  let of_json j =
    { composite_alarms =
        CompositeAlarms.of_json (Util.of_option_exn (Json.lookup j "composite_alarms"))
    ; metric_alarms =
...
module PutInsightRuleInput = struct
    ...
    Some
      { rule_name =
          Xml.required
            "RuleName"
            (Util.option_bind (Xml.member "RuleName" xml) String.parse)
      ; rule_state = Util.option_bind (Xml.member "RuleState" xml) String.parse
      ; rule_definition =
          Xml.required
            "RuleDefinition"
            (Util.option_bind (Xml.member "RuleDefinition" xml) String.parse)
      ; tags = Util.of_option [] (Util.option_bind (Xml.member "Tags" xml) TagList.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Tags.member", TagList.to_query v.tags))
         ; Some (Query.Pair ("RuleDefinition", String.to_query v.rule_definition))
         ; Util.option_map v.rule_state (fun f ->
               Query.Pair ("RuleState", String.to_query f))
         ; Some (Query.Pair ("RuleName", String.to_query v.rule_name))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.rule_state (fun f -> "rule_state", String.to_json f)
         ; Some ("rule_name", String.to_json v.rule_name)
         ])

  let of_json j =
    { rule_name = String.of_json (Util.of_option_exn (Json.lookup j "rule_name"))
    ; rule_state = Util.option_map (Json.lookup j "rule_state") String.of_json
    ; rule_definition =
        String.of_json (Util.of_option_exn (Json.lookup j "rule_definition"))
    ; tags = TagList.of_json (Util.of_option_exn (Json.lookup j "tags"))
    }
end
    ...
    Some
      { metric_data_results =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "MetricDataResults" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("messages", MetricDataResultMessages.to_json v.messages)
         ; Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("metric_data_results", MetricDataResults.to_json v.metric_data_results)
         ])
...
module ListDashboardsOutput = struct
  ...
  let parse xml =
    Some
      { dashboard_entries =
          Util.of_option
            []
            (Util.option_bind (Xml.member "DashboardEntries" xml) DashboardEntries.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("dashboard_entries", DashboardEntries.to_json v.dashboard_entries)
         ])

  let of_json j =
    { dashboard_entries =
        DashboardEntries.of_json (Util.of_option_exn (Json.lookup j "dashboard_entries"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module DescribeInsightRulesOutput = struct
  ...
  let parse xml =
    Some
      ...
      ; insight_rules =
          Util.of_option
            []
            (Util.option_bind (Xml.member "InsightRules" xml) InsightRules.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("InsightRules.member", InsightRules.to_query v.insight_rules))
         ; Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ])
  ...
  let of_json j =
    { next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    ; insight_rules =
        InsightRules.of_json (Util.of_option_exn (Json.lookup j "insight_rules"))
    }
end
...
module PutCompositeAlarmInput = struct
  ...
  let of_json j =
    ...
    ; alarm_description =
        Util.option_map (Json.lookup j "alarm_description") String.of_json
    ; alarm_name = String.of_json (Util.of_option_exn (Json.lookup j "alarm_name"))
    ; alarm_rule = String.of_json (Util.of_option_exn (Json.lookup j "alarm_rule"))
    ; insufficient_data_actions =
        ResourceList.of_json
          (Util.of_option_exn (Json.lookup j "insufficient_data_actions"))
    ; o_k_actions =
...
module GetMetricStatisticsInput = struct
    ...
    Some
      ...
      ; extended_statistics =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ExtendedStatistics" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.unit (fun f -> "unit", StandardUnit.to_json f)
         ; Some ("extended_statistics", ExtendedStatistics.to_json v.extended_statistics)
...
module ListTagsForResourceOutput = struct
  ...
  let to_json v = `Assoc (Util.list_filter_opt [ Some ("tags", TagList.to_json v.tags) ])

  let of_json j = { tags = TagList.of_json (Util.of_option_exn (Json.lookup j "tags")) }
end
...
module DeleteDashboardsInput = struct
  ...
  let parse xml =
    Some
      { dashboard_names =
          Xml.required
            "DashboardNames"
            (Util.option_bind (Xml.member "DashboardNames" xml) DashboardNames.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("dashboard_names", DashboardNames.to_json v.dashboard_names) ])

  let of_json j =
    { dashboard_names =
        DashboardNames.of_json (Util.of_option_exn (Json.lookup j "dashboard_names"))
    }
end
