...
(* OASIS_START *)
(* DO NOT EDIT (digest: 01c6a8767a52d94151d5aae1e7a3b2e7) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\017\199\227\232y\151\141gP\184&\199\235\183\192k";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
