...
module Credentials = struct
  ...
  let parse xml =
    Some
      ...
      ; secret_access_key =
          Xml.required
            "SecretAccessKey"
            (Util.option_bind (Xml.member "SecretAccessKey" xml) String.parse)
      ; session_token =
          Xml.required
            "SessionToken"
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Expiration", DateTime.to_query v.expiration))
         ; Some (Query.Pair ("SessionToken", String.to_query v.session_token))
         ; Some (Query.Pair ("SecretAccessKey", String.to_query v.secret_access_key))
         ; Some (Query.Pair ("AccessKeyId", String.to_query v.access_key_id))
         ])
  ...
  let of_json j =
    { access_key_id = String.of_json (Util.of_option_exn (Json.lookup j "access_key_id"))
    ; secret_access_key =
        String.of_json (Util.of_option_exn (Json.lookup j "secret_access_key"))
    ; session_token = String.of_json (Util.of_option_exn (Json.lookup j "session_token"))
    ; expiration = DateTime.of_json (Util.of_option_exn (Json.lookup j "expiration"))
    }
end
...
module FederatedUser = struct
  ...
  let parse xml =
    Some
      { federated_user_id =
          Xml.required
            "FederatedUserId"
            (Util.option_bind (Xml.member "FederatedUserId" xml) String.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("FederatedUserId", String.to_query v.federated_user_id))
         ])
  ...
  let of_json j =
    { federated_user_id =
        String.of_json (Util.of_option_exn (Json.lookup j "federated_user_id"))
...
module PolicyDescriptorListType = struct
  ...
  let parse xml =
    Util.option_all (List.map PolicyDescriptorType.parse (Xml.members "member" xml))
...
module AssumedRoleUser = struct
  ...
  let parse xml =
    Some
      { assumed_role_id =
          Xml.required
            "AssumedRoleId"
            (Util.option_bind (Xml.member "AssumedRoleId" xml) String.parse)
      ; arn = Xml.required "Arn" (Util.option_bind (Xml.member "Arn" xml) String.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Arn", String.to_query v.arn))
         ; Some (Query.Pair ("AssumedRoleId", String.to_query v.assumed_role_id))
         ])
  ...
  let of_json j =
    { assumed_role_id =
        String.of_json (Util.of_option_exn (Json.lookup j "assumed_role_id"))
    ; arn = String.of_json (Util.of_option_exn (Json.lookup j "arn"))
    }
end
...
module GetFederationTokenResponse = struct
  ...
  let parse xml =
    Some
      { credentials = Util.option_bind (Xml.member "Credentials" xml) Credentials.parse
      ; federated_user =
          Util.option_bind (Xml.member "FederatedUser" xml) FederatedUser.parse
      ; packed_policy_size =
          Util.option_bind (Xml.member "PackedPolicySize" xml) Integer.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.packed_policy_size (fun f ->
               Query.Pair ("PackedPolicySize", Integer.to_query f))
         ; Util.option_map v.federated_user (fun f ->
               Query.Pair ("FederatedUser", FederatedUser.to_query f))
         ; Util.option_map v.credentials (fun f ->
               Query.Pair ("Credentials", Credentials.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.packed_policy_size (fun f ->
               "packed_policy_size", Integer.to_json f)
         ; Util.option_map v.federated_user (fun f ->
               "federated_user", FederatedUser.to_json f)
         ; Util.option_map v.credentials (fun f -> "credentials", Credentials.to_json f)
         ])

  let of_json j =
    { credentials = Util.option_map (Json.lookup j "credentials") Credentials.of_json
    ; federated_user =
        Util.option_map (Json.lookup j "federated_user") FederatedUser.of_json
    ; packed_policy_size =
        Util.option_map (Json.lookup j "packed_policy_size") Integer.of_json
    }
end
...
module GetAccessKeyInfoRequest = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Some ("access_key_id", String.to_json v.access_key_id) ])
...
module GetFederationTokenRequest = struct
    ...
    Some
      ...
      ; policy_arns =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "PolicyArns" xml)
               PolicyDescriptorListType.parse)
      ; duration_seconds =
          Util.option_bind (Xml.member "DurationSeconds" xml) Integer.parse
      ; tags =
          Util.of_option [] (Util.option_bind (Xml.member "Tags" xml) TagListType.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.duration_seconds (fun f ->
               Query.Pair ("DurationSeconds", Integer.to_query f))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.duration_seconds (fun f ->
               "duration_seconds", Integer.to_json f)
         ; Some ("policy_arns", PolicyDescriptorListType.to_json v.policy_arns)
  ...
  let of_json j =
    ...
    ; tags = TagListType.of_json (Util.of_option_exn (Json.lookup j "tags"))
    }
end
...
module AssumeRoleWithSAMLResponse = struct
  ...
  let parse xml =
    Some
      { credentials = Util.option_bind (Xml.member "Credentials" xml) Credentials.parse
      ; assumed_role_user =
          Util.option_bind (Xml.member "AssumedRoleUser" xml) AssumedRoleUser.parse
      ; packed_policy_size =
          Util.option_bind (Xml.member "PackedPolicySize" xml) Integer.parse
      ; subject = Util.option_bind (Xml.member "Subject" xml) String.parse
      ; subject_type = Util.option_bind (Xml.member "SubjectType" xml) String.parse
      ; issuer = Util.option_bind (Xml.member "Issuer" xml) String.parse
      ; audience = Util.option_bind (Xml.member "Audience" xml) String.parse
      ; name_qualifier = Util.option_bind (Xml.member "NameQualifier" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.name_qualifier (fun f ->
               Query.Pair ("NameQualifier", String.to_query f))
         ; Util.option_map v.audience (fun f ->
               Query.Pair ("Audience", String.to_query f))
         ; Util.option_map v.issuer (fun f -> Query.Pair ("Issuer", String.to_query f))
         ; Util.option_map v.subject_type (fun f ->
               Query.Pair ("SubjectType", String.to_query f))
         ; Util.option_map v.subject (fun f -> Query.Pair ("Subject", String.to_query f))
         ; Util.option_map v.packed_policy_size (fun f ->
               Query.Pair ("PackedPolicySize", Integer.to_query f))
         ; Util.option_map v.assumed_role_user (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.name_qualifier (fun f -> "name_qualifier", String.to_json f)
         ; Util.option_map v.audience (fun f -> "audience", String.to_json f)
         ; Util.option_map v.issuer (fun f -> "issuer", String.to_json f)
         ; Util.option_map v.subject_type (fun f -> "subject_type", String.to_json f)
         ; Util.option_map v.subject (fun f -> "subject", String.to_json f)
         ; Util.option_map v.packed_policy_size (fun f ->
               "packed_policy_size", Integer.to_json f)
         ; Util.option_map v.assumed_role_user (fun f ->
               "assumed_role_user", AssumedRoleUser.to_json f)
         ; Util.option_map v.credentials (fun f -> "credentials", Credentials.to_json f)
         ])
  ...
  let of_json j =
    { credentials = Util.option_map (Json.lookup j "credentials") Credentials.of_json
    ; assumed_role_user =
        Util.option_map (Json.lookup j "assumed_role_user") AssumedRoleUser.of_json
    ; packed_policy_size =
        Util.option_map (Json.lookup j "packed_policy_size") Integer.of_json
    ; subject = Util.option_map (Json.lookup j "subject") String.of_json
    ; subject_type = Util.option_map (Json.lookup j "subject_type") String.of_json
    ; issuer = Util.option_map (Json.lookup j "issuer") String.of_json
    ; audience = Util.option_map (Json.lookup j "audience") String.of_json
    ; name_qualifier = Util.option_map (Json.lookup j "name_qualifier") String.of_json
    }
end
...
module DecodeAuthorizationMessageResponse = struct
  ...
  let parse xml =
    Some
      { decoded_message = Util.option_bind (Xml.member "DecodedMessage" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.decoded_message (fun f ->
               Query.Pair ("DecodedMessage", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.decoded_message (fun f ->
               "decoded_message", String.to_json f)
         ])

  let of_json j =
    { decoded_message = Util.option_map (Json.lookup j "decoded_message") String.of_json }
end
...
module GetAccessKeyInfoResponse = struct
  ...
  let parse xml =
    Some { account = Util.option_bind (Xml.member "Account" xml) String.parse }
  ...
  let of_json j = { account = Util.option_map (Json.lookup j "account") String.of_json }
end
...
module DecodeAuthorizationMessageRequest = struct
  ...
  let parse xml =
    Some
      { encoded_message =
          Xml.required
            "EncodedMessage"
            (Util.option_bind (Xml.member "EncodedMessage" xml) String.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("EncodedMessage", String.to_query v.encoded_message)) ])
  ...
  let of_json j =
    { encoded_message =
        String.of_json (Util.of_option_exn (Json.lookup j "encoded_message"))
    }
end
...
module GetSessionTokenRequest = struct
  ...
  let parse xml =
    Some
      { duration_seconds =
          Util.option_bind (Xml.member "DurationSeconds" xml) Integer.parse
      ; serial_number = Util.option_bind (Xml.member "SerialNumber" xml) String.parse
      ; token_code = Util.option_bind (Xml.member "TokenCode" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.token_code (fun f ->
               Query.Pair ("TokenCode", String.to_query f))
         ; Util.option_map v.serial_number (fun f ->
               Query.Pair ("SerialNumber", String.to_query f))
         ; Util.option_map v.duration_seconds (fun f ->
               Query.Pair ("DurationSeconds", Integer.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.token_code (fun f -> "token_code", String.to_json f)
         ; Util.option_map v.serial_number (fun f -> "serial_number", String.to_json f)
         ; Util.option_map v.duration_seconds (fun f ->
               "duration_seconds", Integer.to_json f)
         ])
  ...
  let of_json j =
    { duration_seconds =
        Util.option_map (Json.lookup j "duration_seconds") Integer.of_json
    ; serial_number = Util.option_map (Json.lookup j "serial_number") String.of_json
    ; token_code = Util.option_map (Json.lookup j "token_code") String.of_json
    }
end
...
module AssumeRoleWithSAMLRequest = struct
  ...
  let parse xml =
    Some
      ...
      ; s_a_m_l_assertion =
          Xml.required
            "SAMLAssertion"
            (Util.option_bind (Xml.member "SAMLAssertion" xml) String.parse)
      ; policy_arns =
          Util.of_option
            []
            (Util.option_bind
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Some
             (Query.Pair
                ("PolicyArns.member", PolicyDescriptorListType.to_query v.policy_arns))
         ; Some (Query.Pair ("SAMLAssertion", String.to_query v.s_a_m_l_assertion))
  ...
  let of_json j =
    ...
    ; principal_arn = String.of_json (Util.of_option_exn (Json.lookup j "principal_arn"))
    ; s_a_m_l_assertion =
        String.of_json (Util.of_option_exn (Json.lookup j "s_a_m_l_assertion"))
    ; policy_arns =
        PolicyDescriptorListType.of_json
          (Util.of_option_exn (Json.lookup j "policy_arns"))
    ; policy = Util.option_map (Json.lookup j "policy") String.of_json
...
module AssumeRoleWithWebIdentityResponse = struct
  ...
  let parse xml =
    Some
      { credentials = Util.option_bind (Xml.member "Credentials" xml) Credentials.parse
      ; subject_from_web_identity_token =
          Util.option_bind (Xml.member "SubjectFromWebIdentityToken" xml) String.parse
      ; assumed_role_user =
          Util.option_bind (Xml.member "AssumedRoleUser" xml) AssumedRoleUser.parse
      ; packed_policy_size =
          Util.option_bind (Xml.member "PackedPolicySize" xml) Integer.parse
      ; provider = Util.option_bind (Xml.member "Provider" xml) String.parse
      ; audience = Util.option_bind (Xml.member "Audience" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.audience (fun f ->
               Query.Pair ("Audience", String.to_query f))
         ; Util.option_map v.provider (fun f ->
               Query.Pair ("Provider", String.to_query f))
         ; Util.option_map v.packed_policy_size (fun f ->
               Query.Pair ("PackedPolicySize", Integer.to_query f))
         ; Util.option_map v.assumed_role_user (fun f ->
               Query.Pair ("AssumedRoleUser", AssumedRoleUser.to_query f))
         ; Util.option_map v.subject_from_web_identity_token (fun f ->
               Query.Pair ("SubjectFromWebIdentityToken", String.to_query f))
         ; Util.option_map v.credentials (fun f ->
               Query.Pair ("Credentials", Credentials.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.audience (fun f -> "audience", String.to_json f)
         ; Util.option_map v.provider (fun f -> "provider", String.to_json f)
         ; Util.option_map v.packed_policy_size (fun f ->
               "packed_policy_size", Integer.to_json f)
         ; Util.option_map v.assumed_role_user (fun f ->
               "assumed_role_user", AssumedRoleUser.to_json f)
  ...
  let of_json j =
    { credentials = Util.option_map (Json.lookup j "credentials") Credentials.of_json
    ; subject_from_web_identity_token =
        Util.option_map (Json.lookup j "subject_from_web_identity_token") String.of_json
    ; assumed_role_user =
        Util.option_map (Json.lookup j "assumed_role_user") AssumedRoleUser.of_json
    ; packed_policy_size =
        Util.option_map (Json.lookup j "packed_policy_size") Integer.of_json
    ; provider = Util.option_map (Json.lookup j "provider") String.of_json
    ; audience = Util.option_map (Json.lookup j "audience") String.of_json
    }
end
...
module AssumeRoleWithWebIdentityRequest = struct
  ...
  let parse xml =
    Some
      ...
      ; role_session_name =
          Xml.required
            "RoleSessionName"
            (Util.option_bind (Xml.member "RoleSessionName" xml) String.parse)
      ; web_identity_token =
          Xml.required
            "WebIdentityToken"
            (Util.option_bind (Xml.member "WebIdentityToken" xml) String.parse)
      ; provider_id = Util.option_bind (Xml.member "ProviderId" xml) String.parse
      ; policy_arns =
          Util.of_option
            []
            (Util.option_bind
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Some
             (Query.Pair
                ("PolicyArns.member", PolicyDescriptorListType.to_query v.policy_arns))
         ; Util.option_map v.provider_id (fun f ->
               Query.Pair ("ProviderId", String.to_query f))
         ; Some (Query.Pair ("WebIdentityToken", String.to_query v.web_identity_token))
         ; Some (Query.Pair ("RoleSessionName", String.to_query v.role_session_name))
         ; Some (Query.Pair ("RoleArn", String.to_query v.role_arn))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.policy (fun f -> "policy", String.to_json f)
         ; Some ("policy_arns", PolicyDescriptorListType.to_json v.policy_arns)
         ; Util.option_map v.provider_id (fun f -> "provider_id", String.to_json f)
  ...
  let of_json j =
    { role_arn = String.of_json (Util.of_option_exn (Json.lookup j "role_arn"))
    ; role_session_name =
        String.of_json (Util.of_option_exn (Json.lookup j "role_session_name"))
    ; web_identity_token =
        String.of_json (Util.of_option_exn (Json.lookup j "web_identity_token"))
    ; provider_id = Util.option_map (Json.lookup j "provider_id") String.of_json
    ; policy_arns =
        PolicyDescriptorListType.of_json
          (Util.of_option_exn (Json.lookup j "policy_arns"))
    ; policy = Util.option_map (Json.lookup j "policy") String.of_json
...
module AssumeRoleRequest = struct
  ...
  let parse xml =
    Some
      ...
      ; transitive_tag_keys =
          Util.of_option
            []
            (Util.option_bind (Xml.member "TransitiveTagKeys" xml) TagKeyListType.parse)
      ; external_id = Util.option_bind (Xml.member "ExternalId" xml) String.parse
      ; serial_number = Util.option_bind (Xml.member "SerialNumber" xml) String.parse
      ; token_code = Util.option_bind (Xml.member "TokenCode" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.serial_number (fun f ->
               Query.Pair ("SerialNumber", String.to_query f))
         ; Util.option_map v.external_id (fun f ->
               Query.Pair ("ExternalId", String.to_query f))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.token_code (fun f -> "token_code", String.to_json f)
         ; Util.option_map v.serial_number (fun f -> "serial_number", String.to_json f)
         ; Util.option_map v.external_id (fun f -> "external_id", String.to_json f)
         ; Some ("transitive_tag_keys", TagKeyListType.to_json v.transitive_tag_keys)
         ; Some ("tags", TagListType.to_json v.tags)
         ; Util.option_map v.duration_seconds (fun f ->
               "duration_seconds", Integer.to_json f)
         ; Util.option_map v.policy (fun f -> "policy", String.to_json f)
  ...
  let of_json j =
    ...
    ; tags = TagListType.of_json (Util.of_option_exn (Json.lookup j "tags"))
    ; transitive_tag_keys =
        TagKeyListType.of_json (Util.of_option_exn (Json.lookup j "transitive_tag_keys"))
    ; external_id = Util.option_map (Json.lookup j "external_id") String.of_json
    ; serial_number = Util.option_map (Json.lookup j "serial_number") String.of_json
    ; token_code = Util.option_map (Json.lookup j "token_code") String.of_json
    }
end
