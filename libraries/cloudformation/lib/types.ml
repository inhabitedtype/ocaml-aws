...
module ResourceTargetDefinition = struct
  ...
  let parse xml =
    Some
      { attribute = Util.option_bind (Xml.member "Attribute" xml) ResourceAttribute.parse
      ; name = Util.option_bind (Xml.member "Name" xml) String.parse
      ; requires_recreation =
          Util.option_bind (Xml.member "RequiresRecreation" xml) RequiresRecreation.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.requires_recreation (fun f ->
               Query.Pair ("RequiresRecreation", RequiresRecreation.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.attribute (fun f -> "attribute", ResourceAttribute.to_json f)
         ])

  let of_json j =
    { attribute = Util.option_map (Json.lookup j "attribute") ResourceAttribute.of_json
    ; name = Util.option_map (Json.lookup j "name") String.of_json
    ; requires_recreation =
        Util.option_map (Json.lookup j "requires_recreation") RequiresRecreation.of_json
    }
end
...
module ResourceChangeDetail = struct
  ...
  let parse xml =
    Some
      { target = Util.option_bind (Xml.member "Target" xml) ResourceTargetDefinition.parse
      ; evaluation = Util.option_bind (Xml.member "Evaluation" xml) EvaluationType.parse
      ; change_source =
          Util.option_bind (Xml.member "ChangeSource" xml) ChangeSource.parse
      ; causing_entity = Util.option_bind (Xml.member "CausingEntity" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.causing_entity (fun f ->
               Query.Pair ("CausingEntity", String.to_query f))
         ; Util.option_map v.change_source (fun f ->
               Query.Pair ("ChangeSource", ChangeSource.to_query f))
         ; Util.option_map v.evaluation (fun f ->
               Query.Pair ("Evaluation", EvaluationType.to_query f))
         ; Util.option_map v.target (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.causing_entity (fun f -> "causing_entity", String.to_json f)
         ; Util.option_map v.change_source (fun f ->
               "change_source", ChangeSource.to_json f)
         ; Util.option_map v.evaluation (fun f -> "evaluation", EvaluationType.to_json f)
         ; Util.option_map v.target (fun f ->
               "target", ResourceTargetDefinition.to_json f)
         ])

  let of_json j =
    { target = Util.option_map (Json.lookup j "target") ResourceTargetDefinition.of_json
    ; evaluation = Util.option_map (Json.lookup j "evaluation") EvaluationType.of_json
    ; change_source = Util.option_map (Json.lookup j "change_source") ChangeSource.of_json
    ; causing_entity = Util.option_map (Json.lookup j "causing_entity") String.of_json
    }
end
...
module RollbackTrigger = struct
  ...
  let parse xml =
    Some
      { arn = Xml.required "Arn" (Util.option_bind (Xml.member "Arn" xml) String.parse)
      ; type_ =
          Xml.required "Type" (Util.option_bind (Xml.member "Type" xml) String.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("type_", String.to_json v.type_); Some ("arn", String.to_json v.arn) ])
...
module PropertyDifference = struct
  ...
  let parse xml =
    Some
      ...
      ; expected_value =
          Xml.required
            "ExpectedValue"
            (Util.option_bind (Xml.member "ExpectedValue" xml) String.parse)
      ; actual_value =
          Xml.required
            "ActualValue"
      ...
      ; difference_type =
          Xml.required
            "DifferenceType"
            (Util.option_bind (Xml.member "DifferenceType" xml) DifferenceType.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("DifferenceType", DifferenceType.to_query v.difference_type))
         ; Some (Query.Pair ("ActualValue", String.to_query v.actual_value))
         ; Some (Query.Pair ("ExpectedValue", String.to_query v.expected_value))
         ; Some (Query.Pair ("PropertyPath", String.to_query v.property_path))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("difference_type", DifferenceType.to_json v.difference_type)
  ...
  let of_json j =
    { property_path = String.of_json (Util.of_option_exn (Json.lookup j "property_path"))
    ; expected_value =
        String.of_json (Util.of_option_exn (Json.lookup j "expected_value"))
    ; actual_value = String.of_json (Util.of_option_exn (Json.lookup j "actual_value"))
    ; difference_type =
        DifferenceType.of_json (Util.of_option_exn (Json.lookup j "difference_type"))
    }
end
...
module ResourceChangeDetails = struct
  ...
  let parse xml =
    Util.option_all (List.map ResourceChangeDetail.parse (Xml.members "member" xml))
...
module Scope = struct
  ...
  let parse xml =
    Util.option_all (List.map ResourceAttribute.parse (Xml.members "member" xml))
...
module Output = struct
  ...
  let parse xml =
    Some
      { output_key = Util.option_bind (Xml.member "OutputKey" xml) String.parse
      ; output_value = Util.option_bind (Xml.member "OutputValue" xml) String.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; export_name = Util.option_bind (Xml.member "ExportName" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.export_name (fun f ->
               Query.Pair ("ExportName", String.to_query f))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.output_value (fun f ->
               Query.Pair ("OutputValue", String.to_query f))
         ; Util.option_map v.output_key (fun f ->
               Query.Pair ("OutputKey", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.export_name (fun f -> "export_name", String.to_json f)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.output_value (fun f -> "output_value", String.to_json f)
         ; Util.option_map v.output_key (fun f -> "output_key", String.to_json f)
         ])

  let of_json j =
    { output_key = Util.option_map (Json.lookup j "output_key") String.of_json
    ; output_value = Util.option_map (Json.lookup j "output_value") String.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; export_name = Util.option_map (Json.lookup j "export_name") String.of_json
    }
end
...
module Parameter = struct
  ...
  let parse xml =
    Some
      { parameter_key = Util.option_bind (Xml.member "ParameterKey" xml) String.parse
      ; parameter_value = Util.option_bind (Xml.member "ParameterValue" xml) String.parse
      ; use_previous_value =
          Util.option_bind (Xml.member "UsePreviousValue" xml) Boolean.parse
      ; resolved_value = Util.option_bind (Xml.member "ResolvedValue" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.resolved_value (fun f ->
               Query.Pair ("ResolvedValue", String.to_query f))
         ; Util.option_map v.use_previous_value (fun f ->
         ...
         ; Util.option_map v.parameter_key (fun f ->
               Query.Pair ("ParameterKey", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.resolved_value (fun f -> "resolved_value", String.to_json f)
         ; Util.option_map v.use_previous_value (fun f ->
               "use_previous_value", Boolean.to_json f)
         ; Util.option_map v.parameter_value (fun f ->
               "parameter_value", String.to_json f)
         ; Util.option_map v.parameter_key (fun f -> "parameter_key", String.to_json f)
         ])

  let of_json j =
    { parameter_key = Util.option_map (Json.lookup j "parameter_key") String.of_json
    ; parameter_value = Util.option_map (Json.lookup j "parameter_value") String.of_json
    ; use_previous_value =
        Util.option_map (Json.lookup j "use_previous_value") Boolean.of_json
    ; resolved_value = Util.option_map (Json.lookup j "resolved_value") String.of_json
    }
end
...
module RollbackTriggers = struct
  ...
  let parse xml =
    Util.option_all (List.map RollbackTrigger.parse (Xml.members "member" xml))
...
module AccountGateResult = struct
  ...
  let parse xml =
    Some
      { status = Util.option_bind (Xml.member "Status" xml) AccountGateStatus.parse
      ; status_reason = Util.option_bind (Xml.member "StatusReason" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.status_reason (fun f ->
               Query.Pair ("StatusReason", String.to_query f))
         ; Util.option_map v.status (fun f ->
               Query.Pair ("Status", AccountGateStatus.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.status_reason (fun f -> "status_reason", String.to_json f)
         ; Util.option_map v.status (fun f -> "status", AccountGateStatus.to_json f)
         ])

  let of_json j =
    { status = Util.option_map (Json.lookup j "status") AccountGateStatus.of_json
    ; status_reason = Util.option_map (Json.lookup j "status_reason") String.of_json
    }
end
...
module StackDriftInformationSummary = struct
  ...
  let parse xml =
    Some
      { stack_drift_status =
          Xml.required
            "StackDriftStatus"
            (Util.option_bind (Xml.member "StackDriftStatus" xml) StackDriftStatus.parse)
      ; last_check_timestamp =
          Util.option_bind (Xml.member "LastCheckTimestamp" xml) DateTime.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.last_check_timestamp (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.last_check_timestamp (fun f ->
               "last_check_timestamp", DateTime.to_json f)
         ; Some ("stack_drift_status", StackDriftStatus.to_json v.stack_drift_status)
         ])

  let of_json j =
    { stack_drift_status =
        StackDriftStatus.of_json (Util.of_option_exn (Json.lookup j "stack_drift_status"))
    ; last_check_timestamp =
        Util.option_map (Json.lookup j "last_check_timestamp") DateTime.of_json
    }
end
...
module PhysicalResourceIdContext = struct
  ...
  let parse xml =
    Util.option_all
      (List.map PhysicalResourceIdContextKeyValuePair.parse (Xml.members "member" xml))

  let to_query v = Query.to_query_list PhysicalResourceIdContextKeyValuePair.to_query v

  let to_json v = `List (List.map PhysicalResourceIdContextKeyValuePair.to_json v)

  let of_json j = Json.to_list PhysicalResourceIdContextKeyValuePair.of_json j
end
...
module PropertyDifferences = struct
  ...
  let parse xml =
    Util.option_all (List.map PropertyDifference.parse (Xml.members "member" xml))
...
module ResourceChange = struct
  ...
  let parse xml =
    Some
      { action = Util.option_bind (Xml.member "Action" xml) ChangeAction.parse
      ; logical_resource_id =
          Util.option_bind (Xml.member "LogicalResourceId" xml) String.parse
      ; physical_resource_id =
          Util.option_bind (Xml.member "PhysicalResourceId" xml) String.parse
      ; resource_type = Util.option_bind (Xml.member "ResourceType" xml) String.parse
      ; replacement = Util.option_bind (Xml.member "Replacement" xml) Replacement.parse
      ; scope = Util.of_option [] (Util.option_bind (Xml.member "Scope" xml) Scope.parse)
      ; details =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Details" xml) ResourceChangeDetails.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Details.member", ResourceChangeDetails.to_query v.details))
         ; Some (Query.Pair ("Scope.member", Scope.to_query v.scope))
         ; Util.option_map v.replacement (fun f ->
               Query.Pair ("Replacement", Replacement.to_query f))
         ; Util.option_map v.resource_type (fun f ->
               Query.Pair ("ResourceType", String.to_query f))
         ; Util.option_map v.physical_resource_id (fun f ->
               Query.Pair ("PhysicalResourceId", String.to_query f))
         ; Util.option_map v.logical_resource_id (fun f ->
               Query.Pair ("LogicalResourceId", String.to_query f))
         ; Util.option_map v.action (fun f ->
               Query.Pair ("Action", ChangeAction.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.replacement (fun f -> "replacement", Replacement.to_json f)
         ; Util.option_map v.resource_type (fun f -> "resource_type", String.to_json f)
         ; Util.option_map v.physical_resource_id (fun f ->
               "physical_resource_id", String.to_json f)
         ; Util.option_map v.logical_resource_id (fun f ->
               "logical_resource_id", String.to_json f)
         ; Util.option_map v.action (fun f -> "action", ChangeAction.to_json f)
         ])

  let of_json j =
    { action = Util.option_map (Json.lookup j "action") ChangeAction.of_json
    ; logical_resource_id =
        Util.option_map (Json.lookup j "logical_resource_id") String.of_json
    ; physical_resource_id =
        Util.option_map (Json.lookup j "physical_resource_id") String.of_json
    ; resource_type = Util.option_map (Json.lookup j "resource_type") String.of_json
    ; replacement = Util.option_map (Json.lookup j "replacement") Replacement.of_json
    ; scope = Scope.of_json (Util.of_option_exn (Json.lookup j "scope"))
    ; details =
        ResourceChangeDetails.of_json (Util.of_option_exn (Json.lookup j "details"))
    }
end
...
module AutoDeployment = struct
  ...
  let parse xml =
    Some
      ...
      ; retain_stacks_on_account_removal =
          Util.option_bind (Xml.member "RetainStacksOnAccountRemoval" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.retain_stacks_on_account_removal (fun f ->
               Query.Pair ("RetainStacksOnAccountRemoval", Boolean.to_query f))
  ...
  let of_json j =
    ...
    ; retain_stacks_on_account_removal =
        Util.option_map (Json.lookup j "retain_stacks_on_account_removal") Boolean.of_json
    }
end
    ...
    Some
      { stack_resource_drift_status =
          Xml.required
            ...
            (Util.option_bind
               (Xml.member "StackResourceDriftStatus" xml)
  ...
  let of_json j =
    { stack_resource_drift_status =
        StackResourceDriftStatus.of_json
          (Util.of_option_exn (Json.lookup j "stack_resource_drift_status"))
    ; last_check_timestamp =
        Util.option_map (Json.lookup j "last_check_timestamp") DateTime.of_json
    }
end
...
module ParameterConstraints = struct
  ...
  let parse xml =
    Some
      { allowed_values =
          Util.of_option
            []
            (Util.option_bind (Xml.member "AllowedValues" xml) AllowedValues.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("AllowedValues.member", AllowedValues.to_query v.allowed_values))
         ])
  ...
  let of_json j =
    { allowed_values =
        AllowedValues.of_json (Util.of_option_exn (Json.lookup j "allowed_values"))
    }
end
...
module StackInstanceComprehensiveStatus = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.detailed_status (fun f ->
               Query.Pair ("DetailedStatus", StackInstanceDetailedStatus.to_query f))
         ])
...
module Capabilities = struct
  ...
  let parse xml = Util.option_all (List.map Capability.parse (Xml.members "member" xml))
...
module Outputs = struct
  ...
  let parse xml = Util.option_all (List.map Output.parse (Xml.members "member" xml))
...
module Parameters = struct
  ...
  let parse xml = Util.option_all (List.map Parameter.parse (Xml.members "member" xml))
...
module RollbackConfiguration = struct
  ...
  let parse xml =
    Some
      { rollback_triggers =
          Util.of_option
            []
            (Util.option_bind (Xml.member "RollbackTriggers" xml) RollbackTriggers.parse)
      ; monitoring_time_in_minutes =
          Util.option_bind (Xml.member "MonitoringTimeInMinutes" xml) Integer.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.monitoring_time_in_minutes (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.monitoring_time_in_minutes (fun f ->
               "monitoring_time_in_minutes", Integer.to_json f)
         ; Some ("rollback_triggers", RollbackTriggers.to_json v.rollback_triggers)
         ])

  let of_json j =
    { rollback_triggers =
        RollbackTriggers.of_json (Util.of_option_exn (Json.lookup j "rollback_triggers"))
    ; monitoring_time_in_minutes =
        Util.option_map (Json.lookup j "monitoring_time_in_minutes") Integer.of_json
    }
end
...
module StackSetOperationResultSummary = struct
  ...
  let parse xml =
    Some
      { account = Util.option_bind (Xml.member "Account" xml) String.parse
      ; region = Util.option_bind (Xml.member "Region" xml) String.parse
      ; status =
          Util.option_bind (Xml.member "Status" xml) StackSetOperationResultStatus.parse
      ; status_reason = Util.option_bind (Xml.member "StatusReason" xml) String.parse
      ; account_gate_result =
          Util.option_bind (Xml.member "AccountGateResult" xml) AccountGateResult.parse
      ; organizational_unit_id =
          Util.option_bind (Xml.member "OrganizationalUnitId" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.organizational_unit_id (fun f ->
               Query.Pair ("OrganizationalUnitId", String.to_query f))
         ; Util.option_map v.account_gate_result (fun f ->
               Query.Pair ("AccountGateResult", AccountGateResult.to_query f))
         ; Util.option_map v.status_reason (fun f ->
               Query.Pair ("StatusReason", String.to_query f))
         ; Util.option_map v.status (fun f ->
               Query.Pair ("Status", StackSetOperationResultStatus.to_query f))
         ; Util.option_map v.region (fun f -> Query.Pair ("Region", String.to_query f))
         ; Util.option_map v.account (fun f -> Query.Pair ("Account", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.organizational_unit_id (fun f ->
               "organizational_unit_id", String.to_json f)
         ; Util.option_map v.account_gate_result (fun f ->
         ...
         ; Util.option_map v.account (fun f -> "account", String.to_json f)
         ])
  ...
  let of_json j =
    ...
    ; status =
        Util.option_map (Json.lookup j "status") StackSetOperationResultStatus.of_json
    ; status_reason = Util.option_map (Json.lookup j "status_reason") String.of_json
    ; account_gate_result =
        Util.option_map (Json.lookup j "account_gate_result") AccountGateResult.of_json
    ; organizational_unit_id =
        Util.option_map (Json.lookup j "organizational_unit_id") String.of_json
    }
end
...
module StackSummary = struct
  ...
  let parse xml =
    Some
      { stack_id = Util.option_bind (Xml.member "StackId" xml) String.parse
      ; stack_name =
          Xml.required
            "StackName"
            (Util.option_bind (Xml.member "StackName" xml) String.parse)
      ; template_description =
          Util.option_bind (Xml.member "TemplateDescription" xml) String.parse
      ; creation_time =
          Xml.required
            "CreationTime"
            (Util.option_bind (Xml.member "CreationTime" xml) DateTime.parse)
      ; last_updated_time =
          Util.option_bind (Xml.member "LastUpdatedTime" xml) DateTime.parse
      ; deletion_time = Util.option_bind (Xml.member "DeletionTime" xml) DateTime.parse
      ; stack_status =
          Xml.required
            "StackStatus"
            (Util.option_bind (Xml.member "StackStatus" xml) StackStatus.parse)
      ; stack_status_reason =
          Util.option_bind (Xml.member "StackStatusReason" xml) String.parse
      ; parent_id = Util.option_bind (Xml.member "ParentId" xml) String.parse
      ; root_id = Util.option_bind (Xml.member "RootId" xml) String.parse
      ; drift_information =
          Util.option_bind
            (Xml.member "DriftInformation" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.drift_information (fun f ->
               Query.Pair ("DriftInformation", StackDriftInformationSummary.to_query f))
         ; Util.option_map v.root_id (fun f -> Query.Pair ("RootId", String.to_query f))
         ; Util.option_map v.parent_id (fun f ->
               Query.Pair ("ParentId", String.to_query f))
         ; Util.option_map v.stack_status_reason (fun f ->
               Query.Pair ("StackStatusReason", String.to_query f))
         ; Some (Query.Pair ("StackStatus", StackStatus.to_query v.stack_status))
         ; Util.option_map v.deletion_time (fun f ->
               Query.Pair ("DeletionTime", DateTime.to_query f))
         ; Util.option_map v.last_updated_time (fun f ->
               Query.Pair ("LastUpdatedTime", DateTime.to_query f))
         ; Some (Query.Pair ("CreationTime", DateTime.to_query v.creation_time))
         ; Util.option_map v.template_description (fun f ->
               Query.Pair ("TemplateDescription", String.to_query f))
         ; Some (Query.Pair ("StackName", String.to_query v.stack_name))
         ; Util.option_map v.stack_id (fun f -> Query.Pair ("StackId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.drift_information (fun f ->
               "drift_information", StackDriftInformationSummary.to_json f)
         ; Util.option_map v.root_id (fun f -> "root_id", String.to_json f)
         ; Util.option_map v.parent_id (fun f -> "parent_id", String.to_json f)
         ; Util.option_map v.stack_status_reason (fun f ->
               "stack_status_reason", String.to_json f)
         ; Some ("stack_status", StackStatus.to_json v.stack_status)
         ; Util.option_map v.deletion_time (fun f -> "deletion_time", DateTime.to_json f)
         ; Util.option_map v.last_updated_time (fun f ->
               "last_updated_time", DateTime.to_json f)
         ; Some ("creation_time", DateTime.to_json v.creation_time)
         ; Util.option_map v.template_description (fun f ->
               "template_description", String.to_json f)
         ; Some ("stack_name", String.to_json v.stack_name)
         ; Util.option_map v.stack_id (fun f -> "stack_id", String.to_json f)
         ])

  let of_json j =
    { stack_id = Util.option_map (Json.lookup j "stack_id") String.of_json
    ; stack_name = String.of_json (Util.of_option_exn (Json.lookup j "stack_name"))
    ; template_description =
        Util.option_map (Json.lookup j "template_description") String.of_json
    ; creation_time =
        DateTime.of_json (Util.of_option_exn (Json.lookup j "creation_time"))
    ; last_updated_time =
        Util.option_map (Json.lookup j "last_updated_time") DateTime.of_json
    ; deletion_time = Util.option_map (Json.lookup j "deletion_time") DateTime.of_json
    ; stack_status =
        StackStatus.of_json (Util.of_option_exn (Json.lookup j "stack_status"))
    ; stack_status_reason =
        Util.option_map (Json.lookup j "stack_status_reason") String.of_json
    ; parent_id = Util.option_map (Json.lookup j "parent_id") String.of_json
    ; root_id = Util.option_map (Json.lookup j "root_id") String.of_json
    ; drift_information =
        Util.option_map
          (Json.lookup j "drift_information")
    ...
    Some
      ...
      ; physical_resource_id_context =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "PhysicalResourceIdContext" xml)
      ...
      ; expected_properties =
          Util.option_bind (Xml.member "ExpectedProperties" xml) String.parse
      ; actual_properties =
          Util.option_bind (Xml.member "ActualProperties" xml) String.parse
      ; property_differences =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "PropertyDifferences" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.actual_properties (fun f ->
               Query.Pair ("ActualProperties", String.to_query f))
         ; Util.option_map v.expected_properties (fun f ->
               Query.Pair ("ExpectedProperties", String.to_query f))
         ; Some (Query.Pair ("ResourceType", String.to_query v.resource_type))
         ; Some
             (Query.Pair
         ...
         ; Util.option_map v.physical_resource_id (fun f ->
               Query.Pair ("PhysicalResourceId", String.to_query f))
         ; Some (Query.Pair ("LogicalResourceId", String.to_query v.logical_resource_id))
    ...
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some
             ...
             , StackResourceDriftStatus.to_json v.stack_resource_drift_status )
         ; Some
             ("property_differences", PropertyDifferences.to_json v.property_differences)
         ; Util.option_map v.actual_properties (fun f ->
               "actual_properties", String.to_json f)
         ; Util.option_map v.expected_properties (fun f ->
               "expected_properties", String.to_json f)
         ...
         ; Util.option_map v.physical_resource_id (fun f ->
               "physical_resource_id", String.to_json f)
         ; Some ("logical_resource_id", String.to_json v.logical_resource_id)
         ; Some ("stack_id", String.to_json v.stack_id)
         ])

  let of_json j =
    { stack_id = String.of_json (Util.of_option_exn (Json.lookup j "stack_id"))
    ; logical_resource_id =
        String.of_json (Util.of_option_exn (Json.lookup j "logical_resource_id"))
    ; physical_resource_id =
        Util.option_map (Json.lookup j "physical_resource_id") String.of_json
    ; physical_resource_id_context =
        PhysicalResourceIdContext.of_json
          (Util.of_option_exn (Json.lookup j "physical_resource_id_context"))
    ; resource_type = String.of_json (Util.of_option_exn (Json.lookup j "resource_type"))
    ; expected_properties =
        Util.option_map (Json.lookup j "expected_properties") String.of_json
    ; actual_properties =
    ...
    ; stack_resource_drift_status =
        StackResourceDriftStatus.of_json
          (Util.of_option_exn (Json.lookup j "stack_resource_drift_status"))
    ; timestamp = DateTime.of_json (Util.of_option_exn (Json.lookup j "timestamp"))
    }
end
...
module Change = struct
  ...
  let parse xml =
    Some
      ...
      ; resource_change =
          Util.option_bind (Xml.member "ResourceChange" xml) ResourceChange.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.resource_change (fun f ->
               Query.Pair ("ResourceChange", ResourceChange.to_query f))
         ; Util.option_map v.type_ (fun f -> Query.Pair ("Type", ChangeType.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.resource_change (fun f ->
               "resource_change", ResourceChange.to_json f)
         ; Util.option_map v.type_ (fun f -> "type_", ChangeType.to_json f)
         ])

  let of_json j =
    { type_ = Util.option_map (Json.lookup j "type_") ChangeType.of_json
    ; resource_change =
        Util.option_map (Json.lookup j "resource_change") ResourceChange.of_json
    }
end
...
module ChangeSetSummary = struct
  ...
  let parse xml =
    Some
      { stack_id = Util.option_bind (Xml.member "StackId" xml) String.parse
      ; stack_name = Util.option_bind (Xml.member "StackName" xml) String.parse
      ; change_set_id = Util.option_bind (Xml.member "ChangeSetId" xml) String.parse
      ; change_set_name = Util.option_bind (Xml.member "ChangeSetName" xml) String.parse
      ; execution_status =
          Util.option_bind (Xml.member "ExecutionStatus" xml) ExecutionStatus.parse
      ; status = Util.option_bind (Xml.member "Status" xml) ChangeSetStatus.parse
      ; status_reason = Util.option_bind (Xml.member "StatusReason" xml) String.parse
      ; creation_time = Util.option_bind (Xml.member "CreationTime" xml) DateTime.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      }
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.status_reason (fun f ->
               Query.Pair ("StatusReason", String.to_query f))
         ; Util.option_map v.status (fun f ->
               Query.Pair ("Status", ChangeSetStatus.to_query f))
         ; Util.option_map v.execution_status (fun f ->
               Query.Pair ("ExecutionStatus", ExecutionStatus.to_query f))
         ; Util.option_map v.change_set_name (fun f ->
               Query.Pair ("ChangeSetName", String.to_query f))
         ; Util.option_map v.change_set_id (fun f ->
               Query.Pair ("ChangeSetId", String.to_query f))
         ; Util.option_map v.stack_name (fun f ->
               Query.Pair ("StackName", String.to_query f))
         ; Util.option_map v.stack_id (fun f -> Query.Pair ("StackId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.creation_time (fun f -> "creation_time", DateTime.to_json f)
         ; Util.option_map v.status_reason (fun f -> "status_reason", String.to_json f)
         ; Util.option_map v.status (fun f -> "status", ChangeSetStatus.to_json f)
         ; Util.option_map v.execution_status (fun f ->
               "execution_status", ExecutionStatus.to_json f)
         ; Util.option_map v.change_set_name (fun f ->
               "change_set_name", String.to_json f)
         ; Util.option_map v.change_set_id (fun f -> "change_set_id", String.to_json f)
         ; Util.option_map v.stack_name (fun f -> "stack_name", String.to_json f)
         ; Util.option_map v.stack_id (fun f -> "stack_id", String.to_json f)
         ])

  let of_json j =
    { stack_id = Util.option_map (Json.lookup j "stack_id") String.of_json
    ; stack_name = Util.option_map (Json.lookup j "stack_name") String.of_json
    ; change_set_id = Util.option_map (Json.lookup j "change_set_id") String.of_json
    ; change_set_name = Util.option_map (Json.lookup j "change_set_name") String.of_json
    ; execution_status =
        Util.option_map (Json.lookup j "execution_status") ExecutionStatus.of_json
    ; status = Util.option_map (Json.lookup j "status") ChangeSetStatus.of_json
    ; status_reason = Util.option_map (Json.lookup j "status_reason") String.of_json
    ; creation_time = Util.option_map (Json.lookup j "creation_time") DateTime.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    }
end
...
module Export = struct
  ...
  let parse xml =
    Some
      { exporting_stack_id =
          Util.option_bind (Xml.member "ExportingStackId" xml) String.parse
      ; name = Util.option_bind (Xml.member "Name" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.name (fun f -> Query.Pair ("Name", String.to_query f))
         ; Util.option_map v.exporting_stack_id (fun f ->
               Query.Pair ("ExportingStackId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.name (fun f -> "name", String.to_json f)
         ; Util.option_map v.exporting_stack_id (fun f ->
               "exporting_stack_id", String.to_json f)
         ])

  let of_json j =
    { exporting_stack_id =
        Util.option_map (Json.lookup j "exporting_stack_id") String.of_json
    ; name = Util.option_map (Json.lookup j "name") String.of_json
    ...
    Some
      ...
      ; resource_identifier =
          Xml.required
            "ResourceIdentifier"
            (Util.option_bind
               (Xml.member "ResourceIdentifier" xml)
...
module TemplateParameter = struct
  ...
  let parse xml =
    Some
      ...
      ; no_echo = Util.option_bind (Xml.member "NoEcho" xml) Boolean.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.no_echo (fun f -> Query.Pair ("NoEcho", Boolean.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.no_echo (fun f -> "no_echo", Boolean.to_json f)
...
module StackSetSummary = struct
  ...
  let parse xml =
    Some
      { stack_set_name = Util.option_bind (Xml.member "StackSetName" xml) String.parse
      ; stack_set_id = Util.option_bind (Xml.member "StackSetId" xml) String.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; status = Util.option_bind (Xml.member "Status" xml) StackSetStatus.parse
      ; auto_deployment =
          Util.option_bind (Xml.member "AutoDeployment" xml) AutoDeployment.parse
      ; permission_model =
          Util.option_bind (Xml.member "PermissionModel" xml) PermissionModels.parse
      ; drift_status =
          Util.option_bind (Xml.member "DriftStatus" xml) StackDriftStatus.parse
      ; last_drift_check_timestamp =
          Util.option_bind (Xml.member "LastDriftCheckTimestamp" xml) DateTime.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.last_drift_check_timestamp (fun f ->
               Query.Pair ("LastDriftCheckTimestamp", DateTime.to_query f))
         ; Util.option_map v.drift_status (fun f ->
               Query.Pair ("DriftStatus", StackDriftStatus.to_query f))
         ; Util.option_map v.permission_model (fun f ->
               Query.Pair ("PermissionModel", PermissionModels.to_query f))
         ; Util.option_map v.auto_deployment (fun f ->
               Query.Pair ("AutoDeployment", AutoDeployment.to_query f))
         ; Util.option_map v.status (fun f ->
               Query.Pair ("Status", StackSetStatus.to_query f))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.stack_set_id (fun f ->
               Query.Pair ("StackSetId", String.to_query f))
         ; Util.option_map v.stack_set_name (fun f ->
               Query.Pair ("StackSetName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.last_drift_check_timestamp (fun f ->
               "last_drift_check_timestamp", DateTime.to_json f)
         ; Util.option_map v.drift_status (fun f ->
               "drift_status", StackDriftStatus.to_json f)
         ; Util.option_map v.permission_model (fun f ->
               "permission_model", PermissionModels.to_json f)
         ; Util.option_map v.auto_deployment (fun f ->
               "auto_deployment", AutoDeployment.to_json f)
         ; Util.option_map v.status (fun f -> "status", StackSetStatus.to_json f)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.stack_set_id (fun f -> "stack_set_id", String.to_json f)
         ; Util.option_map v.stack_set_name (fun f -> "stack_set_name", String.to_json f)
         ])

  let of_json j =
    { stack_set_name = Util.option_map (Json.lookup j "stack_set_name") String.of_json
    ; stack_set_id = Util.option_map (Json.lookup j "stack_set_id") String.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; status = Util.option_map (Json.lookup j "status") StackSetStatus.of_json
    ; auto_deployment =
        Util.option_map (Json.lookup j "auto_deployment") AutoDeployment.of_json
    ; permission_model =
        Util.option_map (Json.lookup j "permission_model") PermissionModels.of_json
    ; drift_status =
        Util.option_map (Json.lookup j "drift_status") StackDriftStatus.of_json
    ; last_drift_check_timestamp =
        Util.option_map (Json.lookup j "last_drift_check_timestamp") DateTime.of_json
    }
end
...
module TypeSummary = struct
  ...
  let parse xml =
    Some
      { type_ = Util.option_bind (Xml.member "Type" xml) RegistryType.parse
      ; type_name = Util.option_bind (Xml.member "TypeName" xml) String.parse
      ; default_version_id =
          Util.option_bind (Xml.member "DefaultVersionId" xml) String.parse
      ; type_arn = Util.option_bind (Xml.member "TypeArn" xml) String.parse
      ; last_updated = Util.option_bind (Xml.member "LastUpdated" xml) DateTime.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.last_updated (fun f ->
               Query.Pair ("LastUpdated", DateTime.to_query f))
         ; Util.option_map v.type_arn (fun f -> Query.Pair ("TypeArn", String.to_query f))
         ; Util.option_map v.default_version_id (fun f ->
               Query.Pair ("DefaultVersionId", String.to_query f))
         ; Util.option_map v.type_name (fun f ->
               Query.Pair ("TypeName", String.to_query f))
         ; Util.option_map v.type_ (fun f -> Query.Pair ("Type", RegistryType.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.last_updated (fun f -> "last_updated", DateTime.to_json f)
         ; Util.option_map v.type_arn (fun f -> "type_arn", String.to_json f)
         ; Util.option_map v.default_version_id (fun f ->
               "default_version_id", String.to_json f)
         ; Util.option_map v.type_name (fun f -> "type_name", String.to_json f)
         ; Util.option_map v.type_ (fun f -> "type_", RegistryType.to_json f)
         ])

  let of_json j =
    { type_ = Util.option_map (Json.lookup j "type_") RegistryType.of_json
    ; type_name = Util.option_map (Json.lookup j "type_name") String.of_json
    ; default_version_id =
        Util.option_map (Json.lookup j "default_version_id") String.of_json
    ; type_arn = Util.option_map (Json.lookup j "type_arn") String.of_json
    ; last_updated = Util.option_map (Json.lookup j "last_updated") DateTime.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    }
end
...
module DeploymentTargets = struct
  ...
  let parse xml =
    Some
      { accounts =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Accounts" xml) AccountList.parse)
      ; organizational_unit_ids =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "OrganizationalUnitIds" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("Accounts.member", AccountList.to_query v.accounts))
         ])
  ...
  let of_json j =
    { accounts = AccountList.of_json (Util.of_option_exn (Json.lookup j "accounts"))
    ; organizational_unit_ids =
...
module StackSetDriftDetectionDetails = struct
  ...
  let parse xml =
    Some
      { drift_status =
          Util.option_bind (Xml.member "DriftStatus" xml) StackSetDriftStatus.parse
      ; drift_detection_status =
          Util.option_bind
            (Xml.member "DriftDetectionStatus" xml)
            StackSetDriftDetectionStatus.parse
      ; last_drift_check_timestamp =
          Util.option_bind (Xml.member "LastDriftCheckTimestamp" xml) DateTime.parse
      ; total_stack_instances_count =
          Util.option_bind (Xml.member "TotalStackInstancesCount" xml) Integer.parse
      ; drifted_stack_instances_count =
          Util.option_bind (Xml.member "DriftedStackInstancesCount" xml) Integer.parse
      ; in_sync_stack_instances_count =
          Util.option_bind (Xml.member "InSyncStackInstancesCount" xml) Integer.parse
      ; in_progress_stack_instances_count =
          Util.option_bind (Xml.member "InProgressStackInstancesCount" xml) Integer.parse
      ; failed_stack_instances_count =
          Util.option_bind (Xml.member "FailedStackInstancesCount" xml) Integer.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.failed_stack_instances_count (fun f ->
               Query.Pair ("FailedStackInstancesCount", Integer.to_query f))
         ; Util.option_map v.in_progress_stack_instances_count (fun f ->
               Query.Pair ("InProgressStackInstancesCount", Integer.to_query f))
         ; Util.option_map v.in_sync_stack_instances_count (fun f ->
               Query.Pair ("InSyncStackInstancesCount", Integer.to_query f))
         ; Util.option_map v.drifted_stack_instances_count (fun f ->
               Query.Pair ("DriftedStackInstancesCount", Integer.to_query f))
         ; Util.option_map v.total_stack_instances_count (fun f ->
               Query.Pair ("TotalStackInstancesCount", Integer.to_query f))
         ; Util.option_map v.last_drift_check_timestamp (fun f ->
               Query.Pair ("LastDriftCheckTimestamp", DateTime.to_query f))
         ; Util.option_map v.drift_detection_status (fun f ->
               Query.Pair ("DriftDetectionStatus", StackSetDriftDetectionStatus.to_query f))
         ; Util.option_map v.drift_status (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.failed_stack_instances_count (fun f ->
               "failed_stack_instances_count", Integer.to_json f)
         ; Util.option_map v.in_progress_stack_instances_count (fun f ->
               "in_progress_stack_instances_count", Integer.to_json f)
         ; Util.option_map v.in_sync_stack_instances_count (fun f ->
               "in_sync_stack_instances_count", Integer.to_json f)
         ; Util.option_map v.drifted_stack_instances_count (fun f ->
               "drifted_stack_instances_count", Integer.to_json f)
         ; Util.option_map v.total_stack_instances_count (fun f ->
               "total_stack_instances_count", Integer.to_json f)
         ; Util.option_map v.last_drift_check_timestamp (fun f ->
               "last_drift_check_timestamp", DateTime.to_json f)
         ; Util.option_map v.drift_detection_status (fun f ->
               "drift_detection_status", StackSetDriftDetectionStatus.to_json f)
         ; Util.option_map v.drift_status (fun f ->
               "drift_status", StackSetDriftStatus.to_json f)
         ])

  let of_json j =
    { drift_status =
        Util.option_map (Json.lookup j "drift_status") StackSetDriftStatus.of_json
    ; drift_detection_status =
        Util.option_map
          (Json.lookup j "drift_detection_status")
          StackSetDriftDetectionStatus.of_json
    ; last_drift_check_timestamp =
        Util.option_map (Json.lookup j "last_drift_check_timestamp") DateTime.of_json
    ; total_stack_instances_count =
        Util.option_map (Json.lookup j "total_stack_instances_count") Integer.of_json
    ; drifted_stack_instances_count =
        Util.option_map (Json.lookup j "drifted_stack_instances_count") Integer.of_json
    ; in_sync_stack_instances_count =
        Util.option_map (Json.lookup j "in_sync_stack_instances_count") Integer.of_json
    ; in_progress_stack_instances_count =
        Util.option_map
          (Json.lookup j "in_progress_stack_instances_count")
          Integer.of_json
    ; failed_stack_instances_count =
        Util.option_map (Json.lookup j "failed_stack_instances_count") Integer.of_json
    }
end
...
module StackSetOperationPreferences = struct
  ...
  let parse xml =
    Some
      { region_order =
          Util.of_option
            []
            (Util.option_bind (Xml.member "RegionOrder" xml) RegionList.parse)
      ; failure_tolerance_count =
          Util.option_bind (Xml.member "FailureToleranceCount" xml) Integer.parse
      ; failure_tolerance_percentage =
          Util.option_bind (Xml.member "FailureTolerancePercentage" xml) Integer.parse
      ; max_concurrent_count =
          Util.option_bind (Xml.member "MaxConcurrentCount" xml) Integer.parse
      ; max_concurrent_percentage =
          Util.option_bind (Xml.member "MaxConcurrentPercentage" xml) Integer.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.max_concurrent_percentage (fun f ->
               Query.Pair ("MaxConcurrentPercentage", Integer.to_query f))
         ; Util.option_map v.max_concurrent_count (fun f ->
               Query.Pair ("MaxConcurrentCount", Integer.to_query f))
         ; Util.option_map v.failure_tolerance_percentage (fun f ->
               Query.Pair ("FailureTolerancePercentage", Integer.to_query f))
         ; Util.option_map v.failure_tolerance_count (fun f ->
               Query.Pair ("FailureToleranceCount", Integer.to_query f))
         ; Some (Query.Pair ("RegionOrder.member", RegionList.to_query v.region_order))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.max_concurrent_percentage (fun f ->
               "max_concurrent_percentage", Integer.to_json f)
         ; Util.option_map v.max_concurrent_count (fun f ->
               "max_concurrent_count", Integer.to_json f)
         ; Util.option_map v.failure_tolerance_percentage (fun f ->
               "failure_tolerance_percentage", Integer.to_json f)
         ; Util.option_map v.failure_tolerance_count (fun f ->
               "failure_tolerance_count", Integer.to_json f)
         ; Some ("region_order", RegionList.to_json v.region_order)
         ])

  let of_json j =
    { region_order =
        RegionList.of_json (Util.of_option_exn (Json.lookup j "region_order"))
    ; failure_tolerance_count =
        Util.option_map (Json.lookup j "failure_tolerance_count") Integer.of_json
    ; failure_tolerance_percentage =
        Util.option_map (Json.lookup j "failure_tolerance_percentage") Integer.of_json
    ; max_concurrent_count =
        Util.option_map (Json.lookup j "max_concurrent_count") Integer.of_json
    ; max_concurrent_percentage =
        Util.option_map (Json.lookup j "max_concurrent_percentage") Integer.of_json
    }
end
...
module StackEvent = struct
    ...
    Some
      ...
      ; timestamp =
          Xml.required
            ...
            (Util.option_bind (Xml.member "Timestamp" xml) DateTime.parse)
      ; resource_status =
          Util.option_bind (Xml.member "ResourceStatus" xml) ResourceStatus.parse
      ; resource_status_reason =
          Util.option_bind (Xml.member "ResourceStatusReason" xml) String.parse
      ; resource_properties =
          Util.option_bind (Xml.member "ResourceProperties" xml) String.parse
      ; client_request_token =
          Util.option_bind (Xml.member "ClientRequestToken" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.client_request_token (fun f ->
               Query.Pair ("ClientRequestToken", String.to_query f))
         ; Util.option_map v.resource_properties (fun f ->
               Query.Pair ("ResourceProperties", String.to_query f))
         ; Util.option_map v.resource_status_reason (fun f ->
               Query.Pair ("ResourceStatusReason", String.to_query f))
         ; Util.option_map v.resource_status (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.client_request_token (fun f ->
               "client_request_token", String.to_json f)
         ; Util.option_map v.resource_properties (fun f ->
               "resource_properties", String.to_json f)
         ; Util.option_map v.resource_status_reason (fun f ->
               "resource_status_reason", String.to_json f)
         ; Util.option_map v.resource_status (fun f ->
               "resource_status", ResourceStatus.to_json f)
         ; Some ("timestamp", DateTime.to_json v.timestamp)
         ; Util.option_map v.resource_type (fun f -> "resource_type", String.to_json f)
         ; Util.option_map v.physical_resource_id (fun f ->
               "physical_resource_id", String.to_json f)
  ...
  let of_json j =
    { stack_id = String.of_json (Util.of_option_exn (Json.lookup j "stack_id"))
    ; event_id = String.of_json (Util.of_option_exn (Json.lookup j "event_id"))
    ; stack_name = String.of_json (Util.of_option_exn (Json.lookup j "stack_name"))
    ; logical_resource_id =
        Util.option_map (Json.lookup j "logical_resource_id") String.of_json
    ; physical_resource_id =
    ...
    ; timestamp = DateTime.of_json (Util.of_option_exn (Json.lookup j "timestamp"))
    ; resource_status =
        Util.option_map (Json.lookup j "resource_status") ResourceStatus.of_json
    ; resource_status_reason =
        Util.option_map (Json.lookup j "resource_status_reason") String.of_json
    ; resource_properties =
        Util.option_map (Json.lookup j "resource_properties") String.of_json
    ; client_request_token =
        Util.option_map (Json.lookup j "client_request_token") String.of_json
    }
end
...
module TypeVersionSummary = struct
  ...
  let parse xml =
    Some
      ...
      ; is_default_version =
          Util.option_bind (Xml.member "IsDefaultVersion" xml) Boolean.parse
      ; arn = Util.option_bind (Xml.member "Arn" xml) String.parse
      ; time_created = Util.option_bind (Xml.member "TimeCreated" xml) DateTime.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.time_created (fun f ->
               Query.Pair ("TimeCreated", DateTime.to_query f))
         ; Util.option_map v.arn (fun f -> Query.Pair ("Arn", String.to_query f))
         ; Util.option_map v.is_default_version (fun f ->
               Query.Pair ("IsDefaultVersion", Boolean.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.time_created (fun f -> "time_created", DateTime.to_json f)
         ; Util.option_map v.arn (fun f -> "arn", String.to_json f)
         ; Util.option_map v.is_default_version (fun f ->
               "is_default_version", Boolean.to_json f)
  ...
  let of_json j =
    ...
    ; is_default_version =
        Util.option_map (Json.lookup j "is_default_version") Boolean.of_json
    ; arn = Util.option_map (Json.lookup j "arn") String.of_json
    ; time_created = Util.option_map (Json.lookup j "time_created") DateTime.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    }
end
...
module StackSetOperationSummary = struct
  ...
  let parse xml =
    Some
      { operation_id = Util.option_bind (Xml.member "OperationId" xml) String.parse
      ; action = Util.option_bind (Xml.member "Action" xml) StackSetOperationAction.parse
      ; status = Util.option_bind (Xml.member "Status" xml) StackSetOperationStatus.parse
      ; creation_timestamp =
          Util.option_bind (Xml.member "CreationTimestamp" xml) DateTime.parse
      ; end_timestamp = Util.option_bind (Xml.member "EndTimestamp" xml) DateTime.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.end_timestamp (fun f ->
               Query.Pair ("EndTimestamp", DateTime.to_query f))
         ...
         ; Util.option_map v.operation_id (fun f ->
               Query.Pair ("OperationId", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.end_timestamp (fun f -> "end_timestamp", DateTime.to_json f)
         ; Util.option_map v.creation_timestamp (fun f ->
               "creation_timestamp", DateTime.to_json f)
         ; Util.option_map v.status (fun f -> "status", StackSetOperationStatus.to_json f)
         ; Util.option_map v.action (fun f -> "action", StackSetOperationAction.to_json f)
         ; Util.option_map v.operation_id (fun f -> "operation_id", String.to_json f)
         ])

  let of_json j =
    { operation_id = Util.option_map (Json.lookup j "operation_id") String.of_json
    ; action = Util.option_map (Json.lookup j "action") StackSetOperationAction.of_json
    ; status = Util.option_map (Json.lookup j "status") StackSetOperationStatus.of_json
    ; creation_timestamp =
        Util.option_map (Json.lookup j "creation_timestamp") DateTime.of_json
    ; end_timestamp = Util.option_map (Json.lookup j "end_timestamp") DateTime.of_json
    }
end
...
module StackResourceSummary = struct
    ...
    Some
      ...
      ; last_updated_timestamp =
          Xml.required
            ...
            (Util.option_bind (Xml.member "LastUpdatedTimestamp" xml) DateTime.parse)
      ; resource_status =
          Xml.required
            "ResourceStatus"
            (Util.option_bind (Xml.member "ResourceStatus" xml) ResourceStatus.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.resource_status_reason (fun f ->
               Query.Pair ("ResourceStatusReason", String.to_query f))
         ; Some (Query.Pair ("ResourceStatus", ResourceStatus.to_query v.resource_status))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.drift_information (fun f ->
               "drift_information", StackResourceDriftInformationSummary.to_json f)
         ; Util.option_map v.resource_status_reason (fun f ->
               "resource_status_reason", String.to_json f)
         ; Some ("resource_status", ResourceStatus.to_json v.resource_status)
         ; Some ("last_updated_timestamp", DateTime.to_json v.last_updated_timestamp)
         ; Some ("resource_type", String.to_json v.resource_type)
         ; Util.option_map v.physical_resource_id (fun f ->
               "physical_resource_id", String.to_json f)
         ; Some ("logical_resource_id", String.to_json v.logical_resource_id)
  ...
  let of_json j =
    ...
    ; resource_type = String.of_json (Util.of_option_exn (Json.lookup j "resource_type"))
    ; last_updated_timestamp =
        DateTime.of_json (Util.of_option_exn (Json.lookup j "last_updated_timestamp"))
    ; resource_status =
        ResourceStatus.of_json (Util.of_option_exn (Json.lookup j "resource_status"))
    ; resource_status_reason =
        Util.option_map (Json.lookup j "resource_status_reason") String.of_json
    ; drift_information =
        Util.option_map
...
module StackInstanceFilter = struct
  ...
  let parse xml =
    Some
      { name = Util.option_bind (Xml.member "Name" xml) StackInstanceFilterName.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.values (fun f -> Query.Pair ("Values", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.values (fun f -> "values", String.to_json f)
         ; Util.option_map v.name (fun f -> "name", StackInstanceFilterName.to_json f)
         ])

  let of_json j =
    { name = Util.option_map (Json.lookup j "name") StackInstanceFilterName.of_json
...
module ParameterDeclaration = struct
  ...
  let parse xml =
    Some
      { parameter_key = Util.option_bind (Xml.member "ParameterKey" xml) String.parse
      ; default_value = Util.option_bind (Xml.member "DefaultValue" xml) String.parse
      ; parameter_type = Util.option_bind (Xml.member "ParameterType" xml) String.parse
      ; no_echo = Util.option_bind (Xml.member "NoEcho" xml) Boolean.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; parameter_constraints =
          Util.option_bind
            (Xml.member "ParameterConstraints" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.parameter_constraints (fun f ->
               Query.Pair ("ParameterConstraints", ParameterConstraints.to_query f))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.no_echo (fun f -> Query.Pair ("NoEcho", Boolean.to_query f))
         ; Util.option_map v.parameter_type (fun f ->
               Query.Pair ("ParameterType", String.to_query f))
         ; Util.option_map v.default_value (fun f ->
               Query.Pair ("DefaultValue", String.to_query f))
         ; Util.option_map v.parameter_key (fun f ->
               Query.Pair ("ParameterKey", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.no_echo (fun f -> "no_echo", Boolean.to_json f)
         ; Util.option_map v.parameter_type (fun f -> "parameter_type", String.to_json f)
         ; Util.option_map v.default_value (fun f -> "default_value", String.to_json f)
         ; Util.option_map v.parameter_key (fun f -> "parameter_key", String.to_json f)
         ])
  ...
  let of_json j =
    { parameter_key = Util.option_map (Json.lookup j "parameter_key") String.of_json
    ; default_value = Util.option_map (Json.lookup j "default_value") String.of_json
    ; parameter_type = Util.option_map (Json.lookup j "parameter_type") String.of_json
    ; no_echo = Util.option_map (Json.lookup j "no_echo") Boolean.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; parameter_constraints =
        Util.option_map
          (Json.lookup j "parameter_constraints")
...
module ResourceIdentifierSummary = struct
    ...
    Some
      ...
      ; logical_resource_ids =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "LogicalResourceIds" xml)
               LogicalResourceIds.parse)
      ; resource_identifiers =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ResourceIdentifiers" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some
             ("resource_identifiers", ResourceIdentifiers.to_json v.resource_identifiers)
         ; Some ("logical_resource_ids", LogicalResourceIds.to_json v.logical_resource_ids)
         ; Util.option_map v.resource_type (fun f -> "resource_type", String.to_json f)
         ])
...
module StackInstanceSummary = struct
  ...
  let parse xml =
    Some
      ...
      ; account = Util.option_bind (Xml.member "Account" xml) String.parse
      ; stack_id = Util.option_bind (Xml.member "StackId" xml) String.parse
      ; status = Util.option_bind (Xml.member "Status" xml) StackInstanceStatus.parse
      ; status_reason = Util.option_bind (Xml.member "StatusReason" xml) String.parse
      ; stack_instance_status =
          Util.option_bind
            (Xml.member "StackInstanceStatus" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.organizational_unit_id (fun f ->
               Query.Pair ("OrganizationalUnitId", String.to_query f))
         ; Util.option_map v.stack_instance_status (fun f ->
               Query.Pair
    ...
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.organizational_unit_id (fun f ->
               "organizational_unit_id", String.to_json f)
         ; Util.option_map v.stack_instance_status (fun f ->
               "stack_instance_status", StackInstanceComprehensiveStatus.to_json f)
         ; Util.option_map v.status_reason (fun f -> "status_reason", String.to_json f)
         ; Util.option_map v.status (fun f -> "status", StackInstanceStatus.to_json f)
         ; Util.option_map v.stack_id (fun f -> "stack_id", String.to_json f)
         ; Util.option_map v.account (fun f -> "account", String.to_json f)
         ; Util.option_map v.region (fun f -> "region", String.to_json f)
         ; Util.option_map v.stack_set_id (fun f -> "stack_set_id", String.to_json f)
  ...
  let of_json j =
    ...
    ; account = Util.option_map (Json.lookup j "account") String.of_json
    ; stack_id = Util.option_map (Json.lookup j "stack_id") String.of_json
    ; status = Util.option_map (Json.lookup j "status") StackInstanceStatus.of_json
    ; status_reason = Util.option_map (Json.lookup j "status_reason") String.of_json
    ; stack_instance_status =
        Util.option_map
          (Json.lookup j "stack_instance_status")
...
module Stack = struct
  ...
  let parse xml =
    Some
      ...
      ; rollback_configuration =
          Util.option_bind
            (Xml.member "RollbackConfiguration" xml)
      ...
      ; stack_status_reason =
          Util.option_bind (Xml.member "StackStatusReason" xml) String.parse
      ; disable_rollback =
          Util.option_bind (Xml.member "DisableRollback" xml) Boolean.parse
      ; notification_a_r_ns =
          Util.of_option
            []
            (Util.option_bind (Xml.member "NotificationARNs" xml) NotificationARNs.parse)
      ; timeout_in_minutes =
          Util.option_bind (Xml.member "TimeoutInMinutes" xml) Integer.parse
      ; capabilities =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Capabilities" xml) Capabilities.parse)
      ; outputs =
          Util.of_option [] (Util.option_bind (Xml.member "Outputs" xml) Outputs.parse)
      ; role_a_r_n = Util.option_bind (Xml.member "RoleARN" xml) String.parse
      ; tags = Util.of_option [] (Util.option_bind (Xml.member "Tags" xml) Tags.parse)
      ; enable_termination_protection =
          Util.option_bind (Xml.member "EnableTerminationProtection" xml) Boolean.parse
      ; parent_id = Util.option_bind (Xml.member "ParentId" xml) String.parse
      ; root_id = Util.option_bind (Xml.member "RootId" xml) String.parse
      ; drift_information =
          Util.option_bind (Xml.member "DriftInformation" xml) StackDriftInformation.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.drift_information (fun f ->
               Query.Pair ("DriftInformation", StackDriftInformation.to_query f))
         ; Util.option_map v.root_id (fun f -> Query.Pair ("RootId", String.to_query f))
         ; Util.option_map v.parent_id (fun f ->
               Query.Pair ("ParentId", String.to_query f))
         ; Util.option_map v.enable_termination_protection (fun f ->
               Query.Pair ("EnableTerminationProtection", Boolean.to_query f))
         ; Some (Query.Pair ("Tags.member", Tags.to_query v.tags))
         ; Util.option_map v.role_a_r_n (fun f ->
               Query.Pair ("RoleARN", String.to_query f))
         ; Some (Query.Pair ("Outputs.member", Outputs.to_query v.outputs))
         ; Some (Query.Pair ("Capabilities.member", Capabilities.to_query v.capabilities))
         ; Util.option_map v.timeout_in_minutes (fun f ->
               Query.Pair ("TimeoutInMinutes", Integer.to_query f))
         ; Some
             (Query.Pair
                ( "NotificationARNs.member"
                , NotificationARNs.to_query v.notification_a_r_ns ))
         ; Util.option_map v.disable_rollback (fun f ->
               Query.Pair ("DisableRollback", Boolean.to_query f))
         ; Util.option_map v.stack_status_reason (fun f ->
               Query.Pair ("StackStatusReason", String.to_query f))
         ; Some (Query.Pair ("StackStatus", StackStatus.to_query v.stack_status))
         ; Util.option_map v.rollback_configuration (fun f ->
               Query.Pair ("RollbackConfiguration", RollbackConfiguration.to_query f))
         ; Util.option_map v.last_updated_time (fun f ->
               Query.Pair ("LastUpdatedTime", DateTime.to_query f))
         ; Util.option_map v.deletion_time (fun f ->
               Query.Pair ("DeletionTime", DateTime.to_query f))
         ; Some (Query.Pair ("CreationTime", DateTime.to_query v.creation_time))
         ; Some (Query.Pair ("Parameters.member", Parameters.to_query v.parameters))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.change_set_id (fun f ->
               Query.Pair ("ChangeSetId", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.role_a_r_n (fun f -> "role_a_r_n", String.to_json f)
         ; Some ("outputs", Outputs.to_json v.outputs)
         ; Some ("capabilities", Capabilities.to_json v.capabilities)
         ; Util.option_map v.timeout_in_minutes (fun f ->
               "timeout_in_minutes", Integer.to_json f)
         ; Some ("notification_a_r_ns", NotificationARNs.to_json v.notification_a_r_ns)
         ; Util.option_map v.disable_rollback (fun f ->
               "disable_rollback", Boolean.to_json f)
         ; Util.option_map v.stack_status_reason (fun f ->
               "stack_status_reason", String.to_json f)
         ; Some ("stack_status", StackStatus.to_json v.stack_status)
         ; Util.option_map v.rollback_configuration (fun f ->
  ...
  let of_json j =
    ...
    ; change_set_id = Util.option_map (Json.lookup j "change_set_id") String.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; parameters = Parameters.of_json (Util.of_option_exn (Json.lookup j "parameters"))
    ; creation_time =
        DateTime.of_json (Util.of_option_exn (Json.lookup j "creation_time"))
    ; deletion_time = Util.option_map (Json.lookup j "deletion_time") DateTime.of_json
    ; last_updated_time =
    ...
    ; rollback_configuration =
        Util.option_map
          (Json.lookup j "rollback_configuration")
    ...
    ; timeout_in_minutes =
        Util.option_map (Json.lookup j "timeout_in_minutes") Integer.of_json
    ; capabilities =
        Capabilities.of_json (Util.of_option_exn (Json.lookup j "capabilities"))
    ; outputs = Outputs.of_json (Util.of_option_exn (Json.lookup j "outputs"))
    ; role_a_r_n = Util.option_map (Json.lookup j "role_a_r_n") String.of_json
    ; tags = Tags.of_json (Util.of_option_exn (Json.lookup j "tags"))
    ; enable_termination_protection =
        Util.option_map (Json.lookup j "enable_termination_protection") Boolean.of_json
    ; parent_id = Util.option_map (Json.lookup j "parent_id") String.of_json
    ; root_id = Util.option_map (Json.lookup j "root_id") String.of_json
    ; drift_information =
        Util.option_map (Json.lookup j "drift_information") StackDriftInformation.of_json
    }
end
...
module StackResource = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.drift_information (fun f ->
               Query.Pair ("DriftInformation", StackResourceDriftInformation.to_query f))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.resource_status_reason (fun f ->
               Query.Pair ("ResourceStatusReason", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.drift_information (fun f ->
               "drift_information", StackResourceDriftInformation.to_json f)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.resource_status_reason (fun f ->
               "resource_status_reason", String.to_json f)
         ; Some ("resource_status", ResourceStatus.to_json v.resource_status)
...
module StackResourceDriftStatusFilters = struct
  ...
  let parse xml =
    Util.option_all (List.map StackResourceDriftStatus.parse (Xml.members "member" xml))
...
module StackSetOperationResultSummaries = struct
  ...
  let parse xml =
    Util.option_all
      (List.map StackSetOperationResultSummary.parse (Xml.members "member" xml))

  let to_query v = Query.to_query_list StackSetOperationResultSummary.to_query v
...
module AccountLimitList = struct
  ...
  let parse xml = Util.option_all (List.map AccountLimit.parse (Xml.members "member" xml))
...
module StackSummaries = struct
  ...
  let parse xml = Util.option_all (List.map StackSummary.parse (Xml.members "member" xml))
...
module StackResourceDrifts = struct
  ...
  let parse xml =
    Util.option_all (List.map StackResourceDrift.parse (Xml.members "member" xml))
...
module StackStatusFilter = struct
  ...
  let parse xml = Util.option_all (List.map StackStatus.parse (Xml.members "member" xml))
...
module Changes = struct
  ...
  let parse xml = Util.option_all (List.map Change.parse (Xml.members "member" xml))
...
module ChangeSetSummaries = struct
  ...
  let parse xml =
    Util.option_all (List.map ChangeSetSummary.parse (Xml.members "member" xml))
...
module Exports = struct
  ...
  let parse xml = Util.option_all (List.map Export.parse (Xml.members "member" xml))
...
module ResourcesToImport = struct
  ...
  let parse xml =
    Util.option_all (List.map ResourceToImport.parse (Xml.members "member" xml))
...
module TemplateParameters = struct
  ...
  let parse xml =
    Util.option_all (List.map TemplateParameter.parse (Xml.members "member" xml))
...
module StackInstance = struct
  ...
  let parse xml =
    Some
      ...
      ; parameter_overrides =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ParameterOverrides" xml) Parameters.parse)
      ; status = Util.option_bind (Xml.member "Status" xml) StackInstanceStatus.parse
      ; stack_instance_status =
          Util.option_bind
            (Xml.member "StackInstanceStatus" xml)
    ...
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.stack_instance_status (fun f ->
               "stack_instance_status", StackInstanceComprehensiveStatus.to_json f)
         ; Util.option_map v.status (fun f -> "status", StackInstanceStatus.to_json f)
         ; Some ("parameter_overrides", Parameters.to_json v.parameter_overrides)
         ; Util.option_map v.stack_id (fun f -> "stack_id", String.to_json f)
         ; Util.option_map v.account (fun f -> "account", String.to_json f)
         ; Util.option_map v.region (fun f -> "region", String.to_json f)
         ; Util.option_map v.stack_set_id (fun f -> "stack_set_id", String.to_json f)
  ...
  let of_json j =
    ...
    ; stack_id = Util.option_map (Json.lookup j "stack_id") String.of_json
    ; parameter_overrides =
        Parameters.of_json (Util.of_option_exn (Json.lookup j "parameter_overrides"))
    ; status = Util.option_map (Json.lookup j "status") StackInstanceStatus.of_json
    ; stack_instance_status =
        Util.option_map
          (Json.lookup j "stack_instance_status")
...
module StackSetSummaries = struct
  ...
  let parse xml =
    Util.option_all (List.map StackSetSummary.parse (Xml.members "member" xml))
...
module TypeSummaries = struct
  ...
  let parse xml = Util.option_all (List.map TypeSummary.parse (Xml.members "member" xml))
...
module StackResourceDetail = struct
  ...
  let parse xml =
    Some
      ...
      ; resource_status_reason =
          Util.option_bind (Xml.member "ResourceStatusReason" xml) String.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; metadata = Util.option_bind (Xml.member "Metadata" xml) String.parse
      ; drift_information =
          Util.option_bind
            (Xml.member "DriftInformation" xml)
            StackResourceDriftInformation.parse
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.metadata (fun f ->
               Query.Pair ("Metadata", String.to_query f))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.resource_status_reason (fun f ->
               Query.Pair ("ResourceStatusReason", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.drift_information (fun f ->
               "drift_information", StackResourceDriftInformation.to_json f)
         ; Util.option_map v.metadata (fun f -> "metadata", String.to_json f)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.resource_status_reason (fun f ->
               "resource_status_reason", String.to_json f)
         ; Some ("resource_status", ResourceStatus.to_json v.resource_status)
  ...
  let of_json j =
    ...
    ; resource_status_reason =
        Util.option_map (Json.lookup j "resource_status_reason") String.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; metadata = Util.option_map (Json.lookup j "metadata") String.of_json
    ; drift_information =
        Util.option_map
          (Json.lookup j "drift_information")
          StackResourceDriftInformation.of_json
...
module StackSetOperation = struct
  ...
  let parse xml =
    Some
      ...
      ; operation_preferences =
          Util.option_bind
            (Xml.member "OperationPreferences" xml)
            StackSetOperationPreferences.parse
      ; retain_stacks = Util.option_bind (Xml.member "RetainStacks" xml) Boolean.parse
      ; administration_role_a_r_n =
          Util.option_bind (Xml.member "AdministrationRoleARN" xml) String.parse
      ; execution_role_name =
          Util.option_bind (Xml.member "ExecutionRoleName" xml) String.parse
      ; creation_timestamp =
          Util.option_bind (Xml.member "CreationTimestamp" xml) DateTime.parse
      ; end_timestamp = Util.option_bind (Xml.member "EndTimestamp" xml) DateTime.parse
      ; deployment_targets =
          Util.option_bind (Xml.member "DeploymentTargets" xml) DeploymentTargets.parse
      ; stack_set_drift_detection_details =
          Util.option_bind
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.stack_set_drift_detection_details (fun f ->
               Query.Pair
                 ( "StackSetDriftDetectionDetails"
                 , StackSetDriftDetectionDetails.to_query f ))
         ; Util.option_map v.deployment_targets (fun f ->
               Query.Pair ("DeploymentTargets", DeploymentTargets.to_query f))
         ; Util.option_map v.end_timestamp (fun f ->
               Query.Pair ("EndTimestamp", DateTime.to_query f))
         ; Util.option_map v.creation_timestamp (fun f ->
               Query.Pair ("CreationTimestamp", DateTime.to_query f))
         ; Util.option_map v.execution_role_name (fun f ->
               Query.Pair ("ExecutionRoleName", String.to_query f))
         ; Util.option_map v.administration_role_a_r_n (fun f ->
               Query.Pair ("AdministrationRoleARN", String.to_query f))
         ; Util.option_map v.retain_stacks (fun f ->
               Query.Pair ("RetainStacks", Boolean.to_query f))
         ; Util.option_map v.operation_preferences (fun f ->
               Query.Pair ("OperationPreferences", StackSetOperationPreferences.to_query f))
         ; Util.option_map v.status (fun f ->
               Query.Pair ("Status", StackSetOperationStatus.to_query f))
         ; Util.option_map v.action (fun f ->
               Query.Pair ("Action", StackSetOperationAction.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.deployment_targets (fun f ->
               "deployment_targets", DeploymentTargets.to_json f)
         ; Util.option_map v.end_timestamp (fun f -> "end_timestamp", DateTime.to_json f)
         ; Util.option_map v.creation_timestamp (fun f ->
               "creation_timestamp", DateTime.to_json f)
         ; Util.option_map v.execution_role_name (fun f ->
               "execution_role_name", String.to_json f)
         ; Util.option_map v.administration_role_a_r_n (fun f ->
               "administration_role_a_r_n", String.to_json f)
         ; Util.option_map v.retain_stacks (fun f -> "retain_stacks", Boolean.to_json f)
         ; Util.option_map v.operation_preferences (fun f ->
               "operation_preferences", StackSetOperationPreferences.to_json f)
         ; Util.option_map v.status (fun f -> "status", StackSetOperationStatus.to_json f)
         ; Util.option_map v.action (fun f -> "action", StackSetOperationAction.to_json f)
         ; Util.option_map v.stack_set_id (fun f -> "stack_set_id", String.to_json f)
         ; Util.option_map v.operation_id (fun f -> "operation_id", String.to_json f)
  ...
  let of_json j =
    ...
    ; operation_preferences =
        Util.option_map
          (Json.lookup j "operation_preferences")
          StackSetOperationPreferences.of_json
    ; retain_stacks = Util.option_map (Json.lookup j "retain_stacks") Boolean.of_json
    ; administration_role_a_r_n =
        Util.option_map (Json.lookup j "administration_role_a_r_n") String.of_json
    ; execution_role_name =
        Util.option_map (Json.lookup j "execution_role_name") String.of_json
    ; creation_timestamp =
        Util.option_map (Json.lookup j "creation_timestamp") DateTime.of_json
    ; end_timestamp = Util.option_map (Json.lookup j "end_timestamp") DateTime.of_json
    ; deployment_targets =
        Util.option_map (Json.lookup j "deployment_targets") DeploymentTargets.of_json
    ; stack_set_drift_detection_details =
        Util.option_map
...
module StackEvents = struct
  ...
  let parse xml = Util.option_all (List.map StackEvent.parse (Xml.members "member" xml))
...
module StackSet = struct
  ...
  let parse xml =
    Some
      ...
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; status = Util.option_bind (Xml.member "Status" xml) StackSetStatus.parse
      ; template_body = Util.option_bind (Xml.member "TemplateBody" xml) String.parse
      ; parameters =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Parameters" xml) Parameters.parse)
      ; capabilities =
          Util.of_option
            ...
            (Util.option_bind (Xml.member "Capabilities" xml) Capabilities.parse)
      ; tags = Util.of_option [] (Util.option_bind (Xml.member "Tags" xml) Tags.parse)
      ; stack_set_a_r_n = Util.option_bind (Xml.member "StackSetARN" xml) String.parse
      ; administration_role_a_r_n =
          Util.option_bind (Xml.member "AdministrationRoleARN" xml) String.parse
      ; execution_role_name =
          Util.option_bind (Xml.member "ExecutionRoleName" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.administration_role_a_r_n (fun f ->
               Query.Pair ("AdministrationRoleARN", String.to_query f))
         ; Util.option_map v.stack_set_a_r_n (fun f ->
               Query.Pair ("StackSetARN", String.to_query f))
         ; Some (Query.Pair ("Tags.member", Tags.to_query v.tags))
         ; Some (Query.Pair ("Capabilities.member", Capabilities.to_query v.capabilities))
         ; Some (Query.Pair ("Parameters.member", Parameters.to_query v.parameters))
         ; Util.option_map v.template_body (fun f ->
               Query.Pair ("TemplateBody", String.to_query f))
         ; Util.option_map v.status (fun f ->
               Query.Pair ("Status", StackSetStatus.to_query f))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
    ...
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.administration_role_a_r_n (fun f ->
               "administration_role_a_r_n", String.to_json f)
         ; Util.option_map v.stack_set_a_r_n (fun f ->
               "stack_set_a_r_n", String.to_json f)
         ; Some ("tags", Tags.to_json v.tags)
         ; Some ("capabilities", Capabilities.to_json v.capabilities)
         ; Some ("parameters", Parameters.to_json v.parameters)
         ; Util.option_map v.template_body (fun f -> "template_body", String.to_json f)
         ; Util.option_map v.status (fun f -> "status", StackSetStatus.to_json f)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.stack_set_id (fun f -> "stack_set_id", String.to_json f)
         ; Util.option_map v.stack_set_name (fun f -> "stack_set_name", String.to_json f)
  ...
  let of_json j =
    ...
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; status = Util.option_map (Json.lookup j "status") StackSetStatus.of_json
    ; template_body = Util.option_map (Json.lookup j "template_body") String.of_json
    ; parameters = Parameters.of_json (Util.of_option_exn (Json.lookup j "parameters"))
    ; capabilities =
        Capabilities.of_json (Util.of_option_exn (Json.lookup j "capabilities"))
    ; tags = Tags.of_json (Util.of_option_exn (Json.lookup j "tags"))
    ; stack_set_a_r_n = Util.option_map (Json.lookup j "stack_set_a_r_n") String.of_json
    ; administration_role_a_r_n =
        Util.option_map (Json.lookup j "administration_role_a_r_n") String.of_json
    ; execution_role_name =
        Util.option_map (Json.lookup j "execution_role_name") String.of_json
...
module TypeVersionSummaries = struct
  ...
  let parse xml =
    Util.option_all (List.map TypeVersionSummary.parse (Xml.members "member" xml))
...
module StackSetOperationSummaries = struct
  ...
  let parse xml =
    Util.option_all (List.map StackSetOperationSummary.parse (Xml.members "member" xml))
...
module StackResourceSummaries = struct
  ...
  let parse xml =
    Util.option_all (List.map StackResourceSummary.parse (Xml.members "member" xml))
...
module LoggingConfig = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("LogGroupName", String.to_query v.log_group_name))
  ...
  let of_json j =
    { log_role_arn = String.of_json (Util.of_option_exn (Json.lookup j "log_role_arn"))
    ; log_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "log_group_name"))
    }
end
...
module StackInstanceFilters = struct
  ...
  let parse xml =
    Util.option_all (List.map StackInstanceFilter.parse (Xml.members "member" xml))
...
module ParameterDeclarations = struct
  ...
  let parse xml =
    Util.option_all (List.map ParameterDeclaration.parse (Xml.members "member" xml))
...
module ResourceIdentifierSummaries = struct
  ...
  let parse xml =
    Util.option_all (List.map ResourceIdentifierSummary.parse (Xml.members "member" xml))
...
module StackInstanceSummaries = struct
  ...
  let parse xml =
    Util.option_all (List.map StackInstanceSummary.parse (Xml.members "member" xml))
...
module Stacks = struct
  ...
  let parse xml = Util.option_all (List.map Stack.parse (Xml.members "member" xml))
...
module StackResources = struct
  ...
  let parse xml =
    Util.option_all (List.map StackResource.parse (Xml.members "member" xml))
...
module StageList = struct
  ...
  let parse xml =
    Util.option_all (List.map TemplateStage.parse (Xml.members "member" xml))
  ...
  let of_json j =
    ...
    ; stack_resource_drift_status_filters =
        StackResourceDriftStatusFilters.of_json
          (Util.of_option_exn (Json.lookup j "stack_resource_drift_status_filters"))
...
module DescribeAccountLimitsOutput = struct
  ...
  let parse xml =
    Some
      { account_limits =
          Util.of_option
            []
            (Util.option_bind (Xml.member "AccountLimits" xml) AccountLimitList.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("account_limits", AccountLimitList.to_json v.account_limits)
         ])

  let of_json j =
    { account_limits =
        AccountLimitList.of_json (Util.of_option_exn (Json.lookup j "account_limits"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module CreateStackOutput = struct
  ...
  let parse xml =
    Some { stack_id = Util.option_bind (Xml.member "StackId" xml) String.parse }
  ...
  let of_json j = { stack_id = Util.option_map (Json.lookup j "stack_id") String.of_json }
end
...
module DetectStackSetDriftOutput = struct
  ...
  let parse xml =
    Some { operation_id = Util.option_bind (Xml.member "OperationId" xml) String.parse }
...
module ListStacksOutput = struct
  ...
  let parse xml =
    Some
      { stack_summaries =
          Util.of_option
            []
            (Util.option_bind (Xml.member "StackSummaries" xml) StackSummaries.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("stack_summaries", StackSummaries.to_json v.stack_summaries)
         ])

  let of_json j =
    { stack_summaries =
        StackSummaries.of_json (Util.of_option_exn (Json.lookup j "stack_summaries"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
    ...
    Some
      { stack_resource_drifts =
          Xml.required
            "StackResourceDrifts"
            (Util.option_bind
               (Xml.member "StackResourceDrifts" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some
             ("stack_resource_drifts", StackResourceDrifts.to_json v.stack_resource_drifts)
         ])
...
module GetTemplateInput = struct
  ...
  let parse xml =
    Some
      ...
      ; change_set_name = Util.option_bind (Xml.member "ChangeSetName" xml) String.parse
      ; template_stage =
          Util.option_bind (Xml.member "TemplateStage" xml) TemplateStage.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.template_stage (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.template_stage (fun f ->
               "template_stage", TemplateStage.to_json f)
         ; Util.option_map v.change_set_name (fun f ->
               "change_set_name", String.to_json f)
         ; Util.option_map v.stack_name (fun f -> "stack_name", String.to_json f)
         ])
  ...
  let of_json j =
    ...
    ; change_set_name = Util.option_map (Json.lookup j "change_set_name") String.of_json
    ; template_stage =
        Util.option_map (Json.lookup j "template_stage") TemplateStage.of_json
    }
end
...
module ListStacksInput = struct
    ...
    Some
      ...
      ; stack_status_filter =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "StackStatusFilter" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("stack_status_filter", StackStatusFilter.to_json v.stack_status_filter)
         ; Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ])
...
module DescribeAccountLimitsInput = struct
  ...
  let parse xml =
    Some { next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse }
...
module DescribeChangeSetOutput = struct
  ...
  let parse xml =
    Some
      ...
      ; tags = Util.of_option [] (Util.option_bind (Xml.member "Tags" xml) Tags.parse)
      ; changes =
          Util.of_option [] (Util.option_bind (Xml.member "Changes" xml) Changes.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
...
module GetStackPolicyInput = struct
  ...
  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("stack_name", String.to_json v.stack_name) ])
...
module GetStackPolicyOutput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.stack_policy_body (fun f ->
               Query.Pair ("StackPolicyBody", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.stack_policy_body (fun f ->
               "stack_policy_body", String.to_json f)
         ])
...
module DescribeStackSetOperationInput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("OperationId", String.to_query v.operation_id))
         ; Some (Query.Pair ("StackSetName", String.to_query v.stack_set_name))
         ])
  ...
  let of_json j =
    { stack_set_name =
        String.of_json (Util.of_option_exn (Json.lookup j "stack_set_name"))
    ; operation_id = String.of_json (Util.of_option_exn (Json.lookup j "operation_id"))
    }
end
...
module ListChangeSetsOutput = struct
  ...
  let parse xml =
    Some
      { summaries =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Summaries" xml) ChangeSetSummaries.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some (Query.Pair ("Summaries.member", ChangeSetSummaries.to_query v.summaries))
         ])
  ...
  let of_json j =
    { summaries =
        ChangeSetSummaries.of_json (Util.of_option_exn (Json.lookup j "summaries"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module ListExportsOutput = struct
  ...
  let parse xml =
    Some
      { exports =
          Util.of_option [] (Util.option_bind (Xml.member "Exports" xml) Exports.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let of_json j =
    { exports = Exports.of_json (Util.of_option_exn (Json.lookup j "exports"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module DeleteStackInput = struct
  ...
  let parse xml =
    Some
      ...
      ; retain_resources =
          Util.of_option
            []
            (Util.option_bind (Xml.member "RetainResources" xml) RetainResources.parse)
      ; role_a_r_n = Util.option_bind (Xml.member "RoleARN" xml) String.parse
      ; client_request_token =
          Util.option_bind (Xml.member "ClientRequestToken" xml) String.parse
      }
    ...
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.client_request_token (fun f ->
               "client_request_token", String.to_json f)
         ; Util.option_map v.role_a_r_n (fun f -> "role_a_r_n", String.to_json f)
         ; Some ("retain_resources", RetainResources.to_json v.retain_resources)
         ; Some ("stack_name", String.to_json v.stack_name)
         ])
  ...
  let of_json j =
    { stack_name = String.of_json (Util.of_option_exn (Json.lookup j "stack_name"))
    ; retain_resources =
        RetainResources.of_json (Util.of_option_exn (Json.lookup j "retain_resources"))
    ; role_a_r_n = Util.option_map (Json.lookup j "role_a_r_n") String.of_json
    ; client_request_token =
        Util.option_map (Json.lookup j "client_request_token") String.of_json
    }
...
module DeleteStackInstancesInput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.operation_id (fun f ->
               Query.Pair ("OperationId", String.to_query f))
         ; Some (Query.Pair ("RetainStacks", Boolean.to_query v.retain_stacks))
         ; Util.option_map v.operation_preferences (fun f ->
               Query.Pair ("OperationPreferences", StackSetOperationPreferences.to_query f))
         ; Some (Query.Pair ("Regions.member", RegionList.to_query v.regions))
         ; Util.option_map v.deployment_targets (fun f ->
               Query.Pair ("DeploymentTargets", DeploymentTargets.to_query f))
         ; Some (Query.Pair ("Accounts.member", AccountList.to_query v.accounts))
         ; Some (Query.Pair ("StackSetName", String.to_query v.stack_set_name))
  ...
  let of_json j =
    ...
    ; deployment_targets =
        Util.option_map (Json.lookup j "deployment_targets") DeploymentTargets.of_json
    ; regions = RegionList.of_json (Util.of_option_exn (Json.lookup j "regions"))
    ; operation_preferences =
        Util.option_map
          (Json.lookup j "operation_preferences")
          StackSetOperationPreferences.of_json
    ; retain_stacks = Boolean.of_json (Util.of_option_exn (Json.lookup j "retain_stacks"))
    ; operation_id = Util.option_map (Json.lookup j "operation_id") String.of_json
    }
end
...
module DeleteStackSetInput = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Some ("stack_set_name", String.to_json v.stack_set_name) ])
...
module CreateChangeSetInput = struct
    ...
    Some
      { stack_name =
          Xml.required
            ...
            (Util.option_bind (Xml.member "StackName" xml) String.parse)
      ; template_body = Util.option_bind (Xml.member "TemplateBody" xml) String.parse
      ; template_u_r_l = Util.option_bind (Xml.member "TemplateURL" xml) String.parse
      ; use_previous_template =
          Util.option_bind (Xml.member "UsePreviousTemplate" xml) Boolean.parse
      ; parameters =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Parameters" xml) Parameters.parse)
      ...
      ; resource_types =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ResourceTypes" xml) ResourceTypes.parse)
      ; role_a_r_n = Util.option_bind (Xml.member "RoleARN" xml) String.parse
      ; rollback_configuration =
          Util.option_bind
            (Xml.member "RollbackConfiguration" xml)
      ...
      ; client_token = Util.option_bind (Xml.member "ClientToken" xml) String.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; change_set_type =
          Util.option_bind (Xml.member "ChangeSetType" xml) ChangeSetType.parse
      ; resources_to_import =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ResourcesToImport" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.change_set_type (fun f ->
         ...
         ; Some (Query.Pair ("ChangeSetName", String.to_query v.change_set_name))
         ; Some (Query.Pair ("Tags.member", Tags.to_query v.tags))
         ; Some
             (Query.Pair
                ( "NotificationARNs.member"
         ...
         ; Util.option_map v.role_a_r_n (fun f ->
               Query.Pair ("RoleARN", String.to_query f))
         ; Some
             (Query.Pair ("ResourceTypes.member", ResourceTypes.to_query v.resource_types))
         ; Some (Query.Pair ("Capabilities.member", Capabilities.to_query v.capabilities))
         ; Some (Query.Pair ("Parameters.member", Parameters.to_query v.parameters))
         ; Util.option_map v.use_previous_template (fun f ->
               Query.Pair ("UsePreviousTemplate", Boolean.to_query f))
         ; Util.option_map v.template_u_r_l (fun f ->
               Query.Pair ("TemplateURL", String.to_query f))
         ; Util.option_map v.template_body (fun f ->
               Query.Pair ("TemplateBody", String.to_query f))
         ; Some (Query.Pair ("StackName", String.to_query v.stack_name))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("resources_to_import", ResourcesToImport.to_json v.resources_to_import)
         ; Util.option_map v.change_set_type (fun f ->
               "change_set_type", ChangeSetType.to_json f)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.client_token (fun f -> "client_token", String.to_json f)
         ...
         ; Some ("parameters", Parameters.to_json v.parameters)
         ; Util.option_map v.use_previous_template (fun f ->
               "use_previous_template", Boolean.to_json f)
         ; Util.option_map v.template_u_r_l (fun f -> "template_u_r_l", String.to_json f)
         ; Util.option_map v.template_body (fun f -> "template_body", String.to_json f)
         ; Some ("stack_name", String.to_json v.stack_name)
         ])
  ...
  let of_json j =
    { stack_name = String.of_json (Util.of_option_exn (Json.lookup j "stack_name"))
    ; template_body = Util.option_map (Json.lookup j "template_body") String.of_json
    ; template_u_r_l = Util.option_map (Json.lookup j "template_u_r_l") String.of_json
    ; use_previous_template =
        Util.option_map (Json.lookup j "use_previous_template") Boolean.of_json
    ; parameters = Parameters.of_json (Util.of_option_exn (Json.lookup j "parameters"))
    ; capabilities =
        Capabilities.of_json (Util.of_option_exn (Json.lookup j "capabilities"))
    ; resource_types =
        ResourceTypes.of_json (Util.of_option_exn (Json.lookup j "resource_types"))
    ; role_a_r_n = Util.option_map (Json.lookup j "role_a_r_n") String.of_json
    ; rollback_configuration =
        Util.option_map
          (Json.lookup j "rollback_configuration")
    ...
    ; tags = Tags.of_json (Util.of_option_exn (Json.lookup j "tags"))
    ; change_set_name =
        String.of_json (Util.of_option_exn (Json.lookup j "change_set_name"))
    ; client_token = Util.option_map (Json.lookup j "client_token") String.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; change_set_type =
        Util.option_map (Json.lookup j "change_set_type") ChangeSetType.of_json
    ; resources_to_import =
...
module ContinueUpdateRollbackInput = struct
  ...
  let parse xml =
    Some
      ...
      ; resources_to_skip =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ResourcesToSkip" xml) ResourcesToSkip.parse)
      ; client_request_token =
          Util.option_bind (Xml.member "ClientRequestToken" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.client_request_token (fun f ->
               "client_request_token", String.to_json f)
         ; Some ("resources_to_skip", ResourcesToSkip.to_json v.resources_to_skip)
         ; Util.option_map v.role_a_r_n (fun f -> "role_a_r_n", String.to_json f)
         ; Some ("stack_name", String.to_json v.stack_name)
         ])
  ...
  let of_json j =
    ...
    ; role_a_r_n = Util.option_map (Json.lookup j "role_a_r_n") String.of_json
    ; resources_to_skip =
        ResourcesToSkip.of_json (Util.of_option_exn (Json.lookup j "resources_to_skip"))
    ; client_request_token =
        Util.option_map (Json.lookup j "client_request_token") String.of_json
    }
end
...
module ValidateTemplateOutput = struct
  ...
  let parse xml =
    Some
      { parameters =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Parameters" xml) TemplateParameters.parse)
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; capabilities =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Capabilities" xml) Capabilities.parse)
      ; capabilities_reason =
          Util.option_bind (Xml.member "CapabilitiesReason" xml) String.parse
      ; declared_transforms =
          Util.of_option
            []
            (Util.option_bind (Xml.member "DeclaredTransforms" xml) TransformsList.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.capabilities_reason (fun f ->
               Query.Pair ("CapabilitiesReason", String.to_query f))
         ; Some (Query.Pair ("Capabilities.member", Capabilities.to_query v.capabilities))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Some
             (Query.Pair ("Parameters.member", TemplateParameters.to_query v.parameters))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("declared_transforms", TransformsList.to_json v.declared_transforms)
         ; Util.option_map v.capabilities_reason (fun f ->
               "capabilities_reason", String.to_json f)
         ; Some ("capabilities", Capabilities.to_json v.capabilities)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
  ...
  let of_json j =
    { parameters =
        TemplateParameters.of_json (Util.of_option_exn (Json.lookup j "parameters"))
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; capabilities =
        Capabilities.of_json (Util.of_option_exn (Json.lookup j "capabilities"))
    ; capabilities_reason =
        Util.option_map (Json.lookup j "capabilities_reason") String.of_json
    ; declared_transforms =
        TransformsList.of_json (Util.of_option_exn (Json.lookup j "declared_transforms"))
    }
end
...
module DescribeStackInstanceOutput = struct
  ...
  let parse xml =
    Some
      { stack_instance =
          Util.option_bind (Xml.member "StackInstance" xml) StackInstance.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.stack_instance (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.stack_instance (fun f ->
               "stack_instance", StackInstance.to_json f)
         ])

  let of_json j =
    { stack_instance =
        Util.option_map (Json.lookup j "stack_instance") StackInstance.of_json
    }
end
...
module ListStackSetsOutput = struct
  ...
  let parse xml =
    Some
      { summaries =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Summaries" xml) StackSetSummaries.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some (Query.Pair ("Summaries.member", StackSetSummaries.to_query v.summaries))
         ])
  ...
  let of_json j =
    { summaries =
        StackSetSummaries.of_json (Util.of_option_exn (Json.lookup j "summaries"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module ListTypesOutput = struct
  ...
  let parse xml =
    Some
      { type_summaries =
          Util.of_option
            []
            (Util.option_bind (Xml.member "TypeSummaries" xml) TypeSummaries.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
    ...
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some
             (Query.Pair ("TypeSummaries.member", TypeSummaries.to_query v.type_summaries))
         ])
  ...
  let of_json j =
    { type_summaries =
        TypeSummaries.of_json (Util.of_option_exn (Json.lookup j "type_summaries"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module DescribeStackResourceOutput = struct
  ...
  let parse xml =
    Some
      { stack_resource_detail =
          Util.option_bind
            (Xml.member "StackResourceDetail" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.stack_resource_detail (fun f ->
               Query.Pair ("StackResourceDetail", StackResourceDetail.to_query f))
         ])
  ...
  let of_json j =
    { stack_resource_detail =
        Util.option_map
          (Json.lookup j "stack_resource_detail")
  ...
  let parse xml =
    Some
      { registration_token =
          Xml.required
            "RegistrationToken"
            (Util.option_bind (Xml.member "RegistrationToken" xml) String.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("RegistrationToken", String.to_query v.registration_token)) ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("registration_token", String.to_json v.registration_token) ])

  let of_json j =
    { registration_token =
        String.of_json (Util.of_option_exn (Json.lookup j "registration_token"))
    }
end
...
module DescribeStackDriftDetectionStatusOutput = struct
    ...
    Some
      ...
      ; stack_drift_detection_id =
          Xml.required
            ...
            (Util.option_bind (Xml.member "StackDriftDetectionId" xml) String.parse)
      ; stack_drift_status =
          Util.option_bind (Xml.member "StackDriftStatus" xml) StackDriftStatus.parse
      ; detection_status =
          Xml.required
            "DetectionStatus"
            (Util.option_bind
               (Xml.member "DetectionStatus" xml)
               StackDriftDetectionStatus.parse)
      ; detection_status_reason =
          Util.option_bind (Xml.member "DetectionStatusReason" xml) String.parse
      ; drifted_stack_resource_count =
          Util.option_bind (Xml.member "DriftedStackResourceCount" xml) Integer.parse
      ; timestamp =
          Xml.required
            "Timestamp"
            (Util.option_bind (Xml.member "Timestamp" xml) DateTime.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Timestamp", DateTime.to_query v.timestamp))
         ; Util.option_map v.drifted_stack_resource_count (fun f ->
               Query.Pair ("DriftedStackResourceCount", Integer.to_query f))
         ; Util.option_map v.detection_status_reason (fun f ->
               Query.Pair ("DetectionStatusReason", String.to_query f))
         ; Some
             (Query.Pair
                ("DetectionStatus", StackDriftDetectionStatus.to_query v.detection_status))
         ; Util.option_map v.stack_drift_status (fun f ->
               Query.Pair ("StackDriftStatus", StackDriftStatus.to_query f))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("timestamp", DateTime.to_json v.timestamp)
         ; Util.option_map v.drifted_stack_resource_count (fun f ->
               "drifted_stack_resource_count", Integer.to_json f)
         ; Util.option_map v.detection_status_reason (fun f ->
               "detection_status_reason", String.to_json f)
         ; Some ("detection_status", StackDriftDetectionStatus.to_json v.detection_status)
         ; Util.option_map v.stack_drift_status (fun f ->
               "stack_drift_status", StackDriftStatus.to_json f)
         ; Some ("stack_drift_detection_id", String.to_json v.stack_drift_detection_id)
         ; Some ("stack_id", String.to_json v.stack_id)
         ])
  ...
  let of_json j =
    { stack_id = String.of_json (Util.of_option_exn (Json.lookup j "stack_id"))
    ; stack_drift_detection_id =
        String.of_json (Util.of_option_exn (Json.lookup j "stack_drift_detection_id"))
    ; stack_drift_status =
        Util.option_map (Json.lookup j "stack_drift_status") StackDriftStatus.of_json
    ; detection_status =
        StackDriftDetectionStatus.of_json
          (Util.of_option_exn (Json.lookup j "detection_status"))
    ; detection_status_reason =
        Util.option_map (Json.lookup j "detection_status_reason") String.of_json
    ; drifted_stack_resource_count =
        Util.option_map (Json.lookup j "drifted_stack_resource_count") Integer.of_json
    ; timestamp = DateTime.of_json (Util.of_option_exn (Json.lookup j "timestamp"))
    }
end
...
module ListTypeRegistrationsInput = struct
  ...
  let parse xml =
    Some
      ...
      ; registration_status_filter =
          Util.option_bind
            (Xml.member "RegistrationStatusFilter" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.max_results (fun f ->
               Query.Pair ("MaxResults", Integer.to_query f))
         ; Util.option_map v.registration_status_filter (fun f ->
               Query.Pair ("RegistrationStatusFilter", RegistrationStatus.to_query f))
         ; Util.option_map v.type_arn (fun f -> Query.Pair ("TypeArn", String.to_query f))
         ; Util.option_map v.type_name (fun f ->
               Query.Pair ("TypeName", String.to_query f))
         ; Util.option_map v.type_ (fun f -> Query.Pair ("Type", RegistryType.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.max_results (fun f -> "max_results", Integer.to_json f)
         ; Util.option_map v.registration_status_filter (fun f ->
               "registration_status_filter", RegistrationStatus.to_json f)
         ; Util.option_map v.type_arn (fun f -> "type_arn", String.to_json f)
         ; Util.option_map v.type_name (fun f -> "type_name", String.to_json f)
         ; Util.option_map v.type_ (fun f -> "type_", RegistryType.to_json f)
         ])
  ...
  let of_json j =
    ...
    ; registration_status_filter =
        Util.option_map
          (Json.lookup j "registration_status_filter")
...
module CreateStackSetOutput = struct
  ...
  let parse xml =
    Some { stack_set_id = Util.option_bind (Xml.member "StackSetId" xml) String.parse }
...
module DescribeStackSetOperationOutput = struct
  ...
  let parse xml =
    Some
      { stack_set_operation =
          Util.option_bind (Xml.member "StackSetOperation" xml) StackSetOperation.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.stack_set_operation (fun f ->
               Query.Pair ("StackSetOperation", StackSetOperation.to_query f))
         ])
  ...
  let of_json j =
    { stack_set_operation =
        Util.option_map (Json.lookup j "stack_set_operation") StackSetOperation.of_json
    }
end
...
module DescribeStackEventsOutput = struct
  ...
  let parse xml =
    Some
      { stack_events =
          Util.of_option
            []
            (Util.option_bind (Xml.member "StackEvents" xml) StackEvents.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some (Query.Pair ("StackEvents.member", StackEvents.to_query v.stack_events))
         ])
  ...
  let of_json j =
    { stack_events =
        StackEvents.of_json (Util.of_option_exn (Json.lookup j "stack_events"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module DescribeStackSetOutput = struct
  ...
  let parse xml =
    Some { stack_set = Util.option_bind (Xml.member "StackSet" xml) StackSet.parse }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.stack_set (fun f ->
               Query.Pair ("StackSet", StackSet.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.stack_set (fun f -> "stack_set", StackSet.to_json f) ])

  let of_json j =
    { stack_set = Util.option_map (Json.lookup j "stack_set") StackSet.of_json }
end
...
module ListTypesInput = struct
  ...
  let parse xml =
    Some
      { visibility = Util.option_bind (Xml.member "Visibility" xml) Visibility.parse
      ; provisioning_type =
          Util.option_bind (Xml.member "ProvisioningType" xml) ProvisioningType.parse
      ; deprecated_status =
          Util.option_bind (Xml.member "DeprecatedStatus" xml) DeprecatedStatus.parse
      ; max_results = Util.option_bind (Xml.member "MaxResults" xml) Integer.parse
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.max_results (fun f ->
               Query.Pair ("MaxResults", Integer.to_query f))
         ; Util.option_map v.deprecated_status (fun f ->
               Query.Pair ("DeprecatedStatus", DeprecatedStatus.to_query f))
         ; Util.option_map v.provisioning_type (fun f ->
               Query.Pair ("ProvisioningType", ProvisioningType.to_query f))
         ; Util.option_map v.visibility (fun f ->
               Query.Pair ("Visibility", Visibility.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.max_results (fun f -> "max_results", Integer.to_json f)
         ; Util.option_map v.deprecated_status (fun f ->
               "deprecated_status", DeprecatedStatus.to_json f)
         ; Util.option_map v.provisioning_type (fun f ->
               "provisioning_type", ProvisioningType.to_json f)
         ; Util.option_map v.visibility (fun f -> "visibility", Visibility.to_json f)
         ])

  let of_json j =
    { visibility = Util.option_map (Json.lookup j "visibility") Visibility.of_json
    ; provisioning_type =
        Util.option_map (Json.lookup j "provisioning_type") ProvisioningType.of_json
    ; deprecated_status =
        Util.option_map (Json.lookup j "deprecated_status") DeprecatedStatus.of_json
    ; max_results = Util.option_map (Json.lookup j "max_results") Integer.of_json
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
    ...
    Some
      { type_version_summaries =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "TypeVersionSummaries" xml)
...
module ListImportsOutput = struct
  ...
  let parse xml =
    Some
      { imports =
          Util.of_option [] (Util.option_bind (Xml.member "Imports" xml) Imports.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let of_json j =
    { imports = Imports.of_json (Util.of_option_exn (Json.lookup j "imports"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module RegisterTypeOutput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.registration_token (fun f ->
               Query.Pair ("RegistrationToken", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.registration_token (fun f ->
               "registration_token", String.to_json f)
         ])

  let of_json j =
    { registration_token =
        Util.option_map (Json.lookup j "registration_token") String.of_json
    }
end
...
module ListImportsInput = struct
  ...
  let of_json j =
    { export_name = String.of_json (Util.of_option_exn (Json.lookup j "export_name"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
    ...
    Some
      { stack_resource_summaries =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "StackResourceSummaries" xml)
...
module SetStackPolicyInput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.stack_policy_u_r_l (fun f ->
               Query.Pair ("StackPolicyURL", String.to_query f))
         ; Util.option_map v.stack_policy_body (fun f ->
               Query.Pair ("StackPolicyBody", String.to_query f))
         ; Some (Query.Pair ("StackName", String.to_query v.stack_name))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.stack_policy_u_r_l (fun f ->
               "stack_policy_u_r_l", String.to_json f)
         ; Util.option_map v.stack_policy_body (fun f ->
               "stack_policy_body", String.to_json f)
         ; Some ("stack_name", String.to_json v.stack_name)
         ])
  ...
  let of_json j =
    ...
    ; stack_policy_body =
        Util.option_map (Json.lookup j "stack_policy_body") String.of_json
    ; stack_policy_u_r_l =
        Util.option_map (Json.lookup j "stack_policy_u_r_l") String.of_json
    }
end
...
module DescribeTypeRegistrationOutput = struct
  ...
  let parse xml =
    Some
      { progress_status =
          Util.option_bind (Xml.member "ProgressStatus" xml) RegistrationStatus.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; type_arn = Util.option_bind (Xml.member "TypeArn" xml) String.parse
      ; type_version_arn = Util.option_bind (Xml.member "TypeVersionArn" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.type_version_arn (fun f ->
               Query.Pair ("TypeVersionArn", String.to_query f))
         ; Util.option_map v.type_arn (fun f -> Query.Pair ("TypeArn", String.to_query f))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.progress_status (fun f ->
               Query.Pair ("ProgressStatus", RegistrationStatus.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.type_version_arn (fun f ->
               "type_version_arn", String.to_json f)
         ; Util.option_map v.type_arn (fun f -> "type_arn", String.to_json f)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.progress_status (fun f ->
               "progress_status", RegistrationStatus.to_json f)
         ])

  let of_json j =
    { progress_status =
        Util.option_map (Json.lookup j "progress_status") RegistrationStatus.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; type_arn = Util.option_map (Json.lookup j "type_arn") String.of_json
    ; type_version_arn = Util.option_map (Json.lookup j "type_version_arn") String.of_json
    }
end
  ...
  let parse xml =
    Some
      ...
      ; operation_status =
          Xml.required
            "OperationStatus"
            (Util.option_bind (Xml.member "OperationStatus" xml) OperationStatus.parse)
      ; current_operation_status =
          Util.option_bind (Xml.member "CurrentOperationStatus" xml) OperationStatus.parse
      ; status_message = Util.option_bind (Xml.member "StatusMessage" xml) String.parse
      ; error_code = Util.option_bind (Xml.member "ErrorCode" xml) HandlerErrorCode.parse
      ; resource_model = Util.option_bind (Xml.member "ResourceModel" xml) String.parse
      ; client_request_token =
          Util.option_bind (Xml.member "ClientRequestToken" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.client_request_token (fun f ->
               Query.Pair ("ClientRequestToken", String.to_query f))
         ; Util.option_map v.resource_model (fun f ->
               Query.Pair ("ResourceModel", String.to_query f))
         ...
         ; Util.option_map v.current_operation_status (fun f ->
               Query.Pair ("CurrentOperationStatus", OperationStatus.to_query f))
         ; Some
             (Query.Pair ("OperationStatus", OperationStatus.to_query v.operation_status))
         ; Some (Query.Pair ("BearerToken", String.to_query v.bearer_token))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.client_request_token (fun f ->
               "client_request_token", String.to_json f)
         ; Util.option_map v.resource_model (fun f -> "resource_model", String.to_json f)
         ; Util.option_map v.error_code (fun f ->
               "error_code", HandlerErrorCode.to_json f)
         ; Util.option_map v.status_message (fun f -> "status_message", String.to_json f)
         ; Util.option_map v.current_operation_status (fun f ->
               "current_operation_status", OperationStatus.to_json f)
         ; Some ("operation_status", OperationStatus.to_json v.operation_status)
         ; Some ("bearer_token", String.to_json v.bearer_token)
         ])

  let of_json j =
    { bearer_token = String.of_json (Util.of_option_exn (Json.lookup j "bearer_token"))
    ; operation_status =
        OperationStatus.of_json (Util.of_option_exn (Json.lookup j "operation_status"))
    ; current_operation_status =
        Util.option_map (Json.lookup j "current_operation_status") OperationStatus.of_json
    ; status_message = Util.option_map (Json.lookup j "status_message") String.of_json
    ; error_code = Util.option_map (Json.lookup j "error_code") HandlerErrorCode.of_json
    ; resource_model = Util.option_map (Json.lookup j "resource_model") String.of_json
    ; client_request_token =
        Util.option_map (Json.lookup j "client_request_token") String.of_json
    }
end
...
module EstimateTemplateCostOutput = struct
  ...
  let parse xml = Some { url = Util.option_bind (Xml.member "Url" xml) String.parse }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Util.option_map v.url (fun f -> "url", String.to_json f) ])

  let of_json j = { url = Util.option_map (Json.lookup j "url") String.of_json }
end
...
module DescribeTypeOutput = struct
  ...
  let parse xml =
    Some
      ...
      ; deprecated_status =
          Util.option_bind (Xml.member "DeprecatedStatus" xml) DeprecatedStatus.parse
      ; logging_config =
          Util.option_bind (Xml.member "LoggingConfig" xml) LoggingConfig.parse
      ; execution_role_arn =
          Util.option_bind (Xml.member "ExecutionRoleArn" xml) String.parse
      ; visibility = Util.option_bind (Xml.member "Visibility" xml) Visibility.parse
      ; source_url = Util.option_bind (Xml.member "SourceUrl" xml) String.parse
      ; documentation_url =
          Util.option_bind (Xml.member "DocumentationUrl" xml) String.parse
      ; last_updated = Util.option_bind (Xml.member "LastUpdated" xml) DateTime.parse
      ; time_created = Util.option_bind (Xml.member "TimeCreated" xml) DateTime.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.last_updated (fun f ->
               Query.Pair ("LastUpdated", DateTime.to_query f))
         ; Util.option_map v.documentation_url (fun f ->
               Query.Pair ("DocumentationUrl", String.to_query f))
         ; Util.option_map v.source_url (fun f ->
               Query.Pair ("SourceUrl", String.to_query f))
         ; Util.option_map v.visibility (fun f ->
               Query.Pair ("Visibility", Visibility.to_query f))
         ; Util.option_map v.execution_role_arn (fun f ->
               Query.Pair ("ExecutionRoleArn", String.to_query f))
         ; Util.option_map v.logging_config (fun f ->
               Query.Pair ("LoggingConfig", LoggingConfig.to_query f))
         ; Util.option_map v.deprecated_status (fun f ->
               Query.Pair ("DeprecatedStatus", DeprecatedStatus.to_query f))
         ; Util.option_map v.provisioning_type (fun f ->
               Query.Pair ("ProvisioningType", ProvisioningType.to_query f))
         ; Util.option_map v.schema (fun f -> Query.Pair ("Schema", String.to_query f))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.is_default_version (fun f ->
               Query.Pair ("IsDefaultVersion", Boolean.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.last_updated (fun f -> "last_updated", DateTime.to_json f)
         ; Util.option_map v.documentation_url (fun f ->
               "documentation_url", String.to_json f)
         ; Util.option_map v.source_url (fun f -> "source_url", String.to_json f)
         ; Util.option_map v.visibility (fun f -> "visibility", Visibility.to_json f)
         ; Util.option_map v.execution_role_arn (fun f ->
               "execution_role_arn", String.to_json f)
         ; Util.option_map v.logging_config (fun f ->
               "logging_config", LoggingConfig.to_json f)
         ; Util.option_map v.deprecated_status (fun f ->
               "deprecated_status", DeprecatedStatus.to_json f)
         ; Util.option_map v.provisioning_type (fun f ->
               "provisioning_type", ProvisioningType.to_json f)
  ...
  let of_json j =
    ...
    ; deprecated_status =
        Util.option_map (Json.lookup j "deprecated_status") DeprecatedStatus.of_json
    ; logging_config =
        Util.option_map (Json.lookup j "logging_config") LoggingConfig.of_json
    ; execution_role_arn =
        Util.option_map (Json.lookup j "execution_role_arn") String.of_json
    ; visibility = Util.option_map (Json.lookup j "visibility") Visibility.of_json
    ; source_url = Util.option_map (Json.lookup j "source_url") String.of_json
    ; documentation_url =
...
module ListStackInstancesInput = struct
  ...
  let parse xml =
    Some
      ...
      ; filters =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Filters" xml) StackInstanceFilters.parse)
      ; stack_instance_account =
          Util.option_bind (Xml.member "StackInstanceAccount" xml) String.parse
      ; stack_instance_region =
          Util.option_bind (Xml.member "StackInstanceRegion" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.stack_instance_region (fun f ->
               Query.Pair ("StackInstanceRegion", String.to_query f))
         ; Util.option_map v.stack_instance_account (fun f ->
               Query.Pair ("StackInstanceAccount", String.to_query f))
         ; Some (Query.Pair ("Filters.member", StackInstanceFilters.to_query v.filters))
         ; Util.option_map v.max_results (fun f ->
               Query.Pair ("MaxResults", Integer.to_query f))
         ; Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.stack_instance_region (fun f ->
               "stack_instance_region", String.to_json f)
         ; Util.option_map v.stack_instance_account (fun f ->
               "stack_instance_account", String.to_json f)
  ...
  let of_json j =
    ...
    ; max_results = Util.option_map (Json.lookup j "max_results") Integer.of_json
    ; filters =
        StackInstanceFilters.of_json (Util.of_option_exn (Json.lookup j "filters"))
    ; stack_instance_account =
        Util.option_map (Json.lookup j "stack_instance_account") String.of_json
    ; stack_instance_region =
        Util.option_map (Json.lookup j "stack_instance_region") String.of_json
    }
end
...
module RegisterTypeInput = struct
    ...
    Some
      ...
      ; schema_handler_package =
          Xml.required
            ...
            (Util.option_bind (Xml.member "SchemaHandlerPackage" xml) String.parse)
      ; logging_config =
          Util.option_bind (Xml.member "LoggingConfig" xml) LoggingConfig.parse
      ; execution_role_arn =
          Util.option_bind (Xml.member "ExecutionRoleArn" xml) String.parse
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.logging_config (fun f ->
               Query.Pair ("LoggingConfig", LoggingConfig.to_query f))
         ; Some
             (Query.Pair ("SchemaHandlerPackage", String.to_query v.schema_handler_package))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.logging_config (fun f ->
               "logging_config", LoggingConfig.to_json f)
         ; Some ("schema_handler_package", String.to_json v.schema_handler_package)
  ...
  let of_json j =
    { type_ = Util.option_map (Json.lookup j "type_") RegistryType.of_json
    ; type_name = String.of_json (Util.of_option_exn (Json.lookup j "type_name"))
    ; schema_handler_package =
        String.of_json (Util.of_option_exn (Json.lookup j "schema_handler_package"))
    ; logging_config =
        Util.option_map (Json.lookup j "logging_config") LoggingConfig.of_json
    ; execution_role_arn =
        Util.option_map (Json.lookup j "execution_role_arn") String.of_json
...
module SignalResourceInput = struct
  ...
  let parse xml =
    Some
      ...
      ; status =
          Xml.required
            "Status"
            (Util.option_bind (Xml.member "Status" xml) ResourceSignalStatus.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Status", ResourceSignalStatus.to_query v.status))
  ...
  let of_json j =
    ...
    ; logical_resource_id =
        String.of_json (Util.of_option_exn (Json.lookup j "logical_resource_id"))
    ; unique_id = String.of_json (Util.of_option_exn (Json.lookup j "unique_id"))
    ; status = ResourceSignalStatus.of_json (Util.of_option_exn (Json.lookup j "status"))
    }
end
...
module GetTemplateSummaryOutput = struct
  ...
  let parse xml =
    Some
      { parameters =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Parameters" xml) ParameterDeclarations.parse)
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; capabilities =
          Util.of_option
            []
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Some
             (Query.Pair ("Parameters.member", ParameterDeclarations.to_query v.parameters))
         ])
  ...
  let of_json j =
    { parameters =
        ParameterDeclarations.of_json (Util.of_option_exn (Json.lookup j "parameters"))
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; capabilities =
        Capabilities.of_json (Util.of_option_exn (Json.lookup j "capabilities"))
    ; capabilities_reason =
    ...
    ; resource_identifier_summaries =
        ResourceIdentifierSummaries.of_json
          (Util.of_option_exn (Json.lookup j "resource_identifier_summaries"))
    }
end
    ...
    Some
      ...
      ; accounts =
          Util.of_option
            ...
            (Util.option_bind (Xml.member "Accounts" xml) AccountList.parse)
      ; regions =
          Util.of_option [] (Util.option_bind (Xml.member "Regions" xml) RegionList.parse)
      }
...
module ListStackInstancesOutput = struct
  ...
  let parse xml =
    Some
      { summaries =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Summaries" xml) StackInstanceSummaries.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
    ...
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some
             (Query.Pair ("Summaries.member", StackInstanceSummaries.to_query v.summaries))
         ])
  ...
  let of_json j =
    { summaries =
        StackInstanceSummaries.of_json (Util.of_option_exn (Json.lookup j "summaries"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module DescribeStacksOutput = struct
  ...
  let parse xml =
    Some
      { stacks =
          Util.of_option [] (Util.option_bind (Xml.member "Stacks" xml) Stacks.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let of_json j =
    { stacks = Stacks.of_json (Util.of_option_exn (Json.lookup j "stacks"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module UpdateStackInput = struct
  ...
  let parse xml =
    Some
      ...
      ; use_previous_template =
          Util.option_bind (Xml.member "UsePreviousTemplate" xml) Boolean.parse
      ; stack_policy_during_update_body =
          Util.option_bind (Xml.member "StackPolicyDuringUpdateBody" xml) String.parse
      ; stack_policy_during_update_u_r_l =
          Util.option_bind (Xml.member "StackPolicyDuringUpdateURL" xml) String.parse
      ; parameters =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Parameters" xml) Parameters.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("Capabilities.member", Capabilities.to_query v.capabilities))
         ; Some (Query.Pair ("Parameters.member", Parameters.to_query v.parameters))
         ; Util.option_map v.stack_policy_during_update_u_r_l (fun f ->
               Query.Pair ("StackPolicyDuringUpdateURL", String.to_query f))
         ; Util.option_map v.stack_policy_during_update_body (fun f ->
               Query.Pair ("StackPolicyDuringUpdateBody", String.to_query f))
         ; Util.option_map v.use_previous_template (fun f ->
               Query.Pair ("UsePreviousTemplate", Boolean.to_query f))
         ; Util.option_map v.template_u_r_l (fun f ->
               Query.Pair ("TemplateURL", String.to_query f))
  ...
  let of_json j =
    ...
    ; use_previous_template =
        Util.option_map (Json.lookup j "use_previous_template") Boolean.of_json
    ; stack_policy_during_update_body =
        Util.option_map (Json.lookup j "stack_policy_during_update_body") String.of_json
    ; stack_policy_during_update_u_r_l =
        Util.option_map (Json.lookup j "stack_policy_during_update_u_r_l") String.of_json
    ; parameters = Parameters.of_json (Util.of_option_exn (Json.lookup j "parameters"))
    ; capabilities =
        Capabilities.of_json (Util.of_option_exn (Json.lookup j "capabilities"))
    ; resource_types =
...
module DescribeStackInstanceInput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("StackInstanceRegion", String.to_query v.stack_instance_region))
         ; Some
             (Query.Pair ("StackInstanceAccount", String.to_query v.stack_instance_account))
         ; Some (Query.Pair ("StackSetName", String.to_query v.stack_set_name))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("stack_instance_region", String.to_json v.stack_instance_region)
         ; Some ("stack_instance_account", String.to_json v.stack_instance_account)
         ; Some ("stack_set_name", String.to_json v.stack_set_name)
         ])
  ...
  let of_json j =
    { stack_set_name =
        String.of_json (Util.of_option_exn (Json.lookup j "stack_set_name"))
    ; stack_instance_account =
        String.of_json (Util.of_option_exn (Json.lookup j "stack_instance_account"))
    ; stack_instance_region =
        String.of_json (Util.of_option_exn (Json.lookup j "stack_instance_region"))
    }
end
...
module CreateStackInput = struct
    ...
    Some
      ...
      ; resource_types =
          Util.of_option
            ...
            (Util.option_bind (Xml.member "ResourceTypes" xml) ResourceTypes.parse)
      ; role_a_r_n = Util.option_bind (Xml.member "RoleARN" xml) String.parse
      ; on_failure = Util.option_bind (Xml.member "OnFailure" xml) OnFailure.parse
      ; stack_policy_body =
          Util.option_bind (Xml.member "StackPolicyBody" xml) String.parse
      ; stack_policy_u_r_l =
          Util.option_bind (Xml.member "StackPolicyURL" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.stack_policy_body (fun f ->
               Query.Pair ("StackPolicyBody", String.to_query f))
         ; Util.option_map v.on_failure (fun f ->
               Query.Pair ("OnFailure", OnFailure.to_query f))
         ; Util.option_map v.role_a_r_n (fun f ->
               Query.Pair ("RoleARN", String.to_query f))
         ; Some
             (Query.Pair ("ResourceTypes.member", ResourceTypes.to_query v.resource_types))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.stack_policy_body (fun f ->
               "stack_policy_body", String.to_json f)
         ; Util.option_map v.on_failure (fun f -> "on_failure", OnFailure.to_json f)
         ; Util.option_map v.role_a_r_n (fun f -> "role_a_r_n", String.to_json f)
         ; Some ("resource_types", ResourceTypes.to_json v.resource_types)
         ; Some ("capabilities", Capabilities.to_json v.capabilities)
         ; Some ("notification_a_r_ns", NotificationARNs.to_json v.notification_a_r_ns)
  ...
  let of_json j =
    ...
    ; resource_types =
        ResourceTypes.of_json (Util.of_option_exn (Json.lookup j "resource_types"))
    ; role_a_r_n = Util.option_map (Json.lookup j "role_a_r_n") String.of_json
    ; on_failure = Util.option_map (Json.lookup j "on_failure") OnFailure.of_json
    ; stack_policy_body =
        Util.option_map (Json.lookup j "stack_policy_body") String.of_json
    ; stack_policy_u_r_l =
        Util.option_map (Json.lookup j "stack_policy_u_r_l") String.of_json
    ...
    Some
      { registration_token_list =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "RegistrationTokenList" xml)
...
module DescribeStackResourcesOutput = struct
  ...
  let parse xml =
    Some
      { stack_resources =
          Util.of_option
            []
            (Util.option_bind (Xml.member "StackResources" xml) StackResources.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("stack_resources", StackResources.to_json v.stack_resources) ])

  let of_json j =
    { stack_resources =
        StackResources.of_json (Util.of_option_exn (Json.lookup j "stack_resources"))
    }
end
...
module DetectStackResourceDriftOutput = struct
    ...
    Some
      { stack_resource_drift =
          Xml.required
            "StackResourceDrift"
            (Util.option_bind
               (Xml.member "StackResourceDrift" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("stack_resource_drift", StackResourceDrift.to_json v.stack_resource_drift)
         ])
...
module GetTemplateOutput = struct
  ...
  let parse xml =
    Some
      ...
      ; stages_available =
          Util.of_option
            []
            (Util.option_bind (Xml.member "StagesAvailable" xml) StageList.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("StagesAvailable.member", StageList.to_query v.stages_available))
         ; Util.option_map v.template_body (fun f ->
               Query.Pair ("TemplateBody", String.to_query f))
         ])
  ...
  let of_json j =
    { template_body = Util.option_map (Json.lookup j "template_body") String.of_json
    ; stages_available =
        StageList.of_json (Util.of_option_exn (Json.lookup j "stages_available"))
    }
end
...
module UpdateTerminationProtectionInput = struct
  ...
  let of_json j =
    { enable_termination_protection =
        Boolean.of_json
          (Util.of_option_exn (Json.lookup j "enable_termination_protection"))
    ; stack_name = String.of_json (Util.of_option_exn (Json.lookup j "stack_name"))
    }
end
