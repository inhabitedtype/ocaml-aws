...
(* OASIS_START *)
(* DO NOT EDIT (digest: 601e5bffb084e846440c32963e8ace37) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "aws_cloudformation";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "aws_cloudformation Docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\186\150\251V\1975\022\210\016\003\141\128V\003\148\176";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
