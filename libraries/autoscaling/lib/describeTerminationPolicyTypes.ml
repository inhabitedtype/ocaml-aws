  ...
  try
    ...
    let resp =
      Util.option_bind
        ...
        (Xml.member "DescribeTerminationPolicyTypesResult")
    in
    try
      Util.or_error
        ...
        BadResponse
          { body
          ; message = "Could not find well formed DescribeTerminationPolicyTypesAnswer."
          })
    with Xml.RequiredFieldMissing msg ->
      ...
      `Error
        (BadResponse
           { body
           ; message =
               "Error parsing DescribeTerminationPolicyTypesAnswer - missing field in \
                body or children: "
               ^ msg
           })
  with Failure msg ->
