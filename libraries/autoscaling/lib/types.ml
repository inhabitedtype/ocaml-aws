...
module Ebs = struct
  ...
  let parse xml =
    Some
      { snapshot_id = Util.option_bind (Xml.member "SnapshotId" xml) String.parse
      ; volume_size = Util.option_bind (Xml.member "VolumeSize" xml) Integer.parse
      ; volume_type = Util.option_bind (Xml.member "VolumeType" xml) String.parse
      ; delete_on_termination =
          Util.option_bind (Xml.member "DeleteOnTermination" xml) Boolean.parse
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.volume_type (fun f ->
               Query.Pair ("VolumeType", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.delete_on_termination (fun f ->
               "delete_on_termination", Boolean.to_json f)
         ; Util.option_map v.volume_type (fun f -> "volume_type", String.to_json f)
         ; Util.option_map v.volume_size (fun f -> "volume_size", Integer.to_json f)
         ; Util.option_map v.snapshot_id (fun f -> "snapshot_id", String.to_json f)
         ])

  let of_json j =
    { snapshot_id = Util.option_map (Json.lookup j "snapshot_id") String.of_json
    ; volume_size = Util.option_map (Json.lookup j "volume_size") Integer.of_json
    ; volume_type = Util.option_map (Json.lookup j "volume_type") String.of_json
    ; delete_on_termination =
        Util.option_map (Json.lookup j "delete_on_termination") Boolean.of_json
...
module Alarm = struct
  ...
  let parse xml =
    Some
      ...
      ; alarm_a_r_n = Util.option_bind (Xml.member "AlarmARN" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.alarm_a_r_n (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.alarm_a_r_n (fun f -> "alarm_a_r_n", String.to_json f)
  ...
  let of_json j =
    ...
    ; alarm_a_r_n = Util.option_map (Json.lookup j "alarm_a_r_n") String.of_json
    }
end
...
module StepAdjustment = struct
  ...
  let parse xml =
    Some
      { metric_interval_lower_bound =
          Util.option_bind (Xml.member "MetricIntervalLowerBound" xml) Double.parse
      ; metric_interval_upper_bound =
          Util.option_bind (Xml.member "MetricIntervalUpperBound" xml) Double.parse
      ; scaling_adjustment =
          Xml.required
            "ScalingAdjustment"
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.metric_interval_upper_bound (fun f ->
               Query.Pair ("MetricIntervalUpperBound", Double.to_query f))
         ; Util.option_map v.metric_interval_lower_bound (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.metric_interval_upper_bound (fun f ->
               "metric_interval_upper_bound", Double.to_json f)
         ; Util.option_map v.metric_interval_lower_bound (fun f ->
               "metric_interval_lower_bound", Double.to_json f)
         ])

  let of_json j =
    { metric_interval_lower_bound =
        Util.option_map (Json.lookup j "metric_interval_lower_bound") Double.of_json
    ; metric_interval_upper_bound =
        Util.option_map (Json.lookup j "metric_interval_upper_bound") Double.of_json
    ; scaling_adjustment =
...
module EnabledMetric = struct
  ...
  let parse xml =
    Some
      ...
      ; granularity = Util.option_bind (Xml.member "Granularity" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.granularity (fun f ->
               Query.Pair ("Granularity", String.to_query f))
         ; Util.option_map v.metric (fun f -> Query.Pair ("Metric", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.granularity (fun f -> "granularity", String.to_json f)
         ; Util.option_map v.metric (fun f -> "metric", String.to_json f)
         ])

  let of_json j =
    { metric = Util.option_map (Json.lookup j "metric") String.of_json
    ; granularity = Util.option_map (Json.lookup j "granularity") String.of_json
    }
end
...
module Instance = struct
  ...
  let parse xml =
    Some
      ...
      ; lifecycle_state =
          Xml.required
            "LifecycleState"
            (Util.option_bind (Xml.member "LifecycleState" xml) LifecycleState.parse)
      ; health_status =
          Xml.required
            "HealthStatus"
            (Util.option_bind (Xml.member "HealthStatus" xml) String.parse)
      ; launch_configuration_name =
          Util.option_bind (Xml.member "LaunchConfigurationName" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.launch_configuration_name (fun f ->
               Query.Pair ("LaunchConfigurationName", String.to_query f))
         ; Some (Query.Pair ("HealthStatus", String.to_query v.health_status))
         ; Some (Query.Pair ("LifecycleState", LifecycleState.to_query v.lifecycle_state))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.launch_configuration_name (fun f ->
               "launch_configuration_name", String.to_json f)
         ; Some ("health_status", String.to_json v.health_status)
         ; Some ("lifecycle_state", LifecycleState.to_json v.lifecycle_state)
         ; Some ("availability_zone", String.to_json v.availability_zone)
         ; Some ("instance_id", String.to_json v.instance_id)
         ])

  let of_json j =
    { instance_id = String.of_json (Util.of_option_exn (Json.lookup j "instance_id"))
    ; availability_zone =
        String.of_json (Util.of_option_exn (Json.lookup j "availability_zone"))
    ; lifecycle_state =
        LifecycleState.of_json (Util.of_option_exn (Json.lookup j "lifecycle_state"))
    ; health_status = String.of_json (Util.of_option_exn (Json.lookup j "health_status"))
    ; launch_configuration_name =
        Util.option_map (Json.lookup j "launch_configuration_name") String.of_json
    }
end
...
module SuspendedProcess = struct
  ...
  let parse xml =
    Some
      { process_name = Util.option_bind (Xml.member "ProcessName" xml) String.parse
      ; suspension_reason =
          Util.option_bind (Xml.member "SuspensionReason" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.suspension_reason (fun f ->
               Query.Pair ("SuspensionReason", String.to_query f))
         ; Util.option_map v.process_name (fun f ->
               Query.Pair ("ProcessName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.suspension_reason (fun f ->
               "suspension_reason", String.to_json f)
         ; Util.option_map v.process_name (fun f -> "process_name", String.to_json f)
         ])

  let of_json j =
    { process_name = Util.option_map (Json.lookup j "process_name") String.of_json
    ; suspension_reason =
...
module TagDescription = struct
  ...
  let parse xml =
    Some
      ...
      ; propagate_at_launch =
          Xml.required
            "PropagateAtLaunch"
            (Util.option_bind (Xml.member "PropagateAtLaunch" xml) Boolean.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("PropagateAtLaunch", Boolean.to_query v.propagate_at_launch))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("propagate_at_launch", Boolean.to_json v.propagate_at_launch)
  ...
  let of_json j =
    ...
    ; propagate_at_launch =
        Boolean.of_json (Util.of_option_exn (Json.lookup j "propagate_at_launch"))
    }
end
...
module BlockDeviceMapping = struct
  ...
  let parse xml =
    Some
      { virtual_name = Util.option_bind (Xml.member "VirtualName" xml) String.parse
      ; device_name =
          Xml.required
            "DeviceName"
            (Util.option_bind (Xml.member "DeviceName" xml) String.parse)
      ; ebs = Util.option_bind (Xml.member "Ebs" xml) Ebs.parse
      ; no_device = Util.option_bind (Xml.member "NoDevice" xml) Boolean.parse
      }
    ...
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.no_device (fun f ->
               Query.Pair ("NoDevice", Boolean.to_query f))
         ; Util.option_map v.ebs (fun f -> Query.Pair ("Ebs", Ebs.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.no_device (fun f -> "no_device", Boolean.to_json f)
         ; Util.option_map v.ebs (fun f -> "ebs", Ebs.to_json f)
         ; Some ("device_name", String.to_json v.device_name)
         ; Util.option_map v.virtual_name (fun f -> "virtual_name", String.to_json f)
         ])

  let of_json j =
    { virtual_name = Util.option_map (Json.lookup j "virtual_name") String.of_json
    ; device_name = String.of_json (Util.of_option_exn (Json.lookup j "device_name"))
    ; ebs = Util.option_map (Json.lookup j "ebs") Ebs.of_json
    ; no_device = Util.option_map (Json.lookup j "no_device") Boolean.of_json
    }
end
...
module Alarms = struct
  ...
  let parse xml = Util.option_all (List.map Alarm.parse (Xml.members "member" xml))
...
module StepAdjustments = struct
  ...
  let parse xml =
    Util.option_all (List.map StepAdjustment.parse (Xml.members "member" xml))
...
module EnabledMetrics = struct
  ...
  let parse xml =
    Util.option_all (List.map EnabledMetric.parse (Xml.members "member" xml))
...
module SuspendedProcesses = struct
  ...
  let parse xml =
    Util.option_all (List.map SuspendedProcess.parse (Xml.members "member" xml))
...
module TagDescriptionList = struct
  ...
  let parse xml =
    Util.option_all (List.map TagDescription.parse (Xml.members "member" xml))
...
module BlockDeviceMappings = struct
  ...
  let parse xml =
    Util.option_all (List.map BlockDeviceMapping.parse (Xml.members "member" xml))
...
module InstanceMonitoring = struct
  ...
  let parse xml =
    Some { enabled = Util.option_bind (Xml.member "Enabled" xml) Boolean.parse }
  ...
  let of_json j = { enabled = Util.option_map (Json.lookup j "enabled") Boolean.of_json }
end
...
module Filter = struct
  ...
  let parse xml =
    Some
      ...
      ; values =
          Util.of_option [] (Util.option_bind (Xml.member "Values" xml) Values.parse)
      }
  ...
  let of_json j =
    ...
    ; values = Values.of_json (Util.of_option_exn (Json.lookup j "values"))
    }
end
...
module AutoScalingInstanceDetails = struct
    ...
    Some
      ...
      ; auto_scaling_group_name =
          Xml.required
            ...
            (Util.option_bind (Xml.member "AutoScalingGroupName" xml) String.parse)
      ; availability_zone =
          Xml.required
            "AvailabilityZone"
            (Util.option_bind (Xml.member "AvailabilityZone" xml) String.parse)
      ; lifecycle_state =
          Xml.required
            "LifecycleState"
            (Util.option_bind (Xml.member "LifecycleState" xml) String.parse)
      ; health_status =
          Xml.required
            "HealthStatus"
            (Util.option_bind (Xml.member "HealthStatus" xml) String.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("HealthStatus", String.to_query v.health_status))
         ; Some (Query.Pair ("LifecycleState", String.to_query v.lifecycle_state))
         ; Some (Query.Pair ("AvailabilityZone", String.to_query v.availability_zone))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("launch_configuration_name", String.to_json v.launch_configuration_name)
         ; Some ("health_status", String.to_json v.health_status)
         ; Some ("lifecycle_state", String.to_json v.lifecycle_state)
         ; Some ("availability_zone", String.to_json v.availability_zone)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ; Some ("instance_id", String.to_json v.instance_id)
         ])
  ...
  let of_json j =
    { instance_id = String.of_json (Util.of_option_exn (Json.lookup j "instance_id"))
    ; auto_scaling_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "auto_scaling_group_name"))
    ; availability_zone =
        String.of_json (Util.of_option_exn (Json.lookup j "availability_zone"))
    ; lifecycle_state =
        String.of_json (Util.of_option_exn (Json.lookup j "lifecycle_state"))
    ; health_status = String.of_json (Util.of_option_exn (Json.lookup j "health_status"))
    ; launch_configuration_name =
        String.of_json (Util.of_option_exn (Json.lookup j "launch_configuration_name"))
    }
end
...
module ScalingPolicy = struct
  ...
  let parse xml =
    Some
      { auto_scaling_group_name =
          Util.option_bind (Xml.member "AutoScalingGroupName" xml) String.parse
      ; policy_name = Util.option_bind (Xml.member "PolicyName" xml) String.parse
      ; policy_a_r_n = Util.option_bind (Xml.member "PolicyARN" xml) String.parse
      ; policy_type = Util.option_bind (Xml.member "PolicyType" xml) String.parse
      ; adjustment_type = Util.option_bind (Xml.member "AdjustmentType" xml) String.parse
      ; min_adjustment_step =
          Util.option_bind (Xml.member "MinAdjustmentStep" xml) Integer.parse
      ; min_adjustment_magnitude =
          Util.option_bind (Xml.member "MinAdjustmentMagnitude" xml) Integer.parse
      ; scaling_adjustment =
          Util.option_bind (Xml.member "ScalingAdjustment" xml) Integer.parse
      ; cooldown = Util.option_bind (Xml.member "Cooldown" xml) Integer.parse
      ; step_adjustments =
          Util.of_option
            []
            (Util.option_bind (Xml.member "StepAdjustments" xml) StepAdjustments.parse)
      ; metric_aggregation_type =
          Util.option_bind (Xml.member "MetricAggregationType" xml) String.parse
      ; estimated_instance_warmup =
          Util.option_bind (Xml.member "EstimatedInstanceWarmup" xml) Integer.parse
      ; alarms =
          Util.of_option [] (Util.option_bind (Xml.member "Alarms" xml) Alarms.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.estimated_instance_warmup (fun f ->
               Query.Pair ("EstimatedInstanceWarmup", Integer.to_query f))
         ; Util.option_map v.metric_aggregation_type (fun f ->
               Query.Pair ("MetricAggregationType", String.to_query f))
         ; Some
             (Query.Pair
                ("StepAdjustments.member", StepAdjustments.to_query v.step_adjustments))
         ; Util.option_map v.cooldown (fun f ->
               Query.Pair ("Cooldown", Integer.to_query f))
         ; Util.option_map v.scaling_adjustment (fun f ->
               Query.Pair ("ScalingAdjustment", Integer.to_query f))
         ; Util.option_map v.min_adjustment_magnitude (fun f ->
               Query.Pair ("MinAdjustmentMagnitude", Integer.to_query f))
         ; Util.option_map v.min_adjustment_step (fun f ->
               Query.Pair ("MinAdjustmentStep", Integer.to_query f))
         ; Util.option_map v.adjustment_type (fun f ->
               Query.Pair ("AdjustmentType", String.to_query f))
         ; Util.option_map v.policy_type (fun f ->
               Query.Pair ("PolicyType", String.to_query f))
         ; Util.option_map v.policy_a_r_n (fun f ->
               Query.Pair ("PolicyARN", String.to_query f))
         ; Util.option_map v.policy_name (fun f ->
               Query.Pair ("PolicyName", String.to_query f))
         ; Util.option_map v.auto_scaling_group_name (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.estimated_instance_warmup (fun f ->
               "estimated_instance_warmup", Integer.to_json f)
         ; Util.option_map v.metric_aggregation_type (fun f ->
               "metric_aggregation_type", String.to_json f)
         ; Some ("step_adjustments", StepAdjustments.to_json v.step_adjustments)
         ; Util.option_map v.cooldown (fun f -> "cooldown", Integer.to_json f)
         ; Util.option_map v.scaling_adjustment (fun f ->
               "scaling_adjustment", Integer.to_json f)
         ; Util.option_map v.min_adjustment_magnitude (fun f ->
               "min_adjustment_magnitude", Integer.to_json f)
         ; Util.option_map v.min_adjustment_step (fun f ->
               "min_adjustment_step", Integer.to_json f)
         ; Util.option_map v.adjustment_type (fun f ->
               "adjustment_type", String.to_json f)
         ; Util.option_map v.policy_type (fun f -> "policy_type", String.to_json f)
         ; Util.option_map v.policy_a_r_n (fun f -> "policy_a_r_n", String.to_json f)
         ; Util.option_map v.policy_name (fun f -> "policy_name", String.to_json f)
         ; Util.option_map v.auto_scaling_group_name (fun f ->
               "auto_scaling_group_name", String.to_json f)
         ])

  let of_json j =
    { auto_scaling_group_name =
        Util.option_map (Json.lookup j "auto_scaling_group_name") String.of_json
    ; policy_name = Util.option_map (Json.lookup j "policy_name") String.of_json
    ; policy_a_r_n = Util.option_map (Json.lookup j "policy_a_r_n") String.of_json
    ; policy_type = Util.option_map (Json.lookup j "policy_type") String.of_json
    ; adjustment_type = Util.option_map (Json.lookup j "adjustment_type") String.of_json
    ; min_adjustment_step =
        Util.option_map (Json.lookup j "min_adjustment_step") Integer.of_json
    ; min_adjustment_magnitude =
        Util.option_map (Json.lookup j "min_adjustment_magnitude") Integer.of_json
    ; scaling_adjustment =
        Util.option_map (Json.lookup j "scaling_adjustment") Integer.of_json
    ; cooldown = Util.option_map (Json.lookup j "cooldown") Integer.of_json
    ; step_adjustments =
        StepAdjustments.of_json (Util.of_option_exn (Json.lookup j "step_adjustments"))
    ; metric_aggregation_type =
        Util.option_map (Json.lookup j "metric_aggregation_type") String.of_json
    ; estimated_instance_warmup =
        Util.option_map (Json.lookup j "estimated_instance_warmup") Integer.of_json
    ; alarms = Alarms.of_json (Util.of_option_exn (Json.lookup j "alarms"))
    }
end
...
module LifecycleHook = struct
  ...
  let parse xml =
    Some
      { lifecycle_hook_name =
          Util.option_bind (Xml.member "LifecycleHookName" xml) String.parse
      ; auto_scaling_group_name =
          Util.option_bind (Xml.member "AutoScalingGroupName" xml) String.parse
      ; lifecycle_transition =
          Util.option_bind (Xml.member "LifecycleTransition" xml) String.parse
      ; notification_target_a_r_n =
          Util.option_bind (Xml.member "NotificationTargetARN" xml) String.parse
      ; role_a_r_n = Util.option_bind (Xml.member "RoleARN" xml) String.parse
      ; notification_metadata =
          Util.option_bind (Xml.member "NotificationMetadata" xml) String.parse
      ; heartbeat_timeout =
          Util.option_bind (Xml.member "HeartbeatTimeout" xml) Integer.parse
      ; global_timeout = Util.option_bind (Xml.member "GlobalTimeout" xml) Integer.parse
      ; default_result = Util.option_bind (Xml.member "DefaultResult" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.default_result (fun f ->
               Query.Pair ("DefaultResult", String.to_query f))
         ; Util.option_map v.global_timeout (fun f ->
               Query.Pair ("GlobalTimeout", Integer.to_query f))
         ; Util.option_map v.heartbeat_timeout (fun f ->
               Query.Pair ("HeartbeatTimeout", Integer.to_query f))
         ; Util.option_map v.notification_metadata (fun f ->
               Query.Pair ("NotificationMetadata", String.to_query f))
         ; Util.option_map v.role_a_r_n (fun f ->
               Query.Pair ("RoleARN", String.to_query f))
         ; Util.option_map v.notification_target_a_r_n (fun f ->
               Query.Pair ("NotificationTargetARN", String.to_query f))
         ; Util.option_map v.lifecycle_transition (fun f ->
               Query.Pair ("LifecycleTransition", String.to_query f))
         ; Util.option_map v.auto_scaling_group_name (fun f ->
               Query.Pair ("AutoScalingGroupName", String.to_query f))
         ; Util.option_map v.lifecycle_hook_name (fun f ->
               Query.Pair ("LifecycleHookName", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.default_result (fun f -> "default_result", String.to_json f)
         ; Util.option_map v.global_timeout (fun f -> "global_timeout", Integer.to_json f)
         ; Util.option_map v.heartbeat_timeout (fun f ->
               "heartbeat_timeout", Integer.to_json f)
         ; Util.option_map v.notification_metadata (fun f ->
               "notification_metadata", String.to_json f)
         ; Util.option_map v.role_a_r_n (fun f -> "role_a_r_n", String.to_json f)
         ; Util.option_map v.notification_target_a_r_n (fun f ->
               "notification_target_a_r_n", String.to_json f)
         ; Util.option_map v.lifecycle_transition (fun f ->
               "lifecycle_transition", String.to_json f)
         ; Util.option_map v.auto_scaling_group_name (fun f ->
               "auto_scaling_group_name", String.to_json f)
         ; Util.option_map v.lifecycle_hook_name (fun f ->
               "lifecycle_hook_name", String.to_json f)
         ])

  let of_json j =
    { lifecycle_hook_name =
        Util.option_map (Json.lookup j "lifecycle_hook_name") String.of_json
    ; auto_scaling_group_name =
        Util.option_map (Json.lookup j "auto_scaling_group_name") String.of_json
    ; lifecycle_transition =
        Util.option_map (Json.lookup j "lifecycle_transition") String.of_json
    ; notification_target_a_r_n =
        Util.option_map (Json.lookup j "notification_target_a_r_n") String.of_json
    ; role_a_r_n = Util.option_map (Json.lookup j "role_a_r_n") String.of_json
    ; notification_metadata =
        Util.option_map (Json.lookup j "notification_metadata") String.of_json
    ; heartbeat_timeout =
        Util.option_map (Json.lookup j "heartbeat_timeout") Integer.of_json
    ; global_timeout = Util.option_map (Json.lookup j "global_timeout") Integer.of_json
    ; default_result = Util.option_map (Json.lookup j "default_result") String.of_json
    }
end
...
module Activity = struct
  ...
  let parse xml =
    Some
      ...
      ; cause =
          Xml.required "Cause" (Util.option_bind (Xml.member "Cause" xml) String.parse)
      ; start_time =
          Xml.required
            "StartTime"
      ...
      ; status_code =
          Xml.required
            "StatusCode"
            (Util.option_bind
               (Xml.member "StatusCode" xml)
               ScalingActivityStatusCode.parse)
      ; status_message = Util.option_bind (Xml.member "StatusMessage" xml) String.parse
      ; progress = Util.option_bind (Xml.member "Progress" xml) Integer.parse
      ; details = Util.option_bind (Xml.member "Details" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.details (fun f -> Query.Pair ("Details", String.to_query f))
         ; Util.option_map v.progress (fun f ->
               Query.Pair ("Progress", Integer.to_query f))
         ; Util.option_map v.status_message (fun f ->
               Query.Pair ("StatusMessage", String.to_query f))
         ; Some
             (Query.Pair ("StatusCode", ScalingActivityStatusCode.to_query v.status_code))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.details (fun f -> "details", String.to_json f)
         ; Util.option_map v.progress (fun f -> "progress", Integer.to_json f)
         ; Util.option_map v.status_message (fun f -> "status_message", String.to_json f)
         ; Some ("status_code", ScalingActivityStatusCode.to_json v.status_code)
  ...
  let of_json j =
    { activity_id = String.of_json (Util.of_option_exn (Json.lookup j "activity_id"))
    ; auto_scaling_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "auto_scaling_group_name"))
    ...
    ; progress = Util.option_map (Json.lookup j "progress") Integer.of_json
...
module AutoScalingGroup = struct
    ...
    Some
      { auto_scaling_group_name =
          Xml.required
            ...
            (Util.option_bind (Xml.member "AutoScalingGroupName" xml) String.parse)
      ; auto_scaling_group_a_r_n =
          Util.option_bind (Xml.member "AutoScalingGroupARN" xml) String.parse
      ; launch_configuration_name =
          Util.option_bind (Xml.member "LaunchConfigurationName" xml) String.parse
      ; min_size =
          Xml.required
      ...
      ; desired_capacity =
          Xml.required
            "DesiredCapacity"
            (Util.option_bind (Xml.member "DesiredCapacity" xml) Integer.parse)
      ; default_cooldown =
          Xml.required
            "DefaultCooldown"
            (Util.option_bind (Xml.member "DefaultCooldown" xml) Integer.parse)
      ; availability_zones =
          Xml.required
            "AvailabilityZones"
            (Util.option_bind
      ...
      ; load_balancer_names =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "LoadBalancerNames" xml)
      ...
      ; health_check_grace_period =
          Util.option_bind (Xml.member "HealthCheckGracePeriod" xml) Integer.parse
      ; instances =
          Util.of_option
            []
      ...
      ; suspended_processes =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "SuspendedProcesses" xml)
               SuspendedProcesses.parse)
      ; placement_group = Util.option_bind (Xml.member "PlacementGroup" xml) String.parse
      ; v_p_c_zone_identifier =
          Util.option_bind (Xml.member "VPCZoneIdentifier" xml) String.parse
      ; enabled_metrics =
          Util.of_option
            []
            (Util.option_bind (Xml.member "EnabledMetrics" xml) EnabledMetrics.parse)
      ; status = Util.option_bind (Xml.member "Status" xml) String.parse
      ; tags =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Tags" xml) TagDescriptionList.parse)
      ; termination_policies =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "TerminationPolicies" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("Tags.member", TagDescriptionList.to_query v.tags))
         ...
         ; Util.option_map v.v_p_c_zone_identifier (fun f ->
               Query.Pair ("VPCZoneIdentifier", String.to_query f))
         ; Util.option_map v.placement_group (fun f ->
               Query.Pair ("PlacementGroup", String.to_query f))
         ; Some
             (Query.Pair
                ( "SuspendedProcesses.member"
                , SuspendedProcesses.to_query v.suspended_processes ))
         ; Some (Query.Pair ("CreatedTime", DateTime.to_query v.created_time))
         ; Some (Query.Pair ("Instances.member", Instances.to_query v.instances))
         ; Util.option_map v.health_check_grace_period (fun f ->
               Query.Pair ("HealthCheckGracePeriod", Integer.to_query f))
         ; Some (Query.Pair ("HealthCheckType", String.to_query v.health_check_type))
         ; Some
             (Query.Pair
         ...
         ; Some (Query.Pair ("DefaultCooldown", Integer.to_query v.default_cooldown))
         ; Some (Query.Pair ("DesiredCapacity", Integer.to_query v.desired_capacity))
         ; Some (Query.Pair ("MaxSize", Integer.to_query v.max_size))
         ; Some (Query.Pair ("MinSize", Integer.to_query v.min_size))
         ; Util.option_map v.launch_configuration_name (fun f ->
               Query.Pair ("LaunchConfigurationName", String.to_query f))
         ; Util.option_map v.auto_scaling_group_a_r_n (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some
             ("termination_policies", TerminationPolicies.to_json v.termination_policies)
         ; Some ("tags", TagDescriptionList.to_json v.tags)
         ; Util.option_map v.status (fun f -> "status", String.to_json f)
         ; Some ("enabled_metrics", EnabledMetrics.to_json v.enabled_metrics)
         ; Util.option_map v.v_p_c_zone_identifier (fun f ->
               "v_p_c_zone_identifier", String.to_json f)
         ; Util.option_map v.placement_group (fun f ->
               "placement_group", String.to_json f)
         ; Some ("suspended_processes", SuspendedProcesses.to_json v.suspended_processes)
         ; Some ("created_time", DateTime.to_json v.created_time)
         ; Some ("instances", Instances.to_json v.instances)
         ; Util.option_map v.health_check_grace_period (fun f ->
               "health_check_grace_period", Integer.to_json f)
         ; Some ("health_check_type", String.to_json v.health_check_type)
         ; Some ("load_balancer_names", LoadBalancerNames.to_json v.load_balancer_names)
         ...
         ; Util.option_map v.launch_configuration_name (fun f ->
               "launch_configuration_name", String.to_json f)
         ; Util.option_map v.auto_scaling_group_a_r_n (fun f ->
               "auto_scaling_group_a_r_n", String.to_json f)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ])
  ...
  let of_json j =
    { auto_scaling_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "auto_scaling_group_name"))
    ; auto_scaling_group_a_r_n =
        Util.option_map (Json.lookup j "auto_scaling_group_a_r_n") String.of_json
    ; launch_configuration_name =
        Util.option_map (Json.lookup j "launch_configuration_name") String.of_json
    ; min_size = Integer.of_json (Util.of_option_exn (Json.lookup j "min_size"))
    ; max_size = Integer.of_json (Util.of_option_exn (Json.lookup j "max_size"))
    ; desired_capacity =
        Integer.of_json (Util.of_option_exn (Json.lookup j "desired_capacity"))
    ; default_cooldown =
        Integer.of_json (Util.of_option_exn (Json.lookup j "default_cooldown"))
    ; availability_zones =
    ...
    ; health_check_type =
        String.of_json (Util.of_option_exn (Json.lookup j "health_check_type"))
    ; health_check_grace_period =
        Util.option_map (Json.lookup j "health_check_grace_period") Integer.of_json
    ; instances = Instances.of_json (Util.of_option_exn (Json.lookup j "instances"))
    ; created_time = DateTime.of_json (Util.of_option_exn (Json.lookup j "created_time"))
    ; suspended_processes =
        SuspendedProcesses.of_json
          (Util.of_option_exn (Json.lookup j "suspended_processes"))
    ; placement_group = Util.option_map (Json.lookup j "placement_group") String.of_json
    ; v_p_c_zone_identifier =
        Util.option_map (Json.lookup j "v_p_c_zone_identifier") String.of_json
    ; enabled_metrics =
        EnabledMetrics.of_json (Util.of_option_exn (Json.lookup j "enabled_metrics"))
    ; status = Util.option_map (Json.lookup j "status") String.of_json
    ; tags = TagDescriptionList.of_json (Util.of_option_exn (Json.lookup j "tags"))
    ; termination_policies =
...
module NotificationConfiguration = struct
  ...
  let parse xml =
    Some
      { auto_scaling_group_name =
          Util.option_bind (Xml.member "AutoScalingGroupName" xml) String.parse
      ; topic_a_r_n = Util.option_bind (Xml.member "TopicARN" xml) String.parse
      ; notification_type =
          Util.option_bind (Xml.member "NotificationType" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.notification_type (fun f ->
               Query.Pair ("NotificationType", String.to_query f))
         ; Util.option_map v.topic_a_r_n (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.notification_type (fun f ->
               "notification_type", String.to_json f)
         ; Util.option_map v.topic_a_r_n (fun f -> "topic_a_r_n", String.to_json f)
         ; Util.option_map v.auto_scaling_group_name (fun f ->
               "auto_scaling_group_name", String.to_json f)
         ])
  ...
  let of_json j =
    { auto_scaling_group_name =
        Util.option_map (Json.lookup j "auto_scaling_group_name") String.of_json
    ; topic_a_r_n = Util.option_map (Json.lookup j "topic_a_r_n") String.of_json
    ; notification_type =
...
module LaunchConfiguration = struct
    ...
    Some
      { launch_configuration_name =
          Xml.required
            ...
            (Util.option_bind (Xml.member "LaunchConfigurationName" xml) String.parse)
      ; launch_configuration_a_r_n =
          Util.option_bind (Xml.member "LaunchConfigurationARN" xml) String.parse
      ; image_id =
          Xml.required
            "ImageId"
            (Util.option_bind (Xml.member "ImageId" xml) String.parse)
      ; key_name = Util.option_bind (Xml.member "KeyName" xml) String.parse
      ; security_groups =
          Util.of_option
            []
            (Util.option_bind (Xml.member "SecurityGroups" xml) SecurityGroups.parse)
      ; classic_link_v_p_c_id =
          Util.option_bind (Xml.member "ClassicLinkVPCId" xml) String.parse
      ; classic_link_v_p_c_security_groups =
          Util.of_option
            []
            (Util.option_bind
      ...
      ; user_data = Util.option_bind (Xml.member "UserData" xml) String.parse
      ; instance_type =
          Xml.required
            "InstanceType"
            (Util.option_bind (Xml.member "InstanceType" xml) String.parse)
      ; kernel_id = Util.option_bind (Xml.member "KernelId" xml) String.parse
      ; ramdisk_id = Util.option_bind (Xml.member "RamdiskId" xml) String.parse
      ; block_device_mappings =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "BlockDeviceMappings" xml)
               BlockDeviceMappings.parse)
      ; instance_monitoring =
          Util.option_bind (Xml.member "InstanceMonitoring" xml) InstanceMonitoring.parse
      ; spot_price = Util.option_bind (Xml.member "SpotPrice" xml) String.parse
      ; iam_instance_profile =
      ...
      ; associate_public_ip_address =
          Util.option_bind (Xml.member "AssociatePublicIpAddress" xml) Boolean.parse
      ; placement_tenancy =
          Util.option_bind (Xml.member "PlacementTenancy" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.placement_tenancy (fun f ->
               Query.Pair ("PlacementTenancy", String.to_query f))
         ...
         ; Util.option_map v.instance_monitoring (fun f ->
               Query.Pair ("InstanceMonitoring", InstanceMonitoring.to_query f))
         ; Some
             (Query.Pair
         ...
         ; Util.option_map v.classic_link_v_p_c_id (fun f ->
               Query.Pair ("ClassicLinkVPCId", String.to_query f))
         ; Some
             (Query.Pair
         ...
         ; Util.option_map v.launch_configuration_a_r_n (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.placement_tenancy (fun f ->
               "placement_tenancy", String.to_json f)
         ; Util.option_map v.associate_public_ip_address (fun f ->
               "associate_public_ip_address", Boolean.to_json f)
         ; Util.option_map v.ebs_optimized (fun f -> "ebs_optimized", Boolean.to_json f)
         ; Some ("created_time", DateTime.to_json v.created_time)
         ; Util.option_map v.iam_instance_profile (fun f ->
               "iam_instance_profile", String.to_json f)
         ; Util.option_map v.spot_price (fun f -> "spot_price", String.to_json f)
         ; Util.option_map v.instance_monitoring (fun f ->
               "instance_monitoring", InstanceMonitoring.to_json f)
         ; Some
             ("block_device_mappings", BlockDeviceMappings.to_json v.block_device_mappings)
         ; Util.option_map v.ramdisk_id (fun f -> "ramdisk_id", String.to_json f)
         ; Util.option_map v.kernel_id (fun f -> "kernel_id", String.to_json f)
         ; Some ("instance_type", String.to_json v.instance_type)
         ; Util.option_map v.user_data (fun f -> "user_data", String.to_json f)
         ; Some
             ( "classic_link_v_p_c_security_groups"
             , ClassicLinkVPCSecurityGroups.to_json v.classic_link_v_p_c_security_groups
             )
         ; Util.option_map v.classic_link_v_p_c_id (fun f ->
               "classic_link_v_p_c_id", String.to_json f)
         ; Some ("security_groups", SecurityGroups.to_json v.security_groups)
         ; Util.option_map v.key_name (fun f -> "key_name", String.to_json f)
         ; Some ("image_id", String.to_json v.image_id)
         ; Util.option_map v.launch_configuration_a_r_n (fun f ->
               "launch_configuration_a_r_n", String.to_json f)
         ; Some ("launch_configuration_name", String.to_json v.launch_configuration_name)
         ])
  ...
  let of_json j =
    { launch_configuration_name =
        String.of_json (Util.of_option_exn (Json.lookup j "launch_configuration_name"))
    ; launch_configuration_a_r_n =
        Util.option_map (Json.lookup j "launch_configuration_a_r_n") String.of_json
    ; image_id = String.of_json (Util.of_option_exn (Json.lookup j "image_id"))
    ; key_name = Util.option_map (Json.lookup j "key_name") String.of_json
    ; security_groups =
        SecurityGroups.of_json (Util.of_option_exn (Json.lookup j "security_groups"))
    ; classic_link_v_p_c_id =
        Util.option_map (Json.lookup j "classic_link_v_p_c_id") String.of_json
    ; classic_link_v_p_c_security_groups =
        ClassicLinkVPCSecurityGroups.of_json
          (Util.of_option_exn (Json.lookup j "classic_link_v_p_c_security_groups"))
    ; user_data = Util.option_map (Json.lookup j "user_data") String.of_json
    ; instance_type = String.of_json (Util.of_option_exn (Json.lookup j "instance_type"))
    ; kernel_id = Util.option_map (Json.lookup j "kernel_id") String.of_json
    ; ramdisk_id = Util.option_map (Json.lookup j "ramdisk_id") String.of_json
    ; block_device_mappings =
        BlockDeviceMappings.of_json
          (Util.of_option_exn (Json.lookup j "block_device_mappings"))
    ; instance_monitoring =
        Util.option_map (Json.lookup j "instance_monitoring") InstanceMonitoring.of_json
    ; spot_price = Util.option_map (Json.lookup j "spot_price") String.of_json
    ; iam_instance_profile =
    ...
    ; associate_public_ip_address =
        Util.option_map (Json.lookup j "associate_public_ip_address") Boolean.of_json
    ; placement_tenancy =
...
module ScheduledUpdateGroupAction = struct
  ...
  let parse xml =
    Some
      { auto_scaling_group_name =
          Util.option_bind (Xml.member "AutoScalingGroupName" xml) String.parse
      ; scheduled_action_name =
          Util.option_bind (Xml.member "ScheduledActionName" xml) String.parse
      ; scheduled_action_a_r_n =
          Util.option_bind (Xml.member "ScheduledActionARN" xml) String.parse
      ...
      ; end_time = Util.option_bind (Xml.member "EndTime" xml) DateTime.parse
      ; recurrence = Util.option_bind (Xml.member "Recurrence" xml) String.parse
      ; min_size = Util.option_bind (Xml.member "MinSize" xml) Integer.parse
      ; max_size = Util.option_bind (Xml.member "MaxSize" xml) Integer.parse
      ; desired_capacity =
          Util.option_bind (Xml.member "DesiredCapacity" xml) Integer.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.desired_capacity (fun f ->
               Query.Pair ("DesiredCapacity", Integer.to_query f))
         ; Util.option_map v.max_size (fun f ->
               Query.Pair ("MaxSize", Integer.to_query f))
         ; Util.option_map v.min_size (fun f ->
               Query.Pair ("MinSize", Integer.to_query f))
         ; Util.option_map v.recurrence (fun f ->
               Query.Pair ("Recurrence", String.to_query f))
         ; Util.option_map v.end_time (fun f ->
               Query.Pair ("EndTime", DateTime.to_query f))
         ; Util.option_map v.start_time (fun f ->
               Query.Pair ("StartTime", DateTime.to_query f))
         ; Util.option_map v.time (fun f -> Query.Pair ("Time", DateTime.to_query f))
         ; Util.option_map v.scheduled_action_a_r_n (fun f ->
               Query.Pair ("ScheduledActionARN", String.to_query f))
         ; Util.option_map v.scheduled_action_name (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.desired_capacity (fun f ->
               "desired_capacity", Integer.to_json f)
         ; Util.option_map v.max_size (fun f -> "max_size", Integer.to_json f)
         ; Util.option_map v.min_size (fun f -> "min_size", Integer.to_json f)
         ; Util.option_map v.recurrence (fun f -> "recurrence", String.to_json f)
         ; Util.option_map v.end_time (fun f -> "end_time", DateTime.to_json f)
         ; Util.option_map v.start_time (fun f -> "start_time", DateTime.to_json f)
         ; Util.option_map v.time (fun f -> "time", DateTime.to_json f)
         ; Util.option_map v.scheduled_action_a_r_n (fun f ->
               "scheduled_action_a_r_n", String.to_json f)
         ; Util.option_map v.scheduled_action_name (fun f ->
               "scheduled_action_name", String.to_json f)
         ; Util.option_map v.auto_scaling_group_name (fun f ->
               "auto_scaling_group_name", String.to_json f)
         ])
  ...
  let of_json j =
    { auto_scaling_group_name =
        Util.option_map (Json.lookup j "auto_scaling_group_name") String.of_json
    ; scheduled_action_name =
        Util.option_map (Json.lookup j "scheduled_action_name") String.of_json
    ; scheduled_action_a_r_n =
        Util.option_map (Json.lookup j "scheduled_action_a_r_n") String.of_json
    ...
    ; end_time = Util.option_map (Json.lookup j "end_time") DateTime.of_json
    ; recurrence = Util.option_map (Json.lookup j "recurrence") String.of_json
    ; min_size = Util.option_map (Json.lookup j "min_size") Integer.of_json
    ; max_size = Util.option_map (Json.lookup j "max_size") Integer.of_json
    ; desired_capacity =
...
module LoadBalancerState = struct
  ...
  let parse xml =
    Some
      { load_balancer_name =
          Util.option_bind (Xml.member "LoadBalancerName" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.load_balancer_name (fun f ->
               Query.Pair ("LoadBalancerName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.load_balancer_name (fun f ->
               "load_balancer_name", String.to_json f)
         ])

  let of_json j =
    { load_balancer_name =
        Util.option_map (Json.lookup j "load_balancer_name") String.of_json
...
module MetricCollectionType = struct
  ...
  let parse xml =
    Some { metric = Util.option_bind (Xml.member "Metric" xml) String.parse }
  ...
  let of_json j = { metric = Util.option_map (Json.lookup j "metric") String.of_json }
end
...
module MetricGranularityType = struct
  ...
  let parse xml =
    Some { granularity = Util.option_bind (Xml.member "Granularity" xml) String.parse }
...
module ProcessType = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("ProcessName", String.to_query v.process_name)) ])

  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("process_name", String.to_json v.process_name) ])

  let of_json j =
    { process_name = String.of_json (Util.of_option_exn (Json.lookup j "process_name")) }
end
...
module AutoScalingInstances = struct
  ...
  let parse xml =
    Util.option_all (List.map AutoScalingInstanceDetails.parse (Xml.members "member" xml))

  let to_query v = Query.to_query_list AutoScalingInstanceDetails.to_query v
...
module ScalingPolicies = struct
  ...
  let parse xml =
    Util.option_all (List.map ScalingPolicy.parse (Xml.members "member" xml))
...
module LifecycleHooks = struct
  ...
  let parse xml =
    Util.option_all (List.map LifecycleHook.parse (Xml.members "member" xml))
...
module Activities = struct
  ...
  let parse xml = Util.option_all (List.map Activity.parse (Xml.members "member" xml))
...
module AdjustmentTypes = struct
  ...
  let parse xml =
    Util.option_all (List.map AdjustmentType.parse (Xml.members "member" xml))
...
module AutoScalingGroups = struct
  ...
  let parse xml =
    Util.option_all (List.map AutoScalingGroup.parse (Xml.members "member" xml))
...
module NotificationConfigurations = struct
  ...
  let parse xml =
    Util.option_all (List.map NotificationConfiguration.parse (Xml.members "member" xml))
...
module LaunchConfigurations = struct
  ...
  let parse xml =
    Util.option_all (List.map LaunchConfiguration.parse (Xml.members "member" xml))
...
module ScheduledUpdateGroupActions = struct
  ...
  let parse xml =
    Util.option_all (List.map ScheduledUpdateGroupAction.parse (Xml.members "member" xml))

  let to_query v = Query.to_query_list ScheduledUpdateGroupAction.to_query v
...
module LoadBalancerStates = struct
  ...
  let parse xml =
    Util.option_all (List.map LoadBalancerState.parse (Xml.members "member" xml))
...
module MetricCollectionTypes = struct
  ...
  let parse xml =
    Util.option_all (List.map MetricCollectionType.parse (Xml.members "member" xml))
...
module MetricGranularityTypes = struct
  ...
  let parse xml =
    Util.option_all (List.map MetricGranularityType.parse (Xml.members "member" xml))
...
module Processes = struct
  ...
  let parse xml = Util.option_all (List.map ProcessType.parse (Xml.members "member" xml))
...
module ExitStandbyQuery = struct
  ...
  let parse xml =
    Some
      { instance_ids =
          Util.of_option
            []
            (Util.option_bind (Xml.member "InstanceIds" xml) InstanceIds.parse)
      ; auto_scaling_group_name =
          Xml.required
            "AutoScalingGroupName"
            (Util.option_bind (Xml.member "AutoScalingGroupName" xml) String.parse)
    ...
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair
                ("AutoScalingGroupName", String.to_query v.auto_scaling_group_name))
         ; Some (Query.Pair ("InstanceIds.member", InstanceIds.to_query v.instance_ids))
         ])
  ...
  let of_json j =
    { instance_ids =
        InstanceIds.of_json (Util.of_option_exn (Json.lookup j "instance_ids"))
    ; auto_scaling_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "auto_scaling_group_name"))
    }
end
...
module ActivityType = struct
  ...
  let parse xml =
    Some { activity = Util.option_bind (Xml.member "Activity" xml) Activity.parse }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.activity (fun f ->
               Query.Pair ("Activity", Activity.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.activity (fun f -> "activity", Activity.to_json f) ])

  let of_json j =
    { activity = Util.option_map (Json.lookup j "activity") Activity.of_json }
end
...
module DeleteAutoScalingGroupType = struct
    ...
    Some
      { auto_scaling_group_name =
          Xml.required
            "AutoScalingGroupName"
            (Util.option_bind (Xml.member "AutoScalingGroupName" xml) String.parse)
      ; force_delete = Util.option_bind (Xml.member "ForceDelete" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.force_delete (fun f ->
               Query.Pair ("ForceDelete", Boolean.to_query f))
         ; Some
             (Query.Pair
                ("AutoScalingGroupName", String.to_query v.auto_scaling_group_name))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.force_delete (fun f -> "force_delete", Boolean.to_json f)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ])
  ...
  let of_json j =
    { auto_scaling_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "auto_scaling_group_name"))
    ; force_delete = Util.option_map (Json.lookup j "force_delete") Boolean.of_json
    }
end
...
module DescribeTagsType = struct
  ...
  let parse xml =
    Some
      { filters =
          Util.of_option [] (Util.option_bind (Xml.member "Filters" xml) Filters.parse)
  ...
  let of_json j =
    { filters = Filters.of_json (Util.of_option_exn (Json.lookup j "filters"))
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Some
             (Query.Pair
                ("AutoScalingGroupName", String.to_query v.auto_scaling_group_name))
         ; Some (Query.Pair ("LifecycleHookName", String.to_query v.lifecycle_hook_name))
         ])
    ...
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.lifecycle_transition (fun f ->
               "lifecycle_transition", String.to_json f)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ; Some ("lifecycle_hook_name", String.to_json v.lifecycle_hook_name)
         ])

  let of_json j =
    { lifecycle_hook_name =
        String.of_json (Util.of_option_exn (Json.lookup j "lifecycle_hook_name"))
    ; auto_scaling_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "auto_scaling_group_name"))
    ; lifecycle_transition =
        Util.option_map (Json.lookup j "lifecycle_transition") String.of_json
...
module DetachInstancesQuery = struct
  ...
  let of_json j =
    ...
    ; should_decrement_desired_capacity =
        Boolean.of_json
          (Util.of_option_exn (Json.lookup j "should_decrement_desired_capacity"))
    }
end
...
module ScalingProcessQuery = struct
  ...
  let parse xml =
    Some
      ...
      ; scaling_processes =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ScalingProcesses" xml) ProcessNames.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("scaling_processes", ProcessNames.to_json v.scaling_processes)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ])
  ...
  let of_json j =
    { auto_scaling_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "auto_scaling_group_name"))
    ; scaling_processes =
        ProcessNames.of_json (Util.of_option_exn (Json.lookup j "scaling_processes"))
    }
end
...
module RecordLifecycleActionHeartbeatType = struct
    ...
    Some
      ...
      ; lifecycle_action_token =
          Xml.required
            ...
            (Util.option_bind (Xml.member "LifecycleActionToken" xml) String.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("LifecycleActionToken", String.to_query v.lifecycle_action_token))
         ; Some
             (Query.Pair
                ("AutoScalingGroupName", String.to_query v.auto_scaling_group_name))
         ; Some (Query.Pair ("LifecycleHookName", String.to_query v.lifecycle_hook_name))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("lifecycle_action_token", String.to_json v.lifecycle_action_token)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ; Some ("lifecycle_hook_name", String.to_json v.lifecycle_hook_name)
         ])
  ...
  let of_json j =
    ...
    ; auto_scaling_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "auto_scaling_group_name"))
    ; lifecycle_action_token =
        String.of_json (Util.of_option_exn (Json.lookup j "lifecycle_action_token"))
    }
end
    ...
    Some
      { auto_scaling_instances =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "AutoScalingInstances" xml)
...
module PutNotificationConfigurationType = struct
    ...
    Some
      ...
      ; notification_types =
          Xml.required
            "NotificationTypes"
            (Util.option_bind
               (Xml.member "NotificationTypes" xml)
  ...
  let of_json j =
    { auto_scaling_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "auto_scaling_group_name"))
    ; topic_a_r_n = String.of_json (Util.of_option_exn (Json.lookup j "topic_a_r_n"))
    ; notification_types =
...
module PoliciesType = struct
  ...
  let parse xml =
    Some
      { scaling_policies =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ScalingPolicies" xml) ScalingPolicies.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("scaling_policies", ScalingPolicies.to_json v.scaling_policies)
         ])

  let of_json j =
    { scaling_policies =
        ScalingPolicies.of_json (Util.of_option_exn (Json.lookup j "scaling_policies"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.health_check_grace_period (fun f ->
               Query.Pair ("HealthCheckGracePeriod", Integer.to_query f))
         ; Util.option_map v.health_check_type (fun f ->
               Query.Pair ("HealthCheckType", String.to_query f))
         ; Some
             (Query.Pair
                ( "AvailabilityZones.member"
                , AvailabilityZones.to_query v.availability_zones ))
         ; Util.option_map v.default_cooldown (fun f ->
               Query.Pair ("DefaultCooldown", Integer.to_query f))
         ; Util.option_map v.desired_capacity (fun f ->
               Query.Pair ("DesiredCapacity", Integer.to_query f))
         ; Util.option_map v.max_size (fun f ->
               Query.Pair ("MaxSize", Integer.to_query f))
    ...
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.health_check_grace_period (fun f ->
               "health_check_grace_period", Integer.to_json f)
         ; Util.option_map v.health_check_type (fun f ->
               "health_check_type", String.to_json f)
         ; Some ("availability_zones", AvailabilityZones.to_json v.availability_zones)
         ; Util.option_map v.default_cooldown (fun f ->
               "default_cooldown", Integer.to_json f)
         ; Util.option_map v.desired_capacity (fun f ->
               "desired_capacity", Integer.to_json f)
         ; Util.option_map v.max_size (fun f -> "max_size", Integer.to_json f)
         ; Util.option_map v.min_size (fun f -> "min_size", Integer.to_json f)
...
module CreateAutoScalingGroupType = struct
  ...
  let parse xml =
    Some
      ...
      ; launch_configuration_name =
          Util.option_bind (Xml.member "LaunchConfigurationName" xml) String.parse
      ; instance_id = Util.option_bind (Xml.member "InstanceId" xml) String.parse
      ; min_size =
          Xml.required
            "MinSize"
            (Util.option_bind (Xml.member "MinSize" xml) Integer.parse)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("max_size", Integer.to_json v.max_size)
         ; Some ("min_size", Integer.to_json v.min_size)
         ; Util.option_map v.instance_id (fun f -> "instance_id", String.to_json f)
         ; Util.option_map v.launch_configuration_name (fun f ->
               "launch_configuration_name", String.to_json f)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ])
  ...
  let of_json j =
    ...
    ; launch_configuration_name =
        Util.option_map (Json.lookup j "launch_configuration_name") String.of_json
    ; instance_id = Util.option_map (Json.lookup j "instance_id") String.of_json
    ; min_size = Integer.of_json (Util.of_option_exn (Json.lookup j "min_size"))
    ; max_size = Integer.of_json (Util.of_option_exn (Json.lookup j "max_size"))
    ; desired_capacity =
        Util.option_map (Json.lookup j "desired_capacity") Integer.of_json
...
module DescribeScalingActivitiesType = struct
  ...
  let parse xml =
    Some
      { activity_ids =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ActivityIds" xml) ActivityIds.parse)
      ; auto_scaling_group_name =
          Util.option_bind (Xml.member "AutoScalingGroupName" xml) String.parse
      ; max_records = Util.option_bind (Xml.member "MaxRecords" xml) Integer.parse
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.auto_scaling_group_name (fun f ->
               Query.Pair ("AutoScalingGroupName", String.to_query f))
         ; Some (Query.Pair ("ActivityIds.member", ActivityIds.to_query v.activity_ids))
         ])
  ...
  let of_json j =
    { activity_ids =
        ActivityIds.of_json (Util.of_option_exn (Json.lookup j "activity_ids"))
    ; auto_scaling_group_name =
        Util.option_map (Json.lookup j "auto_scaling_group_name") String.of_json
    ; max_records = Util.option_map (Json.lookup j "max_records") Integer.of_json
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
...
module DeleteScheduledActionType = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("ScheduledActionName", String.to_query v.scheduled_action_name))
         ; Util.option_map v.auto_scaling_group_name (fun f ->
               Query.Pair ("AutoScalingGroupName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("scheduled_action_name", String.to_json v.scheduled_action_name)
         ; Util.option_map v.auto_scaling_group_name (fun f ->
               "auto_scaling_group_name", String.to_json f)
         ])
  ...
  let of_json j =
    { auto_scaling_group_name =
        Util.option_map (Json.lookup j "auto_scaling_group_name") String.of_json
    ; scheduled_action_name =
        String.of_json (Util.of_option_exn (Json.lookup j "scheduled_action_name"))
    }
end
...
module DescribeLifecycleHooksAnswer = struct
  ...
  let parse xml =
    Some
      { lifecycle_hooks =
          Util.of_option
            []
            (Util.option_bind (Xml.member "LifecycleHooks" xml) LifecycleHooks.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("lifecycle_hooks", LifecycleHooks.to_json v.lifecycle_hooks) ])

  let of_json j =
    { lifecycle_hooks =
        LifecycleHooks.of_json (Util.of_option_exn (Json.lookup j "lifecycle_hooks"))
    }
end
...
module SetDesiredCapacityType = struct
    ...
    Some
      ...
      ; desired_capacity =
          Xml.required
            "DesiredCapacity"
            (Util.option_bind (Xml.member "DesiredCapacity" xml) Integer.parse)
      ; honor_cooldown = Util.option_bind (Xml.member "HonorCooldown" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.honor_cooldown (fun f ->
               Query.Pair ("HonorCooldown", Boolean.to_query f))
         ; Some (Query.Pair ("DesiredCapacity", Integer.to_query v.desired_capacity))
         ; Some
             (Query.Pair
                ("AutoScalingGroupName", String.to_query v.auto_scaling_group_name))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.honor_cooldown (fun f -> "honor_cooldown", Boolean.to_json f)
         ; Some ("desired_capacity", Integer.to_json v.desired_capacity)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ])
  ...
  let of_json j =
    ...
    ; desired_capacity =
        Integer.of_json (Util.of_option_exn (Json.lookup j "desired_capacity"))
    ; honor_cooldown = Util.option_map (Json.lookup j "honor_cooldown") Boolean.of_json
    }
end
  ...
  let parse xml =
    Some
      { activities =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Activities" xml) Activities.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Activities.member", Activities.to_query v.activities)) ])

  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("activities", Activities.to_json v.activities) ])

  let of_json j =
    { activities = Activities.of_json (Util.of_option_exn (Json.lookup j "activities")) }
end
    ...
    Some
      { launch_configuration_names =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "LaunchConfigurationNames" xml)
    ...
    Some
      { lifecycle_hook_types =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "LifecycleHookTypes" xml)
               AutoScalingNotificationTypes.parse)
      }
...
module CreateLaunchConfigurationType = struct
    ...
    Some
      { launch_configuration_name =
          Xml.required
            "LaunchConfigurationName"
            (Util.option_bind (Xml.member "LaunchConfigurationName" xml) String.parse)
      ; image_id = Util.option_bind (Xml.member "ImageId" xml) String.parse
      ; key_name = Util.option_bind (Xml.member "KeyName" xml) String.parse
      ; security_groups =
          Util.of_option
            []
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("security_groups", SecurityGroups.to_json v.security_groups)
         ; Util.option_map v.key_name (fun f -> "key_name", String.to_json f)
         ; Util.option_map v.image_id (fun f -> "image_id", String.to_json f)
         ; Some ("launch_configuration_name", String.to_json v.launch_configuration_name)
         ])
  ...
  let of_json j =
    { launch_configuration_name =
        String.of_json (Util.of_option_exn (Json.lookup j "launch_configuration_name"))
    ; image_id = Util.option_map (Json.lookup j "image_id") String.of_json
    ; key_name = Util.option_map (Json.lookup j "key_name") String.of_json
    ; security_groups =
        SecurityGroups.of_json (Util.of_option_exn (Json.lookup j "security_groups"))
    ; classic_link_v_p_c_id =
...
module DescribeAccountLimitsAnswer = struct
  ...
  let parse xml =
    Some
      { max_number_of_auto_scaling_groups =
          Util.option_bind (Xml.member "MaxNumberOfAutoScalingGroups" xml) Integer.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.max_number_of_launch_configurations (fun f ->
               Query.Pair ("MaxNumberOfLaunchConfigurations", Integer.to_query f))
         ; Util.option_map v.max_number_of_auto_scaling_groups (fun f ->
               Query.Pair ("MaxNumberOfAutoScalingGroups", Integer.to_query f))
         ])
...
module DeleteTagsType = struct
  ...
  let parse xml =
    Some
      { tags = Xml.required "Tags" (Util.option_bind (Xml.member "Tags" xml) Tags.parse) }

  let to_query v =
    Query.List
      (Util.list_filter_opt [ Some (Query.Pair ("Tags.member", Tags.to_query v.tags)) ])

  let to_json v = `Assoc (Util.list_filter_opt [ Some ("tags", Tags.to_json v.tags) ])

  let of_json j = { tags = Tags.of_json (Util.of_option_exn (Json.lookup j "tags")) }
end
    ...
    Some
      { termination_policy_types =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "TerminationPolicyTypes" xml)
               TerminationPolicies.parse)
      }
...
module DescribeAdjustmentTypesAnswer = struct
  ...
  let parse xml =
    Some
      { adjustment_types =
          Util.of_option
            []
            (Util.option_bind (Xml.member "AdjustmentTypes" xml) AdjustmentTypes.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("adjustment_types", AdjustmentTypes.to_json v.adjustment_types) ])

  let of_json j =
    { adjustment_types =
        AdjustmentTypes.of_json (Util.of_option_exn (Json.lookup j "adjustment_types"))
    }
end
...
module AutoScalingGroupsType = struct
    ...
    Some
      { auto_scaling_groups =
          Xml.required
            "AutoScalingGroups"
            (Util.option_bind
               (Xml.member "AutoScalingGroups" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("auto_scaling_groups", AutoScalingGroups.to_json v.auto_scaling_groups)
         ])
...
module ExecutePolicyType = struct
  ...
  let parse xml =
    Some
      ...
      ; honor_cooldown = Util.option_bind (Xml.member "HonorCooldown" xml) Boolean.parse
      ; metric_value = Util.option_bind (Xml.member "MetricValue" xml) Double.parse
      ; breach_threshold =
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.breach_threshold (fun f ->
               Query.Pair ("BreachThreshold", Double.to_query f))
         ; Util.option_map v.metric_value (fun f ->
               Query.Pair ("MetricValue", Double.to_query f))
         ; Util.option_map v.honor_cooldown (fun f ->
               Query.Pair ("HonorCooldown", Boolean.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.breach_threshold (fun f ->
               "breach_threshold", Double.to_json f)
         ; Util.option_map v.metric_value (fun f -> "metric_value", Double.to_json f)
         ; Util.option_map v.honor_cooldown (fun f -> "honor_cooldown", Boolean.to_json f)
  ...
  let of_json j =
    ...
    ; honor_cooldown = Util.option_map (Json.lookup j "honor_cooldown") Boolean.of_json
    ; metric_value = Util.option_map (Json.lookup j "metric_value") Double.of_json
    ; breach_threshold = Util.option_map (Json.lookup j "breach_threshold") Double.of_json
    }
end
...
module SetInstanceHealthQuery = struct
  ...
  let parse xml =
    Some
      ...
      ; should_respect_grace_period =
          Util.option_bind (Xml.member "ShouldRespectGracePeriod" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.should_respect_grace_period (fun f ->
               Query.Pair ("ShouldRespectGracePeriod", Boolean.to_query f))
         ; Some (Query.Pair ("HealthStatus", String.to_query v.health_status))
         ; Some (Query.Pair ("InstanceId", String.to_query v.instance_id))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.should_respect_grace_period (fun f ->
               "should_respect_grace_period", Boolean.to_json f)
         ; Some ("health_status", String.to_json v.health_status)
         ; Some ("instance_id", String.to_json v.instance_id)
         ])
  ...
  let of_json j =
    ...
    ; health_status = String.of_json (Util.of_option_exn (Json.lookup j "health_status"))
    ; should_respect_grace_period =
        Util.option_map (Json.lookup j "should_respect_grace_period") Boolean.of_json
    }
end
...
module PutScalingPolicyType = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.min_adjustment_step (fun f ->
               Query.Pair ("MinAdjustmentStep", Integer.to_query f))
         ; Some (Query.Pair ("AdjustmentType", String.to_query v.adjustment_type))
         ; Util.option_map v.policy_type (fun f ->
               Query.Pair ("PolicyType", String.to_query f))
         ; Some (Query.Pair ("PolicyName", String.to_query v.policy_name))
         ; Some
  ...
  let of_json j =
    ...
    ; policy_type = Util.option_map (Json.lookup j "policy_type") String.of_json
    ; adjustment_type =
        String.of_json (Util.of_option_exn (Json.lookup j "adjustment_type"))
    ; min_adjustment_step =
        Util.option_map (Json.lookup j "min_adjustment_step") Integer.of_json
    ; min_adjustment_magnitude =
        Util.option_map (Json.lookup j "min_adjustment_magnitude") Integer.of_json
...
module EnableMetricsCollectionQuery = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Granularity", String.to_query v.granularity))
  ...
  let of_json j =
    ...
    ; granularity = String.of_json (Util.of_option_exn (Json.lookup j "granularity"))
    }
end
...
module DescribePoliciesType = struct
  ...
  let parse xml =
    Some
      ...
      ; policy_names =
          Util.of_option
            []
            (Util.option_bind (Xml.member "PolicyNames" xml) PolicyNames.parse)
      ; policy_types =
          Util.of_option
            []
            (Util.option_bind (Xml.member "PolicyTypes" xml) PolicyTypes.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      ; max_records = Util.option_bind (Xml.member "MaxRecords" xml) Integer.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some (Query.Pair ("PolicyTypes.member", PolicyTypes.to_query v.policy_types))
         ; Some (Query.Pair ("PolicyNames.member", PolicyNames.to_query v.policy_names))
         ; Util.option_map v.auto_scaling_group_name (fun f ->
               Query.Pair ("AutoScalingGroupName", String.to_query f))
         ])
  ...
  let of_json j =
    { auto_scaling_group_name =
        Util.option_map (Json.lookup j "auto_scaling_group_name") String.of_json
    ; policy_names =
        PolicyNames.of_json (Util.of_option_exn (Json.lookup j "policy_names"))
    ; policy_types =
        PolicyTypes.of_json (Util.of_option_exn (Json.lookup j "policy_types"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    ; max_records = Util.option_map (Json.lookup j "max_records") Integer.of_json
    }
end
  ...
  let of_json j =
    { notification_configurations =
        NotificationConfigurations.of_json
          (Util.of_option_exn (Json.lookup j "notification_configurations"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
    ...
    Some
      { auto_scaling_group_names =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "AutoScalingGroupNames" xml)
    ...
    Some
      { launch_configurations =
          Xml.required
            ...
            (Util.option_bind
               (Xml.member "LaunchConfigurations" xml)
  ...
  let of_json j =
    { scheduled_update_group_actions =
        ScheduledUpdateGroupActions.of_json
          (Util.of_option_exn (Json.lookup j "scheduled_update_group_actions"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module DescribeAutoScalingNotificationTypesAnswer = struct
  ...
  let of_json j =
    { auto_scaling_notification_types =
        AutoScalingNotificationTypes.of_json
          (Util.of_option_exn (Json.lookup j "auto_scaling_notification_types"))
    }
end
...
module DescribeLoadBalancersResponse = struct
  ...
  let parse xml =
    Some
      { load_balancers =
          Util.of_option
            []
            (Util.option_bind (Xml.member "LoadBalancers" xml) LoadBalancerStates.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("load_balancers", LoadBalancerStates.to_json v.load_balancers)
         ])

  let of_json j =
    { load_balancers =
        LoadBalancerStates.of_json (Util.of_option_exn (Json.lookup j "load_balancers"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module PolicyARNType = struct
  ...
  let parse xml =
    Some { policy_a_r_n = Util.option_bind (Xml.member "PolicyARN" xml) String.parse }
...
module DescribeMetricCollectionTypesAnswer = struct
  ...
  let parse xml =
    Some
      { metrics =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Metrics" xml) MetricCollectionTypes.parse)
      ; granularities =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "Granularities" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("Metrics.member", MetricCollectionTypes.to_query v.metrics))
         ])
  ...
  let of_json j =
    { metrics =
        MetricCollectionTypes.of_json (Util.of_option_exn (Json.lookup j "metrics"))
    ; granularities =
...
module DescribeLifecycleHooksType = struct
    ...
    Some
      ...
      ; lifecycle_hook_names =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "LifecycleHookNames" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("lifecycle_hook_names", LifecycleHookNames.to_json v.lifecycle_hook_names)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ])
...
module ProcessesType = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Processes.member", Processes.to_query v.processes)) ])

  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("processes", Processes.to_json v.processes) ])

  let of_json j =
    { processes = Processes.of_json (Util.of_option_exn (Json.lookup j "processes")) }
end
...
module CompleteLifecycleActionType = struct
    ...
    Some
      ...
      ; lifecycle_action_result =
          Xml.required
            ...
            (Util.option_bind (Xml.member "LifecycleActionResult" xml) String.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("lifecycle_action_result", String.to_json v.lifecycle_action_result)
         ; Some ("lifecycle_action_token", String.to_json v.lifecycle_action_token)
         ; Some ("auto_scaling_group_name", String.to_json v.auto_scaling_group_name)
         ; Some ("lifecycle_hook_name", String.to_json v.lifecycle_hook_name)
         ])
  ...
  let of_json j =
    ...
    ; lifecycle_action_token =
        String.of_json (Util.of_option_exn (Json.lookup j "lifecycle_action_token"))
    ; lifecycle_action_result =
        String.of_json (Util.of_option_exn (Json.lookup j "lifecycle_action_result"))
    }
end
    ...
    Some
      ...
      ; scheduled_action_names =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ScheduledActionNames" xml)
