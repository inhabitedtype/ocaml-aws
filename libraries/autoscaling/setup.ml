...
(* OASIS_START *)
(* DO NOT EDIT (digest: f1cf4ba2b864ef285b4f00ac066f6e97) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "aws_autoscaling";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "aws_autoscaling Docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "2\140\157\2479o\214\243\189\130\204\188I+3\000";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
