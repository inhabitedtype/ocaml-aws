...
functor
  ...
  struct
    ...
    let create_document config ~name () =
      Runtime.(
        un_m
          (run_request
    ...
    let delete_document config ~name () =
      Runtime.(
        un_m
          (run_request
             ~region:config.region
    ...
    let list_test config _ =
      let list_request = list_documents config () in
    ...
    let suite config = "Test SSM" >::: [ "SSM list test" >:: list_test config ]
