...
module AssociationStatus = struct
  ...
  let parse xml =
    Some
      { date =
          Xml.required "Date" (Util.option_bind (Xml.member "Date" xml) DateTime.parse)
      ; name =
          Xml.required
            "Name"
            (Util.option_bind (Xml.member "Name" xml) AssociationStatusName.parse)
      ; message =
          Xml.required
            "Message"
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("Name", AssociationStatusName.to_query v.name))
  ...
  let of_json j =
    ...
    ; name = AssociationStatusName.of_json (Util.of_option_exn (Json.lookup j "name"))
...
module AssociationFilter = struct
  ...
  let parse xml =
    Some
      { key =
          Xml.required
            "key"
            (Util.option_bind (Xml.member "key" xml) AssociationFilterKey.parse)
      ; value =
  ...
  let of_json j =
    { key = AssociationFilterKey.of_json (Util.of_option_exn (Json.lookup j "key"))
...
module DocumentFilter = struct
  ...
  let parse xml =
    Some
      { key =
          Xml.required
            "key"
            (Util.option_bind (Xml.member "key" xml) DocumentFilterKey.parse)
      ; value =
          Xml.required "value" (Util.option_bind (Xml.member "value" xml) String.parse)
      }
  ...
  let of_json j =
    { key = DocumentFilterKey.of_json (Util.of_option_exn (Json.lookup j "key"))
    ; value = String.of_json (Util.of_option_exn (Json.lookup j "value"))
    }
end
...
module AssociationDescription = struct
  ...
  let parse xml =
    Some
      ...
      ; status = Util.option_bind (Xml.member "Status" xml) AssociationStatus.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.status (fun f -> "status", AssociationStatus.to_json f)
  ...
  let of_json j =
    ...
    ; status = Util.option_map (Json.lookup j "status") AssociationStatus.of_json
    }
end
...
module FailedCreateAssociation = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.fault (fun f -> Query.Pair ("Fault", Fault.to_query f))
         ; Util.option_map v.message (fun f -> Query.Pair ("Message", String.to_query f))
         ; Util.option_map v.entry (fun f ->
               Query.Pair ("Entry", CreateAssociationBatchRequestEntry.to_query f))
         ])
  ...
  let of_json j =
    { entry =
        Util.option_map (Json.lookup j "entry") CreateAssociationBatchRequestEntry.of_json
...
module AssociationFilterList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map AssociationFilter.parse (Xml.members "AssociationFilter" xml))
...
module AssociationList = struct
  ...
  let parse xml =
    Util.option_all (List.map Association.parse (Xml.members "Association" xml))
...
module DocumentIdentifierList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map DocumentIdentifier.parse (Xml.members "DocumentIdentifier" xml))
...
module DocumentFilterList = struct
  ...
  let parse xml =
    Util.option_all (List.map DocumentFilter.parse (Xml.members "DocumentFilter" xml))
...
module DocumentDescription = struct
  ...
  let parse xml =
    Some
      ...
      ; status = Util.option_bind (Xml.member "Status" xml) DocumentStatus.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.status (fun f ->
               Query.Pair ("Status", DocumentStatus.to_query f))
         ; Util.option_map v.created_date (fun f ->
               Query.Pair ("CreatedDate", DateTime.to_query f))
         ; Util.option_map v.name (fun f -> Query.Pair ("Name", String.to_query f))
         ; Util.option_map v.sha1 (fun f -> Query.Pair ("Sha1", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.status (fun f -> "status", DocumentStatus.to_json f)
  ...
  let of_json j =
    ...
    ; status = Util.option_map (Json.lookup j "status") DocumentStatus.of_json
    }
end
...
module AssociationDescriptionList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map AssociationDescription.parse (Xml.members "AssociationDescription" xml))
...
module CreateAssociationBatchRequestEntries = struct
  ...
  let parse xml =
    Util.option_all
      (List.map CreateAssociationBatchRequestEntry.parse (Xml.members "entries" xml))

  let to_query v = Query.to_query_list CreateAssociationBatchRequestEntry.to_query v
...
module CreateDocumentRequest = struct
  ...
  let of_json j =
    { content = String.of_json (Util.of_option_exn (Json.lookup j "content"))
    ...
    Some
      { association_filter_list =
          Xml.required
            ...
            (Util.option_bind
               (Xml.member "AssociationFilterList" xml)
...
module UpdateAssociationStatusResult = struct
  ...
  let parse xml =
    Some
      { association_description =
          Util.option_bind
            (Xml.member "AssociationDescription" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.association_description (fun f ->
               Query.Pair ("AssociationDescription", AssociationDescription.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.association_description (fun f ->
               "association_description", AssociationDescription.to_json f)
         ])

  let of_json j =
    { association_description =
        Util.option_map
          (Json.lookup j "association_description")
...
module ListAssociationsResult = struct
  ...
  let parse xml =
    Some
      { associations =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Associations" xml) AssociationList.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
    ...
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some
             (Query.Pair ("Associations.member", AssociationList.to_query v.associations))
         ])
  ...
  let of_json j =
    { associations =
        AssociationList.of_json (Util.of_option_exn (Json.lookup j "associations"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
    ...
    Some
      { document_identifiers =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "DocumentIdentifiers" xml)
    ...
    Some
      { document_filter_list =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "DocumentFilterList" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Util.option_map v.max_results (fun f -> "max_results", Integer.to_json f)
         ; Some ("document_filter_list", DocumentFilterList.to_json v.document_filter_list)
         ])
...
module DescribeDocumentResult = struct
  ...
  let parse xml =
    Some
      { document = Util.option_bind (Xml.member "Document" xml) DocumentDescription.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.document (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.document (fun f -> "document", DocumentDescription.to_json f)
         ])

  let of_json j =
    { document = Util.option_map (Json.lookup j "document") DocumentDescription.of_json }
end
...
module UpdateAssociationStatusRequest = struct
    ...
    Some
      ...
      ; association_status =
          Xml.required
            "AssociationStatus"
            (Util.option_bind
               (Xml.member "AssociationStatus" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("association_status", AssociationStatus.to_json v.association_status)
         ; Some ("instance_id", String.to_json v.instance_id)
         ; Some ("name", String.to_json v.name)
         ])
...
module GetDocumentResult = struct
  ...
  let parse xml =
    Some
      { name = Util.option_bind (Xml.member "Name" xml) String.parse
      ; content = Util.option_bind (Xml.member "Content" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.content (fun f -> Query.Pair ("Content", String.to_query f))
         ; Util.option_map v.name (fun f -> Query.Pair ("Name", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.content (fun f -> "content", String.to_json f)
         ; Util.option_map v.name (fun f -> "name", String.to_json f)
         ])
...
module CreateAssociationBatchResult = struct
    ...
    Some
      { successful =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "Successful" xml)
               AssociationDescriptionList.parse)
      ; failed =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Failed" xml) FailedCreateAssociationList.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("Failed.member", FailedCreateAssociationList.to_query v.failed))
         ; Some
             (Query.Pair
  ...
  let of_json j =
    ...
    ; failed =
        FailedCreateAssociationList.of_json (Util.of_option_exn (Json.lookup j "failed"))
    }
end
...
module CreateDocumentResult = struct
  ...
  let parse xml =
    Some
      { document_description =
          Util.option_bind
            (Xml.member "DocumentDescription" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.document_description (fun f ->
               Query.Pair ("DocumentDescription", DocumentDescription.to_query f))
         ])
  ...
  let of_json j =
    { document_description =
        Util.option_map (Json.lookup j "document_description") DocumentDescription.of_json
    }
end
