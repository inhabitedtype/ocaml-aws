...
(* OASIS_START *)
(* DO NOT EDIT (digest: bb6e65a30ed9d4540c7a3a5858528624) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "aws_cloudtrail";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\127O\164\0261>\243\219\011\233\172\031$\252y\150";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
