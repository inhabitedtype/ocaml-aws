...
module DataResource = struct
  ...
  let parse xml =
    Some
      ...
      ; values =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Values" xml) DataResourceValues.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Values.member", DataResourceValues.to_query v.values))
  ...
  let of_json j =
    ...
    ; values = DataResourceValues.of_json (Util.of_option_exn (Json.lookup j "values"))
    }
end
...
module Resource = struct
  ...
  let parse xml =
    Some
      ...
      ; resource_name = Util.option_bind (Xml.member "ResourceName" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.resource_name (fun f ->
               Query.Pair ("ResourceName", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.resource_name (fun f -> "resource_name", String.to_json f)
  ...
  let of_json j =
    ...
    ; resource_name = Util.option_map (Json.lookup j "resource_name") String.of_json
    }
end
...
module DataResources = struct
  ...
  let parse xml = Util.option_all (List.map DataResource.parse (Xml.members "member" xml))
...
module ResourceList = struct
  ...
  let parse xml = Util.option_all (List.map Resource.parse (Xml.members "member" xml))
...
module InsightSelector = struct
  ...
  let parse xml =
    Some
      { insight_type = Util.option_bind (Xml.member "InsightType" xml) InsightType.parse }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.insight_type (fun f ->
               Query.Pair ("InsightType", InsightType.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.insight_type (fun f -> "insight_type", InsightType.to_json f)
         ])

  let of_json j =
    { insight_type = Util.option_map (Json.lookup j "insight_type") InsightType.of_json }
end
...
module ResourceTag = struct
  ...
  let parse xml =
    Some
      ...
      ; tags_list =
          Util.of_option [] (Util.option_bind (Xml.member "TagsList" xml) TagsList.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("TagsList.member", TagsList.to_query v.tags_list))
  ...
  let of_json j =
    ...
    ; tags_list = TagsList.of_json (Util.of_option_exn (Json.lookup j "tags_list"))
    }
end
...
module EventSelector = struct
  ...
  let parse xml =
    Some
      { read_write_type =
          Util.option_bind (Xml.member "ReadWriteType" xml) ReadWriteType.parse
      ; include_management_events =
          Util.option_bind (Xml.member "IncludeManagementEvents" xml) Boolean.parse
      ; data_resources =
          Util.of_option
            []
            (Util.option_bind (Xml.member "DataResources" xml) DataResources.parse)
      ; exclude_management_event_sources =
          Util.of_option
            []
            (Util.option_bind
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some
             (Query.Pair ("DataResources.member", DataResources.to_query v.data_resources))
         ; Util.option_map v.include_management_events (fun f ->
               Query.Pair ("IncludeManagementEvents", Boolean.to_query f))
         ; Util.option_map v.read_write_type (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.include_management_events (fun f ->
               "include_management_events", Boolean.to_json f)
         ; Util.option_map v.read_write_type (fun f ->
               "read_write_type", ReadWriteType.to_json f)
         ])

  let of_json j =
    { read_write_type =
        Util.option_map (Json.lookup j "read_write_type") ReadWriteType.of_json
    ; include_management_events =
        Util.option_map (Json.lookup j "include_management_events") Boolean.of_json
    ; data_resources =
        DataResources.of_json (Util.of_option_exn (Json.lookup j "data_resources"))
    ; exclude_management_event_sources =
        ExcludeManagementEventSources.of_json
          (Util.of_option_exn (Json.lookup j "exclude_management_event_sources"))
    }
end
...
module LookupAttribute = struct
  ...
  let parse xml =
    Some
      { attribute_key =
          Xml.required
            "AttributeKey"
            (Util.option_bind (Xml.member "AttributeKey" xml) LookupAttributeKey.parse)
      ; attribute_value =
          Xml.required
            "AttributeValue"
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("AttributeValue", String.to_query v.attribute_value))
         ; Some (Query.Pair ("AttributeKey", LookupAttributeKey.to_query v.attribute_key))
         ])
  ...
  let of_json j =
    { attribute_key =
        LookupAttributeKey.of_json (Util.of_option_exn (Json.lookup j "attribute_key"))
    ; attribute_value =
        String.of_json (Util.of_option_exn (Json.lookup j "attribute_value"))
    }
end
...
module TrailInfo = struct
  ...
  let parse xml =
    Some
      { trail_a_r_n = Util.option_bind (Xml.member "TrailARN" xml) String.parse
      ; name = Util.option_bind (Xml.member "Name" xml) String.parse
      ; home_region = Util.option_bind (Xml.member "HomeRegion" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.home_region (fun f ->
               Query.Pair ("HomeRegion", String.to_query f))
         ; Util.option_map v.name (fun f -> Query.Pair ("Name", String.to_query f))
         ; Util.option_map v.trail_a_r_n (fun f ->
               Query.Pair ("TrailARN", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.home_region (fun f -> "home_region", String.to_json f)
         ; Util.option_map v.name (fun f -> "name", String.to_json f)
         ; Util.option_map v.trail_a_r_n (fun f -> "trail_a_r_n", String.to_json f)
         ])

  let of_json j =
    { trail_a_r_n = Util.option_map (Json.lookup j "trail_a_r_n") String.of_json
    ; name = Util.option_map (Json.lookup j "name") String.of_json
    ; home_region = Util.option_map (Json.lookup j "home_region") String.of_json
    }
end
...
module Event = struct
  ...
  let parse xml =
    Some
      { event_id = Util.option_bind (Xml.member "EventId" xml) String.parse
      ; event_name = Util.option_bind (Xml.member "EventName" xml) String.parse
      ; read_only = Util.option_bind (Xml.member "ReadOnly" xml) String.parse
      ; access_key_id = Util.option_bind (Xml.member "AccessKeyId" xml) String.parse
      ; event_time = Util.option_bind (Xml.member "EventTime" xml) DateTime.parse
      ; event_source = Util.option_bind (Xml.member "EventSource" xml) String.parse
      ; username = Util.option_bind (Xml.member "Username" xml) String.parse
      ; resources =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Resources" xml) ResourceList.parse)
      ; cloud_trail_event =
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.cloud_trail_event (fun f ->
               Query.Pair ("CloudTrailEvent", String.to_query f))
         ; Some (Query.Pair ("Resources.member", ResourceList.to_query v.resources))
         ; Util.option_map v.username (fun f ->
               Query.Pair ("Username", String.to_query f))
         ; Util.option_map v.event_source (fun f ->
               Query.Pair ("EventSource", String.to_query f))
         ; Util.option_map v.event_time (fun f ->
               Query.Pair ("EventTime", DateTime.to_query f))
         ; Util.option_map v.access_key_id (fun f ->
               Query.Pair ("AccessKeyId", String.to_query f))
         ; Util.option_map v.read_only (fun f ->
               Query.Pair ("ReadOnly", String.to_query f))
         ; Util.option_map v.event_name (fun f ->
               Query.Pair ("EventName", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.cloud_trail_event (fun f ->
               "cloud_trail_event", String.to_json f)
         ; Some ("resources", ResourceList.to_json v.resources)
         ; Util.option_map v.username (fun f -> "username", String.to_json f)
         ; Util.option_map v.event_source (fun f -> "event_source", String.to_json f)
         ; Util.option_map v.event_time (fun f -> "event_time", DateTime.to_json f)
         ; Util.option_map v.access_key_id (fun f -> "access_key_id", String.to_json f)
         ; Util.option_map v.read_only (fun f -> "read_only", String.to_json f)
         ; Util.option_map v.event_name (fun f -> "event_name", String.to_json f)
         ; Util.option_map v.event_id (fun f -> "event_id", String.to_json f)
         ])

  let of_json j =
    { event_id = Util.option_map (Json.lookup j "event_id") String.of_json
    ; event_name = Util.option_map (Json.lookup j "event_name") String.of_json
    ; read_only = Util.option_map (Json.lookup j "read_only") String.of_json
    ; access_key_id = Util.option_map (Json.lookup j "access_key_id") String.of_json
    ; event_time = Util.option_map (Json.lookup j "event_time") DateTime.of_json
    ; event_source = Util.option_map (Json.lookup j "event_source") String.of_json
    ; username = Util.option_map (Json.lookup j "username") String.of_json
    ; resources = ResourceList.of_json (Util.of_option_exn (Json.lookup j "resources"))
    ; cloud_trail_event =
...
module PublicKey = struct
  ...
  let parse xml =
    Some
      ...
      ; validity_start_time =
          Util.option_bind (Xml.member "ValidityStartTime" xml) DateTime.parse
      ; validity_end_time =
          Util.option_bind (Xml.member "ValidityEndTime" xml) DateTime.parse
      ; fingerprint = Util.option_bind (Xml.member "Fingerprint" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.fingerprint (fun f ->
               Query.Pair ("Fingerprint", String.to_query f))
         ; Util.option_map v.validity_end_time (fun f ->
               Query.Pair ("ValidityEndTime", DateTime.to_query f))
         ; Util.option_map v.validity_start_time (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.fingerprint (fun f -> "fingerprint", String.to_json f)
         ; Util.option_map v.validity_end_time (fun f ->
               "validity_end_time", DateTime.to_json f)
         ; Util.option_map v.validity_start_time (fun f ->
               "validity_start_time", DateTime.to_json f)
  ...
  let of_json j =
    ...
    ; validity_start_time =
        Util.option_map (Json.lookup j "validity_start_time") DateTime.of_json
    ; validity_end_time =
        Util.option_map (Json.lookup j "validity_end_time") DateTime.of_json
    ; fingerprint = Util.option_map (Json.lookup j "fingerprint") String.of_json
    }
end
...
module Trail = struct
  ...
  let parse xml =
    Some
      { name = Util.option_bind (Xml.member "Name" xml) String.parse
      ; s3_bucket_name = Util.option_bind (Xml.member "S3BucketName" xml) String.parse
      ; s3_key_prefix = Util.option_bind (Xml.member "S3KeyPrefix" xml) String.parse
      ; sns_topic_name = Util.option_bind (Xml.member "SnsTopicName" xml) String.parse
      ; sns_topic_a_r_n = Util.option_bind (Xml.member "SnsTopicARN" xml) String.parse
      ; include_global_service_events =
          Util.option_bind (Xml.member "IncludeGlobalServiceEvents" xml) Boolean.parse
      ; is_multi_region_trail =
          Util.option_bind (Xml.member "IsMultiRegionTrail" xml) Boolean.parse
      ; home_region = Util.option_bind (Xml.member "HomeRegion" xml) String.parse
      ; trail_a_r_n = Util.option_bind (Xml.member "TrailARN" xml) String.parse
      ; log_file_validation_enabled =
          Util.option_bind (Xml.member "LogFileValidationEnabled" xml) Boolean.parse
      ; cloud_watch_logs_log_group_arn =
          Util.option_bind (Xml.member "CloudWatchLogsLogGroupArn" xml) String.parse
      ; cloud_watch_logs_role_arn =
          Util.option_bind (Xml.member "CloudWatchLogsRoleArn" xml) String.parse
      ; kms_key_id = Util.option_bind (Xml.member "KmsKeyId" xml) String.parse
      ; has_custom_event_selectors =
          Util.option_bind (Xml.member "HasCustomEventSelectors" xml) Boolean.parse
      ; has_insight_selectors =
          Util.option_bind (Xml.member "HasInsightSelectors" xml) Boolean.parse
      ; is_organization_trail =
          Util.option_bind (Xml.member "IsOrganizationTrail" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.is_organization_trail (fun f ->
               Query.Pair ("IsOrganizationTrail", Boolean.to_query f))
         ; Util.option_map v.has_insight_selectors (fun f ->
               Query.Pair ("HasInsightSelectors", Boolean.to_query f))
         ; Util.option_map v.has_custom_event_selectors (fun f ->
         ...
         ; Util.option_map v.cloud_watch_logs_role_arn (fun f ->
               Query.Pair ("CloudWatchLogsRoleArn", String.to_query f))
         ; Util.option_map v.cloud_watch_logs_log_group_arn (fun f ->
               Query.Pair ("CloudWatchLogsLogGroupArn", String.to_query f))
         ; Util.option_map v.log_file_validation_enabled (fun f ->
               Query.Pair ("LogFileValidationEnabled", Boolean.to_query f))
         ; Util.option_map v.trail_a_r_n (fun f ->
               Query.Pair ("TrailARN", String.to_query f))
         ; Util.option_map v.home_region (fun f ->
               Query.Pair ("HomeRegion", String.to_query f))
         ; Util.option_map v.is_multi_region_trail (fun f ->
               Query.Pair ("IsMultiRegionTrail", Boolean.to_query f))
         ; Util.option_map v.include_global_service_events (fun f ->
               Query.Pair ("IncludeGlobalServiceEvents", Boolean.to_query f))
         ; Util.option_map v.sns_topic_a_r_n (fun f ->
               Query.Pair ("SnsTopicARN", String.to_query f))
         ; Util.option_map v.sns_topic_name (fun f ->
               Query.Pair ("SnsTopicName", String.to_query f))
         ; Util.option_map v.s3_key_prefix (fun f ->
               Query.Pair ("S3KeyPrefix", String.to_query f))
         ; Util.option_map v.s3_bucket_name (fun f ->
               Query.Pair ("S3BucketName", String.to_query f))
         ; Util.option_map v.name (fun f -> Query.Pair ("Name", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.is_organization_trail (fun f ->
               "is_organization_trail", Boolean.to_json f)
         ; Util.option_map v.has_insight_selectors (fun f ->
               "has_insight_selectors", Boolean.to_json f)
         ; Util.option_map v.has_custom_event_selectors (fun f ->
               "has_custom_event_selectors", Boolean.to_json f)
         ; Util.option_map v.kms_key_id (fun f -> "kms_key_id", String.to_json f)
         ; Util.option_map v.cloud_watch_logs_role_arn (fun f ->
               "cloud_watch_logs_role_arn", String.to_json f)
         ; Util.option_map v.cloud_watch_logs_log_group_arn (fun f ->
               "cloud_watch_logs_log_group_arn", String.to_json f)
         ; Util.option_map v.log_file_validation_enabled (fun f ->
               "log_file_validation_enabled", Boolean.to_json f)
         ; Util.option_map v.trail_a_r_n (fun f -> "trail_a_r_n", String.to_json f)
         ; Util.option_map v.home_region (fun f -> "home_region", String.to_json f)
         ; Util.option_map v.is_multi_region_trail (fun f ->
               "is_multi_region_trail", Boolean.to_json f)
         ; Util.option_map v.include_global_service_events (fun f ->
               "include_global_service_events", Boolean.to_json f)
         ; Util.option_map v.sns_topic_a_r_n (fun f ->
               "sns_topic_a_r_n", String.to_json f)
         ; Util.option_map v.sns_topic_name (fun f -> "sns_topic_name", String.to_json f)
         ; Util.option_map v.s3_key_prefix (fun f -> "s3_key_prefix", String.to_json f)
         ; Util.option_map v.s3_bucket_name (fun f -> "s3_bucket_name", String.to_json f)
         ; Util.option_map v.name (fun f -> "name", String.to_json f)
         ])

  let of_json j =
    { name = Util.option_map (Json.lookup j "name") String.of_json
    ; s3_bucket_name = Util.option_map (Json.lookup j "s3_bucket_name") String.of_json
    ; s3_key_prefix = Util.option_map (Json.lookup j "s3_key_prefix") String.of_json
    ; sns_topic_name = Util.option_map (Json.lookup j "sns_topic_name") String.of_json
    ; sns_topic_a_r_n = Util.option_map (Json.lookup j "sns_topic_a_r_n") String.of_json
    ; include_global_service_events =
        Util.option_map (Json.lookup j "include_global_service_events") Boolean.of_json
    ; is_multi_region_trail =
        Util.option_map (Json.lookup j "is_multi_region_trail") Boolean.of_json
    ; home_region = Util.option_map (Json.lookup j "home_region") String.of_json
    ; trail_a_r_n = Util.option_map (Json.lookup j "trail_a_r_n") String.of_json
    ; log_file_validation_enabled =
        Util.option_map (Json.lookup j "log_file_validation_enabled") Boolean.of_json
    ; cloud_watch_logs_log_group_arn =
        Util.option_map (Json.lookup j "cloud_watch_logs_log_group_arn") String.of_json
    ; cloud_watch_logs_role_arn =
        Util.option_map (Json.lookup j "cloud_watch_logs_role_arn") String.of_json
    ; kms_key_id = Util.option_map (Json.lookup j "kms_key_id") String.of_json
    ; has_custom_event_selectors =
        Util.option_map (Json.lookup j "has_custom_event_selectors") Boolean.of_json
    ; has_insight_selectors =
        Util.option_map (Json.lookup j "has_insight_selectors") Boolean.of_json
    ; is_organization_trail =
        Util.option_map (Json.lookup j "is_organization_trail") Boolean.of_json
    }
end
...
module InsightSelectors = struct
  ...
  let parse xml =
    Util.option_all (List.map InsightSelector.parse (Xml.members "member" xml))
...
module ResourceTagList = struct
  ...
  let parse xml = Util.option_all (List.map ResourceTag.parse (Xml.members "member" xml))
...
module EventSelectors = struct
  ...
  let parse xml =
    Util.option_all (List.map EventSelector.parse (Xml.members "member" xml))
...
module LookupAttributesList = struct
  ...
  let parse xml =
    Util.option_all (List.map LookupAttribute.parse (Xml.members "member" xml))
...
module Trails = struct
  ...
  let parse xml = Util.option_all (List.map TrailInfo.parse (Xml.members "member" xml))
...
module PublicKeyList = struct
  ...
  let parse xml = Util.option_all (List.map PublicKey.parse (Xml.members "member" xml))
...
module TrailList = struct
  ...
  let parse xml = Util.option_all (List.map Trail.parse (Xml.members "member" xml))
...
module GetInsightSelectorsResponse = struct
  ...
  let parse xml =
    Some
      ...
      ; insight_selectors =
          Util.of_option
            []
            (Util.option_bind (Xml.member "InsightSelectors" xml) InsightSelectors.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("insight_selectors", InsightSelectors.to_json v.insight_selectors)
         ; Util.option_map v.trail_a_r_n (fun f -> "trail_a_r_n", String.to_json f)
         ])
  ...
  let of_json j =
    { trail_a_r_n = Util.option_map (Json.lookup j "trail_a_r_n") String.of_json
    ; insight_selectors =
        InsightSelectors.of_json (Util.of_option_exn (Json.lookup j "insight_selectors"))
    }
end
  ...
  let parse xml =
    Some
      { resource_id_list =
          Xml.required
            "ResourceIdList"
            (Util.option_bind (Xml.member "ResourceIdList" xml) ResourceIdList.parse)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("resource_id_list", ResourceIdList.to_json v.resource_id_list)
         ])

  let of_json j =
    { resource_id_list =
        ResourceIdList.of_json (Util.of_option_exn (Json.lookup j "resource_id_list"))
...
module ListTagsResponse = struct
  ...
  let parse xml =
    Some
      { resource_tag_list =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ResourceTagList" xml) ResourceTagList.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("resource_tag_list", ResourceTagList.to_json v.resource_tag_list)
         ])

  let of_json j =
    { resource_tag_list =
        ResourceTagList.of_json (Util.of_option_exn (Json.lookup j "resource_tag_list"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module PutEventSelectorsResponse = struct
  ...
  let parse xml =
    Some
      ...
      ; event_selectors =
          Util.of_option
            []
            (Util.option_bind (Xml.member "EventSelectors" xml) EventSelectors.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("event_selectors", EventSelectors.to_json v.event_selectors)
         ; Util.option_map v.trail_a_r_n (fun f -> "trail_a_r_n", String.to_json f)
         ])
  ...
  let of_json j =
    { trail_a_r_n = Util.option_map (Json.lookup j "trail_a_r_n") String.of_json
    ; event_selectors =
        EventSelectors.of_json (Util.of_option_exn (Json.lookup j "event_selectors"))
    }
end
...
module LookupEventsRequest = struct
    ...
    Some
      { lookup_attributes =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "LookupAttributes" xml)
      ...
      ; event_category =
          Util.option_bind (Xml.member "EventCategory" xml) EventCategory.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.event_category (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.event_category (fun f ->
               "event_category", EventCategory.to_json f)
         ...
         ; Some ("lookup_attributes", LookupAttributesList.to_json v.lookup_attributes)
         ])
  ...
  let of_json j =
    ...
    ; event_category =
        Util.option_map (Json.lookup j "event_category") EventCategory.of_json
...
module GetTrailStatusResponse = struct
  ...
  let parse xml =
    Some
      { is_logging = Util.option_bind (Xml.member "IsLogging" xml) Boolean.parse
      ; latest_delivery_error =
          Util.option_bind (Xml.member "LatestDeliveryError" xml) String.parse
      ; latest_notification_error =
          Util.option_bind (Xml.member "LatestNotificationError" xml) String.parse
      ; latest_delivery_time =
          Util.option_bind (Xml.member "LatestDeliveryTime" xml) DateTime.parse
      ; latest_notification_time =
          Util.option_bind (Xml.member "LatestNotificationTime" xml) DateTime.parse
      ; start_logging_time =
          Util.option_bind (Xml.member "StartLoggingTime" xml) DateTime.parse
      ; stop_logging_time =
          Util.option_bind (Xml.member "StopLoggingTime" xml) DateTime.parse
      ; latest_cloud_watch_logs_delivery_error =
          Util.option_bind
      ...
      ; latest_cloud_watch_logs_delivery_time =
          Util.option_bind
            ...
            DateTime.parse
      ; latest_digest_delivery_time =
          Util.option_bind (Xml.member "LatestDigestDeliveryTime" xml) DateTime.parse
      ; latest_digest_delivery_error =
          Util.option_bind (Xml.member "LatestDigestDeliveryError" xml) String.parse
      ; latest_delivery_attempt_time =
          Util.option_bind (Xml.member "LatestDeliveryAttemptTime" xml) String.parse
      ; latest_notification_attempt_time =
          Util.option_bind (Xml.member "LatestNotificationAttemptTime" xml) String.parse
      ; latest_notification_attempt_succeeded =
          Util.option_bind
            (Xml.member "LatestNotificationAttemptSucceeded" xml)
            String.parse
      ; latest_delivery_attempt_succeeded =
          Util.option_bind (Xml.member "LatestDeliveryAttemptSucceeded" xml) String.parse
      ; time_logging_started =
          Util.option_bind (Xml.member "TimeLoggingStarted" xml) String.parse
      ; time_logging_stopped =
          Util.option_bind (Xml.member "TimeLoggingStopped" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.time_logging_stopped (fun f ->
               Query.Pair ("TimeLoggingStopped", String.to_query f))
         ; Util.option_map v.time_logging_started (fun f ->
               Query.Pair ("TimeLoggingStarted", String.to_query f))
         ; Util.option_map v.latest_delivery_attempt_succeeded (fun f ->
               Query.Pair ("LatestDeliveryAttemptSucceeded", String.to_query f))
         ; Util.option_map v.latest_notification_attempt_succeeded (fun f ->
               Query.Pair ("LatestNotificationAttemptSucceeded", String.to_query f))
         ; Util.option_map v.latest_notification_attempt_time (fun f ->
               Query.Pair ("LatestNotificationAttemptTime", String.to_query f))
         ; Util.option_map v.latest_delivery_attempt_time (fun f ->
               Query.Pair ("LatestDeliveryAttemptTime", String.to_query f))
         ; Util.option_map v.latest_digest_delivery_error (fun f ->
               Query.Pair ("LatestDigestDeliveryError", String.to_query f))
         ; Util.option_map v.latest_digest_delivery_time (fun f ->
               Query.Pair ("LatestDigestDeliveryTime", DateTime.to_query f))
         ; Util.option_map v.latest_cloud_watch_logs_delivery_time (fun f ->
               Query.Pair ("LatestCloudWatchLogsDeliveryTime", DateTime.to_query f))
         ; Util.option_map v.latest_cloud_watch_logs_delivery_error (fun f ->
               Query.Pair ("LatestCloudWatchLogsDeliveryError", String.to_query f))
         ; Util.option_map v.stop_logging_time (fun f ->
               Query.Pair ("StopLoggingTime", DateTime.to_query f))
         ; Util.option_map v.start_logging_time (fun f ->
               Query.Pair ("StartLoggingTime", DateTime.to_query f))
         ; Util.option_map v.latest_notification_time (fun f ->
               Query.Pair ("LatestNotificationTime", DateTime.to_query f))
         ; Util.option_map v.latest_delivery_time (fun f ->
               Query.Pair ("LatestDeliveryTime", DateTime.to_query f))
         ; Util.option_map v.latest_notification_error (fun f ->
               Query.Pair ("LatestNotificationError", String.to_query f))
         ; Util.option_map v.latest_delivery_error (fun f ->
               Query.Pair ("LatestDeliveryError", String.to_query f))
         ; Util.option_map v.is_logging (fun f ->
               Query.Pair ("IsLogging", Boolean.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.time_logging_stopped (fun f ->
               "time_logging_stopped", String.to_json f)
         ; Util.option_map v.time_logging_started (fun f ->
               "time_logging_started", String.to_json f)
         ; Util.option_map v.latest_delivery_attempt_succeeded (fun f ->
         ...
         ; Util.option_map v.latest_delivery_attempt_time (fun f ->
               "latest_delivery_attempt_time", String.to_json f)
         ; Util.option_map v.latest_digest_delivery_error (fun f ->
               "latest_digest_delivery_error", String.to_json f)
         ; Util.option_map v.latest_digest_delivery_time (fun f ->
               "latest_digest_delivery_time", DateTime.to_json f)
         ; Util.option_map v.latest_cloud_watch_logs_delivery_time (fun f ->
               "latest_cloud_watch_logs_delivery_time", DateTime.to_json f)
         ; Util.option_map v.latest_cloud_watch_logs_delivery_error (fun f ->
               "latest_cloud_watch_logs_delivery_error", String.to_json f)
         ; Util.option_map v.stop_logging_time (fun f ->
               "stop_logging_time", DateTime.to_json f)
         ; Util.option_map v.start_logging_time (fun f ->
               "start_logging_time", DateTime.to_json f)
         ; Util.option_map v.latest_notification_time (fun f ->
               "latest_notification_time", DateTime.to_json f)
         ; Util.option_map v.latest_delivery_time (fun f ->
               "latest_delivery_time", DateTime.to_json f)
         ; Util.option_map v.latest_notification_error (fun f ->
               "latest_notification_error", String.to_json f)
         ; Util.option_map v.latest_delivery_error (fun f ->
               "latest_delivery_error", String.to_json f)
         ; Util.option_map v.is_logging (fun f -> "is_logging", Boolean.to_json f)
         ])

  let of_json j =
    { is_logging = Util.option_map (Json.lookup j "is_logging") Boolean.of_json
    ; latest_delivery_error =
        Util.option_map (Json.lookup j "latest_delivery_error") String.of_json
    ; latest_notification_error =
        Util.option_map (Json.lookup j "latest_notification_error") String.of_json
    ; latest_delivery_time =
        Util.option_map (Json.lookup j "latest_delivery_time") DateTime.of_json
    ; latest_notification_time =
        Util.option_map (Json.lookup j "latest_notification_time") DateTime.of_json
    ; start_logging_time =
        Util.option_map (Json.lookup j "start_logging_time") DateTime.of_json
    ; stop_logging_time =
        Util.option_map (Json.lookup j "stop_logging_time") DateTime.of_json
    ; latest_cloud_watch_logs_delivery_error =
        Util.option_map
    ...
    ; latest_cloud_watch_logs_delivery_time =
        Util.option_map
          ...
          DateTime.of_json
    ; latest_digest_delivery_time =
        Util.option_map (Json.lookup j "latest_digest_delivery_time") DateTime.of_json
    ; latest_digest_delivery_error =
        Util.option_map (Json.lookup j "latest_digest_delivery_error") String.of_json
    ; latest_delivery_attempt_time =
        Util.option_map (Json.lookup j "latest_delivery_attempt_time") String.of_json
    ; latest_notification_attempt_time =
        Util.option_map (Json.lookup j "latest_notification_attempt_time") String.of_json
    ; latest_notification_attempt_succeeded =
        Util.option_map
          (Json.lookup j "latest_notification_attempt_succeeded")
          String.of_json
    ; latest_delivery_attempt_succeeded =
        Util.option_map (Json.lookup j "latest_delivery_attempt_succeeded") String.of_json
    ; time_logging_started =
        Util.option_map (Json.lookup j "time_logging_started") String.of_json
    ; time_logging_stopped =
        Util.option_map (Json.lookup j "time_logging_stopped") String.of_json
    }
end
...
module ListTrailsResponse = struct
  ...
  let parse xml =
    Some
      { trails =
          Util.of_option [] (Util.option_bind (Xml.member "Trails" xml) Trails.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let of_json j =
    { trails = Trails.of_json (Util.of_option_exn (Json.lookup j "trails"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module GetTrailResponse = struct
  ...
  let parse xml = Some { trail = Util.option_bind (Xml.member "Trail" xml) Trail.parse }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.trail (fun f -> Query.Pair ("Trail", Trail.to_query f)) ])
  ...
  let of_json j = { trail = Util.option_map (Json.lookup j "trail") Trail.of_json }
end
...
module CreateTrailRequest = struct
  ...
  let parse xml =
    Some
      ...
      ; is_multi_region_trail =
          Util.option_bind (Xml.member "IsMultiRegionTrail" xml) Boolean.parse
      ; enable_log_file_validation =
          Util.option_bind (Xml.member "EnableLogFileValidation" xml) Boolean.parse
      ; cloud_watch_logs_log_group_arn =
          Util.option_bind (Xml.member "CloudWatchLogsLogGroupArn" xml) String.parse
      ; cloud_watch_logs_role_arn =
          Util.option_bind (Xml.member "CloudWatchLogsRoleArn" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cloud_watch_logs_log_group_arn (fun f ->
               Query.Pair ("CloudWatchLogsLogGroupArn", String.to_query f))
         ; Util.option_map v.enable_log_file_validation (fun f ->
    ...
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cloud_watch_logs_log_group_arn (fun f ->
               "cloud_watch_logs_log_group_arn", String.to_json f)
         ; Util.option_map v.enable_log_file_validation (fun f ->
               "enable_log_file_validation", Boolean.to_json f)
         ; Util.option_map v.is_multi_region_trail (fun f ->
               "is_multi_region_trail", Boolean.to_json f)
         ; Util.option_map v.include_global_service_events (fun f ->
               "include_global_service_events", Boolean.to_json f)
  ...
  let of_json j =
    ...
    ; is_multi_region_trail =
        Util.option_map (Json.lookup j "is_multi_region_trail") Boolean.of_json
    ; enable_log_file_validation =
        Util.option_map (Json.lookup j "enable_log_file_validation") Boolean.of_json
    ; cloud_watch_logs_log_group_arn =
        Util.option_map (Json.lookup j "cloud_watch_logs_log_group_arn") String.of_json
    ; cloud_watch_logs_role_arn =
        Util.option_map (Json.lookup j "cloud_watch_logs_role_arn") String.of_json
...
module PutInsightSelectorsRequest = struct
  ...
  let of_json j =
    { trail_name = String.of_json (Util.of_option_exn (Json.lookup j "trail_name"))
    ; insight_selectors =
        InsightSelectors.of_json (Util.of_option_exn (Json.lookup j "insight_selectors"))
    }
end
...
module GetEventSelectorsRequest = struct
  ...
  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("trail_name", String.to_json v.trail_name) ])
...
module DescribeTrailsRequest = struct
  ...
  let parse xml =
    Some
      { trail_name_list =
          Util.of_option
            []
            (Util.option_bind (Xml.member "trailNameList" xml) TrailNameList.parse)
      ; include_shadow_trails =
          Util.option_bind (Xml.member "includeShadowTrails" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.include_shadow_trails (fun f ->
               Query.Pair ("includeShadowTrails", Boolean.to_query f))
         ; Some
             (Query.Pair ("trailNameList.member", TrailNameList.to_query v.trail_name_list))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.include_shadow_trails (fun f ->
               "include_shadow_trails", Boolean.to_json f)
         ; Some ("trail_name_list", TrailNameList.to_json v.trail_name_list)
         ])

  let of_json j =
    { trail_name_list =
        TrailNameList.of_json (Util.of_option_exn (Json.lookup j "trail_name_list"))
    ; include_shadow_trails =
        Util.option_map (Json.lookup j "include_shadow_trails") Boolean.of_json
    }
end
...
module LookupEventsResponse = struct
  ...
  let parse xml =
    Some
      { events =
          Util.of_option [] (Util.option_bind (Xml.member "Events" xml) EventsList.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some (Query.Pair ("Events.member", EventsList.to_query v.events))
         ])
  ...
  let of_json j =
    { events = EventsList.of_json (Util.of_option_exn (Json.lookup j "events"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module ListPublicKeysResponse = struct
  ...
  let parse xml =
    Some
      { public_key_list =
          Util.of_option
            []
            (Util.option_bind (Xml.member "PublicKeyList" xml) PublicKeyList.parse)
      ; next_token = Util.option_bind (Xml.member "NextToken" xml) String.parse
      }
    ...
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f ->
               Query.Pair ("NextToken", String.to_query f))
         ; Some
             (Query.Pair ("PublicKeyList.member", PublicKeyList.to_query v.public_key_list))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.next_token (fun f -> "next_token", String.to_json f)
         ; Some ("public_key_list", PublicKeyList.to_json v.public_key_list)
         ])

  let of_json j =
    { public_key_list =
        PublicKeyList.of_json (Util.of_option_exn (Json.lookup j "public_key_list"))
    ; next_token = Util.option_map (Json.lookup j "next_token") String.of_json
    }
end
...
module DescribeTrailsResponse = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("trailList.member", TrailList.to_query v.trail_list)) ])

  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("trail_list", TrailList.to_json v.trail_list) ])

  let of_json j =
    { trail_list = TrailList.of_json (Util.of_option_exn (Json.lookup j "trail_list")) }
end
