...
module Listener = struct
  ...
  let parse xml =
    Some
      ...
      ; load_balancer_port =
          Xml.required
            "LoadBalancerPort"
            (Util.option_bind (Xml.member "LoadBalancerPort" xml) Integer.parse)
      ; instance_protocol =
          Util.option_bind (Xml.member "InstanceProtocol" xml) String.parse
      ; instance_port =
          Xml.required
            "InstancePort"
            (Util.option_bind (Xml.member "InstancePort" xml) Integer.parse)
      ; s_s_l_certificate_id =
          Util.option_bind (Xml.member "SSLCertificateId" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.s_s_l_certificate_id (fun f ->
               Query.Pair ("SSLCertificateId", String.to_query f))
         ; Some (Query.Pair ("InstancePort", Integer.to_query v.instance_port))
         ; Util.option_map v.instance_protocol (fun f ->
               Query.Pair ("InstanceProtocol", String.to_query f))
         ; Some (Query.Pair ("LoadBalancerPort", Integer.to_query v.load_balancer_port))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.s_s_l_certificate_id (fun f ->
               "s_s_l_certificate_id", String.to_json f)
         ; Some ("instance_port", Integer.to_json v.instance_port)
         ; Util.option_map v.instance_protocol (fun f ->
               "instance_protocol", String.to_json f)
         ; Some ("load_balancer_port", Integer.to_json v.load_balancer_port)
  ...
  let of_json j =
    ...
    ; load_balancer_port =
        Integer.of_json (Util.of_option_exn (Json.lookup j "load_balancer_port"))
    ; instance_protocol =
        Util.option_map (Json.lookup j "instance_protocol") String.of_json
    ; instance_port = Integer.of_json (Util.of_option_exn (Json.lookup j "instance_port"))
    ; s_s_l_certificate_id =
        Util.option_map (Json.lookup j "s_s_l_certificate_id") String.of_json
    }
end
...
module AppCookieStickinessPolicy = struct
  ...
  let parse xml =
    Some
      ...
      ; cookie_name = Util.option_bind (Xml.member "CookieName" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.cookie_name (fun f ->
               Query.Pair ("CookieName", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.cookie_name (fun f -> "cookie_name", String.to_json f)
  ...
  let of_json j =
    ...
    ; cookie_name = Util.option_map (Json.lookup j "cookie_name") String.of_json
    }
end
...
module LBCookieStickinessPolicy = struct
  ...
  let parse xml =
    Some
      ...
      ; cookie_expiration_period =
          Util.option_bind (Xml.member "CookieExpirationPeriod" xml) Long.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.cookie_expiration_period (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.cookie_expiration_period (fun f ->
               "cookie_expiration_period", Long.to_json f)
         ; Util.option_map v.policy_name (fun f -> "policy_name", String.to_json f)
         ])
  ...
  let of_json j =
    { policy_name = Util.option_map (Json.lookup j "policy_name") String.of_json
    ; cookie_expiration_period =
        Util.option_map (Json.lookup j "cookie_expiration_period") Long.of_json
    }
end
...
module PolicyAttributeDescription = struct
  ...
  let parse xml =
    Some
      ...
      ; attribute_value = Util.option_bind (Xml.member "AttributeValue" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.attribute_value (fun f ->
               "attribute_value", String.to_json f)
  ...
  let of_json j =
    ...
    ; attribute_value = Util.option_map (Json.lookup j "attribute_value") String.of_json
    }
end
...
module PolicyAttributeTypeDescription = struct
  ...
  let parse xml =
    Some
      { attribute_name = Util.option_bind (Xml.member "AttributeName" xml) String.parse
      ; attribute_type = Util.option_bind (Xml.member "AttributeType" xml) String.parse
      ...
      ; cardinality = Util.option_bind (Xml.member "Cardinality" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.cardinality (fun f ->
               Query.Pair ("Cardinality", String.to_query f))
         ...
         ; Util.option_map v.attribute_type (fun f ->
               Query.Pair ("AttributeType", String.to_query f))
         ; Util.option_map v.attribute_name (fun f ->
               Query.Pair ("AttributeName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.cardinality (fun f -> "cardinality", String.to_json f)
         ...
         ; Util.option_map v.attribute_type (fun f -> "attribute_type", String.to_json f)
         ; Util.option_map v.attribute_name (fun f -> "attribute_name", String.to_json f)
         ])

  let of_json j =
    { attribute_name = Util.option_map (Json.lookup j "attribute_name") String.of_json
    ; attribute_type = Util.option_map (Json.lookup j "attribute_type") String.of_json
    ...
    ; cardinality = Util.option_map (Json.lookup j "cardinality") String.of_json
    }
end
...
module BackendServerDescription = struct
  ...
  let parse xml =
    Some
      { instance_port = Util.option_bind (Xml.member "InstancePort" xml) Integer.parse
      ; policy_names =
          Util.of_option
            []
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.instance_port (fun f ->
               Query.Pair ("InstancePort", Integer.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.instance_port (fun f -> "instance_port", Integer.to_json f)
         ])

  let of_json j =
    { instance_port = Util.option_map (Json.lookup j "instance_port") Integer.of_json
    ; policy_names =
...
module Instance = struct
  ...
  let parse xml =
    Some { instance_id = Util.option_bind (Xml.member "InstanceId" xml) String.parse }
...
module ListenerDescription = struct
  ...
  let parse xml =
    Some
      { listener = Util.option_bind (Xml.member "Listener" xml) Listener.parse
      ; policy_names =
          Util.of_option
            []
            (Util.option_bind (Xml.member "PolicyNames" xml) PolicyNames.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("PolicyNames.member", PolicyNames.to_query v.policy_names))
         ; Util.option_map v.listener (fun f ->
               Query.Pair ("Listener", Listener.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("policy_names", PolicyNames.to_json v.policy_names)
         ; Util.option_map v.listener (fun f -> "listener", Listener.to_json f)
         ])

  let of_json j =
    { listener = Util.option_map (Json.lookup j "listener") Listener.of_json
    ; policy_names =
        PolicyNames.of_json (Util.of_option_exn (Json.lookup j "policy_names"))
    }
end
...
module AppCookieStickinessPolicies = struct
  ...
  let parse xml =
    Util.option_all (List.map AppCookieStickinessPolicy.parse (Xml.members "member" xml))
...
module LBCookieStickinessPolicies = struct
  ...
  let parse xml =
    Util.option_all (List.map LBCookieStickinessPolicy.parse (Xml.members "member" xml))
...
module PolicyAttributeDescriptions = struct
  ...
  let parse xml =
    Util.option_all (List.map PolicyAttributeDescription.parse (Xml.members "member" xml))

  let to_query v = Query.to_query_list PolicyAttributeDescription.to_query v
...
module PolicyAttributeTypeDescriptions = struct
  ...
  let parse xml =
    Util.option_all
      (List.map PolicyAttributeTypeDescription.parse (Xml.members "member" xml))

  let to_query v = Query.to_query_list PolicyAttributeTypeDescription.to_query v
...
module BackendServerDescriptions = struct
  ...
  let parse xml =
    Util.option_all (List.map BackendServerDescription.parse (Xml.members "member" xml))
...
module HealthCheck = struct
  ...
  let parse xml =
    Some
      { target =
          Xml.required "Target" (Util.option_bind (Xml.member "Target" xml) String.parse)
      ; interval =
          Xml.required
            "Interval"
      ...
      ; unhealthy_threshold =
          Xml.required
            "UnhealthyThreshold"
            (Util.option_bind (Xml.member "UnhealthyThreshold" xml) Integer.parse)
      ; healthy_threshold =
          Xml.required
            "HealthyThreshold"
            (Util.option_bind (Xml.member "HealthyThreshold" xml) Integer.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("HealthyThreshold", Integer.to_query v.healthy_threshold))
         ; Some
             (Query.Pair ("UnhealthyThreshold", Integer.to_query v.unhealthy_threshold))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("unhealthy_threshold", Integer.to_json v.unhealthy_threshold)
  ...
  let of_json j =
    { target = String.of_json (Util.of_option_exn (Json.lookup j "target"))
    ; interval = Integer.of_json (Util.of_option_exn (Json.lookup j "interval"))
    ; timeout = Integer.of_json (Util.of_option_exn (Json.lookup j "timeout"))
    ; unhealthy_threshold =
        Integer.of_json (Util.of_option_exn (Json.lookup j "unhealthy_threshold"))
    ; healthy_threshold =
        Integer.of_json (Util.of_option_exn (Json.lookup j "healthy_threshold"))
    }
end
...
module ListenerDescriptions = struct
  ...
  let parse xml =
    Util.option_all (List.map ListenerDescription.parse (Xml.members "member" xml))
...
module Policies = struct
  ...
  let parse xml =
    Some
      ...
      ; other_policies =
          Util.of_option
            []
            (Util.option_bind (Xml.member "OtherPolicies" xml) PolicyNames.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("OtherPolicies.member", PolicyNames.to_query v.other_policies))
         ; Some
             (Query.Pair
  ...
  let of_json j =
    { app_cookie_stickiness_policies =
        AppCookieStickinessPolicies.of_json
          (Util.of_option_exn (Json.lookup j "app_cookie_stickiness_policies"))
    ; l_b_cookie_stickiness_policies =
        LBCookieStickinessPolicies.of_json
          (Util.of_option_exn (Json.lookup j "l_b_cookie_stickiness_policies"))
    ; other_policies =
        PolicyNames.of_json (Util.of_option_exn (Json.lookup j "other_policies"))
    }
end
...
module SourceSecurityGroup = struct
  ...
  let parse xml =
    Some
      { owner_alias = Util.option_bind (Xml.member "OwnerAlias" xml) String.parse
      ; group_name = Util.option_bind (Xml.member "GroupName" xml) String.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.group_name (fun f -> "group_name", String.to_json f)
         ; Util.option_map v.owner_alias (fun f -> "owner_alias", String.to_json f)
         ])

  let of_json j =
    { owner_alias = Util.option_map (Json.lookup j "owner_alias") String.of_json
    ; group_name = Util.option_map (Json.lookup j "group_name") String.of_json
    }
end
...
module AccessLog = struct
  ...
  let parse xml =
    Some
      ...
      ; emit_interval = Util.option_bind (Xml.member "EmitInterval" xml) Integer.parse
      ; s3_bucket_prefix = Util.option_bind (Xml.member "S3BucketPrefix" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.s3_bucket_prefix (fun f ->
               Query.Pair ("S3BucketPrefix", String.to_query f))
         ; Util.option_map v.emit_interval (fun f ->
               Query.Pair ("EmitInterval", Integer.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.s3_bucket_prefix (fun f ->
               "s3_bucket_prefix", String.to_json f)
         ; Util.option_map v.emit_interval (fun f -> "emit_interval", Integer.to_json f)
         ; Util.option_map v.s3_bucket_name (fun f -> "s3_bucket_name", String.to_json f)
         ; Some ("enabled", Boolean.to_json v.enabled)
         ])

  let of_json j =
    { enabled = Boolean.of_json (Util.of_option_exn (Json.lookup j "enabled"))
    ; s3_bucket_name = Util.option_map (Json.lookup j "s3_bucket_name") String.of_json
    ; emit_interval = Util.option_map (Json.lookup j "emit_interval") Integer.of_json
    ; s3_bucket_prefix = Util.option_map (Json.lookup j "s3_bucket_prefix") String.of_json
    }
end
...
module AdditionalAttributes = struct
  ...
  let parse xml =
    Util.option_all (List.map AdditionalAttribute.parse (Xml.members "member" xml))
...
module ConnectionDraining = struct
    ...
    Some
      { enabled =
          Xml.required
            "Enabled"
            (Util.option_bind (Xml.member "Enabled" xml) Boolean.parse)
      ; timeout = Util.option_bind (Xml.member "Timeout" xml) Integer.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.timeout (fun f -> Query.Pair ("Timeout", Integer.to_query f))
         ; Some (Query.Pair ("Enabled", Boolean.to_query v.enabled))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.timeout (fun f -> "timeout", Integer.to_json f)
         ; Some ("enabled", Boolean.to_json v.enabled)
         ])
...
module ConnectionSettings = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("IdleTimeout", Integer.to_query v.idle_timeout)) ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Some ("idle_timeout", Integer.to_json v.idle_timeout) ])

  let of_json j =
    { idle_timeout = Integer.of_json (Util.of_option_exn (Json.lookup j "idle_timeout")) }
end
...
module TagKeyOnly = struct
  ...
  let parse xml = Some { key = Util.option_bind (Xml.member "Key" xml) String.parse }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Util.option_map v.key (fun f -> "key", String.to_json f) ])

  let of_json j = { key = Util.option_map (Json.lookup j "key") String.of_json }
end
...
module PolicyDescription = struct
  ...
  let parse xml =
    Some
      { policy_name = Util.option_bind (Xml.member "PolicyName" xml) String.parse
      ; policy_type_name = Util.option_bind (Xml.member "PolicyTypeName" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.policy_type_name (fun f ->
               Query.Pair ("PolicyTypeName", String.to_query f))
         ; Util.option_map v.policy_name (fun f ->
               Query.Pair ("PolicyName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.policy_type_name (fun f ->
               "policy_type_name", String.to_json f)
         ; Util.option_map v.policy_name (fun f -> "policy_name", String.to_json f)
         ])

  let of_json j =
    { policy_name = Util.option_map (Json.lookup j "policy_name") String.of_json
    ; policy_type_name = Util.option_map (Json.lookup j "policy_type_name") String.of_json
    ; policy_attribute_descriptions =
        PolicyAttributeDescriptions.of_json
          (Util.of_option_exn (Json.lookup j "policy_attribute_descriptions"))
    }
end
...
module InstanceState = struct
  ...
  let parse xml =
    Some
      ...
      ; reason_code = Util.option_bind (Xml.member "ReasonCode" xml) String.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.reason_code (fun f ->
               Query.Pair ("ReasonCode", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.reason_code (fun f -> "reason_code", String.to_json f)
  ...
  let of_json j =
    ...
    ; reason_code = Util.option_map (Json.lookup j "reason_code") String.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    }
end
  ...
  let of_json j =
    ...
    ; policy_attribute_type_descriptions =
        PolicyAttributeTypeDescriptions.of_json
          (Util.of_option_exn (Json.lookup j "policy_attribute_type_descriptions"))
    }
end
...
module LoadBalancerDescription = struct
  ...
  let parse xml =
    Some
      ...
      ; canonical_hosted_zone_name =
          Util.option_bind (Xml.member "CanonicalHostedZoneName" xml) String.parse
      ; canonical_hosted_zone_name_i_d =
          Util.option_bind (Xml.member "CanonicalHostedZoneNameID" xml) String.parse
      ; listener_descriptions =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ListenerDescriptions" xml)
               ListenerDescriptions.parse)
      ; policies = Util.option_bind (Xml.member "Policies" xml) Policies.parse
      ; backend_server_descriptions =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "BackendServerDescriptions" xml)
      ...
      ; subnets =
          Util.of_option [] (Util.option_bind (Xml.member "Subnets" xml) Subnets.parse)
      ; v_p_c_id = Util.option_bind (Xml.member "VPCId" xml) String.parse
      ; instances =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Instances" xml) Instances.parse)
      ; health_check = Util.option_bind (Xml.member "HealthCheck" xml) HealthCheck.parse
      ; source_security_group =
          Util.option_bind
            (Xml.member "SourceSecurityGroup" xml)
            SourceSecurityGroup.parse
      ; security_groups =
          Util.of_option
            []
            (Util.option_bind (Xml.member "SecurityGroups" xml) SecurityGroups.parse)
      ; created_time = Util.option_bind (Xml.member "CreatedTime" xml) DateTime.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.scheme (fun f -> Query.Pair ("Scheme", String.to_query f))
         ; Util.option_map v.created_time (fun f ->
               Query.Pair ("CreatedTime", DateTime.to_query f))
         ; Some
             (Query.Pair
                ("SecurityGroups.member", SecurityGroups.to_query v.security_groups))
         ; Util.option_map v.source_security_group (fun f ->
               Query.Pair ("SourceSecurityGroup", SourceSecurityGroup.to_query f))
         ; Util.option_map v.health_check (fun f ->
               Query.Pair ("HealthCheck", HealthCheck.to_query f))
         ...
         ; Util.option_map v.policies (fun f ->
               Query.Pair ("Policies", Policies.to_query f))
         ; Some
             (Query.Pair
                ( "ListenerDescriptions.member"
                , ListenerDescriptions.to_query v.listener_descriptions ))
         ; Util.option_map v.canonical_hosted_zone_name_i_d (fun f ->
               Query.Pair ("CanonicalHostedZoneNameID", String.to_query f))
         ; Util.option_map v.canonical_hosted_zone_name (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.created_time (fun f -> "created_time", DateTime.to_json f)
         ; Some ("security_groups", SecurityGroups.to_json v.security_groups)
         ; Util.option_map v.source_security_group (fun f ->
               "source_security_group", SourceSecurityGroup.to_json f)
         ; Util.option_map v.health_check (fun f -> "health_check", HealthCheck.to_json f)
         ...
         ; Util.option_map v.policies (fun f -> "policies", Policies.to_json f)
         ; Some
             ( "listener_descriptions"
         ...
         ; Util.option_map v.canonical_hosted_zone_name (fun f ->
               "canonical_hosted_zone_name", String.to_json f)
  ...
  let of_json j =
    ...
    ; canonical_hosted_zone_name =
        Util.option_map (Json.lookup j "canonical_hosted_zone_name") String.of_json
    ; canonical_hosted_zone_name_i_d =
        Util.option_map (Json.lookup j "canonical_hosted_zone_name_i_d") String.of_json
    ; listener_descriptions =
        ListenerDescriptions.of_json
          (Util.of_option_exn (Json.lookup j "listener_descriptions"))
    ; policies = Util.option_map (Json.lookup j "policies") Policies.of_json
    ; backend_server_descriptions =
        BackendServerDescriptions.of_json
          (Util.of_option_exn (Json.lookup j "backend_server_descriptions"))
    ; availability_zones =
        AvailabilityZones.of_json
          (Util.of_option_exn (Json.lookup j "availability_zones"))
    ; subnets = Subnets.of_json (Util.of_option_exn (Json.lookup j "subnets"))
    ...
    ; health_check = Util.option_map (Json.lookup j "health_check") HealthCheck.of_json
    ; source_security_group =
        Util.option_map
          (Json.lookup j "source_security_group")
          SourceSecurityGroup.of_json
    ; security_groups =
        SecurityGroups.of_json (Util.of_option_exn (Json.lookup j "security_groups"))
    ; created_time = Util.option_map (Json.lookup j "created_time") DateTime.of_json
...
module LoadBalancerAttributes = struct
  ...
  let parse xml =
    Some
      { cross_zone_load_balancing =
          Util.option_bind
            (Xml.member "CrossZoneLoadBalancing" xml)
            CrossZoneLoadBalancing.parse
      ; access_log = Util.option_bind (Xml.member "AccessLog" xml) AccessLog.parse
      ; connection_draining =
          Util.option_bind (Xml.member "ConnectionDraining" xml) ConnectionDraining.parse
      ; connection_settings =
          Util.option_bind (Xml.member "ConnectionSettings" xml) ConnectionSettings.parse
      ; additional_attributes =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "AdditionalAttributes" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.connection_settings (fun f ->
               Query.Pair ("ConnectionSettings", ConnectionSettings.to_query f))
         ; Util.option_map v.connection_draining (fun f ->
               Query.Pair ("ConnectionDraining", ConnectionDraining.to_query f))
         ; Util.option_map v.access_log (fun f ->
               Query.Pair ("AccessLog", AccessLog.to_query f))
         ; Util.option_map v.cross_zone_load_balancing (fun f ->
               Query.Pair ("CrossZoneLoadBalancing", CrossZoneLoadBalancing.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.access_log (fun f -> "access_log", AccessLog.to_json f)
         ; Util.option_map v.cross_zone_load_balancing (fun f ->
               "cross_zone_load_balancing", CrossZoneLoadBalancing.to_json f)
         ])

  let of_json j =
    { cross_zone_load_balancing =
        Util.option_map
          (Json.lookup j "cross_zone_load_balancing")
          CrossZoneLoadBalancing.of_json
    ; access_log = Util.option_map (Json.lookup j "access_log") AccessLog.of_json
    ; connection_draining =
        Util.option_map (Json.lookup j "connection_draining") ConnectionDraining.of_json
    ; connection_settings =
        Util.option_map (Json.lookup j "connection_settings") ConnectionSettings.of_json
    ; additional_attributes =
...
module Listeners = struct
  ...
  let parse xml = Util.option_all (List.map Listener.parse (Xml.members "member" xml))
...
module PolicyAttributes = struct
  ...
  let parse xml =
    Util.option_all (List.map PolicyAttribute.parse (Xml.members "member" xml))
...
module TagKeyList = struct
  ...
  let parse xml = Util.option_all (List.map TagKeyOnly.parse (Xml.members "member" xml))
...
module PolicyDescriptions = struct
  ...
  let parse xml =
    Util.option_all (List.map PolicyDescription.parse (Xml.members "member" xml))
...
module Ports = struct
  ...
  let parse xml = Util.option_all (List.map Integer.parse (Xml.members "member" xml))
...
module PolicyTypeDescriptions = struct
  ...
  let parse xml =
    Util.option_all (List.map PolicyTypeDescription.parse (Xml.members "member" xml))
...
module LoadBalancerDescriptions = struct
  ...
  let parse xml =
    Util.option_all (List.map LoadBalancerDescription.parse (Xml.members "member" xml))
...
module DescribeTagsOutput = struct
  ...
  let parse xml =
    Some
      { tag_descriptions =
          Util.of_option
            []
            (Util.option_bind (Xml.member "TagDescriptions" xml) TagDescriptions.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("tag_descriptions", TagDescriptions.to_json v.tag_descriptions) ])

  let of_json j =
    { tag_descriptions =
        TagDescriptions.of_json (Util.of_option_exn (Json.lookup j "tag_descriptions"))
    }
end
...
module ModifyLoadBalancerAttributesOutput = struct
  ...
  let parse xml =
    Some
      ...
      ; load_balancer_attributes =
          Util.option_bind
            (Xml.member "LoadBalancerAttributes" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.load_balancer_attributes (fun f ->
               Query.Pair ("LoadBalancerAttributes", LoadBalancerAttributes.to_query f))
         ; Util.option_map v.load_balancer_name (fun f ->
               Query.Pair ("LoadBalancerName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.load_balancer_attributes (fun f ->
               "load_balancer_attributes", LoadBalancerAttributes.to_json f)
         ; Util.option_map v.load_balancer_name (fun f ->
               "load_balancer_name", String.to_json f)
         ])
  ...
  let of_json j =
    ...
    ; load_balancer_attributes =
        Util.option_map
          (Json.lookup j "load_balancer_attributes")
...
module CreateLoadBalancerListenerInput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Listeners.member", Listeners.to_query v.listeners))
         ; Some (Query.Pair ("LoadBalancerName", String.to_query v.load_balancer_name))
         ])
  ...
  let of_json j =
    { load_balancer_name =
        String.of_json (Util.of_option_exn (Json.lookup j "load_balancer_name"))
    ; listeners = Listeners.of_json (Util.of_option_exn (Json.lookup j "listeners"))
    }
end
...
module CreateLoadBalancerPolicyInput = struct
  ...
  let parse xml =
    Some
      ...
      ; policy_attributes =
          Util.of_option
            []
            (Util.option_bind (Xml.member "PolicyAttributes" xml) PolicyAttributes.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("PolicyTypeName", String.to_query v.policy_type_name))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("policy_attributes", PolicyAttributes.to_json v.policy_attributes)
  ...
  let of_json j =
    ...
    ; policy_type_name =
        String.of_json (Util.of_option_exn (Json.lookup j "policy_type_name"))
    ; policy_attributes =
        PolicyAttributes.of_json (Util.of_option_exn (Json.lookup j "policy_attributes"))
    }
end
...
module CreateAccessPointOutput = struct
  ...
  let parse xml =
    Some { d_n_s_name = Util.option_bind (Xml.member "DNSName" xml) String.parse }
...
module RemoveTagsInput = struct
      ...
      { load_balancer_names =
          Xml.required
            ...
            (Util.option_bind
               ...
               LoadBalancerNames.parse)
      ; tags =
          Xml.required "Tags" (Util.option_bind (Xml.member "Tags" xml) TagKeyList.parse)
      }
  ...
  let of_json j =
    { load_balancer_names =
        LoadBalancerNames.of_json
          (Util.of_option_exn (Json.lookup j "load_balancer_names"))
    ; tags = TagKeyList.of_json (Util.of_option_exn (Json.lookup j "tags"))
    }
end
...
module DescribeAccessPointsInput = struct
  ...
  let parse xml =
    Some
      ...
      ; page_size = Util.option_bind (Xml.member "PageSize" xml) Integer.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.page_size (fun f ->
               Query.Pair ("PageSize", Integer.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.page_size (fun f -> "page_size", Integer.to_json f)
  ...
  let of_json j =
    ...
    ; page_size = Util.option_map (Json.lookup j "page_size") Integer.of_json
    }
end
...
module DetachLoadBalancerFromSubnetsOutput = struct
  ...
  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("subnets", Subnets.to_json v.subnets) ])
...
module DescribeLoadBalancerPoliciesOutput = struct
    ...
    Some
      { policy_descriptions =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "PolicyDescriptions" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("policy_descriptions", PolicyDescriptions.to_json v.policy_descriptions)
         ])
...
module DescribeEndPointStateOutput = struct
  ...
  let parse xml =
    Some
      { instance_states =
          Util.of_option
            []
            (Util.option_bind (Xml.member "InstanceStates" xml) InstanceStates.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("instance_states", InstanceStates.to_json v.instance_states) ])

  let of_json j =
    { instance_states =
        InstanceStates.of_json (Util.of_option_exn (Json.lookup j "instance_states"))
    }
end
...
module CreateAppCookieStickinessPolicyInput = struct
  ...
  let of_json j =
    { load_balancer_name =
        String.of_json (Util.of_option_exn (Json.lookup j "load_balancer_name"))
    ; policy_name = String.of_json (Util.of_option_exn (Json.lookup j "policy_name"))
    ; cookie_name = String.of_json (Util.of_option_exn (Json.lookup j "cookie_name"))
    }
end
...
module DescribeTagsInput = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some
             ("load_balancer_names", LoadBalancerNamesMax20.to_json v.load_balancer_names)
         ])
...
module DescribeLoadBalancerPolicyTypesInput = struct
  ...
  let parse xml =
    Some
      { policy_type_names =
          Util.of_option
            []
            (Util.option_bind (Xml.member "PolicyTypeNames" xml) PolicyTypeNames.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("policy_type_names", PolicyTypeNames.to_json v.policy_type_names) ])

  let of_json j =
    { policy_type_names =
        PolicyTypeNames.of_json (Util.of_option_exn (Json.lookup j "policy_type_names"))
    }
end
...
module DeregisterEndPointsOutput = struct
  ...
  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("instances", Instances.to_json v.instances) ])
...
module SetLoadBalancerListenerSSLCertificateInput = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("SSLCertificateId", String.to_query v.s_s_l_certificate_id))
         ; Some (Query.Pair ("LoadBalancerPort", Integer.to_query v.load_balancer_port))
         ; Some (Query.Pair ("LoadBalancerName", String.to_query v.load_balancer_name))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("s_s_l_certificate_id", String.to_json v.s_s_l_certificate_id)
         ; Some ("load_balancer_port", Integer.to_json v.load_balancer_port)
         ; Some ("load_balancer_name", String.to_json v.load_balancer_name)
         ])
  ...
  let of_json j =
    ...
    ; load_balancer_port =
        Integer.of_json (Util.of_option_exn (Json.lookup j "load_balancer_port"))
    ; s_s_l_certificate_id =
        String.of_json (Util.of_option_exn (Json.lookup j "s_s_l_certificate_id"))
    }
end
...
module DeleteLoadBalancerListenerInput = struct
  ...
  let parse xml =
    Some
      ...
      ; load_balancer_ports =
          Xml.required
            "LoadBalancerPorts"
            (Util.option_bind (Xml.member "LoadBalancerPorts" xml) Ports.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("LoadBalancerPorts.member", Ports.to_query v.load_balancer_ports))
         ; Some (Query.Pair ("LoadBalancerName", String.to_query v.load_balancer_name))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("load_balancer_ports", Ports.to_json v.load_balancer_ports)
         ; Some ("load_balancer_name", String.to_json v.load_balancer_name)
         ])
  ...
  let of_json j =
    { load_balancer_name =
        String.of_json (Util.of_option_exn (Json.lookup j "load_balancer_name"))
    ; load_balancer_ports =
        Ports.of_json (Util.of_option_exn (Json.lookup j "load_balancer_ports"))
    }
end
    ...
    Some
      { policy_type_descriptions =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "PolicyTypeDescriptions" xml)
    ...
    Some
      { load_balancer_descriptions =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "LoadBalancerDescriptions" xml)
