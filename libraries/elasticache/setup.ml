...
(* OASIS_START *)
(* DO NOT EDIT (digest: 13d28750e28bfed891524e05f7e40d43) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "aws_elasticache";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "aws_elasticache Docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\229\2423UVv\004M\136\206\190\141\135\185Pg";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
