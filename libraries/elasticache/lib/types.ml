...
module OutpostArnsList = struct
  ...
  let parse xml = Util.option_all (List.map String.parse (Xml.members "OutpostArn" xml))
...
module NodeGroupMemberUpdateStatus = struct
  ...
  let parse xml =
    Some
      { cache_cluster_id = Util.option_bind (Xml.member "CacheClusterId" xml) String.parse
      ; cache_node_id = Util.option_bind (Xml.member "CacheNodeId" xml) String.parse
      ; node_update_status =
          Util.option_bind (Xml.member "NodeUpdateStatus" xml) NodeUpdateStatus.parse
      ; node_deletion_date =
          Util.option_bind (Xml.member "NodeDeletionDate" xml) DateTime.parse
      ; node_update_start_date =
          Util.option_bind (Xml.member "NodeUpdateStartDate" xml) DateTime.parse
      ; node_update_end_date =
          Util.option_bind (Xml.member "NodeUpdateEndDate" xml) DateTime.parse
      ; node_update_initiated_by =
          Util.option_bind
            (Xml.member "NodeUpdateInitiatedBy" xml)
            NodeUpdateInitiatedBy.parse
      ; node_update_initiated_date =
          Util.option_bind (Xml.member "NodeUpdateInitiatedDate" xml) DateTime.parse
      ; node_update_status_modified_date =
          Util.option_bind (Xml.member "NodeUpdateStatusModifiedDate" xml) DateTime.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.node_update_status_modified_date (fun f ->
               Query.Pair ("NodeUpdateStatusModifiedDate", DateTime.to_query f))
         ; Util.option_map v.node_update_initiated_date (fun f ->
               Query.Pair ("NodeUpdateInitiatedDate", DateTime.to_query f))
         ; Util.option_map v.node_update_initiated_by (fun f ->
               Query.Pair ("NodeUpdateInitiatedBy", NodeUpdateInitiatedBy.to_query f))
         ; Util.option_map v.node_update_end_date (fun f ->
               Query.Pair ("NodeUpdateEndDate", DateTime.to_query f))
         ; Util.option_map v.node_update_start_date (fun f ->
               Query.Pair ("NodeUpdateStartDate", DateTime.to_query f))
         ; Util.option_map v.node_deletion_date (fun f ->
               Query.Pair ("NodeDeletionDate", DateTime.to_query f))
         ; Util.option_map v.node_update_status (fun f ->
               Query.Pair ("NodeUpdateStatus", NodeUpdateStatus.to_query f))
         ; Util.option_map v.cache_node_id (fun f ->
               Query.Pair ("CacheNodeId", String.to_query f))
         ; Util.option_map v.cache_cluster_id (fun f ->
               Query.Pair ("CacheClusterId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.node_update_initiated_date (fun f ->
               "node_update_initiated_date", DateTime.to_json f)
         ; Util.option_map v.node_update_initiated_by (fun f ->
               "node_update_initiated_by", NodeUpdateInitiatedBy.to_json f)
         ; Util.option_map v.node_update_end_date (fun f ->
               "node_update_end_date", DateTime.to_json f)
         ; Util.option_map v.node_update_start_date (fun f ->
               "node_update_start_date", DateTime.to_json f)
         ; Util.option_map v.node_deletion_date (fun f ->
               "node_deletion_date", DateTime.to_json f)
         ; Util.option_map v.node_update_status (fun f ->
               "node_update_status", NodeUpdateStatus.to_json f)
         ; Util.option_map v.cache_node_id (fun f -> "cache_node_id", String.to_json f)
         ; Util.option_map v.cache_cluster_id (fun f ->
               "cache_cluster_id", String.to_json f)
         ])

  let of_json j =
    { cache_cluster_id = Util.option_map (Json.lookup j "cache_cluster_id") String.of_json
    ; cache_node_id = Util.option_map (Json.lookup j "cache_node_id") String.of_json
    ; node_update_status =
        Util.option_map (Json.lookup j "node_update_status") NodeUpdateStatus.of_json
    ; node_deletion_date =
        Util.option_map (Json.lookup j "node_deletion_date") DateTime.of_json
    ; node_update_start_date =
        Util.option_map (Json.lookup j "node_update_start_date") DateTime.of_json
    ; node_update_end_date =
        Util.option_map (Json.lookup j "node_update_end_date") DateTime.of_json
    ; node_update_initiated_by =
        Util.option_map
          (Json.lookup j "node_update_initiated_by")
          NodeUpdateInitiatedBy.of_json
    ; node_update_initiated_date =
        Util.option_map (Json.lookup j "node_update_initiated_date") DateTime.of_json
    ; node_update_status_modified_date =
        Util.option_map
          (Json.lookup j "node_update_status_modified_date")
          DateTime.of_json
    }
end
...
module NodeGroupMember = struct
  ...
  let parse xml =
    Some
      { cache_cluster_id = Util.option_bind (Xml.member "CacheClusterId" xml) String.parse
      ; cache_node_id = Util.option_bind (Xml.member "CacheNodeId" xml) String.parse
      ; read_endpoint = Util.option_bind (Xml.member "ReadEndpoint" xml) Endpoint.parse
      ; preferred_availability_zone =
          Util.option_bind (Xml.member "PreferredAvailabilityZone" xml) String.parse
      ; preferred_outpost_arn =
          Util.option_bind (Xml.member "PreferredOutpostArn" xml) String.parse
      ; current_role = Util.option_bind (Xml.member "CurrentRole" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.current_role (fun f ->
               Query.Pair ("CurrentRole", String.to_query f))
         ; Util.option_map v.preferred_outpost_arn (fun f ->
               Query.Pair ("PreferredOutpostArn", String.to_query f))
         ; Util.option_map v.preferred_availability_zone (fun f ->
               Query.Pair ("PreferredAvailabilityZone", String.to_query f))
         ; Util.option_map v.read_endpoint (fun f ->
               Query.Pair ("ReadEndpoint", Endpoint.to_query f))
         ; Util.option_map v.cache_node_id (fun f ->
               Query.Pair ("CacheNodeId", String.to_query f))
         ; Util.option_map v.cache_cluster_id (fun f ->
               Query.Pair ("CacheClusterId", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.current_role (fun f -> "current_role", String.to_json f)
         ; Util.option_map v.preferred_outpost_arn (fun f ->
               "preferred_outpost_arn", String.to_json f)
         ; Util.option_map v.preferred_availability_zone (fun f ->
               "preferred_availability_zone", String.to_json f)
         ; Util.option_map v.read_endpoint (fun f -> "read_endpoint", Endpoint.to_json f)
         ; Util.option_map v.cache_node_id (fun f -> "cache_node_id", String.to_json f)
         ; Util.option_map v.cache_cluster_id (fun f ->
               "cache_cluster_id", String.to_json f)
         ])
  ...
  let of_json j =
    { cache_cluster_id = Util.option_map (Json.lookup j "cache_cluster_id") String.of_json
    ; cache_node_id = Util.option_map (Json.lookup j "cache_node_id") String.of_json
    ; read_endpoint = Util.option_map (Json.lookup j "read_endpoint") Endpoint.of_json
    ; preferred_availability_zone =
        Util.option_map (Json.lookup j "preferred_availability_zone") String.of_json
    ; preferred_outpost_arn =
        Util.option_map (Json.lookup j "preferred_outpost_arn") String.of_json
    ; current_role = Util.option_map (Json.lookup j "current_role") String.of_json
    }
end
...
module SubnetOutpost = struct
  ...
  let parse xml =
    Some
      { subnet_outpost_arn =
          Util.option_bind (Xml.member "SubnetOutpostArn" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.subnet_outpost_arn (fun f ->
               Query.Pair ("SubnetOutpostArn", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.subnet_outpost_arn (fun f ->
               "subnet_outpost_arn", String.to_json f)
         ])

  let of_json j =
    { subnet_outpost_arn =
        Util.option_map (Json.lookup j "subnet_outpost_arn") String.of_json
    }
end
...
module CacheNodeTypeSpecificValue = struct
  ...
  let parse xml =
    Some
      { cache_node_type = Util.option_bind (Xml.member "CacheNodeType" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_node_type (fun f ->
               Query.Pair ("CacheNodeType", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_node_type (fun f ->
               "cache_node_type", String.to_json f)
         ])

  let of_json j =
    { cache_node_type = Util.option_map (Json.lookup j "cache_node_type") String.of_json
...
module NodeGroupConfiguration = struct
  ...
  let parse xml =
    Some
      { node_group_id = Util.option_bind (Xml.member "NodeGroupId" xml) String.parse
      ; slots = Util.option_bind (Xml.member "Slots" xml) String.parse
      ; replica_count = Util.option_bind (Xml.member "ReplicaCount" xml) Integer.parse
      ; primary_availability_zone =
          Util.option_bind (Xml.member "PrimaryAvailabilityZone" xml) String.parse
      ; replica_availability_zones =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ReplicaAvailabilityZones" xml)
               AvailabilityZonesList.parse)
      ; primary_outpost_arn =
          Util.option_bind (Xml.member "PrimaryOutpostArn" xml) String.parse
      ; replica_outpost_arns =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ReplicaOutpostArns" xml) OutpostArnsList.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.primary_outpost_arn (fun f ->
               Query.Pair ("PrimaryOutpostArn", String.to_query f))
         ; Some
             (Query.Pair
                ( "ReplicaAvailabilityZones.member"
                , AvailabilityZonesList.to_query v.replica_availability_zones ))
         ; Util.option_map v.primary_availability_zone (fun f ->
               Query.Pair ("PrimaryAvailabilityZone", String.to_query f))
         ; Util.option_map v.replica_count (fun f ->
               Query.Pair ("ReplicaCount", Integer.to_query f))
         ; Util.option_map v.slots (fun f -> Query.Pair ("Slots", String.to_query f))
         ; Util.option_map v.node_group_id (fun f ->
               Query.Pair ("NodeGroupId", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("replica_outpost_arns", OutpostArnsList.to_json v.replica_outpost_arns)
         ; Util.option_map v.primary_outpost_arn (fun f ->
               "primary_outpost_arn", String.to_json f)
         ; Some
             ( "replica_availability_zones"
             , AvailabilityZonesList.to_json v.replica_availability_zones )
         ; Util.option_map v.primary_availability_zone (fun f ->
               "primary_availability_zone", String.to_json f)
         ; Util.option_map v.replica_count (fun f -> "replica_count", Integer.to_json f)
         ; Util.option_map v.slots (fun f -> "slots", String.to_json f)
         ; Util.option_map v.node_group_id (fun f -> "node_group_id", String.to_json f)
         ])

  let of_json j =
    { node_group_id = Util.option_map (Json.lookup j "node_group_id") String.of_json
    ; slots = Util.option_map (Json.lookup j "slots") String.of_json
    ; replica_count = Util.option_map (Json.lookup j "replica_count") Integer.of_json
    ; primary_availability_zone =
        Util.option_map (Json.lookup j "primary_availability_zone") String.of_json
    ; replica_availability_zones =
        AvailabilityZonesList.of_json
          (Util.of_option_exn (Json.lookup j "replica_availability_zones"))
    ; primary_outpost_arn =
        Util.option_map (Json.lookup j "primary_outpost_arn") String.of_json
    ; replica_outpost_arns =
...
module NodeGroupMemberUpdateStatusList = struct
  ...
  let to_query v = Query.to_query_list NodeGroupMemberUpdateStatus.to_query v
...
module NodeGroupMemberList = struct
  ...
  let parse xml =
    Util.option_all (List.map NodeGroupMember.parse (Xml.members "NodeGroupMember" xml))
...
module SlotMigration = struct
  ...
  let parse xml =
    Some
      { progress_percentage =
          Util.option_bind (Xml.member "ProgressPercentage" xml) Double.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.progress_percentage (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.progress_percentage (fun f ->
               "progress_percentage", Double.to_json f)
         ])

  let of_json j =
    { progress_percentage =
        Util.option_map (Json.lookup j "progress_percentage") Double.of_json
    }
end
...
module Subnet = struct
  ...
  let parse xml =
    Some
      ...
      ; subnet_outpost =
          Util.option_bind (Xml.member "SubnetOutpost" xml) SubnetOutpost.parse
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.subnet_outpost (fun f ->
               "subnet_outpost", SubnetOutpost.to_json f)
         ; Util.option_map v.subnet_availability_zone (fun f ->
  ...
  let of_json j =
    ...
    ; subnet_outpost =
        Util.option_map (Json.lookup j "subnet_outpost") SubnetOutpost.of_json
    }
end
...
module CacheNodeTypeSpecificValueList = struct
  ...
  let to_query v = Query.to_query_list CacheNodeTypeSpecificValue.to_query v
...
module ReshardingConfiguration = struct
  ...
  let of_json j =
    ...
    ; preferred_availability_zones =
        AvailabilityZonesList.of_json
          (Util.of_option_exn (Json.lookup j "preferred_availability_zones"))
    }
end
...
module NodeSnapshot = struct
  ...
  let parse xml =
    Some
      ...
      ; node_group_configuration =
          Util.option_bind
            (Xml.member "NodeGroupConfiguration" xml)
            NodeGroupConfiguration.parse
      ; cache_size = Util.option_bind (Xml.member "CacheSize" xml) String.parse
      ; cache_node_create_time =
          Util.option_bind (Xml.member "CacheNodeCreateTime" xml) DateTime.parse
      ; snapshot_create_time =
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_node_create_time (fun f ->
               Query.Pair ("CacheNodeCreateTime", DateTime.to_query f))
         ; Util.option_map v.cache_size (fun f ->
               Query.Pair ("CacheSize", String.to_query f))
         ; Util.option_map v.node_group_configuration (fun f ->
               Query.Pair ("NodeGroupConfiguration", NodeGroupConfiguration.to_query f))
         ; Util.option_map v.cache_node_id (fun f ->
               Query.Pair ("CacheNodeId", String.to_query f))
         ; Util.option_map v.node_group_id (fun f ->
               Query.Pair ("NodeGroupId", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_node_create_time (fun f ->
               "cache_node_create_time", DateTime.to_json f)
         ; Util.option_map v.cache_size (fun f -> "cache_size", String.to_json f)
         ; Util.option_map v.node_group_configuration (fun f ->
               "node_group_configuration", NodeGroupConfiguration.to_json f)
         ; Util.option_map v.cache_node_id (fun f -> "cache_node_id", String.to_json f)
         ; Util.option_map v.node_group_id (fun f -> "node_group_id", String.to_json f)
         ; Util.option_map v.cache_cluster_id (fun f ->
               "cache_cluster_id", String.to_json f)
  ...
  let of_json j =
    ...
    ; node_group_configuration =
        Util.option_map
          (Json.lookup j "node_group_configuration")
          NodeGroupConfiguration.of_json
    ; cache_size = Util.option_map (Json.lookup j "cache_size") String.of_json
    ; cache_node_create_time =
        Util.option_map (Json.lookup j "cache_node_create_time") DateTime.of_json
    ; snapshot_create_time =
...
module GlobalNodeGroup = struct
  ...
  let parse xml =
    Some
      { global_node_group_id =
          Util.option_bind (Xml.member "GlobalNodeGroupId" xml) String.parse
      ; slots = Util.option_bind (Xml.member "Slots" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.slots (fun f -> Query.Pair ("Slots", String.to_query f))
         ; Util.option_map v.global_node_group_id (fun f ->
               Query.Pair ("GlobalNodeGroupId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.slots (fun f -> "slots", String.to_json f)
         ; Util.option_map v.global_node_group_id (fun f ->
               "global_node_group_id", String.to_json f)
         ])

  let of_json j =
    { global_node_group_id =
        Util.option_map (Json.lookup j "global_node_group_id") String.of_json
    ; slots = Util.option_map (Json.lookup j "slots") String.of_json
    }
end
...
module GlobalReplicationGroupMember = struct
  ...
  let parse xml =
    Some
      { replication_group_id =
          Util.option_bind (Xml.member "ReplicationGroupId" xml) String.parse
      ; replication_group_region =
          Util.option_bind (Xml.member "ReplicationGroupRegion" xml) String.parse
      ; role = Util.option_bind (Xml.member "Role" xml) String.parse
      ; automatic_failover =
          Util.option_bind
            (Xml.member "AutomaticFailover" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.status (fun f -> Query.Pair ("Status", String.to_query f))
         ; Util.option_map v.automatic_failover (fun f ->
               Query.Pair ("AutomaticFailover", AutomaticFailoverStatus.to_query f))
         ; Util.option_map v.role (fun f -> Query.Pair ("Role", String.to_query f))
         ; Util.option_map v.replication_group_region (fun f ->
               Query.Pair ("ReplicationGroupRegion", String.to_query f))
         ; Util.option_map v.replication_group_id (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.replication_group_region (fun f ->
               "replication_group_region", String.to_json f)
         ; Util.option_map v.replication_group_id (fun f ->
               "replication_group_id", String.to_json f)
         ])

  let of_json j =
    { replication_group_id =
        Util.option_map (Json.lookup j "replication_group_id") String.of_json
    ; replication_group_region =
        Util.option_map (Json.lookup j "replication_group_region") String.of_json
    ; role = Util.option_map (Json.lookup j "role") String.of_json
    ; automatic_failover =
        Util.option_map
          (Json.lookup j "automatic_failover")
...
module CacheNode = struct
  ...
  let parse xml =
    Some
      ...
      ; parameter_group_status =
          Util.option_bind (Xml.member "ParameterGroupStatus" xml) String.parse
      ; source_cache_node_id =
          Util.option_bind (Xml.member "SourceCacheNodeId" xml) String.parse
      ; customer_availability_zone =
          Util.option_bind (Xml.member "CustomerAvailabilityZone" xml) String.parse
      ; customer_outpost_arn =
          Util.option_bind (Xml.member "CustomerOutpostArn" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.customer_outpost_arn (fun f ->
               Query.Pair ("CustomerOutpostArn", String.to_query f))
         ; Util.option_map v.customer_availability_zone (fun f ->
               Query.Pair ("CustomerAvailabilityZone", String.to_query f))
         ; Util.option_map v.source_cache_node_id (fun f ->
               Query.Pair ("SourceCacheNodeId", String.to_query f))
         ; Util.option_map v.parameter_group_status (fun f ->
               Query.Pair ("ParameterGroupStatus", String.to_query f))
         ; Util.option_map v.endpoint (fun f ->
               Query.Pair ("Endpoint", Endpoint.to_query f))
         ; Util.option_map v.cache_node_create_time (fun f ->
               Query.Pair ("CacheNodeCreateTime", DateTime.to_query f))
         ; Util.option_map v.cache_node_status (fun f ->
               Query.Pair ("CacheNodeStatus", String.to_query f))
         ; Util.option_map v.cache_node_id (fun f ->
               Query.Pair ("CacheNodeId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.customer_outpost_arn (fun f ->
               "customer_outpost_arn", String.to_json f)
         ; Util.option_map v.customer_availability_zone (fun f ->
               "customer_availability_zone", String.to_json f)
         ; Util.option_map v.source_cache_node_id (fun f ->
               "source_cache_node_id", String.to_json f)
         ; Util.option_map v.parameter_group_status (fun f ->
               "parameter_group_status", String.to_json f)
         ; Util.option_map v.endpoint (fun f -> "endpoint", Endpoint.to_json f)
         ; Util.option_map v.cache_node_create_time (fun f ->
               "cache_node_create_time", DateTime.to_json f)
         ; Util.option_map v.cache_node_status (fun f ->
               "cache_node_status", String.to_json f)
         ; Util.option_map v.cache_node_id (fun f -> "cache_node_id", String.to_json f)
         ])
  ...
  let of_json j =
    ...
    ; parameter_group_status =
        Util.option_map (Json.lookup j "parameter_group_status") String.of_json
    ; source_cache_node_id =
        Util.option_map (Json.lookup j "source_cache_node_id") String.of_json
    ; customer_availability_zone =
        Util.option_map (Json.lookup j "customer_availability_zone") String.of_json
    ; customer_outpost_arn =
        Util.option_map (Json.lookup j "customer_outpost_arn") String.of_json
    }
end
...
module CacheNodeIdsList = struct
  ...
  let parse xml = Util.option_all (List.map String.parse (Xml.members "CacheNodeId" xml))
...
module CacheSecurityGroupMembership = struct
  ...
  let parse xml =
    Some
      { cache_security_group_name =
          Util.option_bind (Xml.member "CacheSecurityGroupName" xml) String.parse
      ; status = Util.option_bind (Xml.member "Status" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.status (fun f -> Query.Pair ("Status", String.to_query f))
         ; Util.option_map v.cache_security_group_name (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.status (fun f -> "status", String.to_json f)
         ; Util.option_map v.cache_security_group_name (fun f ->
               "cache_security_group_name", String.to_json f)
         ])

  let of_json j =
    { cache_security_group_name =
        Util.option_map (Json.lookup j "cache_security_group_name") String.of_json
    ; status = Util.option_map (Json.lookup j "status") String.of_json
    }
end
...
module SecurityGroupMembership = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.status (fun f -> Query.Pair ("Status", String.to_query f))
         ; Util.option_map v.security_group_id (fun f ->
               Query.Pair ("SecurityGroupId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.status (fun f -> "status", String.to_json f)
         ; Util.option_map v.security_group_id (fun f ->
               "security_group_id", String.to_json f)
         ])
  ...
  let of_json j =
    ...
    ; node_group_member_update_status =
        NodeGroupMemberUpdateStatusList.of_json
          (Util.of_option_exn (Json.lookup j "node_group_member_update_status"))
    }
end
...
module NodeGroup = struct
  ...
  let parse xml =
    Some
      ...
      ; status = Util.option_bind (Xml.member "Status" xml) String.parse
      ; primary_endpoint =
          Util.option_bind (Xml.member "PrimaryEndpoint" xml) Endpoint.parse
      ; reader_endpoint =
          Util.option_bind (Xml.member "ReaderEndpoint" xml) Endpoint.parse
      ; slots = Util.option_bind (Xml.member "Slots" xml) String.parse
      ; node_group_members =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "NodeGroupMembers" xml)
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.reader_endpoint (fun f ->
               Query.Pair ("ReaderEndpoint", Endpoint.to_query f))
         ; Util.option_map v.primary_endpoint (fun f ->
               Query.Pair ("PrimaryEndpoint", Endpoint.to_query f))
         ; Util.option_map v.status (fun f -> Query.Pair ("Status", String.to_query f))
         ; Util.option_map v.node_group_id (fun f ->
               Query.Pair ("NodeGroupId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("node_group_members", NodeGroupMemberList.to_json v.node_group_members)
         ; Util.option_map v.slots (fun f -> "slots", String.to_json f)
         ; Util.option_map v.reader_endpoint (fun f ->
               "reader_endpoint", Endpoint.to_json f)
         ; Util.option_map v.primary_endpoint (fun f ->
               "primary_endpoint", Endpoint.to_json f)
         ; Util.option_map v.status (fun f -> "status", String.to_json f)
         ; Util.option_map v.node_group_id (fun f -> "node_group_id", String.to_json f)
         ])
  ...
  let of_json j =
    ...
    ; status = Util.option_map (Json.lookup j "status") String.of_json
    ; primary_endpoint =
        Util.option_map (Json.lookup j "primary_endpoint") Endpoint.of_json
    ; reader_endpoint = Util.option_map (Json.lookup j "reader_endpoint") Endpoint.of_json
    ; slots = Util.option_map (Json.lookup j "slots") String.of_json
    ; node_group_members =
...
module ReshardingStatus = struct
  ...
  let parse xml =
    Some
      { slot_migration =
          Util.option_bind (Xml.member "SlotMigration" xml) SlotMigration.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.slot_migration (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.slot_migration (fun f ->
               "slot_migration", SlotMigration.to_json f)
         ])

  let of_json j =
    { slot_migration =
        Util.option_map (Json.lookup j "slot_migration") SlotMigration.of_json
    }
end
  ...
  let parse xml =
    Some
      { user_group_ids_to_add =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UserGroupIdsToAdd" xml) UserGroupIdList.parse)
      ; user_group_ids_to_remove =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "UserGroupIdsToRemove" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("user_group_ids_to_add", UserGroupIdList.to_json v.user_group_ids_to_add)
         ])
...
module CacheNodeTypeSpecificParameter = struct
  ...
  let parse xml =
    Some
      ...
      ; change_type = Util.option_bind (Xml.member "ChangeType" xml) ChangeType.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.change_type (fun f ->
               Query.Pair ("ChangeType", ChangeType.to_query f))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.change_type (fun f -> "change_type", ChangeType.to_json f)
         ; Some
             ( "cache_node_type_specific_values"
  ...
  let of_json j =
    ...
    ; cache_node_type_specific_values =
        CacheNodeTypeSpecificValueList.of_json
          (Util.of_option_exn (Json.lookup j "cache_node_type_specific_values"))
    ; change_type = Util.option_map (Json.lookup j "change_type") ChangeType.of_json
    }
end
...
module ReshardingConfigurationList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map ReshardingConfiguration.parse (Xml.members "ReshardingConfiguration" xml))
...
module NodeSnapshotList = struct
  ...
  let parse xml =
    Util.option_all (List.map NodeSnapshot.parse (Xml.members "NodeSnapshot" xml))
...
module GlobalNodeGroupList = struct
  ...
  let parse xml =
    Util.option_all (List.map GlobalNodeGroup.parse (Xml.members "GlobalNodeGroup" xml))
...
module GlobalReplicationGroupMemberList = struct
  ...
  let to_query v = Query.to_query_list GlobalReplicationGroupMember.to_query v
...
module Authentication = struct
  ...
  let parse xml =
    Some
      { type_ = Util.option_bind (Xml.member "Type" xml) AuthenticationType.parse
      ; password_count = Util.option_bind (Xml.member "PasswordCount" xml) Integer.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.password_count (fun f ->
               Query.Pair ("PasswordCount", Integer.to_query f))
         ; Util.option_map v.type_ (fun f ->
               Query.Pair ("Type", AuthenticationType.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.password_count (fun f -> "password_count", Integer.to_json f)
         ; Util.option_map v.type_ (fun f -> "type_", AuthenticationType.to_json f)
         ])

  let of_json j =
    { type_ = Util.option_map (Json.lookup j "type_") AuthenticationType.of_json
    ; password_count = Util.option_map (Json.lookup j "password_count") Integer.of_json
    }
end
...
module PreferredAvailabilityZoneList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "PreferredAvailabilityZone" xml))
...
module PreferredOutpostArnList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "PreferredOutpostArn" xml))
...
module CacheNodeList = struct
  ...
  let parse xml = Util.option_all (List.map CacheNode.parse (Xml.members "CacheNode" xml))
...
module CacheParameterGroupStatus = struct
  ...
  let parse xml =
    Some
      { cache_parameter_group_name =
          Util.option_bind (Xml.member "CacheParameterGroupName" xml) String.parse
      ; parameter_apply_status =
      ...
      ; cache_node_ids_to_reboot =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "CacheNodeIdsToReboot" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_parameter_group_name (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_parameter_group_name (fun f ->
               "cache_parameter_group_name", String.to_json f)
         ])

  let of_json j =
    { cache_parameter_group_name =
        Util.option_map (Json.lookup j "cache_parameter_group_name") String.of_json
    ; parameter_apply_status =
...
module CacheSecurityGroupMembershipList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map CacheSecurityGroupMembership.parse (Xml.members "CacheSecurityGroup" xml))

  let to_query v = Query.to_query_list CacheSecurityGroupMembership.to_query v
...
module NotificationConfiguration = struct
  ...
  let parse xml =
    Some
      { topic_arn = Util.option_bind (Xml.member "TopicArn" xml) String.parse
      ; topic_status = Util.option_bind (Xml.member "TopicStatus" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.topic_status (fun f ->
               Query.Pair ("TopicStatus", String.to_query f))
         ; Util.option_map v.topic_arn (fun f ->
               Query.Pair ("TopicArn", String.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.topic_status (fun f -> "topic_status", String.to_json f)
         ; Util.option_map v.topic_arn (fun f -> "topic_arn", String.to_json f)
         ])

  let of_json j =
    { topic_arn = Util.option_map (Json.lookup j "topic_arn") String.of_json
    ; topic_status = Util.option_map (Json.lookup j "topic_status") String.of_json
    }
end
...
module PendingModifiedValues = struct
  ...
  let parse xml =
    Some
      { num_cache_nodes = Util.option_bind (Xml.member "NumCacheNodes" xml) Integer.parse
      ; cache_node_ids_to_remove =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "CacheNodeIdsToRemove" xml)
               CacheNodeIdsList.parse)
      ; engine_version = Util.option_bind (Xml.member "EngineVersion" xml) String.parse
      ; cache_node_type = Util.option_bind (Xml.member "CacheNodeType" xml) String.parse
      ; auth_token_status =
          Util.option_bind (Xml.member "AuthTokenStatus" xml) AuthTokenUpdateStatus.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.auth_token_status (fun f ->
               Query.Pair ("AuthTokenStatus", AuthTokenUpdateStatus.to_query f))
         ; Util.option_map v.cache_node_type (fun f ->
               Query.Pair ("CacheNodeType", String.to_query f))
         ...
         ; Util.option_map v.num_cache_nodes (fun f ->
               Query.Pair ("NumCacheNodes", Integer.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.num_cache_nodes (fun f ->
               "num_cache_nodes", Integer.to_json f)
         ])

  let of_json j =
    { num_cache_nodes = Util.option_map (Json.lookup j "num_cache_nodes") Integer.of_json
    ; cache_node_ids_to_remove =
        CacheNodeIdsList.of_json
    ...
    ; cache_node_type = Util.option_map (Json.lookup j "cache_node_type") String.of_json
    ; auth_token_status =
        Util.option_map (Json.lookup j "auth_token_status") AuthTokenUpdateStatus.of_json
    }
end
...
module SecurityGroupMembershipList = struct
  ...
  let parse xml =
    Util.option_all (List.map SecurityGroupMembership.parse (Xml.members "member" xml))
...
module UserGroupPendingChanges = struct
  ...
  let parse xml =
    Some
      { user_ids_to_remove =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UserIdsToRemove" xml) UserIdList.parse)
      ; user_ids_to_add =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UserIdsToAdd" xml) UserIdList.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some
             (Query.Pair ("UserIdsToAdd.member", UserIdList.to_query v.user_ids_to_add))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("user_ids_to_remove", UserIdList.to_json v.user_ids_to_remove)
         ])

  let of_json j =
    { user_ids_to_remove =
        UserIdList.of_json (Util.of_option_exn (Json.lookup j "user_ids_to_remove"))
    ; user_ids_to_add =
        UserIdList.of_json (Util.of_option_exn (Json.lookup j "user_ids_to_add"))
    }
end
...
module CacheNodeUpdateStatusList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map CacheNodeUpdateStatus.parse (Xml.members "CacheNodeUpdateStatus" xml))
...
module NodeGroupUpdateStatusList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map NodeGroupUpdateStatus.parse (Xml.members "NodeGroupUpdateStatus" xml))
...
module ClusterIdList = struct
  ...
  let parse xml = Util.option_all (List.map String.parse (Xml.members "ClusterId" xml))
...
module GlobalReplicationGroupInfo = struct
  ...
  let parse xml =
    Some
      { global_replication_group_id =
          Util.option_bind (Xml.member "GlobalReplicationGroupId" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.global_replication_group_member_role (fun f ->
               Query.Pair ("GlobalReplicationGroupMemberRole", String.to_query f))
         ; Util.option_map v.global_replication_group_id (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.global_replication_group_id (fun f ->
               "global_replication_group_id", String.to_json f)
         ])

  let of_json j =
    { global_replication_group_id =
        Util.option_map (Json.lookup j "global_replication_group_id") String.of_json
    ; global_replication_group_member_role =
        Util.option_map
...
module NodeGroupList = struct
  ...
  let parse xml = Util.option_all (List.map NodeGroup.parse (Xml.members "NodeGroup" xml))
...
module ReplicationGroupOutpostArnList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "ReplicationGroupOutpostArn" xml))
...
module ReplicationGroupPendingModifiedValues = struct
  ...
  let parse xml =
    Some
      { primary_cluster_id =
          Util.option_bind (Xml.member "PrimaryClusterId" xml) String.parse
      ; automatic_failover_status =
          Util.option_bind
            (Xml.member "AutomaticFailoverStatus" xml)
            PendingAutomaticFailoverStatus.parse
      ; resharding = Util.option_bind (Xml.member "Resharding" xml) ReshardingStatus.parse
      ; auth_token_status =
          Util.option_bind (Xml.member "AuthTokenStatus" xml) AuthTokenUpdateStatus.parse
      ; user_groups =
          Util.option_bind (Xml.member "UserGroups" xml) UserGroupsUpdateStatus.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.user_groups (fun f ->
               Query.Pair ("UserGroups", UserGroupsUpdateStatus.to_query f))
         ; Util.option_map v.auth_token_status (fun f ->
               Query.Pair ("AuthTokenStatus", AuthTokenUpdateStatus.to_query f))
         ; Util.option_map v.resharding (fun f ->
               Query.Pair ("Resharding", ReshardingStatus.to_query f))
         ; Util.option_map v.automatic_failover_status (fun f ->
               Query.Pair
                 ("AutomaticFailoverStatus", PendingAutomaticFailoverStatus.to_query f))
         ; Util.option_map v.primary_cluster_id (fun f ->
               Query.Pair ("PrimaryClusterId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.user_groups (fun f ->
               "user_groups", UserGroupsUpdateStatus.to_json f)
         ; Util.option_map v.auth_token_status (fun f ->
               "auth_token_status", AuthTokenUpdateStatus.to_json f)
         ; Util.option_map v.resharding (fun f ->
               "resharding", ReshardingStatus.to_json f)
         ; Util.option_map v.automatic_failover_status (fun f ->
               "automatic_failover_status", PendingAutomaticFailoverStatus.to_json f)
         ; Util.option_map v.primary_cluster_id (fun f ->
               "primary_cluster_id", String.to_json f)
         ])

  let of_json j =
    { primary_cluster_id =
        Util.option_map (Json.lookup j "primary_cluster_id") String.of_json
    ; automatic_failover_status =
        Util.option_map
          (Json.lookup j "automatic_failover_status")
          PendingAutomaticFailoverStatus.of_json
    ; resharding = Util.option_map (Json.lookup j "resharding") ReshardingStatus.of_json
    ; auth_token_status =
        Util.option_map (Json.lookup j "auth_token_status") AuthTokenUpdateStatus.of_json
    ; user_groups =
        Util.option_map (Json.lookup j "user_groups") UserGroupsUpdateStatus.of_json
    }
end
...
module CacheParameterGroup = struct
  ...
  let parse xml =
    Some
      { cache_parameter_group_name =
          Util.option_bind (Xml.member "CacheParameterGroupName" xml) String.parse
      ; cache_parameter_group_family =
          Util.option_bind (Xml.member "CacheParameterGroupFamily" xml) String.parse
      ; description = Util.option_bind (Xml.member "Description" xml) String.parse
      ; is_global = Util.option_bind (Xml.member "IsGlobal" xml) Boolean.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.a_r_n (fun f -> Query.Pair ("ARN", String.to_query f))
         ; Util.option_map v.is_global (fun f ->
               Query.Pair ("IsGlobal", Boolean.to_query f))
         ; Util.option_map v.description (fun f ->
               Query.Pair ("Description", String.to_query f))
         ; Util.option_map v.cache_parameter_group_family (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.is_global (fun f -> "is_global", Boolean.to_json f)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.cache_parameter_group_family (fun f ->
               "cache_parameter_group_family", String.to_json f)
         ; Util.option_map v.cache_parameter_group_name (fun f ->
               "cache_parameter_group_name", String.to_json f)
         ])
  ...
  let of_json j =
    { cache_parameter_group_name =
        Util.option_map (Json.lookup j "cache_parameter_group_name") String.of_json
    ; cache_parameter_group_family =
        Util.option_map (Json.lookup j "cache_parameter_group_family") String.of_json
    ; description = Util.option_map (Json.lookup j "description") String.of_json
    ; is_global = Util.option_map (Json.lookup j "is_global") Boolean.of_json
...
module CacheSubnetGroup = struct
  ...
  let parse xml =
    Some
      { cache_subnet_group_name =
          Util.option_bind (Xml.member "CacheSubnetGroupName" xml) String.parse
      ; cache_subnet_group_description =
          Util.option_bind (Xml.member "CacheSubnetGroupDescription" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_subnet_group_description (fun f ->
               Query.Pair ("CacheSubnetGroupDescription", String.to_query f))
         ; Util.option_map v.cache_subnet_group_name (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_subnet_group_name (fun f ->
               "cache_subnet_group_name", String.to_json f)
         ])

  let of_json j =
    { cache_subnet_group_name =
        Util.option_map (Json.lookup j "cache_subnet_group_name") String.of_json
    ; cache_subnet_group_description =
        Util.option_map (Json.lookup j "cache_subnet_group_description") String.of_json
...
module CacheNodeTypeSpecificParametersList = struct
  ...
  let to_query v = Query.to_query_list CacheNodeTypeSpecificParameter.to_query v
    ...
    Some
      ...
      ; resharding_configuration =
          Xml.required
            ...
            (Util.option_bind
               (Xml.member "ReshardingConfiguration" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some
             (Query.Pair ("ReplicationGroupId", String.to_query v.replication_group_id))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("replication_group_region", String.to_json v.replication_group_region)
         ; Some ("replication_group_id", String.to_json v.replication_group_id)
         ])

  let of_json j =
    { replication_group_id =
        String.of_json (Util.of_option_exn (Json.lookup j "replication_group_id"))
    ; replication_group_region =
        String.of_json (Util.of_option_exn (Json.lookup j "replication_group_region"))
    ; resharding_configuration =
...
module ReservedCacheNodesOffering = struct
  ...
  let parse xml =
    Some
      { reserved_cache_nodes_offering_id =
          Util.option_bind (Xml.member "ReservedCacheNodesOfferingId" xml) String.parse
      ; cache_node_type = Util.option_bind (Xml.member "CacheNodeType" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_node_type (fun f ->
               Query.Pair ("CacheNodeType", String.to_query f))
         ; Util.option_map v.reserved_cache_nodes_offering_id (fun f ->
               Query.Pair ("ReservedCacheNodesOfferingId", String.to_query f))
         ])
  ...
  let of_json j =
    { reserved_cache_nodes_offering_id =
        Util.option_map (Json.lookup j "reserved_cache_nodes_offering_id") String.of_json
    ; cache_node_type = Util.option_map (Json.lookup j "cache_node_type") String.of_json
...
module Snapshot = struct
  ...
  let parse xml =
    Some
      { snapshot_name = Util.option_bind (Xml.member "SnapshotName" xml) String.parse
      ; replication_group_id =
          Util.option_bind (Xml.member "ReplicationGroupId" xml) String.parse
      ; replication_group_description =
          Util.option_bind (Xml.member "ReplicationGroupDescription" xml) String.parse
      ; cache_cluster_id = Util.option_bind (Xml.member "CacheClusterId" xml) String.parse
      ; snapshot_status = Util.option_bind (Xml.member "SnapshotStatus" xml) String.parse
      ; snapshot_source = Util.option_bind (Xml.member "SnapshotSource" xml) String.parse
      ; cache_node_type = Util.option_bind (Xml.member "CacheNodeType" xml) String.parse
      ...
      ; preferred_outpost_arn =
          Util.option_bind (Xml.member "PreferredOutpostArn" xml) String.parse
      ; cache_cluster_create_time =
          Util.option_bind (Xml.member "CacheClusterCreateTime" xml) DateTime.parse
      ; preferred_maintenance_window =
      ...
      ; snapshot_retention_limit =
          Util.option_bind (Xml.member "SnapshotRetentionLimit" xml) Integer.parse
      ; snapshot_window = Util.option_bind (Xml.member "SnapshotWindow" xml) String.parse
      ; num_node_groups = Util.option_bind (Xml.member "NumNodeGroups" xml) Integer.parse
      ; automatic_failover =
          Util.option_bind
            (Xml.member "AutomaticFailover" xml)
            AutomaticFailoverStatus.parse
      ; node_snapshots =
          Util.of_option
            []
            (Util.option_bind (Xml.member "NodeSnapshots" xml) NodeSnapshotList.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.automatic_failover (fun f ->
               Query.Pair ("AutomaticFailover", AutomaticFailoverStatus.to_query f))
         ; Util.option_map v.num_node_groups (fun f ->
               Query.Pair ("NumNodeGroups", Integer.to_query f))
         ; Util.option_map v.snapshot_window (fun f ->
               Query.Pair ("SnapshotWindow", String.to_query f))
         ; Util.option_map v.snapshot_retention_limit (fun f ->
         ...
         ; Util.option_map v.cache_cluster_create_time (fun f ->
         ...
         ; Util.option_map v.cache_node_type (fun f ->
               Query.Pair ("CacheNodeType", String.to_query f))
         ; Util.option_map v.snapshot_source (fun f ->
               Query.Pair ("SnapshotSource", String.to_query f))
         ; Util.option_map v.snapshot_status (fun f ->
               Query.Pair ("SnapshotStatus", String.to_query f))
         ; Util.option_map v.cache_cluster_id (fun f ->
               Query.Pair ("CacheClusterId", String.to_query f))
         ; Util.option_map v.replication_group_description (fun f ->
               Query.Pair ("ReplicationGroupDescription", String.to_query f))
         ; Util.option_map v.replication_group_id (fun f ->
               Query.Pair ("ReplicationGroupId", String.to_query f))
         ; Util.option_map v.snapshot_name (fun f ->
               Query.Pair ("SnapshotName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("node_snapshots", NodeSnapshotList.to_json v.node_snapshots)
         ; Util.option_map v.automatic_failover (fun f ->
               "automatic_failover", AutomaticFailoverStatus.to_json f)
         ; Util.option_map v.num_node_groups (fun f ->
               "num_node_groups", Integer.to_json f)
         ; Util.option_map v.snapshot_window (fun f ->
               "snapshot_window", String.to_json f)
         ; Util.option_map v.snapshot_retention_limit (fun f ->
               "snapshot_retention_limit", Integer.to_json f)
         ; Util.option_map v.auto_minor_version_upgrade (fun f ->
         ...
         ; Util.option_map v.cache_cluster_create_time (fun f ->
               "cache_cluster_create_time", DateTime.to_json f)
         ; Util.option_map v.preferred_outpost_arn (fun f ->
               "preferred_outpost_arn", String.to_json f)
         ; Util.option_map v.preferred_availability_zone (fun f ->
               "preferred_availability_zone", String.to_json f)
         ...
         ; Util.option_map v.cache_node_type (fun f ->
               "cache_node_type", String.to_json f)
         ; Util.option_map v.snapshot_source (fun f ->
               "snapshot_source", String.to_json f)
         ; Util.option_map v.snapshot_status (fun f ->
               "snapshot_status", String.to_json f)
         ; Util.option_map v.cache_cluster_id (fun f ->
               "cache_cluster_id", String.to_json f)
         ; Util.option_map v.replication_group_description (fun f ->
               "replication_group_description", String.to_json f)
         ; Util.option_map v.replication_group_id (fun f ->
               "replication_group_id", String.to_json f)
         ; Util.option_map v.snapshot_name (fun f -> "snapshot_name", String.to_json f)
         ])

  let of_json j =
    { snapshot_name = Util.option_map (Json.lookup j "snapshot_name") String.of_json
    ; replication_group_id =
        Util.option_map (Json.lookup j "replication_group_id") String.of_json
    ; replication_group_description =
        Util.option_map (Json.lookup j "replication_group_description") String.of_json
    ; cache_cluster_id = Util.option_map (Json.lookup j "cache_cluster_id") String.of_json
    ; snapshot_status = Util.option_map (Json.lookup j "snapshot_status") String.of_json
    ; snapshot_source = Util.option_map (Json.lookup j "snapshot_source") String.of_json
    ; cache_node_type = Util.option_map (Json.lookup j "cache_node_type") String.of_json
    ...
    ; preferred_outpost_arn =
        Util.option_map (Json.lookup j "preferred_outpost_arn") String.of_json
    ; cache_cluster_create_time =
        Util.option_map (Json.lookup j "cache_cluster_create_time") DateTime.of_json
    ; preferred_maintenance_window =
    ...
    ; snapshot_retention_limit =
        Util.option_map (Json.lookup j "snapshot_retention_limit") Integer.of_json
    ; snapshot_window = Util.option_map (Json.lookup j "snapshot_window") String.of_json
    ; num_node_groups = Util.option_map (Json.lookup j "num_node_groups") Integer.of_json
    ; automatic_failover =
        Util.option_map
          (Json.lookup j "automatic_failover")
          AutomaticFailoverStatus.of_json
    ; node_snapshots =
        NodeSnapshotList.of_json (Util.of_option_exn (Json.lookup j "node_snapshots"))
...
module GlobalReplicationGroup = struct
    ...
    Some
      ...
      ; members =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "Members" xml)
               GlobalReplicationGroupMemberList.parse)
      ; cluster_enabled = Util.option_bind (Xml.member "ClusterEnabled" xml) Boolean.parse
      ; global_node_groups =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "GlobalNodeGroups" xml)
               GlobalNodeGroupList.parse)
      ; auth_token_enabled =
          Util.option_bind (Xml.member "AuthTokenEnabled" xml) Boolean.parse
      ; transit_encryption_enabled =
          Util.option_bind (Xml.member "TransitEncryptionEnabled" xml) Boolean.parse
      ; at_rest_encryption_enabled =
          Util.option_bind (Xml.member "AtRestEncryptionEnabled" xml) Boolean.parse
      ; a_r_n = Util.option_bind (Xml.member "ARN" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.a_r_n (fun f -> Query.Pair ("ARN", String.to_query f))
         ; Util.option_map v.at_rest_encryption_enabled (fun f ->
               Query.Pair ("AtRestEncryptionEnabled", Boolean.to_query f))
         ; Util.option_map v.transit_encryption_enabled (fun f ->
               Query.Pair ("TransitEncryptionEnabled", Boolean.to_query f))
         ; Util.option_map v.auth_token_enabled (fun f ->
               Query.Pair ("AuthTokenEnabled", Boolean.to_query f))
         ; Some
             (Query.Pair
                ( "GlobalNodeGroups.member"
                , GlobalNodeGroupList.to_query v.global_node_groups ))
         ; Util.option_map v.cluster_enabled (fun f ->
               Query.Pair ("ClusterEnabled", Boolean.to_query f))
         ; Some
             (Query.Pair
         ...
         ; Util.option_map v.cache_node_type (fun f ->
               Query.Pair ("CacheNodeType", String.to_query f))
         ; Util.option_map v.status (fun f -> Query.Pair ("Status", String.to_query f))
         ; Util.option_map v.global_replication_group_description (fun f ->
               Query.Pair ("GlobalReplicationGroupDescription", String.to_query f))
         ; Util.option_map v.global_replication_group_id (fun f ->
               Query.Pair ("GlobalReplicationGroupId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.a_r_n (fun f -> "a_r_n", String.to_json f)
         ; Util.option_map v.at_rest_encryption_enabled (fun f ->
               "at_rest_encryption_enabled", Boolean.to_json f)
         ; Util.option_map v.transit_encryption_enabled (fun f ->
               "transit_encryption_enabled", Boolean.to_json f)
         ; Util.option_map v.auth_token_enabled (fun f ->
               "auth_token_enabled", Boolean.to_json f)
         ; Some ("global_node_groups", GlobalNodeGroupList.to_json v.global_node_groups)
         ; Util.option_map v.cluster_enabled (fun f ->
               "cluster_enabled", Boolean.to_json f)
  ...
  let of_json j =
    ...
    ; cluster_enabled = Util.option_map (Json.lookup j "cluster_enabled") Boolean.of_json
    ; global_node_groups =
        GlobalNodeGroupList.of_json
          (Util.of_option_exn (Json.lookup j "global_node_groups"))
    ; auth_token_enabled =
        Util.option_map (Json.lookup j "auth_token_enabled") Boolean.of_json
    ; transit_encryption_enabled =
        Util.option_map (Json.lookup j "transit_encryption_enabled") Boolean.of_json
    ; at_rest_encryption_enabled =
        Util.option_map (Json.lookup j "at_rest_encryption_enabled") Boolean.of_json
    ; a_r_n = Util.option_map (Json.lookup j "a_r_n") String.of_json
    }
end
...
module ServiceUpdate = struct
  ...
  let parse xml =
    Some
      { service_update_name =
          Util.option_bind (Xml.member "ServiceUpdateName" xml) String.parse
      ; service_update_release_date =
          Util.option_bind (Xml.member "ServiceUpdateReleaseDate" xml) DateTime.parse
      ; service_update_end_date =
          Util.option_bind (Xml.member "ServiceUpdateEndDate" xml) DateTime.parse
      ; service_update_severity =
          Util.option_bind
            (Xml.member "ServiceUpdateSeverity" xml)
      ...
      ; service_update_status =
          Util.option_bind
            (Xml.member "ServiceUpdateStatus" xml)
            ServiceUpdateStatus.parse
      ; service_update_description =
          Util.option_bind (Xml.member "ServiceUpdateDescription" xml) String.parse
      ; service_update_type =
          Util.option_bind (Xml.member "ServiceUpdateType" xml) ServiceUpdateType.parse
      ; engine = Util.option_bind (Xml.member "Engine" xml) String.parse
      ; engine_version = Util.option_bind (Xml.member "EngineVersion" xml) String.parse
      ; auto_update_after_recommended_apply_by_date =
          Util.option_bind
            ...
            Boolean.parse
      ; estimated_update_time =
          Util.option_bind (Xml.member "EstimatedUpdateTime" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.estimated_update_time (fun f ->
               Query.Pair ("EstimatedUpdateTime", String.to_query f))
         ; Util.option_map v.auto_update_after_recommended_apply_by_date (fun f ->
               Query.Pair ("AutoUpdateAfterRecommendedApplyByDate", Boolean.to_query f))
         ; Util.option_map v.engine_version (fun f ->
               Query.Pair ("EngineVersion", String.to_query f))
         ; Util.option_map v.engine (fun f -> Query.Pair ("Engine", String.to_query f))
         ; Util.option_map v.service_update_type (fun f ->
               Query.Pair ("ServiceUpdateType", ServiceUpdateType.to_query f))
         ; Util.option_map v.service_update_description (fun f ->
               Query.Pair ("ServiceUpdateDescription", String.to_query f))
         ; Util.option_map v.service_update_status (fun f ->
               Query.Pair ("ServiceUpdateStatus", ServiceUpdateStatus.to_query f))
         ; Util.option_map v.service_update_recommended_apply_by_date (fun f ->
               Query.Pair ("ServiceUpdateRecommendedApplyByDate", DateTime.to_query f))
         ; Util.option_map v.service_update_severity (fun f ->
               Query.Pair ("ServiceUpdateSeverity", ServiceUpdateSeverity.to_query f))
         ; Util.option_map v.service_update_end_date (fun f ->
               Query.Pair ("ServiceUpdateEndDate", DateTime.to_query f))
         ; Util.option_map v.service_update_release_date (fun f ->
               Query.Pair ("ServiceUpdateReleaseDate", DateTime.to_query f))
         ; Util.option_map v.service_update_name (fun f ->
               Query.Pair ("ServiceUpdateName", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.estimated_update_time (fun f ->
               "estimated_update_time", String.to_json f)
         ; Util.option_map v.auto_update_after_recommended_apply_by_date (fun f ->
               "auto_update_after_recommended_apply_by_date", Boolean.to_json f)
         ; Util.option_map v.engine_version (fun f -> "engine_version", String.to_json f)
         ; Util.option_map v.engine (fun f -> "engine", String.to_json f)
         ; Util.option_map v.service_update_type (fun f ->
               "service_update_type", ServiceUpdateType.to_json f)
         ; Util.option_map v.service_update_description (fun f ->
               "service_update_description", String.to_json f)
         ; Util.option_map v.service_update_status (fun f ->
               "service_update_status", ServiceUpdateStatus.to_json f)
         ; Util.option_map v.service_update_recommended_apply_by_date (fun f ->
               "service_update_recommended_apply_by_date", DateTime.to_json f)
         ; Util.option_map v.service_update_severity (fun f ->
               "service_update_severity", ServiceUpdateSeverity.to_json f)
         ; Util.option_map v.service_update_end_date (fun f ->
               "service_update_end_date", DateTime.to_json f)
         ; Util.option_map v.service_update_release_date (fun f ->
               "service_update_release_date", DateTime.to_json f)
         ; Util.option_map v.service_update_name (fun f ->
               "service_update_name", String.to_json f)
         ])

  let of_json j =
    { service_update_name =
        Util.option_map (Json.lookup j "service_update_name") String.of_json
    ; service_update_release_date =
        Util.option_map (Json.lookup j "service_update_release_date") DateTime.of_json
    ; service_update_end_date =
        Util.option_map (Json.lookup j "service_update_end_date") DateTime.of_json
    ; service_update_severity =
        Util.option_map
          (Json.lookup j "service_update_severity")
    ...
    ; service_update_status =
        Util.option_map
          (Json.lookup j "service_update_status")
          ServiceUpdateStatus.of_json
    ; service_update_description =
        Util.option_map (Json.lookup j "service_update_description") String.of_json
    ; service_update_type =
        Util.option_map (Json.lookup j "service_update_type") ServiceUpdateType.of_json
    ; engine = Util.option_map (Json.lookup j "engine") String.of_json
    ; engine_version = Util.option_map (Json.lookup j "engine_version") String.of_json
    ; auto_update_after_recommended_apply_by_date =
        Util.option_map
          ...
          Boolean.of_json
    ; estimated_update_time =
        Util.option_map (Json.lookup j "estimated_update_time") String.of_json
    }
end
...
module User = struct
  ...
  let parse xml =
    Some
      ...
      ; status = Util.option_bind (Xml.member "Status" xml) String.parse
      ; engine = Util.option_bind (Xml.member "Engine" xml) String.parse
      ; access_string = Util.option_bind (Xml.member "AccessString" xml) String.parse
      ; user_group_ids =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UserGroupIds" xml) UserGroupIdList.parse)
      ; authentication =
          Util.option_bind (Xml.member "Authentication" xml) Authentication.parse
      ; a_r_n = Util.option_bind (Xml.member "ARN" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.a_r_n (fun f -> Query.Pair ("ARN", String.to_query f))
         ; Util.option_map v.authentication (fun f ->
               Query.Pair ("Authentication", Authentication.to_query f))
         ; Some
             (Query.Pair ("UserGroupIds.member", UserGroupIdList.to_query v.user_group_ids))
         ; Util.option_map v.access_string (fun f ->
               Query.Pair ("AccessString", String.to_query f))
         ; Util.option_map v.engine (fun f -> Query.Pair ("Engine", String.to_query f))
         ; Util.option_map v.status (fun f -> Query.Pair ("Status", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("user_group_ids", UserGroupIdList.to_json v.user_group_ids)
         ; Util.option_map v.access_string (fun f -> "access_string", String.to_json f)
         ; Util.option_map v.engine (fun f -> "engine", String.to_json f)
         ; Util.option_map v.status (fun f -> "status", String.to_json f)
         ; Util.option_map v.user_name (fun f -> "user_name", String.to_json f)
         ; Util.option_map v.user_id (fun f -> "user_id", String.to_json f)
         ])
  ...
  let of_json j =
    ...
    ; status = Util.option_map (Json.lookup j "status") String.of_json
    ; engine = Util.option_map (Json.lookup j "engine") String.of_json
    ; access_string = Util.option_map (Json.lookup j "access_string") String.of_json
    ; user_group_ids =
        UserGroupIdList.of_json (Util.of_option_exn (Json.lookup j "user_group_ids"))
    ; authentication =
        Util.option_map (Json.lookup j "authentication") Authentication.of_json
    ; a_r_n = Util.option_map (Json.lookup j "a_r_n") String.of_json
    }
end
...
module ConfigureShard = struct
  ...
  let parse xml =
    Some
      ...
      ; new_replica_count =
          Xml.required
            "NewReplicaCount"
            (Util.option_bind (Xml.member "NewReplicaCount" xml) Integer.parse)
      ; preferred_availability_zones =
          Util.of_option
            []
            (Util.option_bind
      ...
      ; preferred_outpost_arns =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "PreferredOutpostArns" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some (Query.Pair ("NewReplicaCount", Integer.to_query v.new_replica_count))
         ; Some (Query.Pair ("NodeGroupId", String.to_query v.node_group_id))
         ])
  ...
  let of_json j =
    { node_group_id = String.of_json (Util.of_option_exn (Json.lookup j "node_group_id"))
    ; new_replica_count =
        Integer.of_json (Util.of_option_exn (Json.lookup j "new_replica_count"))
    ; preferred_availability_zones =
...
module CacheCluster = struct
  ...
  let parse xml =
    Some
      { cache_cluster_id = Util.option_bind (Xml.member "CacheClusterId" xml) String.parse
      ; configuration_endpoint =
          Util.option_bind (Xml.member "ConfigurationEndpoint" xml) Endpoint.parse
      ; client_download_landing_page =
          Util.option_bind (Xml.member "ClientDownloadLandingPage" xml) String.parse
      ; cache_node_type = Util.option_bind (Xml.member "CacheNodeType" xml) String.parse
      ; engine = Util.option_bind (Xml.member "Engine" xml) String.parse
      ; engine_version = Util.option_bind (Xml.member "EngineVersion" xml) String.parse
      ; cache_cluster_status =
          Util.option_bind (Xml.member "CacheClusterStatus" xml) String.parse
      ; num_cache_nodes = Util.option_bind (Xml.member "NumCacheNodes" xml) Integer.parse
      ; preferred_availability_zone =
          Util.option_bind (Xml.member "PreferredAvailabilityZone" xml) String.parse
      ; preferred_outpost_arn =
      ...
      ; cache_security_groups =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "CacheSecurityGroups" xml)
               CacheSecurityGroupMembershipList.parse)
      ; cache_parameter_group =
          Util.option_bind
            (Xml.member "CacheParameterGroup" xml)
      ...
      ; cache_nodes =
          Util.of_option
            []
            (Util.option_bind (Xml.member "CacheNodes" xml) CacheNodeList.parse)
      ; auto_minor_version_upgrade =
          Util.option_bind (Xml.member "AutoMinorVersionUpgrade" xml) Boolean.parse
      ; security_groups =
          Util.of_option
      ...
      ; auth_token_enabled =
          Util.option_bind (Xml.member "AuthTokenEnabled" xml) Boolean.parse
      ; auth_token_last_modified_date =
          Util.option_bind (Xml.member "AuthTokenLastModifiedDate" xml) DateTime.parse
      ; transit_encryption_enabled =
          Util.option_bind (Xml.member "TransitEncryptionEnabled" xml) Boolean.parse
      ; at_rest_encryption_enabled =
          Util.option_bind (Xml.member "AtRestEncryptionEnabled" xml) Boolean.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.transit_encryption_enabled (fun f ->
               Query.Pair ("TransitEncryptionEnabled", Boolean.to_query f))
         ; Util.option_map v.auth_token_last_modified_date (fun f ->
               Query.Pair ("AuthTokenLastModifiedDate", DateTime.to_query f))
         ; Util.option_map v.auth_token_enabled (fun f ->
               Query.Pair ("AuthTokenEnabled", Boolean.to_query f))
         ; Util.option_map v.snapshot_window (fun f ->
               Query.Pair ("SnapshotWindow", String.to_query f))
         ...
         ; Util.option_map v.auto_minor_version_upgrade (fun f ->
               Query.Pair ("AutoMinorVersionUpgrade", Boolean.to_query f))
         ; Some (Query.Pair ("CacheNodes.member", CacheNodeList.to_query v.cache_nodes))
         ; Util.option_map v.cache_subnet_group_name (fun f ->
               Query.Pair ("CacheSubnetGroupName", String.to_query f))
         ; Util.option_map v.cache_parameter_group (fun f ->
               Query.Pair ("CacheParameterGroup", CacheParameterGroupStatus.to_query f))
         ; Some
             (Query.Pair
                ( "CacheSecurityGroups.member"
                , CacheSecurityGroupMembershipList.to_query v.cache_security_groups ))
         ; Util.option_map v.notification_configuration (fun f ->
               Query.Pair
         ...
         ; Util.option_map v.num_cache_nodes (fun f ->
               Query.Pair ("NumCacheNodes", Integer.to_query f))
         ; Util.option_map v.cache_cluster_status (fun f ->
         ...
         ; Util.option_map v.cache_node_type (fun f ->
               Query.Pair ("CacheNodeType", String.to_query f))
         ; Util.option_map v.client_download_landing_page (fun f ->
               Query.Pair ("ClientDownloadLandingPage", String.to_query f))
         ; Util.option_map v.configuration_endpoint (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.replication_group_id (fun f ->
               "replication_group_id", String.to_json f)
         ; Some ("security_groups", SecurityGroupMembershipList.to_json v.security_groups)
         ; Util.option_map v.auto_minor_version_upgrade (fun f ->
               "auto_minor_version_upgrade", Boolean.to_json f)
         ...
         ; Util.option_map v.cache_subnet_group_name (fun f ->
               "cache_subnet_group_name", String.to_json f)
         ; Util.option_map v.cache_parameter_group (fun f ->
               "cache_parameter_group", CacheParameterGroupStatus.to_json f)
         ; Some
             ( "cache_security_groups"
             , CacheSecurityGroupMembershipList.to_json v.cache_security_groups )
         ; Util.option_map v.notification_configuration (fun f ->
               "notification_configuration", NotificationConfiguration.to_json f)
         ; Util.option_map v.pending_modified_values (fun f ->
         ...
         ; Util.option_map v.num_cache_nodes (fun f ->
               "num_cache_nodes", Integer.to_json f)
         ; Util.option_map v.cache_cluster_status (fun f ->
               "cache_cluster_status", String.to_json f)
         ; Util.option_map v.engine_version (fun f -> "engine_version", String.to_json f)
         ; Util.option_map v.engine (fun f -> "engine", String.to_json f)
         ; Util.option_map v.cache_node_type (fun f ->
               "cache_node_type", String.to_json f)
         ; Util.option_map v.client_download_landing_page (fun f ->
               "client_download_landing_page", String.to_json f)
         ; Util.option_map v.configuration_endpoint (fun f ->
               "configuration_endpoint", Endpoint.to_json f)
         ; Util.option_map v.cache_cluster_id (fun f ->
               "cache_cluster_id", String.to_json f)
         ])
  ...
  let of_json j =
    { cache_cluster_id = Util.option_map (Json.lookup j "cache_cluster_id") String.of_json
    ; configuration_endpoint =
        Util.option_map (Json.lookup j "configuration_endpoint") Endpoint.of_json
    ; client_download_landing_page =
        Util.option_map (Json.lookup j "client_download_landing_page") String.of_json
    ; cache_node_type = Util.option_map (Json.lookup j "cache_node_type") String.of_json
    ; engine = Util.option_map (Json.lookup j "engine") String.of_json
    ; engine_version = Util.option_map (Json.lookup j "engine_version") String.of_json
    ; cache_cluster_status =
        Util.option_map (Json.lookup j "cache_cluster_status") String.of_json
    ; num_cache_nodes = Util.option_map (Json.lookup j "num_cache_nodes") Integer.of_json
    ; preferred_availability_zone =
        Util.option_map (Json.lookup j "preferred_availability_zone") String.of_json
    ; preferred_outpost_arn =
    ...
    ; notification_configuration =
        Util.option_map
          (Json.lookup j "notification_configuration")
    ...
    ; cache_parameter_group =
        Util.option_map
          (Json.lookup j "cache_parameter_group")
          CacheParameterGroupStatus.of_json
    ; cache_subnet_group_name =
        Util.option_map (Json.lookup j "cache_subnet_group_name") String.of_json
    ; cache_nodes =
        CacheNodeList.of_json (Util.of_option_exn (Json.lookup j "cache_nodes"))
    ; auto_minor_version_upgrade =
        Util.option_map (Json.lookup j "auto_minor_version_upgrade") Boolean.of_json
    ; security_groups =
    ...
    ; auth_token_enabled =
        Util.option_map (Json.lookup j "auth_token_enabled") Boolean.of_json
    ; auth_token_last_modified_date =
        Util.option_map (Json.lookup j "auth_token_last_modified_date") DateTime.of_json
    ; transit_encryption_enabled =
        Util.option_map (Json.lookup j "transit_encryption_enabled") Boolean.of_json
    ; at_rest_encryption_enabled =
        Util.option_map (Json.lookup j "at_rest_encryption_enabled") Boolean.of_json
...
module UserGroup = struct
  ...
  let parse xml =
    Some
      { user_group_id = Util.option_bind (Xml.member "UserGroupId" xml) String.parse
      ; status = Util.option_bind (Xml.member "Status" xml) String.parse
      ; engine = Util.option_bind (Xml.member "Engine" xml) String.parse
      ; user_ids =
          Util.of_option [] (Util.option_bind (Xml.member "UserIds" xml) UserIdList.parse)
      ; pending_changes =
          Util.option_bind (Xml.member "PendingChanges" xml) UserGroupPendingChanges.parse
      ; replication_groups =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ReplicationGroups" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.pending_changes (fun f ->
               Query.Pair ("PendingChanges", UserGroupPendingChanges.to_query f))
         ; Some (Query.Pair ("UserIds.member", UserIdList.to_query v.user_ids))
         ; Util.option_map v.engine (fun f -> Query.Pair ("Engine", String.to_query f))
         ; Util.option_map v.status (fun f -> Query.Pair ("Status", String.to_query f))
         ; Util.option_map v.user_group_id (fun f ->
               Query.Pair ("UserGroupId", String.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.a_r_n (fun f -> "a_r_n", String.to_json f)
         ; Some
             ("replication_groups", UGReplicationGroupIdList.to_json v.replication_groups)
         ; Util.option_map v.pending_changes (fun f ->
               "pending_changes", UserGroupPendingChanges.to_json f)
         ; Some ("user_ids", UserIdList.to_json v.user_ids)
         ; Util.option_map v.engine (fun f -> "engine", String.to_json f)
         ; Util.option_map v.status (fun f -> "status", String.to_json f)
         ; Util.option_map v.user_group_id (fun f -> "user_group_id", String.to_json f)
         ])

  let of_json j =
    { user_group_id = Util.option_map (Json.lookup j "user_group_id") String.of_json
    ; status = Util.option_map (Json.lookup j "status") String.of_json
    ; engine = Util.option_map (Json.lookup j "engine") String.of_json
    ; user_ids = UserIdList.of_json (Util.of_option_exn (Json.lookup j "user_ids"))
    ; pending_changes =
        Util.option_map (Json.lookup j "pending_changes") UserGroupPendingChanges.of_json
    ; replication_groups =
...
module UpdateAction = struct
  ...
  let parse xml =
    Some
      ...
      ; service_update_type =
          Util.option_bind (Xml.member "ServiceUpdateType" xml) ServiceUpdateType.parse
      ; update_action_available_date =
          Util.option_bind (Xml.member "UpdateActionAvailableDate" xml) DateTime.parse
      ; update_action_status =
          Util.option_bind (Xml.member "UpdateActionStatus" xml) UpdateActionStatus.parse
      ; nodes_updated = Util.option_bind (Xml.member "NodesUpdated" xml) String.parse
      ; update_action_status_modified_date =
          Util.option_bind
      ...
      ; node_group_update_status =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "NodeGroupUpdateStatus" xml)
               NodeGroupUpdateStatusList.parse)
      ; cache_node_update_status =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "CacheNodeUpdateStatus" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.sla_met (fun f -> Query.Pair ("SlaMet", SlaMet.to_query f))
         ; Util.option_map v.update_action_status_modified_date (fun f ->
               Query.Pair ("UpdateActionStatusModifiedDate", DateTime.to_query f))
         ; Util.option_map v.nodes_updated (fun f ->
               Query.Pair ("NodesUpdated", String.to_query f))
         ; Util.option_map v.update_action_status (fun f ->
               Query.Pair ("UpdateActionStatus", UpdateActionStatus.to_query f))
         ; Util.option_map v.update_action_available_date (fun f ->
               Query.Pair ("UpdateActionAvailableDate", DateTime.to_query f))
         ; Util.option_map v.service_update_type (fun f ->
               Query.Pair ("ServiceUpdateType", ServiceUpdateType.to_query f))
         ; Util.option_map v.service_update_recommended_apply_by_date (fun f ->
               Query.Pair ("ServiceUpdateRecommendedApplyByDate", DateTime.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.sla_met (fun f -> "sla_met", SlaMet.to_json f)
         ; Util.option_map v.update_action_status_modified_date (fun f ->
               "update_action_status_modified_date", DateTime.to_json f)
         ; Util.option_map v.nodes_updated (fun f -> "nodes_updated", String.to_json f)
         ; Util.option_map v.update_action_status (fun f ->
               "update_action_status", UpdateActionStatus.to_json f)
         ; Util.option_map v.update_action_available_date (fun f ->
               "update_action_available_date", DateTime.to_json f)
         ; Util.option_map v.service_update_type (fun f ->
               "service_update_type", ServiceUpdateType.to_json f)
         ; Util.option_map v.service_update_recommended_apply_by_date (fun f ->
               "service_update_recommended_apply_by_date", DateTime.to_json f)
  ...
  let of_json j =
    ...
    ; service_update_type =
        Util.option_map (Json.lookup j "service_update_type") ServiceUpdateType.of_json
    ; update_action_available_date =
        Util.option_map (Json.lookup j "update_action_available_date") DateTime.of_json
    ; update_action_status =
        Util.option_map (Json.lookup j "update_action_status") UpdateActionStatus.of_json
    ; nodes_updated = Util.option_map (Json.lookup j "nodes_updated") String.of_json
    ; update_action_status_modified_date =
        Util.option_map
...
module UnprocessedUpdateAction = struct
  ...
  let parse xml =
    Some
      ...
      ; service_update_name =
          Util.option_bind (Xml.member "ServiceUpdateName" xml) String.parse
      ; error_type = Util.option_bind (Xml.member "ErrorType" xml) String.parse
      ; error_message = Util.option_bind (Xml.member "ErrorMessage" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.error_type (fun f ->
               Query.Pair ("ErrorType", String.to_query f))
         ; Util.option_map v.service_update_name (fun f ->
               Query.Pair ("ServiceUpdateName", String.to_query f))
         ; Util.option_map v.cache_cluster_id (fun f ->
               Query.Pair ("CacheClusterId", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.error_message (fun f -> "error_message", String.to_json f)
         ; Util.option_map v.error_type (fun f -> "error_type", String.to_json f)
         ; Util.option_map v.service_update_name (fun f ->
               "service_update_name", String.to_json f)
         ; Util.option_map v.cache_cluster_id (fun f ->
               "cache_cluster_id", String.to_json f)
  ...
  let of_json j =
    ...
    ; service_update_name =
        Util.option_map (Json.lookup j "service_update_name") String.of_json
    ; error_type = Util.option_map (Json.lookup j "error_type") String.of_json
    ; error_message = Util.option_map (Json.lookup j "error_message") String.of_json
    }
end
...
module ReplicationGroup = struct
  ...
  let parse xml =
    Some
      ...
      ; global_replication_group_info =
          Util.option_bind
            (Xml.member "GlobalReplicationGroupInfo" xml)
      ...
      ; member_clusters =
          Util.of_option
            []
            (Util.option_bind (Xml.member "MemberClusters" xml) ClusterIdList.parse)
      ; node_groups =
          Util.of_option
            []
            (Util.option_bind (Xml.member "NodeGroups" xml) NodeGroupList.parse)
      ; snapshotting_cluster_id =
          Util.option_bind (Xml.member "SnapshottingClusterId" xml) String.parse
      ; automatic_failover =
          Util.option_bind
            (Xml.member "AutomaticFailover" xml)
            AutomaticFailoverStatus.parse
      ; multi_a_z = Util.option_bind (Xml.member "MultiAZ" xml) MultiAZStatus.parse
      ; configuration_endpoint =
          Util.option_bind (Xml.member "ConfigurationEndpoint" xml) Endpoint.parse
      ; snapshot_retention_limit =
          Util.option_bind (Xml.member "SnapshotRetentionLimit" xml) Integer.parse
      ...
      ; member_clusters_outpost_arns =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "MemberClustersOutpostArns" xml)
    ...
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.multi_a_z (fun f ->
               Query.Pair ("MultiAZ", MultiAZStatus.to_query f))
         ; Util.option_map v.automatic_failover (fun f ->
               Query.Pair ("AutomaticFailover", AutomaticFailoverStatus.to_query f))
         ; Util.option_map v.snapshotting_cluster_id (fun f ->
               Query.Pair ("SnapshottingClusterId", String.to_query f))
         ; Some (Query.Pair ("NodeGroups.member", NodeGroupList.to_query v.node_groups))
         ; Some
             (Query.Pair
         ...
         ; Util.option_map v.status (fun f -> Query.Pair ("Status", String.to_query f))
         ; Util.option_map v.global_replication_group_info (fun f ->
               Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.configuration_endpoint (fun f ->
               "configuration_endpoint", Endpoint.to_json f)
         ; Util.option_map v.multi_a_z (fun f -> "multi_a_z", MultiAZStatus.to_json f)
         ; Util.option_map v.automatic_failover (fun f ->
               "automatic_failover", AutomaticFailoverStatus.to_json f)
         ; Util.option_map v.snapshotting_cluster_id (fun f ->
               "snapshotting_cluster_id", String.to_json f)
         ; Some ("node_groups", NodeGroupList.to_json v.node_groups)
         ; Some ("member_clusters", ClusterIdList.to_json v.member_clusters)
         ; Util.option_map v.pending_modified_values (fun f ->
               "pending_modified_values", ReplicationGroupPendingModifiedValues.to_json f)
         ; Util.option_map v.status (fun f -> "status", String.to_json f)
         ; Util.option_map v.global_replication_group_info (fun f ->
               "global_replication_group_info", GlobalReplicationGroupInfo.to_json f)
         ; Util.option_map v.description (fun f -> "description", String.to_json f)
         ; Util.option_map v.replication_group_id (fun f ->
               "replication_group_id", String.to_json f)
         ])
  ...
  let of_json j =
    ...
    ; global_replication_group_info =
        Util.option_map
          (Json.lookup j "global_replication_group_info")
    ...
    ; member_clusters =
        ClusterIdList.of_json (Util.of_option_exn (Json.lookup j "member_clusters"))
    ; node_groups =
        NodeGroupList.of_json (Util.of_option_exn (Json.lookup j "node_groups"))
    ; snapshotting_cluster_id =
        Util.option_map (Json.lookup j "snapshotting_cluster_id") String.of_json
    ; automatic_failover =
        Util.option_map
          (Json.lookup j "automatic_failover")
          AutomaticFailoverStatus.of_json
    ; multi_a_z = Util.option_map (Json.lookup j "multi_a_z") MultiAZStatus.of_json
    ; configuration_endpoint =
        Util.option_map (Json.lookup j "configuration_endpoint") Endpoint.of_json
    ; snapshot_retention_limit =
        Util.option_map (Json.lookup j "snapshot_retention_limit") Integer.of_json
    ...
    ; member_clusters_outpost_arns =
        ReplicationGroupOutpostArnList.of_json
          (Util.of_option_exn (Json.lookup j "member_clusters_outpost_arns"))
    ; kms_key_id = Util.option_map (Json.lookup j "kms_key_id") String.of_json
    ; a_r_n = Util.option_map (Json.lookup j "a_r_n") String.of_json
    ; user_group_ids =
        UserGroupIdList.of_json (Util.of_option_exn (Json.lookup j "user_group_ids"))
...
module CacheEngineVersion = struct
  ...
  let parse xml =
    Some
      ...
      ; cache_parameter_group_family =
          Util.option_bind (Xml.member "CacheParameterGroupFamily" xml) String.parse
      ; cache_engine_description =
          Util.option_bind (Xml.member "CacheEngineDescription" xml) String.parse
      ; cache_engine_version_description =
          Util.option_bind (Xml.member "CacheEngineVersionDescription" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.cache_engine_version_description (fun f ->
               Query.Pair ("CacheEngineVersionDescription", String.to_query f))
         ; Util.option_map v.cache_engine_description (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_engine_description (fun f ->
               "cache_engine_description", String.to_json f)
         ; Util.option_map v.cache_parameter_group_family (fun f ->
               "cache_parameter_group_family", String.to_json f)
         ; Util.option_map v.engine_version (fun f -> "engine_version", String.to_json f)
         ; Util.option_map v.engine (fun f -> "engine", String.to_json f)
  ...
  let of_json j =
    ...
    ; cache_parameter_group_family =
        Util.option_map (Json.lookup j "cache_parameter_group_family") String.of_json
    ; cache_engine_description =
        Util.option_map (Json.lookup j "cache_engine_description") String.of_json
    ; cache_engine_version_description =
        Util.option_map (Json.lookup j "cache_engine_version_description") String.of_json
    }
end
...
module ReservedCacheNode = struct
  ...
  let parse xml =
    Some
      { reserved_cache_node_id =
          Util.option_bind (Xml.member "ReservedCacheNodeId" xml) String.parse
      ; reserved_cache_nodes_offering_id =
          Util.option_bind (Xml.member "ReservedCacheNodesOfferingId" xml) String.parse
      ; cache_node_type = Util.option_bind (Xml.member "CacheNodeType" xml) String.parse
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.reservation_a_r_n (fun f ->
               Query.Pair ("ReservationARN", String.to_query f))
         ; Some
             (Query.Pair
                ( "RecurringCharges.member"
                , RecurringChargeList.to_query v.recurring_charges ))
         ...
         ; Util.option_map v.product_description (fun f ->
               Query.Pair ("ProductDescription", String.to_query f))
         ; Util.option_map v.cache_node_count (fun f ->
               Query.Pair ("CacheNodeCount", Integer.to_query f))
         ; Util.option_map v.usage_price (fun f ->
               Query.Pair ("UsagePrice", Double.to_query f))
         ; Util.option_map v.fixed_price (fun f ->
               Query.Pair ("FixedPrice", Double.to_query f))
         ...
         ; Util.option_map v.reserved_cache_nodes_offering_id (fun f ->
               Query.Pair ("ReservedCacheNodesOfferingId", String.to_query f))
         ; Util.option_map v.reserved_cache_node_id (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.reservation_a_r_n (fun f ->
               "reservation_a_r_n", String.to_json f)
         ; Some ("recurring_charges", RecurringChargeList.to_json v.recurring_charges)
         ...
         ; Util.option_map v.product_description (fun f ->
               "product_description", String.to_json f)
         ; Util.option_map v.cache_node_count (fun f ->
               "cache_node_count", Integer.to_json f)
         ; Util.option_map v.usage_price (fun f -> "usage_price", Double.to_json f)
         ; Util.option_map v.fixed_price (fun f -> "fixed_price", Double.to_json f)
         ; Util.option_map v.duration (fun f -> "duration", Integer.to_json f)
         ...
         ; Util.option_map v.reserved_cache_nodes_offering_id (fun f ->
               "reserved_cache_nodes_offering_id", String.to_json f)
         ; Util.option_map v.reserved_cache_node_id (fun f ->
               "reserved_cache_node_id", String.to_json f)
         ])

  let of_json j =
    { reserved_cache_node_id =
        Util.option_map (Json.lookup j "reserved_cache_node_id") String.of_json
    ; reserved_cache_nodes_offering_id =
        Util.option_map (Json.lookup j "reserved_cache_nodes_offering_id") String.of_json
    ; cache_node_type = Util.option_map (Json.lookup j "cache_node_type") String.of_json
...
module CacheParameterGroupList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map CacheParameterGroup.parse (Xml.members "CacheParameterGroup" xml))
...
module CacheSubnetGroups = struct
  ...
  let parse xml =
    Util.option_all (List.map CacheSubnetGroup.parse (Xml.members "CacheSubnetGroup" xml))
...
module GlobalNodeGroupIdList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "GlobalNodeGroupId" xml))
...
module CacheSecurityGroupNameList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "CacheSecurityGroupName" xml))
...
module NodeGroupConfigurationList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map NodeGroupConfiguration.parse (Xml.members "NodeGroupConfiguration" xml))
...
module SecurityGroupIdsList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "SecurityGroupId" xml))
...
module SnapshotArnsList = struct
  ...
  let parse xml = Util.option_all (List.map String.parse (Xml.members "SnapshotArn" xml))
  ...
  let of_json j =
    ...
    ; cache_node_type_specific_parameters =
        CacheNodeTypeSpecificParametersList.of_json
          (Util.of_option_exn (Json.lookup j "cache_node_type_specific_parameters"))
    }
end
...
module RegionalConfigurationList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map RegionalConfiguration.parse (Xml.members "RegionalConfiguration" xml))
...
module CacheSecurityGroups = struct
  ...
  let parse xml =
    Util.option_all
      (List.map CacheSecurityGroup.parse (Xml.members "CacheSecurityGroup" xml))
...
module FilterList = struct
  ...
  let parse xml = Util.option_all (List.map Filter.parse (Xml.members "member" xml))
...
module CustomerNodeEndpointList = struct
  ...
  let parse xml =
    Util.option_all (List.map CustomerNodeEndpoint.parse (Xml.members "member" xml))
...
module ReservedCacheNodesOfferingList = struct
  ...
  let to_query v = Query.to_query_list ReservedCacheNodesOffering.to_query v
...
module SnapshotList = struct
  ...
  let parse xml = Util.option_all (List.map Snapshot.parse (Xml.members "Snapshot" xml))
...
module ServiceUpdateStatusList = struct
  ...
  let parse xml =
    Util.option_all (List.map ServiceUpdateStatus.parse (Xml.members "member" xml))
...
module GlobalReplicationGroupList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map GlobalReplicationGroup.parse (Xml.members "GlobalReplicationGroup" xml))
...
module ServiceUpdateList = struct
  ...
  let parse xml =
    Util.option_all (List.map ServiceUpdate.parse (Xml.members "ServiceUpdate" xml))
...
module UserList = struct
  ...
  let parse xml = Util.option_all (List.map User.parse (Xml.members "member" xml))
...
module ReplicaConfigurationList = struct
  ...
  let parse xml =
    Util.option_all (List.map ConfigureShard.parse (Xml.members "ConfigureShard" xml))
...
module ParameterNameValueList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map ParameterNameValue.parse (Xml.members "ParameterNameValue" xml))
...
module CacheClusterList = struct
  ...
  let parse xml =
    Util.option_all (List.map CacheCluster.parse (Xml.members "CacheCluster" xml))
...
module UserGroupList = struct
  ...
  let parse xml = Util.option_all (List.map UserGroup.parse (Xml.members "member" xml))
...
module NodeGroupsToRemoveList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "NodeGroupToRemove" xml))
...
module NodeGroupsToRetainList = struct
  ...
  let parse xml =
    Util.option_all (List.map String.parse (Xml.members "NodeGroupToRetain" xml))
...
module UpdateActionStatusList = struct
  ...
  let parse xml =
    Util.option_all (List.map UpdateActionStatus.parse (Xml.members "member" xml))
...
module UpdateActionList = struct
  ...
  let parse xml =
    Util.option_all (List.map UpdateAction.parse (Xml.members "UpdateAction" xml))
...
module ProcessedUpdateActionList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map ProcessedUpdateAction.parse (Xml.members "ProcessedUpdateAction" xml))
...
module UnprocessedUpdateActionList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map UnprocessedUpdateAction.parse (Xml.members "UnprocessedUpdateAction" xml))
...
module ReplicationGroupList = struct
  ...
  let parse xml =
    Util.option_all (List.map ReplicationGroup.parse (Xml.members "ReplicationGroup" xml))
...
module CacheEngineVersionList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map CacheEngineVersion.parse (Xml.members "CacheEngineVersion" xml))
...
module ReservedCacheNodeList = struct
  ...
  let parse xml =
    Util.option_all
      (List.map ReservedCacheNode.parse (Xml.members "ReservedCacheNode" xml))
    ...
    Some
      ...
      ; cache_parameter_groups =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "CacheParameterGroups" xml)
...
module DescribeCacheClustersMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; marker = Util.option_bind (Xml.member "Marker" xml) String.parse
      ; show_cache_node_info =
          Util.option_bind (Xml.member "ShowCacheNodeInfo" xml) Boolean.parse
      ; show_cache_clusters_not_in_replication_groups =
          Util.option_bind
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.show_cache_clusters_not_in_replication_groups (fun f ->
               Query.Pair ("ShowCacheClustersNotInReplicationGroups", Boolean.to_query f))
         ; Util.option_map v.show_cache_node_info (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.show_cache_clusters_not_in_replication_groups (fun f ->
               "show_cache_clusters_not_in_replication_groups", Boolean.to_json f)
         ; Util.option_map v.show_cache_node_info (fun f ->
               "show_cache_node_info", Boolean.to_json f)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
  ...
  let of_json j =
    ...
    ; marker = Util.option_map (Json.lookup j "marker") String.of_json
    ; show_cache_node_info =
        Util.option_map (Json.lookup j "show_cache_node_info") Boolean.of_json
    ; show_cache_clusters_not_in_replication_groups =
        Util.option_map
...
module CreateReplicationGroupResult = struct
  ...
  let parse xml =
    Some
      { replication_group =
          Util.option_bind (Xml.member "ReplicationGroup" xml) ReplicationGroup.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.replication_group (fun f ->
               Query.Pair ("ReplicationGroup", ReplicationGroup.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.replication_group (fun f ->
               "replication_group", ReplicationGroup.to_json f)
         ])

  let of_json j =
    { replication_group =
        Util.option_map (Json.lookup j "replication_group") ReplicationGroup.of_json
    }
end
...
module CreateUserMessage = struct
  ...
  let parse xml =
    Some
      { user_id =
          Xml.required "UserId" (Util.option_bind (Xml.member "UserId" xml) String.parse)
      ; user_name =
          Xml.required
            "UserName"
      ...
      ; passwords =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Passwords" xml) PasswordListInput.parse)
      ; access_string =
          Xml.required
            "AccessString"
            (Util.option_bind (Xml.member "AccessString" xml) String.parse)
      ; no_password_required =
          Util.option_bind (Xml.member "NoPasswordRequired" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.no_password_required (fun f ->
               Query.Pair ("NoPasswordRequired", Boolean.to_query f))
         ; Some (Query.Pair ("AccessString", String.to_query v.access_string))
         ; Some (Query.Pair ("Passwords.member", PasswordListInput.to_query v.passwords))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.no_password_required (fun f ->
               "no_password_required", Boolean.to_json f)
  ...
  let of_json j =
    { user_id = String.of_json (Util.of_option_exn (Json.lookup j "user_id"))
    ; user_name = String.of_json (Util.of_option_exn (Json.lookup j "user_name"))
    ; engine = String.of_json (Util.of_option_exn (Json.lookup j "engine"))
    ; passwords =
        PasswordListInput.of_json (Util.of_option_exn (Json.lookup j "passwords"))
    ; access_string = String.of_json (Util.of_option_exn (Json.lookup j "access_string"))
    ; no_password_required =
        Util.option_map (Json.lookup j "no_password_required") Boolean.of_json
    }
end
...
module ModifyCacheSubnetGroupResult = struct
  ...
  let parse xml =
    Some
      { cache_subnet_group =
          Util.option_bind (Xml.member "CacheSubnetGroup" xml) CacheSubnetGroup.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.cache_subnet_group (fun f ->
               Query.Pair ("CacheSubnetGroup", CacheSubnetGroup.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.cache_subnet_group (fun f ->
               "cache_subnet_group", CacheSubnetGroup.to_json f)
         ])

  let of_json j =
    { cache_subnet_group =
        Util.option_map (Json.lookup j "cache_subnet_group") CacheSubnetGroup.of_json
    }
end
...
module DeleteCacheClusterResult = struct
  ...
  let parse xml =
    Some
      { cache_cluster =
          Util.option_bind (Xml.member "CacheCluster" xml) CacheCluster.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.cache_cluster (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.cache_cluster (fun f ->
               "cache_cluster", CacheCluster.to_json f)
         ])

  let of_json j =
    { cache_cluster = Util.option_map (Json.lookup j "cache_cluster") CacheCluster.of_json
    }
end
...
module DeleteUserMessage = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt [ Some (Query.Pair ("UserId", String.to_query v.user_id)) ])

  let to_json v =
    `Assoc (Util.list_filter_opt [ Some ("user_id", String.to_json v.user_id) ])
...
module DescribeGlobalReplicationGroupsMessage = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.show_member_info (fun f ->
               Query.Pair ("ShowMemberInfo", Boolean.to_query f))
         ; Util.option_map v.marker (fun f -> Query.Pair ("Marker", String.to_query f))
         ; Util.option_map v.max_records (fun f ->
               Query.Pair ("MaxRecords", Integer.to_query f))
         ; Util.option_map v.global_replication_group_id (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.show_member_info (fun f ->
               "show_member_info", Boolean.to_json f)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
         ; Util.option_map v.max_records (fun f -> "max_records", Integer.to_json f)
         ; Util.option_map v.global_replication_group_id (fun f ->
               "global_replication_group_id", String.to_json f)
...
module CacheSubnetGroupMessage = struct
    ...
    Some
      ...
      ; cache_subnet_groups =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "CacheSubnetGroups" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("cache_subnet_groups", CacheSubnetGroups.to_json v.cache_subnet_groups)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
         ])
...
module DeleteCacheParameterGroupMessage = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("cache_parameter_group_name", String.to_json v.cache_parameter_group_name)
         ])

  let of_json j =
    { cache_parameter_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "cache_parameter_group_name"))
    }
end
...
module PurchaseReservedCacheNodesOfferingMessage = struct
  ...
  let of_json j =
    { reserved_cache_nodes_offering_id =
        String.of_json
          (Util.of_option_exn (Json.lookup j "reserved_cache_nodes_offering_id"))
    ; reserved_cache_node_id =
        Util.option_map (Json.lookup j "reserved_cache_node_id") String.of_json
    ; cache_node_count =
        Util.option_map (Json.lookup j "cache_node_count") Integer.of_json
...
module CreateUserGroupMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; user_ids =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UserIds" xml) UserIdListInput.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("UserIds.member", UserIdListInput.to_query v.user_ids))
         ; Some (Query.Pair ("Engine", String.to_query v.engine))
         ; Some (Query.Pair ("UserGroupId", String.to_query v.user_group_id))
         ])
  ...
  let of_json j =
    { user_group_id = String.of_json (Util.of_option_exn (Json.lookup j "user_group_id"))
    ; engine = String.of_json (Util.of_option_exn (Json.lookup j "engine"))
    ; user_ids = UserIdListInput.of_json (Util.of_option_exn (Json.lookup j "user_ids"))
    }
end
...
module RevokeCacheSecurityGroupIngressResult = struct
  ...
  let parse xml =
    Some
      { cache_security_group =
          Util.option_bind (Xml.member "CacheSecurityGroup" xml) CacheSecurityGroup.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.cache_security_group (fun f ->
               Query.Pair ("CacheSecurityGroup", CacheSecurityGroup.to_query f))
         ])
  ...
  let of_json j =
    { cache_security_group =
        Util.option_map (Json.lookup j "cache_security_group") CacheSecurityGroup.of_json
    }
end
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.cache_subnet_group_description (fun f ->
               "cache_subnet_group_description", String.to_json f)
         ; Some ("cache_subnet_group_name", String.to_json v.cache_subnet_group_name)
         ])

  let of_json j =
    { cache_subnet_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "cache_subnet_group_name"))
    ; cache_subnet_group_description =
        Util.option_map (Json.lookup j "cache_subnet_group_description") String.of_json
    ; subnet_ids =
...
module DecreaseNodeGroupsInGlobalReplicationGroupMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; node_group_count =
          Xml.required
            "NodeGroupCount"
            (Util.option_bind (Xml.member "NodeGroupCount" xml) Integer.parse)
      ; global_node_groups_to_remove =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "GlobalNodeGroupsToRemove" xml)
               GlobalNodeGroupIdList.parse)
      ; global_node_groups_to_retain =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "GlobalNodeGroupsToRetain" xml)
               GlobalNodeGroupIdList.parse)
      ; apply_immediately =
          Xml.required
            "ApplyImmediately"
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("ApplyImmediately", Boolean.to_query v.apply_immediately))
         ; Some
             (Query.Pair
         ...
         ; Some (Query.Pair ("NodeGroupCount", Integer.to_query v.node_group_count))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some
             ("global_replication_group_id", String.to_json v.global_replication_group_id)
         ])

  let of_json j =
    { global_replication_group_id =
        String.of_json (Util.of_option_exn (Json.lookup j "global_replication_group_id"))
    ; node_group_count =
        Integer.of_json (Util.of_option_exn (Json.lookup j "node_group_count"))
    ; global_node_groups_to_remove =
        GlobalNodeGroupIdList.of_json
          (Util.of_option_exn (Json.lookup j "global_node_groups_to_remove"))
    ; global_node_groups_to_retain =
        GlobalNodeGroupIdList.of_json
          (Util.of_option_exn (Json.lookup j "global_node_groups_to_retain"))
    ; apply_immediately =
        Boolean.of_json (Util.of_option_exn (Json.lookup j "apply_immediately"))
    }
end
...
module CreateReplicationGroupMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; primary_cluster_id =
          Util.option_bind (Xml.member "PrimaryClusterId" xml) String.parse
      ; automatic_failover_enabled =
          Util.option_bind (Xml.member "AutomaticFailoverEnabled" xml) Boolean.parse
      ; multi_a_z_enabled =
          Util.option_bind (Xml.member "MultiAZEnabled" xml) Boolean.parse
      ; num_cache_clusters =
          Util.option_bind (Xml.member "NumCacheClusters" xml) Integer.parse
      ; preferred_cache_cluster_a_zs =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "PreferredCacheClusterAZs" xml)
               AvailabilityZonesList.parse)
      ; num_node_groups = Util.option_bind (Xml.member "NumNodeGroups" xml) Integer.parse
      ; replicas_per_node_group =
          Util.option_bind (Xml.member "ReplicasPerNodeGroup" xml) Integer.parse
      ; node_group_configuration =
          Util.of_option
            []
            (Util.option_bind
      ...
      ; cache_security_group_names =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "CacheSecurityGroupNames" xml)
               CacheSecurityGroupNameList.parse)
      ; security_group_ids =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "SecurityGroupIds" xml)
               SecurityGroupIdsList.parse)
      ; tags = Util.of_option [] (Util.option_bind (Xml.member "Tags" xml) TagList.parse)
      ; snapshot_arns =
          Util.of_option
            []
            (Util.option_bind (Xml.member "SnapshotArns" xml) SnapshotArnsList.parse)
      ; snapshot_name = Util.option_bind (Xml.member "SnapshotName" xml) String.parse
      ; preferred_maintenance_window =
          Util.option_bind (Xml.member "PreferredMaintenanceWindow" xml) String.parse
      ; port = Util.option_bind (Xml.member "Port" xml) Integer.parse
      ; notification_topic_arn =
          Util.option_bind (Xml.member "NotificationTopicArn" xml) String.parse
      ; auto_minor_version_upgrade =
          Util.option_bind (Xml.member "AutoMinorVersionUpgrade" xml) Boolean.parse
      ; snapshot_retention_limit =
          Util.option_bind (Xml.member "SnapshotRetentionLimit" xml) Integer.parse
      ; snapshot_window = Util.option_bind (Xml.member "SnapshotWindow" xml) String.parse
      ; auth_token = Util.option_bind (Xml.member "AuthToken" xml) String.parse
      ; transit_encryption_enabled =
          Util.option_bind (Xml.member "TransitEncryptionEnabled" xml) Boolean.parse
      ; at_rest_encryption_enabled =
          Util.option_bind (Xml.member "AtRestEncryptionEnabled" xml) Boolean.parse
      ...
      ; user_group_ids =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UserGroupIds" xml) UserGroupIdListInput.parse)
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.transit_encryption_enabled (fun f ->
               Query.Pair ("TransitEncryptionEnabled", Boolean.to_query f))
         ; Util.option_map v.auth_token (fun f ->
               Query.Pair ("AuthToken", String.to_query f))
         ; Util.option_map v.snapshot_window (fun f ->
               Query.Pair ("SnapshotWindow", String.to_query f))
         ; Util.option_map v.snapshot_retention_limit (fun f ->
               Query.Pair ("SnapshotRetentionLimit", Integer.to_query f))
         ; Util.option_map v.auto_minor_version_upgrade (fun f ->
               Query.Pair ("AutoMinorVersionUpgrade", Boolean.to_query f))
         ; Util.option_map v.notification_topic_arn (fun f ->
         ...
         ; Util.option_map v.snapshot_name (fun f ->
               Query.Pair ("SnapshotName", String.to_query f))
         ; Some
             (Query.Pair ("SnapshotArns.member", SnapshotArnsList.to_query v.snapshot_arns))
         ...
         ; Util.option_map v.replicas_per_node_group (fun f ->
         ...
         ; Util.option_map v.num_cache_clusters (fun f ->
               Query.Pair ("NumCacheClusters", Integer.to_query f))
         ; Util.option_map v.multi_a_z_enabled (fun f ->
               Query.Pair ("MultiAZEnabled", Boolean.to_query f))
         ; Util.option_map v.automatic_failover_enabled (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("user_group_ids", UserGroupIdListInput.to_json v.user_group_ids)
         ; Util.option_map v.kms_key_id (fun f -> "kms_key_id", String.to_json f)
         ; Util.option_map v.at_rest_encryption_enabled (fun f ->
               "at_rest_encryption_enabled", Boolean.to_json f)
         ; Util.option_map v.transit_encryption_enabled (fun f ->
               "transit_encryption_enabled", Boolean.to_json f)
         ; Util.option_map v.auth_token (fun f -> "auth_token", String.to_json f)
         ; Util.option_map v.snapshot_window (fun f ->
               "snapshot_window", String.to_json f)
         ; Util.option_map v.snapshot_retention_limit (fun f ->
               "snapshot_retention_limit", Integer.to_json f)
         ; Util.option_map v.auto_minor_version_upgrade (fun f ->
               "auto_minor_version_upgrade", Boolean.to_json f)
         ; Util.option_map v.notification_topic_arn (fun f ->
               "notification_topic_arn", String.to_json f)
         ; Util.option_map v.port (fun f -> "port", Integer.to_json f)
         ; Util.option_map v.preferred_maintenance_window (fun f ->
               "preferred_maintenance_window", String.to_json f)
         ; Util.option_map v.snapshot_name (fun f -> "snapshot_name", String.to_json f)
         ...
         ; Some ("security_group_ids", SecurityGroupIdsList.to_json v.security_group_ids)
         ; Some
             ( "cache_security_group_names"
         ...
         ; Util.option_map v.replicas_per_node_group (fun f ->
               "replicas_per_node_group", Integer.to_json f)
         ; Util.option_map v.num_node_groups (fun f ->
               "num_node_groups", Integer.to_json f)
         ; Some
             ( "preferred_cache_cluster_a_zs"
         ...
         ; Util.option_map v.num_cache_clusters (fun f ->
               "num_cache_clusters", Integer.to_json f)
         ; Util.option_map v.multi_a_z_enabled (fun f ->
               "multi_a_z_enabled", Boolean.to_json f)
         ; Util.option_map v.automatic_failover_enabled (fun f ->
               "automatic_failover_enabled", Boolean.to_json f)
         ; Util.option_map v.primary_cluster_id (fun f ->
               "primary_cluster_id", String.to_json f)
         ; Util.option_map v.global_replication_group_id (fun f ->
               "global_replication_group_id", String.to_json f)
  ...
  let of_json j =
    ...
    ; replication_group_description =
        String.of_json
          (Util.of_option_exn (Json.lookup j "replication_group_description"))
    ; global_replication_group_id =
        Util.option_map (Json.lookup j "global_replication_group_id") String.of_json
    ; primary_cluster_id =
        Util.option_map (Json.lookup j "primary_cluster_id") String.of_json
    ; automatic_failover_enabled =
        Util.option_map (Json.lookup j "automatic_failover_enabled") Boolean.of_json
    ; multi_a_z_enabled =
        Util.option_map (Json.lookup j "multi_a_z_enabled") Boolean.of_json
    ; num_cache_clusters =
        Util.option_map (Json.lookup j "num_cache_clusters") Integer.of_json
    ; preferred_cache_cluster_a_zs =
        AvailabilityZonesList.of_json
          (Util.of_option_exn (Json.lookup j "preferred_cache_cluster_a_zs"))
    ; num_node_groups = Util.option_map (Json.lookup j "num_node_groups") Integer.of_json
    ; replicas_per_node_group =
        Util.option_map (Json.lookup j "replicas_per_node_group") Integer.of_json
    ; node_group_configuration =
    ...
    ; snapshot_arns =
        SnapshotArnsList.of_json (Util.of_option_exn (Json.lookup j "snapshot_arns"))
    ; snapshot_name = Util.option_map (Json.lookup j "snapshot_name") String.of_json
    ; preferred_maintenance_window =
        Util.option_map (Json.lookup j "preferred_maintenance_window") String.of_json
    ; port = Util.option_map (Json.lookup j "port") Integer.of_json
    ; notification_topic_arn =
        Util.option_map (Json.lookup j "notification_topic_arn") String.of_json
    ; auto_minor_version_upgrade =
        Util.option_map (Json.lookup j "auto_minor_version_upgrade") Boolean.of_json
    ; snapshot_retention_limit =
        Util.option_map (Json.lookup j "snapshot_retention_limit") Integer.of_json
    ; snapshot_window = Util.option_map (Json.lookup j "snapshot_window") String.of_json
    ; auth_token = Util.option_map (Json.lookup j "auth_token") String.of_json
    ; transit_encryption_enabled =
        Util.option_map (Json.lookup j "transit_encryption_enabled") Boolean.of_json
    ; at_rest_encryption_enabled =
        Util.option_map (Json.lookup j "at_rest_encryption_enabled") Boolean.of_json
    ; kms_key_id = Util.option_map (Json.lookup j "kms_key_id") String.of_json
    ; user_group_ids =
        UserGroupIdListInput.of_json (Util.of_option_exn (Json.lookup j "user_group_ids"))
    }
end
...
module CreateCacheSubnetGroupMessage = struct
  ...
  let of_json j =
    ...
    ; cache_subnet_group_description =
        String.of_json
          (Util.of_option_exn (Json.lookup j "cache_subnet_group_description"))
    ; subnet_ids =
        SubnetIdentifierList.of_json (Util.of_option_exn (Json.lookup j "subnet_ids"))
    }
end
...
module DeleteSnapshotResult = struct
  ...
  let parse xml =
    Some { snapshot = Util.option_bind (Xml.member "Snapshot" xml) Snapshot.parse }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.snapshot (fun f ->
               Query.Pair ("Snapshot", Snapshot.to_query f))
         ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.snapshot (fun f -> "snapshot", Snapshot.to_json f) ])

  let of_json j =
    { snapshot = Util.option_map (Json.lookup j "snapshot") Snapshot.of_json }
end
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("cache_security_group_name", String.to_json v.cache_security_group_name)
         ])

  let of_json j =
    { cache_security_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "cache_security_group_name"))
...
module BatchStopUpdateActionMessage = struct
    ...
    Some
      { replication_group_ids =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ReplicationGroupIds" xml)
               ReplicationGroupIdList.parse)
      ; cache_cluster_ids =
          Util.of_option
            []
            (Util.option_bind (Xml.member "CacheClusterIds" xml) CacheClusterIdList.parse)
      ; service_update_name =
          Xml.required
            "ServiceUpdateName"
            (Util.option_bind (Xml.member "ServiceUpdateName" xml) String.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("ServiceUpdateName", String.to_query v.service_update_name))
         ; Some
             (Query.Pair
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("service_update_name", String.to_json v.service_update_name)
         ; Some ("cache_cluster_ids", CacheClusterIdList.to_json v.cache_cluster_ids)
         ; Some
             ( "replication_group_ids"
  ...
  let of_json j =
    ...
    ; service_update_name =
        String.of_json (Util.of_option_exn (Json.lookup j "service_update_name"))
    }
end
...
module ModifyUserMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; access_string = Util.option_bind (Xml.member "AccessString" xml) String.parse
      ; append_access_string =
          Util.option_bind (Xml.member "AppendAccessString" xml) String.parse
      ; passwords =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Passwords" xml) PasswordListInput.parse)
    ...
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.no_password_required (fun f ->
               Query.Pair ("NoPasswordRequired", Boolean.to_query f))
         ; Some (Query.Pair ("Passwords.member", PasswordListInput.to_query v.passwords))
         ; Util.option_map v.append_access_string (fun f ->
               Query.Pair ("AppendAccessString", String.to_query f))
         ; Util.option_map v.access_string (fun f ->
               Query.Pair ("AccessString", String.to_query f))
         ; Some (Query.Pair ("UserId", String.to_query v.user_id))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("passwords", PasswordListInput.to_json v.passwords)
         ; Util.option_map v.append_access_string (fun f ->
               "append_access_string", String.to_json f)
         ; Util.option_map v.access_string (fun f -> "access_string", String.to_json f)
         ; Some ("user_id", String.to_json v.user_id)
         ])
  ...
  let of_json j =
    ...
    ; access_string = Util.option_map (Json.lookup j "access_string") String.of_json
    ; append_access_string =
        Util.option_map (Json.lookup j "append_access_string") String.of_json
    ; passwords =
        PasswordListInput.of_json (Util.of_option_exn (Json.lookup j "passwords"))
    ; no_password_required =
        Util.option_map (Json.lookup j "no_password_required") Boolean.of_json
...
module DescribeSnapshotsMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; max_records = Util.option_bind (Xml.member "MaxRecords" xml) Integer.parse
      ; show_node_group_config =
          Util.option_bind (Xml.member "ShowNodeGroupConfig" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.show_node_group_config (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.show_node_group_config (fun f ->
               "show_node_group_config", Boolean.to_json f)
         ; Util.option_map v.max_records (fun f -> "max_records", Integer.to_json f)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
         ; Util.option_map v.snapshot_source (fun f ->
               "snapshot_source", String.to_json f)
  ...
  let of_json j =
    ...
    ; max_records = Util.option_map (Json.lookup j "max_records") Integer.of_json
    ; show_node_group_config =
        Util.option_map (Json.lookup j "show_node_group_config") Boolean.of_json
    }
end
    ...
    Some
      ...
      ; regional_configurations =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "RegionalConfigurations" xml)
...
module AllowedNodeTypeModificationsMessage = struct
  ...
  let parse xml =
    Some
      { scale_up_modifications =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ScaleUpModifications" xml) NodeTypeList.parse)
      ; scale_down_modifications =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ScaleDownModifications" xml)
               NodeTypeList.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some
             ("scale_down_modifications", NodeTypeList.to_json v.scale_down_modifications)
         ; Some ("scale_up_modifications", NodeTypeList.to_json v.scale_up_modifications)
         ])

  let of_json j =
    { scale_up_modifications =
        NodeTypeList.of_json (Util.of_option_exn (Json.lookup j "scale_up_modifications"))
    ; scale_down_modifications =
...
module ModifyReplicationGroupMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; cache_parameter_group_name =
          Util.option_bind (Xml.member "CacheParameterGroupName" xml) String.parse
      ; notification_topic_status =
          Util.option_bind (Xml.member "NotificationTopicStatus" xml) String.parse
      ; apply_immediately =
          Util.option_bind (Xml.member "ApplyImmediately" xml) Boolean.parse
      ; engine_version = Util.option_bind (Xml.member "EngineVersion" xml) String.parse
      ; auto_minor_version_upgrade =
      ...
      ; auth_token_update_strategy =
          Util.option_bind
            (Xml.member "AuthTokenUpdateStrategy" xml)
      ...
      ; user_group_ids_to_remove =
          Util.of_option
            ...
            (Util.option_bind
               ...
               UserGroupIdList.parse)
      ; remove_user_groups =
          Util.option_bind (Xml.member "RemoveUserGroups" xml) Boolean.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.remove_user_groups (fun f ->
               Query.Pair ("RemoveUserGroups", Boolean.to_query f))
         ; Some
             (Query.Pair
                ( "UserGroupIdsToRemove.member"
                , UserGroupIdList.to_query v.user_group_ids_to_remove ))
         ; Some
             (Query.Pair
                ( "UserGroupIdsToAdd.member"
                , UserGroupIdList.to_query v.user_group_ids_to_add ))
         ; Util.option_map v.auth_token_update_strategy (fun f ->
               Query.Pair
         ...
         ; Util.option_map v.notification_topic_status (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.remove_user_groups (fun f ->
               "remove_user_groups", Boolean.to_json f)
         ; Some
             ( "user_group_ids_to_remove"
             , UserGroupIdList.to_json v.user_group_ids_to_remove )
         ; Some ("user_group_ids_to_add", UserGroupIdList.to_json v.user_group_ids_to_add)
         ; Util.option_map v.auth_token_update_strategy (fun f ->
               "auth_token_update_strategy", AuthTokenUpdateStrategyType.to_json f)
         ; Util.option_map v.auth_token (fun f -> "auth_token", String.to_json f)
         ; Util.option_map v.cache_node_type (fun f ->
               "cache_node_type", String.to_json f)
         ; Util.option_map v.snapshot_window (fun f ->
         ...
         ; Util.option_map v.notification_topic_status (fun f ->
               "notification_topic_status", String.to_json f)
         ; Util.option_map v.cache_parameter_group_name (fun f ->
               "cache_parameter_group_name", String.to_json f)
         ; Util.option_map v.notification_topic_arn (fun f ->
               "notification_topic_arn", String.to_json f)
  ...
  let of_json j =
    ...
    ; cache_parameter_group_name =
        Util.option_map (Json.lookup j "cache_parameter_group_name") String.of_json
    ; notification_topic_status =
        Util.option_map (Json.lookup j "notification_topic_status") String.of_json
    ; apply_immediately =
    ...
    ; auth_token_update_strategy =
        Util.option_map
          (Json.lookup j "auth_token_update_strategy")
    ...
    ; user_group_ids_to_remove =
        UserGroupIdList.of_json
          (Util.of_option_exn (Json.lookup j "user_group_ids_to_remove"))
    ; remove_user_groups =
        Util.option_map (Json.lookup j "remove_user_groups") Boolean.of_json
    }
end
...
module RebalanceSlotsInGlobalReplicationGroupResult = struct
  ...
  let parse xml =
    Some
      { global_replication_group =
          Util.option_bind
            (Xml.member "GlobalReplicationGroup" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.global_replication_group (fun f ->
               Query.Pair ("GlobalReplicationGroup", GlobalReplicationGroup.to_query f))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.global_replication_group (fun f ->
               "global_replication_group", GlobalReplicationGroup.to_json f)
         ])

  let of_json j =
    { global_replication_group =
        Util.option_map
          (Json.lookup j "global_replication_group")
...
module DeleteGlobalReplicationGroupMessage = struct
  ...
  let of_json j =
    ...
    ; retain_primary_replication_group =
        Boolean.of_json
          (Util.of_option_exn (Json.lookup j "retain_primary_replication_group"))
    }
end
...
module CacheSecurityGroupMessage = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some
             ("cache_security_groups", CacheSecurityGroups.to_json v.cache_security_groups)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
         ])
...
module DeleteSnapshotMessage = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("SnapshotName", String.to_query v.snapshot_name)) ])

  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Some ("snapshot_name", String.to_json v.snapshot_name) ])

  let of_json j =
    { snapshot_name = String.of_json (Util.of_option_exn (Json.lookup j "snapshot_name"))
    }
end
...
module ModifyCacheClusterMessage = struct
      ...
      ; cache_node_ids_to_remove =
          Util.of_option
            ...
            (Util.option_bind
               (Xml.member "CacheNodeIdsToRemove" xml)
               CacheNodeIdsList.parse)
      ; a_z_mode = Util.option_bind (Xml.member "AZMode" xml) AZMode.parse
      ; new_availability_zones =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "NewAvailabilityZones" xml)
               PreferredAvailabilityZoneList.parse)
      ; cache_security_group_names =
          Util.of_option
            []
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.a_z_mode (fun f -> Query.Pair ("AZMode", AZMode.to_query f))
         ; Some
             (Query.Pair
                ( "CacheNodeIdsToRemove.member"
                , CacheNodeIdsList.to_query v.cache_node_ids_to_remove ))
         ; Util.option_map v.num_cache_nodes (fun f ->
               Query.Pair ("NumCacheNodes", Integer.to_query f))
         ; Some (Query.Pair ("CacheClusterId", String.to_query v.cache_cluster_id))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.a_z_mode (fun f -> "a_z_mode", AZMode.to_json f)
         ; Some
             ( "cache_node_ids_to_remove"
             , CacheNodeIdsList.to_json v.cache_node_ids_to_remove )
         ; Util.option_map v.num_cache_nodes (fun f ->
  ...
  let of_json j =
    { cache_cluster_id =
        String.of_json (Util.of_option_exn (Json.lookup j "cache_cluster_id"))
    ; num_cache_nodes = Util.option_map (Json.lookup j "num_cache_nodes") Integer.of_json
    ; cache_node_ids_to_remove =
        CacheNodeIdsList.of_json
          (Util.of_option_exn (Json.lookup j "cache_node_ids_to_remove"))
    ; a_z_mode = Util.option_map (Json.lookup j "a_z_mode") AZMode.of_json
    ; new_availability_zones =
        PreferredAvailabilityZoneList.of_json
    ...
    Some
      ...
      ; customer_node_endpoint_list =
          Xml.required
            ...
            (Util.option_bind
               (Xml.member "CustomerNodeEndpointList" xml)
  ...
  let of_json j =
    ...
    ; customer_node_endpoint_list =
        CustomerNodeEndpointList.of_json
          (Util.of_option_exn (Json.lookup j "customer_node_endpoint_list"))
    }
end
...
module CreateGlobalReplicationGroupMessage = struct
    ...
    Some
      ...
      ; primary_replication_group_id =
          Xml.required
            ...
            (Util.option_bind (Xml.member "PrimaryReplicationGroupId" xml) String.parse)
      }
  ...
  let of_json j =
    { global_replication_group_id_suffix =
        String.of_json
          (Util.of_option_exn (Json.lookup j "global_replication_group_id_suffix"))
    ; global_replication_group_description =
        Util.option_map
          (Json.lookup j "global_replication_group_description")
          String.of_json
    ; primary_replication_group_id =
        String.of_json (Util.of_option_exn (Json.lookup j "primary_replication_group_id"))
    }
end
  ...
  let of_json j =
    ...
    ; reserved_cache_nodes_offerings =
        ReservedCacheNodesOfferingList.of_json
          (Util.of_option_exn (Json.lookup j "reserved_cache_nodes_offerings"))
    }
end
...
module DeleteCacheClusterMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; final_snapshot_identifier =
          Util.option_bind (Xml.member "FinalSnapshotIdentifier" xml) String.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.final_snapshot_identifier (fun f ->
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.final_snapshot_identifier (fun f ->
               "final_snapshot_identifier", String.to_json f)
         ; Some ("cache_cluster_id", String.to_json v.cache_cluster_id)
         ])
  ...
  let of_json j =
    { cache_cluster_id =
        String.of_json (Util.of_option_exn (Json.lookup j "cache_cluster_id"))
    ; final_snapshot_identifier =
        Util.option_map (Json.lookup j "final_snapshot_identifier") String.of_json
    }
end
...
module DescribeSnapshotsListMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; snapshots =
          Util.of_option
            []
            (Util.option_bind (Xml.member "Snapshots" xml) SnapshotList.parse)
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Some (Query.Pair ("Snapshots.member", SnapshotList.to_query v.snapshots))
         ; Util.option_map v.marker (fun f -> Query.Pair ("Marker", String.to_query f))
         ])
  ...
  let of_json j =
    { marker = Util.option_map (Json.lookup j "marker") String.of_json
    ; snapshots = SnapshotList.of_json (Util.of_option_exn (Json.lookup j "snapshots"))
    }
end
    ...
    Some
      ...
      ; global_replication_groups =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "GlobalReplicationGroups" xml)
...
module ServiceUpdatesMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; service_updates =
          Util.of_option
            []
            (Util.option_bind (Xml.member "ServiceUpdates" xml) ServiceUpdateList.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("service_updates", ServiceUpdateList.to_json v.service_updates)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
         ])
  ...
  let of_json j =
    { marker = Util.option_map (Json.lookup j "marker") String.of_json
    ; service_updates =
        ServiceUpdateList.of_json (Util.of_option_exn (Json.lookup j "service_updates"))
    }
end
...
module AuthorizeCacheSecurityGroupIngressMessage = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("e_c2_security_group_name", String.to_json v.e_c2_security_group_name)
         ; Some ("cache_security_group_name", String.to_json v.cache_security_group_name)
         ])
  ...
  let of_json j =
    { cache_security_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "cache_security_group_name"))
    ; e_c2_security_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "e_c2_security_group_name"))
    ; e_c2_security_group_owner_id =
        String.of_json (Util.of_option_exn (Json.lookup j "e_c2_security_group_owner_id"))
    }
end
...
module DescribeUsersResult = struct
  ...
  let parse xml =
    Some
      { users =
          Util.of_option [] (Util.option_bind (Xml.member "Users" xml) UserList.parse)
      ; marker = Util.option_bind (Xml.member "Marker" xml) String.parse
      }
  ...
  let of_json j =
    { users = UserList.of_json (Util.of_option_exn (Json.lookup j "users"))
    ; marker = Util.option_map (Json.lookup j "marker") String.of_json
    }
end
...
module DeleteReplicationGroupMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; retain_primary_cluster =
          Util.option_bind (Xml.member "RetainPrimaryCluster" xml) Boolean.parse
      ; final_snapshot_identifier =
          Util.option_bind (Xml.member "FinalSnapshotIdentifier" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.final_snapshot_identifier (fun f ->
               Query.Pair ("FinalSnapshotIdentifier", String.to_query f))
         ; Util.option_map v.retain_primary_cluster (fun f ->
    ...
    `Assoc
      (Util.list_filter_opt
         [ Util.option_map v.final_snapshot_identifier (fun f ->
               "final_snapshot_identifier", String.to_json f)
         ; Util.option_map v.retain_primary_cluster (fun f ->
               "retain_primary_cluster", Boolean.to_json f)
         ; Some ("replication_group_id", String.to_json v.replication_group_id)
         ])
  ...
  let of_json j =
    { replication_group_id =
        String.of_json (Util.of_option_exn (Json.lookup j "replication_group_id"))
    ; retain_primary_cluster =
        Util.option_map (Json.lookup j "retain_primary_cluster") Boolean.of_json
    ; final_snapshot_identifier =
        Util.option_map (Json.lookup j "final_snapshot_identifier") String.of_json
    }
end
...
module DeleteUserGroupMessage = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Some ("user_group_id", String.to_json v.user_group_id) ])
...
module DecreaseReplicaCountMessage = struct
    ...
    Some
      ...
      ; replica_configuration =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ReplicaConfiguration" xml)
               ReplicaConfigurationList.parse)
      ; replicas_to_remove =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ReplicasToRemove" xml)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.new_replica_count (fun f ->
               Query.Pair ("NewReplicaCount", Integer.to_query f))
         ; Some
             (Query.Pair ("ReplicationGroupId", String.to_query v.replication_group_id))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("apply_immediately", Boolean.to_json v.apply_immediately)
         ; Some ("replicas_to_remove", RemoveReplicasList.to_json v.replicas_to_remove)
         ; Some
             ( "replica_configuration"
             , ReplicaConfigurationList.to_json v.replica_configuration )
         ; Util.option_map v.new_replica_count (fun f ->
               "new_replica_count", Integer.to_json f)
         ; Some ("replication_group_id", String.to_json v.replication_group_id)
         ])
  ...
  let of_json j =
    { replication_group_id =
        String.of_json (Util.of_option_exn (Json.lookup j "replication_group_id"))
    ; new_replica_count =
        Util.option_map (Json.lookup j "new_replica_count") Integer.of_json
    ; replica_configuration =
    ...
    Some
      ...
      ; parameter_name_values =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ParameterNameValues" xml)
...
module CacheClusterMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; cache_clusters =
          Util.of_option
            []
            (Util.option_bind (Xml.member "CacheClusters" xml) CacheClusterList.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("cache_clusters", CacheClusterList.to_json v.cache_clusters)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
         ])
  ...
  let of_json j =
    { marker = Util.option_map (Json.lookup j "marker") String.of_json
    ; cache_clusters =
        CacheClusterList.of_json (Util.of_option_exn (Json.lookup j "cache_clusters"))
    }
end
...
module DescribeUserGroupsResult = struct
  ...
  let parse xml =
    Some
      { user_groups =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UserGroups" xml) UserGroupList.parse)
      ; marker = Util.option_bind (Xml.member "Marker" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.marker (fun f -> Query.Pair ("Marker", String.to_query f))
         ; Some (Query.Pair ("UserGroups.member", UserGroupList.to_query v.user_groups))
         ])
  ...
  let of_json j =
    { user_groups =
        UserGroupList.of_json (Util.of_option_exn (Json.lookup j "user_groups"))
    ; marker = Util.option_map (Json.lookup j "marker") String.of_json
    }
end
    ...
    Some
      ...
      ; node_groups_to_remove =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "NodeGroupsToRemove" xml)
               NodeGroupsToRemoveList.parse)
      ; node_groups_to_retain =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "NodeGroupsToRetain" xml)
...
module CreateCacheParameterGroupResult = struct
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.cache_parameter_group (fun f ->
               Query.Pair ("CacheParameterGroup", CacheParameterGroup.to_query f))
         ])
...
module DescribeUpdateActionsMessage = struct
      ...
      ; service_update_status =
          Util.of_option
            ...
            (Util.option_bind
               ...
               ServiceUpdateStatusList.parse)
      ; service_update_time_range =
          Util.option_bind (Xml.member "ServiceUpdateTimeRange" xml) TimeRangeFilter.parse
      ; update_action_status =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "UpdateActionStatus" xml)
               UpdateActionStatusList.parse)
      ; show_node_level_update_status =
          Util.option_bind (Xml.member "ShowNodeLevelUpdateStatus" xml) Boolean.parse
      ; max_records = Util.option_bind (Xml.member "MaxRecords" xml) Integer.parse
      ; marker = Util.option_bind (Xml.member "Marker" xml) String.parse
      }
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.max_records (fun f ->
               Query.Pair ("MaxRecords", Integer.to_query f))
         ; Util.option_map v.show_node_level_update_status (fun f ->
               Query.Pair ("ShowNodeLevelUpdateStatus", Boolean.to_query f))
         ; Some
             (Query.Pair
                ( "UpdateActionStatus.member"
                , UpdateActionStatusList.to_query v.update_action_status ))
         ; Util.option_map v.service_update_time_range (fun f ->
               Query.Pair ("ServiceUpdateTimeRange", TimeRangeFilter.to_query f))
         ; Some
             (Query.Pair
                ( "ServiceUpdateStatus.member"
                , ServiceUpdateStatusList.to_query v.service_update_status ))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.max_records (fun f -> "max_records", Integer.to_json f)
         ; Util.option_map v.show_node_level_update_status (fun f ->
               "show_node_level_update_status", Boolean.to_json f)
         ; Some
             ( "update_action_status"
  ...
  let of_json j =
    ...
    ; service_update_time_range =
        Util.option_map
          (Json.lookup j "service_update_time_range")
          TimeRangeFilter.of_json
    ; update_action_status =
        UpdateActionStatusList.of_json
          (Util.of_option_exn (Json.lookup j "update_action_status"))
    ; show_node_level_update_status =
        Util.option_map (Json.lookup j "show_node_level_update_status") Boolean.of_json
    ; max_records = Util.option_map (Json.lookup j "max_records") Integer.of_json
    ; marker = Util.option_map (Json.lookup j "marker") String.of_json
    }
end
...
module UpdateActionsMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; update_actions =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UpdateActions" xml) UpdateActionList.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("update_actions", UpdateActionList.to_json v.update_actions)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
         ])
  ...
  let of_json j =
    { marker = Util.option_map (Json.lookup j "marker") String.of_json
    ; update_actions =
        UpdateActionList.of_json (Util.of_option_exn (Json.lookup j "update_actions"))
    }
end
  ...
  let parse xml =
    Some
      { source_snapshot_name =
          Xml.required
            "SourceSnapshotName"
            (Util.option_bind (Xml.member "SourceSnapshotName" xml) String.parse)
      ; target_snapshot_name =
          Xml.required
            "TargetSnapshotName"
            (Util.option_bind (Xml.member "TargetSnapshotName" xml) String.parse)
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Some
             (Query.Pair ("TargetSnapshotName", String.to_query v.target_snapshot_name))
         ; Some
             (Query.Pair ("SourceSnapshotName", String.to_query v.source_snapshot_name))
         ])
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Some ("target_snapshot_name", String.to_json v.target_snapshot_name)
         ; Some ("source_snapshot_name", String.to_json v.source_snapshot_name)
         ])

  let of_json j =
    { source_snapshot_name =
        String.of_json (Util.of_option_exn (Json.lookup j "source_snapshot_name"))
    ; target_snapshot_name =
        String.of_json (Util.of_option_exn (Json.lookup j "target_snapshot_name"))
...
module CreateCacheClusterMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; snapshot_window = Util.option_bind (Xml.member "SnapshotWindow" xml) String.parse
      ; auth_token = Util.option_bind (Xml.member "AuthToken" xml) String.parse
      ; outpost_mode = Util.option_bind (Xml.member "OutpostMode" xml) OutpostMode.parse
      ; preferred_outpost_arn =
          Util.option_bind (Xml.member "PreferredOutpostArn" xml) String.parse
      ; preferred_outpost_arns =
          Util.of_option
  ...
  let to_query v =
    Query.List
      (Util.list_filter_opt
         ...
         ; Util.option_map v.preferred_outpost_arn (fun f ->
               Query.Pair ("PreferredOutpostArn", String.to_query f))
         ; Util.option_map v.outpost_mode (fun f ->
               Query.Pair ("OutpostMode", OutpostMode.to_query f))
         ; Util.option_map v.auth_token (fun f ->
               Query.Pair ("AuthToken", String.to_query f))
         ; Util.option_map v.snapshot_window (fun f ->
               Query.Pair ("SnapshotWindow", String.to_query f))
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         ...
         ; Util.option_map v.preferred_outpost_arn (fun f ->
               "preferred_outpost_arn", String.to_json f)
         ; Util.option_map v.outpost_mode (fun f -> "outpost_mode", OutpostMode.to_json f)
         ; Util.option_map v.auth_token (fun f -> "auth_token", String.to_json f)
         ; Util.option_map v.snapshot_window (fun f ->
               "snapshot_window", String.to_json f)
         ; Util.option_map v.snapshot_retention_limit (fun f ->
  ...
  let of_json j =
    ...
    ; snapshot_window = Util.option_map (Json.lookup j "snapshot_window") String.of_json
    ; auth_token = Util.option_map (Json.lookup j "auth_token") String.of_json
    ; outpost_mode = Util.option_map (Json.lookup j "outpost_mode") OutpostMode.of_json
    ; preferred_outpost_arn =
        Util.option_map (Json.lookup j "preferred_outpost_arn") String.of_json
    ; preferred_outpost_arns =
        PreferredOutpostArnList.of_json
    ...
    Some
      { processed_update_actions =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ProcessedUpdateActions" xml)
               ProcessedUpdateActionList.parse)
      ; unprocessed_update_actions =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "UnprocessedUpdateActions" xml)
...
module ReplicationGroupMessage = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("replication_groups", ReplicationGroupList.to_json v.replication_groups)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
         ])
...
module CreateCacheParameterGroupMessage = struct
  ...
  let of_json j =
    { cache_parameter_group_name =
        String.of_json (Util.of_option_exn (Json.lookup j "cache_parameter_group_name"))
    ; cache_parameter_group_family =
        String.of_json (Util.of_option_exn (Json.lookup j "cache_parameter_group_family"))
    ; description = String.of_json (Util.of_option_exn (Json.lookup j "description"))
    }
end
    ...
    Some
      ...
      ; cache_engine_versions =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "CacheEngineVersions" xml)
...
module PurchaseReservedCacheNodesOfferingResult = struct
  ...
  let parse xml =
    Some
      { reserved_cache_node =
          Util.option_bind (Xml.member "ReservedCacheNode" xml) ReservedCacheNode.parse
      }

  let to_query v =
    Query.List
      (Util.list_filter_opt
         [ Util.option_map v.reserved_cache_node (fun f ->
               Query.Pair ("ReservedCacheNode", ReservedCacheNode.to_query f))
         ])
  ...
  let of_json j =
    { reserved_cache_node =
        Util.option_map (Json.lookup j "reserved_cache_node") ReservedCacheNode.of_json
    }
end
...
module ListTagsForResourceMessage = struct
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt [ Some ("resource_name", String.to_json v.resource_name) ])
...
module ModifyUserGroupMessage = struct
  ...
  let parse xml =
    Some
      ...
      ; user_ids_to_add =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UserIdsToAdd" xml) UserIdListInput.parse)
      ; user_ids_to_remove =
          Util.of_option
            []
            (Util.option_bind (Xml.member "UserIdsToRemove" xml) UserIdListInput.parse)
      }
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some ("user_ids_to_remove", UserIdListInput.to_json v.user_ids_to_remove)
         ; Some ("user_ids_to_add", UserIdListInput.to_json v.user_ids_to_add)
         ; Some ("user_group_id", String.to_json v.user_group_id)
         ])
  ...
  let of_json j =
    { user_group_id = String.of_json (Util.of_option_exn (Json.lookup j "user_group_id"))
    ; user_ids_to_add =
        UserIdListInput.of_json (Util.of_option_exn (Json.lookup j "user_ids_to_add"))
    ; user_ids_to_remove =
        UserIdListInput.of_json (Util.of_option_exn (Json.lookup j "user_ids_to_remove"))
    }
end
...
module ReservedCacheNodeMessage = struct
    ...
    Some
      ...
      ; reserved_cache_nodes =
          Util.of_option
            []
            (Util.option_bind
               (Xml.member "ReservedCacheNodes" xml)
  ...
  let to_json v =
    `Assoc
      (Util.list_filter_opt
         [ Some
             ("reserved_cache_nodes", ReservedCacheNodeList.to_json v.reserved_cache_nodes)
         ; Util.option_map v.marker (fun f -> "marker", String.to_json f)
         ])
