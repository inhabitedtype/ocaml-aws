...
module NodeSnapshot = struct
  ...
  let make ?cache_node_id ?cache_size ?cache_node_create_time ?snapshot_create_time () =
    { cache_node_id; cache_size; cache_node_create_time; snapshot_create_time }
...
module NodeGroup = struct
  ...
  let make ?node_group_id ?status ?primary_endpoint ?(node_group_members = []) () =
...
module PendingModifiedValues = struct
  ...
  let make ?num_cache_nodes ?(cache_node_ids_to_remove = []) ?engine_version () =
...
module CacheSubnetGroup = struct
  ...
  let make
      ...
      ?(subnets = [])
      () =
    { cache_subnet_group_name; cache_subnet_group_description; vpc_id; subnets }
...
module CacheSecurityGroup = struct
  ...
  let make
      ...
      () =
    { owner_id; cache_security_group_name; description; e_c2_security_groups }
...
module ResetCacheParameterGroupMessage = struct
  ...
  let make ~cache_parameter_group_name ?reset_all_parameters ~parameter_name_values () =
...
module CreateSnapshotMessage = struct
  ...
  let make ~cache_cluster_id ~snapshot_name () = { cache_cluster_id; snapshot_name }
...
module DescribeSnapshotsMessage = struct
  ...
  let make ?cache_cluster_id ?snapshot_name ?snapshot_source ?marker ?max_records () =
