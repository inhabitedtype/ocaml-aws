...
(* OASIS_START *)
(* DO NOT EDIT (digest: 437ea79a982518c820a3f01b4c9b324b) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the Lwt runtime";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the Async runtime";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the code generation tool";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "aws_gen.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/inhabitedtype/ocaml-aws.git";
                      src_repo_browser =
                        Some "https://github.com/inhabitedtype/ocaml-aws";
     ...
     oasis_digest = Some "u\145\229\0316\212\154\164\214\145\180|\207\221aw";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
