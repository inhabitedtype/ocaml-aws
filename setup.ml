...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6c9173a8f3944e73ac37a49aeab253d1) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build the code generation binary";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\134\184\171\1799\0176\197\242\142\005\019F%;\136";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
